...
sap.ui.define([
	...
	QUnit.test("Should move buttons out of the actionsheet if there is space in the bar and there"
		...
		// reset spy to see that changing the DOM size triggers a resize event; sometimes
		// applyChanges already triggered a resize event
		oResizeHandler.reset();
		...
		// Assert
		assert.strictEqual(oResizeHandler.callCount, 1, "Resize handler is called once");
