sap.ui.define([
	...
	MockServerInitializer._initializeMockServerInitializationData = function() {
	...
	MockServerInitializer.initializeMockServers = function(aMockServersToInitialize) {
		if (MockServerInitializer._mockServerInitializationData === null) {
			MockServerInitializer._initializeMockServerInitializationData();
		}
	...
	MockServerInitializer.initializeMockData = async function(oComponent) {
		oComponent._oSharingDialog = oComponent._createSharingDialog();
		await oComponent._createSharingView();
