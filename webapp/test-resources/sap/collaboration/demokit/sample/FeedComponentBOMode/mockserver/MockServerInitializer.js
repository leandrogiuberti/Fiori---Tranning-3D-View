sap.ui.define([
	...
	MockServerInitializer.prototype.initializeMockData = async function(oGroupFeedComponent) {
		...
		var oSocialProfile = await oGroupFeedController._pSocialProfile;
		await oSocialProfile._createView();
