...
sap.ui.define([
    ...
    QUnit.module("sap.ovp.cards.charts.Line", {
        /**
    ...
    QUnit.test("Line chart - Without Filters", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_1",
                model: "salesShare",
        ...
        cardUtils
            ...
            .then(function (oView) {
                ...
                assert.ok(
                    chartUtils.vizNodeExists(cardXml, "line"),
                    "VIZ Frame - see that there is a VIZFrame for Line chart"
                );
                assert.ok(
    ...
    QUnit.test("Line chart - With Filters", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_2",
                model: "salesShare",
    ...
    QUnit.test("Line chart - With Filters Without Sorters", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_3",
                model: "salesShare",
    ...
    QUnit.test("Line chart - With faulty filter configuration", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_5",
                model: "salesShare",
    ...
    QUnit.test("Line chart - Without DataPoint Annotation", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_6",
                model: "salesShare",
    ...
    QUnit.test("Line chart - With DataPoint, Without Title and Value", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_7",
                model: "salesShare",
    ...
    QUnit.test("Line chart - With ObjectStream Filters", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_8",
                model: "salesShare",
    ...
    QUnit.test("Line chart - With MeasureAttributes and DimensionAttributes missing", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_9",
                model: "salesShare",
        ...
        cardUtils.createCardView(cardTestData, oModel).then(function (oView) {
            ...
            assert.ok(chartUtils.ovpNodeExists(cardXml), "OVP Card - see that there is a OVP Card Format");
            assert.ok(
                chartUtils.vizNodeNotExists(cardXml, "line"),
                "VIZ Frame - see that there is no VIZFrame rendered for Line chart"
            );
            fnDone();
        });
    });

    QUnit.test("Line chart - Axis title visibility when header exists.", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_10",
                model: "salesShare",
        ...
        cardUtils.createCardView(cardTestData, oModel).then(function (oView) {
            ...
            assert.ok(
                chartUtils.checkAxisTitleVisibility(cardViz, false),
    ...
    QUnit.test("Line chart - With Timeseries", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_11",
                model: "salesShare",
    ...
    QUnit.test("Line chart - Customizing with colorPalette - 4 colors", function (assert) {
        var cardTestData = {
            card: {
                id: "chart_12",
                model: "salesShare",
