...
"sap/ui/Device"], function (ODataModel, CoreComponent, Device) {
    ...
    utils.createCardView = function (cardData, oModel, oModelViewMap, sModelName) {
        return oModel.getMetaModel().loaded()
            .then(function () {
                ...
                if (oModelViewMap && sModelName) {
                    oComponentData.mainComponent = {
                            oModelViewMap: oModelViewMap ? oModelViewMap : {},
                    ...
                    oComponentData.modelName = sModelName ? sModelName : "";
                };
