sap.ui.define([
	...
	'sap/m/Label',
	'sap/m/Table'
], function (Element, ManagedObject, ValueHelpDialog, SmartFilterBar, Device, HorizontalLayout, JSONModel, syncStyleClass, ColumnListItem, Label, Table) {
    "use strict";
    ...
    ValueHelpItemAdder.prototype.getValueHelpDialog = function (oValueList) {
        ...
        if (this.oValueHelpDialog == null || this._oValueList != oValueList) {
			...
			syncStyleClass("sapUiSizeCompact", this.VIEW, this.oValueHelpDialog);
			syncStyleClass("sapUiSizeCozy", this.VIEW, this.oValueHelpDialog);
    ...
    ValueHelpItemAdder.prototype._rebindTable = function (oSmartFilterBar, sEntitySetName) {
        ...
        oTable = this.oValueHelpDialog.getTableAsync().then(function(oTable) {
