sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartfilterbar_DateTypes.Component", {
		metadata: {
			rootView: {
				"viewName": "sap.ui.comp.sample.smartfilterbar_DateTypes.SmartFilterBar",
				"type": "XML",
				"async": true
			},
			dependencies: {
		...
		init: function () {
			...
			var sMockdataUrl = sap.ui.require.toUrl("sap/ui/comp/sample/smartfilterbar_DateTypes/mockserver");
