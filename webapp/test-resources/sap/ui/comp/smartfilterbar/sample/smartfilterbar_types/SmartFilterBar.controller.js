sap.ui.define([
	...
	return Controller.extend("sap.ui.comp.sample.smartfilterbar_types.SmartFilterBar", {
		...
		onInit: function() {
			...
			this._ostatusTextExpanded = this.getView().byId("statusTextExpanded");
		...
		onAssignedFiltersChanged: function(oEvent) {
			if (this._oFilterBar) {
				var sText = this._oFilterBar.retrieveFiltersWithValuesAsText(),
					sExpandedText = this._oFilterBar.retrieveFiltersWithValuesAsTextExpanded();
				this._oStatusText.setText(sText);

				this._ostatusTextExpanded.setText(sExpandedText);
			}
		},
