sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DateTime Multi d-f Date",
			fieldConfigurationString: "Edm.DateTime sap:display-format='Date' sap:filter-restriction='multi-value' - No DateRangeType"
		},
		oExpected = {
			filterQuery: "DATETIME_MULTI_d-f_Date eq datetime'2023-02-01T00:00:00'",
