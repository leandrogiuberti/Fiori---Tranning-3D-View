sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DTOffset Auto",
			fieldConfigurationString: "Edm.DateTimeOffset - No DateRangeType"
		},
		oExpected = {
			filterQuery: "(DTOFFSET_AUTO ge datetimeoffset'2023-02-01T13:30:00Z' and DTOFFSET_AUTO le datetimeoffset'2023-02-01T13:30:00.999Z')",
	...
	oTestRunner.iEnterValue = function (When, sFieldName) {
		...
		When.iEnterValueInValueHelpMultiInput("sap.ui.comp.smartfilterbar.SmartFilterBar", "sap.m.DateTimePicker", sFieldName, sValue);
	};
