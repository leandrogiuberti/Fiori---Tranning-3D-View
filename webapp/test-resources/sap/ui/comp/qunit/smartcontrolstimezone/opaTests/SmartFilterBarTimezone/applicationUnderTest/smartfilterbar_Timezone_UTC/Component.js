sap.ui.define([
	...
	return UIComponent.extend("applicationUnderTest.smartfilterbar_Timezone_UTC.Component", {
		metadata: {
			manifest: "json"
		},
		init: function () {
			...
			var oMockServer = new MockServer({
				rootUri: "/smartfilterbar_Timezone_UTC/"
			});
			this._oMockServer = oMockServer;
			var sMockdataUrl = sap.ui.require.toUrl("applicationUnderTest/smartfilterbar_Timezone_UTC/mockserver");
