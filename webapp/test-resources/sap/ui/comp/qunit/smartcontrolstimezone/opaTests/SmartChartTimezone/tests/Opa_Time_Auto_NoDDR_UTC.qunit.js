sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "Time Auto",
			fieldConfigurationString: "Edm.Time Auto"
		},
		oExpected = {
			filterQuery: "TIME_AUTO eq time'PT13H30M00S'",
	...
	oTestRunner.iEnterValue = function (When, sFieldName) {
		When.iEnterValueInValueHelpMultiInput("sap.m.p13n.FilterPanel", "sap.m.TimePicker",  sFieldName, " 1:30:00 PM"); // 13:30:00
	};
