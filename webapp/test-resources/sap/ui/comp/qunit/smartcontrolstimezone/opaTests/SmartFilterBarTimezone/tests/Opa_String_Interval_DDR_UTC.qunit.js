sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "String Interval DDR",
			fieldConfigurationString: "Edm.String sap:filter-restriction='interval' - DateRangeType"
		},
		oExpected = {
			filterQuery: "(STRING_INTERVAL_DDR ge '20230201' and STRING_INTERVAL_DDR le '20230208')",
