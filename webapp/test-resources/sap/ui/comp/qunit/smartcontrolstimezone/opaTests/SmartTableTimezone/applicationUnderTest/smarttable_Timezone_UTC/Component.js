sap.ui.define([
	...
	return UIComponent.extend("applicationUnderTest.smarttable_Timezone_UTC.Component", {
		metadata: {
			manifest: "json"
		},
		init: function () {
			...
			var oMockServer = new MockServer({
				rootUri: "/smarttable_Timezone_UTC/"
			});
			this._oMockServer = oMockServer;
			var sMockdataUrl = sap.ui.require.toUrl("applicationUnderTest/smarttable_Timezone_UTC/mockserver");
