sap.ui.define([
	...
	var oConfig = {
		...
		fieldName: "DateTime Single DDR",
		fieldConfigurationString: "Edm.DateTime sap:filter-restriction='single-value' - DateRangeType",
		skipVariant: true // TODO: remove when DateTime fields with no display format are checked how should behave
	},
	oExpected = {
		filterQuery: "DATETIME_SINGLE_DDR eq datetime'2023-02-01T00:00:00'",
