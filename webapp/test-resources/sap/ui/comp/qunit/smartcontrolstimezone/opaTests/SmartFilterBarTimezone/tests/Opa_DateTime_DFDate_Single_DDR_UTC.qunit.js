sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DateTime Single d-f Date DDR",
			fieldConfigurationString: "Edm.DateTime sap:display-format='Date' sap:filter-restriction='single-value' - DateRangeType"
		},
		oExpected = {
			filterQuery: "DATETIME_SINGLE_d-f_Date_DDR eq datetime'2023-02-01T00:00:00'",
