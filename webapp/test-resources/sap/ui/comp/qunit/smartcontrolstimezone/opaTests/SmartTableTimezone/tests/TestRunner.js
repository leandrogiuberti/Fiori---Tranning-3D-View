...
sap.ui.define([
	...
	var SmartTableTimezoneTestRunner = BaseTestRunner.extend("sap.ui.comp.qunit.smartcontrolstimezone.opaTests.SmartTableTimezone.tests.opa.TestRunner", /** @lends sap.ui.comp.qunit.smartcontrolstimezone.opaTests.SmartTableTimezone.tests.opa.TestRunner */ {
	});

	SmartTableTimezoneTestRunner.prototype._arrange = function (Given, When, Then) {
		// Arrange
	...
	SmartTableTimezoneTestRunner.prototype._executeTests = function (oExpectedOverrides) {
	...
	SmartTableTimezoneTestRunner.prototype._clean = function (Given, When, Then) {
		// Cleanup
		When.iPressResetButton();
	};

	return SmartTableTimezoneTestRunner;
});
