sap.ui.define([
	...
	var oConfig = {
		...
		oExpected = {
			filterQuery: "DTOFFSET_AUTO eq datetimeoffset'2023-02-01T13:30:00Z'",
	...
	oTestRunner.iEnterValue = function (When, sFieldName) {
		...
		When.iEnterValueInValueHelpMultiInput("sap.m.p13n.FilterPanel", "sap.m.DatePicker", sFieldName, sValue); // 1st of February 2023
	};
