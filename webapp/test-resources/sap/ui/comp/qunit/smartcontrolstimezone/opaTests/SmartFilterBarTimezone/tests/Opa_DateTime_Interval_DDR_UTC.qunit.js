sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DateTime Interval DDR",
			fieldConfigurationString: "Edm.DateTime sap:filter-restriction='interval' - DateRangeType",
			skipVariant: true // TODO: remove when DateTime fields with no display format are checked how should behave
		},
		oExpected = {
			filterQuery: "(DATETIME_INTERVAL_DDR ge datetime'2023-02-01T00:00:00' and DATETIME_INTERVAL_DDR le datetime'2023-02-01T23:59:59.999')",
