sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "String Single CalendarDate",
			fieldConfigurationString: "Edm.String sap:filter-restriction='single-value' CalendarDate - No DateRangeType"
		},
		oExpected = {
			filterQuery: "STRING_SINGLE_CalendarDate eq '20230201'",
			variant: "20230201",
			uiState: "20230201",
