sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DateTime Single d-f Date",
			fieldConfigurationString: "Edm.DateTime sap:display-format='Date' sap:filter-restriction='single-value' - No DateRangeType"
		},
		oExpected = {
			filterQuery: "DATETIME_SINGLE_d-f_Date eq datetime'2023-02-01T00:00:00'",
	...
	oTestRunner.iEnterValue = function (When, sFieldName) {
		When.iEnterValueInDatePicker("sap.ui.comp.smartfilterbar.SmartFilterBar", sFieldName, "2/1/23"); // 1st of February 2023
	};
