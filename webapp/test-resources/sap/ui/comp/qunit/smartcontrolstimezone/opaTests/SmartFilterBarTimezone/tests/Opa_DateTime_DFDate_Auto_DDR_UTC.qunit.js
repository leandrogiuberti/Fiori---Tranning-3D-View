sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DateTime Auto d-f Date DDR",
			fieldConfigurationString: "Edm.DateTime sap:display-format='Date' - DateRangeType"
		},
		oExpected = {
			filterQuery: "(DATETIME_AUTO_d-f_Date_DDR ge datetime'2023-02-01T00:00:00' and DATETIME_AUTO_d-f_Date_DDR le datetime'2023-02-01T00:00:00')",
