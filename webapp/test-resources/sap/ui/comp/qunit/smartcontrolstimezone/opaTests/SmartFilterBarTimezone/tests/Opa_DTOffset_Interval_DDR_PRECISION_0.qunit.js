sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DTOffset DDR Precision=0",
			fieldConfigurationString: "Edm.DateTimeOffset sap:filter-restriction='interval' - DateRangeType Precision=0"
		},
		oExpected = {
			filterQuery: "(DTOFFSET_DDR_PRECISION0 ge datetimeoffset'2023-02-01T13:30:00Z' and DTOFFSET_DDR_PRECISION0 le datetimeoffset'2023-02-01T13:30:00Z')",
