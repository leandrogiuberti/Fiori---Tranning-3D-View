sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DTOffset Multi",
			fieldConfigurationString: "Edm.DateTimeOffset sap:filter-restriction='multi-value' - No DateRangeType"
		},
		oExpected = {
			filterQuery: "DTOFFSET_MULTI eq datetimeoffset'2023-02-01T13:30:00Z'",
