sap.ui.define([
	...
	var oConfig = {
			...
			fieldName: "DateTime Multi d-f Date DDR",
			fieldConfigurationString: "Edm.DateTime sap:display-format='Date' sap:filter-restriction='multi-value' - DateRangeType"
		},
		oExpected = {
			filterQuery: "(DATETIME_MULTI_d-f_Date_DDR ge datetime'2023-02-01T00:00:00' and DATETIME_MULTI_d-f_Date_DDR le datetime'2023-02-01T00:00:00')",
