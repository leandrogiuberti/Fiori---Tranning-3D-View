...
sap.ui.define([
	...
	QUnit.module("DateTimeOffset Auto with EQ");

    opaTest("Check with condition EQ send query with precision", function(Given, When, Then) {
        // Arrange
    ...
    opaTest("Saving and restoring variant with condition EQ", function(Given, When, Then) {
        // Arrange
        Given.iEnsureMyAppIsRunning();
        var aControlName = ["DTOFFSET_AUTO", "DTOFFSET_AUTO_PRECISION0", "DTOFFSET_AUTO_PRECISION1", "DTOFFSET_AUTO_PRECISION2", "DTOFFSET_AUTO_PRECISION3",
                "DTOFFSET_AUTO_PRECISION4", "DTOFFSET_AUTO_PRECISION5", "DTOFFSET_AUTO_PRECISION6", "DTOFFSET_AUTO_PRECISION7"],
        ...
        // Act
        var sVariantName = "DTOFFSET_AUTO_EQ" + new Date().toISOString();
