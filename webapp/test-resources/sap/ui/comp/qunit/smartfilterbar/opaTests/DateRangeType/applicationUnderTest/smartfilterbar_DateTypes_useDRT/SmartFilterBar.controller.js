sap.ui.define([
	...
	return Controller.extend("applicationUnderTest.smartfilterbar_DateTypes_useDRT.SmartFilterBar", {
...
//				}
		...
		onSetUiState: function () {
            var oUiState = '{"$Parameter.P_KeyDate":{"conditionTypeInfo":{"name":"sap.ui.comp.config.condition.DateRangeType","data":{"operation":"DATE","value1":"2018-11-30T22:00:00.000Z","value2":null,"key":"$Parameter.P_KeyDate","calendarType":"Gregorian"}},"ranges":[{"operation":"EQ","value1":"2018-11-30T22:00:00.000Z","exclude":false,"keyField":"$Parameter.P_KeyDate"}],"items":[]}}';

			this._oFilterBar.setFilterDataAsString(oUiState);
		},

		onSetUiStateWithNoSemanticDates: function () {
			var oUiState = this._oFilterBar.getUiState();
			oUiState.setSemanticDates({ Dates: [] });
			this._oFilterBar.setUiState(oUiState);
		},
