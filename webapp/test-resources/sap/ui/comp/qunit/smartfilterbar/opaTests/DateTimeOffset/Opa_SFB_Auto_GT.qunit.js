...
sap.ui.define([
	...
	QUnit.module("DateTimeOffset Auto GT");

    opaTest("Saving and restoring variant with condition GT", function(Given, When, Then) {
        // Arrange
        ...
        var aControlName = ["DTOFFSET_AUTO", "DTOFFSET_AUTO_PRECISION0", "DTOFFSET_AUTO_PRECISION1", "DTOFFSET_AUTO_PRECISION2", "DTOFFSET_AUTO_PRECISION3",
            ...
            sDateStartResult = "2024-01-12T17:25:00Z",
            sDateEndResult = sDateStartResult.substring(0,19);

        // Act
        When.iClickShowAll();
        fSetConditionValues(When, aControlName, sViewName, "EQ",[sDate]);
        When.iPressTheFilterGoButton();

        var sResult = "(DTOFFSET_AUTO ge datetimeoffset'" + sDateStartResult + "' and " +
            "DTOFFSET_AUTO le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO") + "') and " +
            "(DTOFFSET_AUTO_PRECISION0 ge datetimeoffset'" + sDateStartResult +
            "' and DTOFFSET_AUTO_PRECISION0 le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO_PRECISION0") + "') and " +
            "(DTOFFSET_AUTO_PRECISION1 ge datetimeoffset'" + sDateStartResult +
            "' and DTOFFSET_AUTO_PRECISION1 le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO_PRECISION1") + "') and " +
            "(DTOFFSET_AUTO_PRECISION2 ge datetimeoffset'" + sDateStartResult +
            "' and DTOFFSET_AUTO_PRECISION2 le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO_PRECISION2") + "') and " +
            "(DTOFFSET_AUTO_PRECISION3 ge datetimeoffset'" + sDateStartResult +
            "' and DTOFFSET_AUTO_PRECISION3 le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO_PRECISION3") + "') and " +
            "(DTOFFSET_AUTO_PRECISION4 ge datetimeoffset'" + sDateStartResult +
            "' and DTOFFSET_AUTO_PRECISION4 le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO_PRECISION4") + "') and " +
            "(DTOFFSET_AUTO_PRECISION5 ge datetimeoffset'" + sDateStartResult +
            "' and DTOFFSET_AUTO_PRECISION5 le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO_PRECISION5") + "') and " +
            "(DTOFFSET_AUTO_PRECISION6 ge datetimeoffset'" + sDateStartResult +
            "' and DTOFFSET_AUTO_PRECISION6 le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO_PRECISION6") + "') and " +
            "(DTOFFSET_AUTO_PRECISION7 ge datetimeoffset'" + sDateStartResult +
            "' and DTOFFSET_AUTO_PRECISION7 le datetimeoffset'" + sDateEndResult + fReturnMilliseconds("DTOFFSET_AUTO_PRECISION7") + "')";
        Then.theFiltersShouldMatch(sResult);

        // Act
        var sVariantName = "DTOFFSET_AUTO_BT" + new Date().toISOString();
    ...
    opaTest("Check with condition GT send query with precision", function(Given, When, Then) {
        // Arrange
        Given.iEnsureMyAppIsRunning();
        var aControlName = ["DTOFFSET_AUTO", "DTOFFSET_AUTO_PRECISION0", "DTOFFSET_AUTO_PRECISION1", "DTOFFSET_AUTO_PRECISION2", "DTOFFSET_AUTO_PRECISION3",
                "DTOFFSET_AUTO_PRECISION4", "DTOFFSET_AUTO_PRECISION5", "DTOFFSET_AUTO_PRECISION6", "DTOFFSET_AUTO_PRECISION7"],
        ...
        // Act
        When.iClickShowAll();
        fSetConditionValues(When, aControlName, sViewName, "GT",[sDate]);
        When.iPressTheFilterGoButton();
        // Assert

        var sResult = "DTOFFSET_AUTO gt datetimeoffset'" + sDateResult +
                "' and DTOFFSET_AUTO_PRECISION0 gt datetimeoffset'" + sDateResult +
                "' and DTOFFSET_AUTO_PRECISION1 gt datetimeoffset'" + sDateResult +
                "' and DTOFFSET_AUTO_PRECISION2 gt datetimeoffset'" + sDateResult +
                "' and DTOFFSET_AUTO_PRECISION3 gt datetimeoffset'" + sDateResult +
                "' and DTOFFSET_AUTO_PRECISION4 gt datetimeoffset'" + sDateResult +
                "' and DTOFFSET_AUTO_PRECISION5 gt datetimeoffset'" + sDateResult +
                "' and DTOFFSET_AUTO_PRECISION6 gt datetimeoffset'" + sDateResult +
                "' and DTOFFSET_AUTO_PRECISION7 gt datetimeoffset'" + sDateResult + "'",
            oRange = {
                "Sign": "I",
                "Option": "GT",
                "Low": sLow,
