sap.ui.define([
	...
	return UIComponent.extend("applicationUnderTest.smartfilterbar_DateTypes_useDRT.Component", {
		metadata: {
			rootView: {
				"viewName": "applicationUnderTest.smartfilterbar_DateTypes_useDRT.SmartFilterBar",
				"type": "XML",
				"async": true
			},
			dependencies: {
		...
		init: function () {
			...
			var sMockdataUrl = sap.ui.require.toUrl("applicationUnderTest/smartfilterbar_DateTypes_useDRT/mockserver");
