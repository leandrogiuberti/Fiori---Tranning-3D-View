sap.ui.define([
	...
	return UIComponent.extend("applicationUnderTest.smartfilterbar_AdaptFilterRearrange.Component", {
		metadata: {
			rootView: {
				"viewName": "applicationUnderTest.smartfilterbar_AdaptFilterRearrange.SmartFilterBar",
				"type": "XML",
				"async": true
			},
			dependencies: {
		...
		init: function () {
			...
			var sMockdataUrl = sap.ui.require.toUrl("applicationUnderTest/smartfilterbar_AdaptFilterRearrange/mockserver");
