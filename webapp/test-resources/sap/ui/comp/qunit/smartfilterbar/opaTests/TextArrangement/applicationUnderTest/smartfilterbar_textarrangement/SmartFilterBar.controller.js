sap.ui.define([
	...
	return Controller.extend("sap.ui.comp.sample.smartfilterbar_textarrangement.SmartFilterBar", {
		...
		onShortModeChange: function (oEvent) {
			var bState = oEvent.getParameter("state");

			// Toggle visibility
			this._oFilterBar.setVisible(!bState);
			this._oFilterBarShort.setVisible(bState);
		},
