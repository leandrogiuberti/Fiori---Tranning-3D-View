...
sap.ui.define([
	...
	QUnit.module("DateTimeOffset Auto NotEQ");

    opaTest("Check with condition Not EQ send query with precision", function(Given, When, Then) {
        // Arrange
