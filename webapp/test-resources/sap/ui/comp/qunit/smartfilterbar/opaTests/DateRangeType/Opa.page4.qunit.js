...
sap.ui.define([
	...
	QUnit.module("Ticket related incidents");

	opaTest("It should set value correctly if lazy option is loaded", function(Given, When, Then) {
		// Arrange
		Given.iEnsureMyAppIsRunning();

		// Act
		When.iPressButton("lazyOptionValueSet");
		When.iPressTheFilterGoButton();

		// Assert
		Then.iShouldSeeDynamicDateRangeWithValue("smartFilterBar-filterItemControlA_-Test8", { operator: "TOMORROW", values: [] });
