	...
	function (Error, BaseObject, jQuery, Log) {
		...
		var SelectionVariant = BaseObject.extend("sap.ui.comp.sample.MockSelectionVariant",  {
			...
			_serializeParameters: function (oExternalSelectionVariant) {
				...
				Object.keys(this._mParameters).forEach(function (sParameterName) {
					var sParameterValue = this._mParameters[sParameterName];
					var oParObject = {
			...
			_serializeSelectOptions: function (oExternalSelectionVariant) {
				...
				Object.keys(this._mSelectOptions).forEach(function (sPropertyName) {
					var aEntries = this._mSelectOptions[sPropertyName];
					var oSelectOption = {
