sap.ui.define([
	...
	return UIComponent.extend("applicationUnderTest.smartfilterbar_DDR_mandatory.Component", {
		metadata: {
		    manifest: "json"
		},
		init: function () {
			...
			var sMockdataUrl = sap.ui.require.toUrl("applicationUnderTest/smartfilterbar_DDR_mandatory/mockserver");
