	...
	return Controller.extend("view.Main", {
		...
		onInit: function() {
			...
			oModel.getMetaModel().loaded().then(function(){
				...
				this.aInitialSorter = aColumnKeysOrdered.reduce(function(aSorter, sColumnKey, iIndex, aColumnKeys) {
					var bIsSorted = that.oColumnKey2ColumnMap[sColumnKey].getSortOrder() !== "None";
		...
		_initVariantManagement: function() {
			...
			oControl.applyVariant = function(oVariantJSON) {
				this.oP13nDialogController.setPersonalizationData(isEmptyObject(oVariantJSON) ? null : merge({}, oVariantJSON));
