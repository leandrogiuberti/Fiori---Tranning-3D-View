...
(function() {
	...
	sap.ui.define([
		...
		QUnit.test("getSideEffects", function (assert) {
		...
		QUnit.test("_checkSourceProperties", function (assert) {
			var oSideEffectWithSourceProperties = {
					SourceProperties: [
						{
							PropertyPath: "TaxAmount"
						}
			...
			assert.ok(this.oSideEffects._checkSourceProperties(oSideEffectWithSourceProperties, "TaxAmount"));
		});

		QUnit.test("_checkSourceEntities", function (assert) {
			var oSideEffectWithSourceEntities = {
					SourceEntities: [
						{
							NavigationPropertyPath: "Item/ScheduleLine"
						}
			...
			assert.ok(this.oSideEffects._checkSourceEntities(oSideEffectWithSourceEntities, "Item/ScheduleLine"));
		});
