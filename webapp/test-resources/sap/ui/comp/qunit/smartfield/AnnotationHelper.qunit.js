...
sap.ui.define([
	...
	QUnit.test("getUIHiddenPath", function(assert) {
		var oProperty, oResult;
		...
		oProperty = {
				...
				"com.sap.vocabularies.UI.v1.Hidden": {
					"Path": "CreatedAt_UIHidden"
				}
		};

		oResult = this.oMetaData.getUIHiddenPath(oProperty);
		assert.equal(oResult, "CreatedAt_UIHidden");
	});
	...
	QUnit.test("getVisible", function(assert) {
		...
		//if visible has binding path to another EDM Property
		delete oProperty["sap:visible"];
		delete oProperty["com.sap.vocabularies.Common.v1.FieldControl"];
		oProperty["com.sap.vocabularies.UI.v1.Hidden"] = { "Path": "EDMProperty" };
		oResult = this.oMetaData.getVisible(oProperty);
		assert.equal(oResult, "true");
	});

	QUnit.test("getVisible - visible with UI.Hidden annotation default value", function(assert) {
		var oProperty = {
				"name": "Name",
				"type": "Edm.String",
				"com.sap.vocabularies.UI.v1.Hidden": {}
		...
		bResult = this.oMetaData.getVisible(oProperty);
