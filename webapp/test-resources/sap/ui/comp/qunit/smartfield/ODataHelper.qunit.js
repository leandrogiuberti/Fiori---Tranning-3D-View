...
sap.ui.define([
	...
	QUnit.test("applyCriticality - Should apply criticality taken from DataFieldDefault, LineItem, DataPoint, FieldGroup or ConnectedFields", function(assert) {
	//Arrange
	var oDataHelper = this.oMetaData,
				...
				connectedfields: [
					{
						"annotation": {
							"Label": {
								"String": "Semantically connected field(issue example)"
							},
							"Template": {
								"String": "{IsActiveEntity} / {ProductCategory}"
							},
							"Data": {
								"Name": {
									"Value": {
						...
						"groupLabel": "Semantically connected field(issue example)",
						"criticality": {
							"Name": {
								"path": "Criticality"
							}
		...
		oTestingObjects = [
			...
			{criticalityFromAnnotation: "ConnectedFields", metadata: oMetadataWithConnectedFields, qualifiers: [null, "IsSimulatedIndicator"]}
		];
