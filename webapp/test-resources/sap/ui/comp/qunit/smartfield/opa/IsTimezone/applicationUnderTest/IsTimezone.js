			...
			sap.ui.require([
				...
				var MyController = Controller.extend("mainView.controller", {
					onInit: function () {
						...
						this._oModel = oModel;
						window.model = oModel;
						oModel.attachPropertyChange(this.showPendingChanges.bind(this));
						this.showPendingChanges();
					},
					showPendingChanges: function () {
						if (this._oModel.getPendingChanges()["Employees('0001')"]) {
							this.byId("modelDump").setText(
								"Name:" +
								this._oModel.getPendingChanges()["Employees('0001')"].Name +
								", Cbmx:" +
								this._oModel.getPendingChanges()["Employees('0001')"].Cbmx
							);
						}
					},
					onExit: function () {
