...
sap.ui.define([
    ...
    "use strict";
    var appUrl = sap.ui.require.toUrl("test-resources/sap/ui/comp/qunit/smartfield/opa/CurrencyAndUoMWithCustomList/applicationUnderTestUoM/UoMWithCustomListFixedList.html"),
	...
	sap.ui.require([
		...
		opaTest("When I input a valid Quantity amount and code, it should be formatted correctly with value state NONE", function (Given, When, Then) {
			...
			Then.onTheSmartFieldTypesPage.iShouldSeeSmartFieldFixedListWithIdAndValue(sUnitCodeControlId, "Kilogram");
