...
sap.ui.define([
...
], function (SmartColumnMicroChart, JSONModel, Label, Model, CustomData, ColumnMicroChart, Button, MLibrary, nextUIUpdate) {
	"use strict";
	...
	QUnit.test("Labels are updated",function(assert){
		this.oSCMC._updateLabel("leftTopLabel",{text:"label"});
		assert.equal(this.oSCMC.getAggregation("_chart").getAggregation("leftTopLabel").getProperty("label"),"label","leftTopLabel updated successfully");
		this.oSCMC._updateLabel("rightTopLabel",{text:"label"});
		assert.equal(this.oSCMC.getAggregation("_chart").getAggregation("rightTopLabel").getProperty("label"),"label","rightTopLabel updated successfully");
		this.oSCMC._updateLabel("leftBottomLabel",{text:"label"});
		assert.equal(this.oSCMC.getAggregation("_chart").getAggregation("leftBottomLabel").getProperty("label"),"label","leftBottomLabel updated successfully");
		this.oSCMC._updateLabel("rightBottomLabel",{text:"label"});
		assert.equal(this.oSCMC.getAggregation("_chart").getAggregation("rightBottomLabel").getProperty("label"),"label","rightBottomLabel updated successfully");
	});
	...
	*/
	QUnit.test("Height and width not set when isResponsive true", async function(assert) {
		this.oSCMC.setHeight("200px");
		this.oSCMC.setWidth("200px");
		this.oSCMC.setSize(Size.Responsive);
	...
	/**
		* @deprecated Since version 1.62
	*/
	QUnit.test("Height and width set when isResponsive false", async function(assert) {
		this.oSCMC.setHeight("200px");
		this.oSCMC.setWidth("200px");
		this.oSCMC.setSize(Size.Auto);
