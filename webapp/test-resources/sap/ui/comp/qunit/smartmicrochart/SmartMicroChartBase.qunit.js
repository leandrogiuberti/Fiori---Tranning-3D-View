...
sap.ui.define([
	...
	QUnit.test("Check decimal consistency", function (assert) {
		//Act
		sinon.stub(this.oChart, "_getPropertyAnnotation").returns({
			precision: 25,
			scale: 3
		...
		var oFormatter = this.oChart._getLabelNumberFormatter();
		//Assert
		assert.equal(oFormatter.format(1244.445445),"1.244K", "Returns a number three decimal number");
		assert.equal(oFormatter.format(1244.44), "1.244K", "Returns a three decimal number");
		this.oChart._getPropertyAnnotation.restore();
	});
