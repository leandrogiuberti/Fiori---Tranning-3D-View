sap.ui.define([
	"sap/ui/model/odata/v2/ODataModel", "sap/ui/core/util/MockServer", "sap/ui/core/CustomData", "sap/ui/core/mvc/Controller"
], function(ODataModel, MockServer, CustomData, Controller) {
	"use strict";

	return Controller.extend("sap.ui.comp.sample.smartmicrochart.SmartBulletMicroChart.exampleDirect.Page", {
		onInit: function() {
