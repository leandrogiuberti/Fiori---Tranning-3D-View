sap.ui.define([ "sap/ui/model/odata/v2/ODataModel", "sap/ui/core/util/MockServer", "sap/ui/core/mvc/Controller" ],
	function(ODataModel, MockServer, Controller) {
	"use strict";

	return Controller.extend("sap.ui.comp.sample.smartmicrochart.SmartBulletMicroChart.exampleDeltaMode.Page", {
		onInit: function() {
