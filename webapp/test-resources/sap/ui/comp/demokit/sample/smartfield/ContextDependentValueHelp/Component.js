sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartfield.ContextDependentValueHelp.Component", {
		metadata: {
			manifest: "json"
		},
		init: function () {
			...
			this.oMockServer = new MockServer({
				rootUri: "smartfield.ContextDependentValueHelp.Main/"
			});
			...
			this.oModel = new ODataModel("smartfield.ContextDependentValueHelp.Main");
