sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartfield.SmartFieldWithCompositeKeys.Component", {
		metadata: {
			manifest: "json"
		},
		init: function () {
			...
			this.oMockServer = new MockServer({
				rootUri: "smartfield.SmartFieldWithCompositeKeys.Main/"
			});
			...
			this.oModel = new ODataModel("smartfield.SmartFieldWithCompositeKeys.Main");
