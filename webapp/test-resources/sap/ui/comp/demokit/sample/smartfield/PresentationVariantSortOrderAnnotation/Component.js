sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartfield.PresentationVariantSortOrderAnnotation.Component", {
		metadata: {
			manifest: "json"
		},
		init: function () {
			...
			this.oMockServer = new MockServer({
				rootUri: "smartfield.PresentationVariantSortOrderAnnotation.Main/"
			});
			...
			this.oMockServer.simulate(sMockdataUrl + "/metadata.xml", {
				...
				aEntitySetsNames: [
					"VL_Companies", "Products"
				]
			});
			this.oMockServer.start();

			//define the model for the data, using the mockserver
			this.oModel = new ODataModel("smartfield.PresentationVariantSortOrderAnnotation.Main");
