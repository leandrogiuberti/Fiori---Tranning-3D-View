sap.ui.define([
	...
	return Controller.extend("sap.ui.comp.sample.valuehelpdialog.conditionsOnly.ValueHelpDialogs", {
		onInit: function () {
		...
		onMultipleConditionsVHRequested: function() {
			...
			this.loadFragment({
				name: "sap.ui.comp.sample.valuehelpdialog.conditionsOnly.ValueHelpDialogMultipleConditions"
