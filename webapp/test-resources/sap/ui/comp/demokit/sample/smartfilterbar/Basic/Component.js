sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartfilterbar.Basic.Component", {
		...
		init: function () {
			...
			/** Start Mockserver using unique 'rootUri' key string
				to avoid shared metadata caching. */
			this._oMockServer = new MockServer({
				rootUri: "/MockDataServiceExample1/"
			});
