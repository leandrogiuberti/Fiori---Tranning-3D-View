...
], function(ODataModel, MockServer, MessageToast, ResourceModel, syncStyleClass, Controller, Fragment) {
	"use strict";

	return Controller.extend("sap.ui.comp.sample.smartmultieditfriendly.Page", {
		onInit: function() {
		...
		onOpenMultiEdit: function() {
			Fragment.load({
				name: "sap.ui.comp.sample.smartmultieditfriendly.MultiEditDialog",
				controller: this
