sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartchart.calendarFiscalAnnotations.Component", {
		metadata: {
			manifest: "json"
		},

		init: function () {
			var sMockdataBaseUrl = "test-resources/sap/ui/comp/demokit/sample/smartchart/calendarFiscalAnnotations/mockserver/";
