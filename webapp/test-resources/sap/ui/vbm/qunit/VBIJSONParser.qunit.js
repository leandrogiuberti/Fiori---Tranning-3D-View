...
sap.ui.define([
	...
	QUnit.test("Removing data", function(assert) {
		...
		assert.ok(library.findInArray(context.data.Axles, compare.bind(undefined, "QPLpY6+KHueQh/KMyCjtpA==")) !== undefined, "Axle with id 'QPLpY6+KHueQh/KMyCjtpA==' is found.");
		assert.ok(library.findInArray(context.data.Boxes, compare.bind(undefined, "QPLpY6+KHueQh/C2vWLtoQ==")) !== undefined, "Box with id 'QPLpY6+KHueQh/C2vWLtoQ==' is found.");
		assert.ok(library.findInArray(context.data.Boxes, compare.bind(undefined, "QPLpY6+KHueQh/KMyCiNpA==")) !== undefined, "Box with id 'QPLpY6+KHueQh/KMyCiNpA==' is found.");

		parser.loadVBIJSON(removeDataVBIJSON);

		assert.ok(library.findInArray(context.data.Axles, compare.bind(undefined, "QPLpY6+KHueQh/KMyCjtpA==")) === undefined, "Axle with id 'QPLpY6+KHueQh/KMyCjtpA==' is removed successfully.");
		assert.ok(library.findInArray(context.data.Boxes, compare.bind(undefined, "QPLpY6+KHueQh/C2vWLtoQ==")) === undefined, "Box with id 'QPLpY6+KHueQh/C2vWLtoQ==' is removed successfully.");
		assert.ok(library.findInArray(context.data.Boxes, compare.bind(undefined, "QPLpY6+KHueQh/KMyCiNpA==")) === undefined, "Box with id 'QPLpY6+KHueQh/KMyCiNpA==' is removed successfully.");
	});
