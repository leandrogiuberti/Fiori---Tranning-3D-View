sap.ui.define([
	...
	return Controller.extend("sap.ui.vbm.sample.AnalyticMapSpots.Main", {

		onInit: function() {
			var oModel = new JSONModel("test-resources/sap/ui/vbm/demokit/sample/AnalyticMapSpots/Data.json");
