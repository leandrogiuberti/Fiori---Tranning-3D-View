sap.ui.define([
	...
	return Controller.extend("sap.ui.vbm.sample.AnalyticMapCircles.Main", {

		onInit: function () {
			var oModel = new JSONModel("test-resources/sap/ui/vbm/demokit/sample/AnalyticMapCircles/Data.json");
		...
		onContextMenuCircle: function ( evt ) {
			MessageToast.show("Circle onContextMenu");
		}
	});
