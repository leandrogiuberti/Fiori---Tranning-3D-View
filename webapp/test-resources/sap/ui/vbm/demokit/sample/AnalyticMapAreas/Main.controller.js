sap.ui.define([
	...
	return Controller.extend("sap.ui.vbm.sample.AnalyticMapAreas.Main", {

		onInit: function () {
			var oModel = new JSONModel("test-resources/sap/ui/vbm/demokit/sample/AnalyticMapAreas/Data.json");
