sap.ui.define([
	...
	return Controller.extend("threejsObjects.controller.App", {
		...
		onInit: function() {
			...
			obj = new THREE.Mesh(
				new THREE.TorusKnotGeometry(4, 1, 256, 24),
			...
			obj = new THREE.Mesh(
				new THREE.CylinderGeometry(5, 5, 10, 48),
			...
			obj = new THREE.Mesh(
				...
				new THREE.MeshPhongMaterial({ color: 0x0000C0, flatShading: true })
			);
			...
			obj = new THREE.Mesh(
				...
				new THREE.MeshPhongMaterial({ color: 0x00C000, flatShading: true })
			);
			...
			obj = new THREE.Mesh(
				...
				new THREE.MeshPhongMaterial({ color: 0xC0C000, flatShading: true })
			);
