sap.ui.define([
	...
	MockDvl([{
		...
		Materials: [
			{ name: "Black", emissiveColor: 0 },
			{
				name: "Blue", opacity: 1.0, glossiness: 0.2, specularLevel: 0.4, emissiveColor: 0x0000FF, ambientColor: 0, specularColor: 0, diffuseColor: 0,
				textures: []
			},
			{ name: "Green", emissiveColor: 0x00FF00 },
			{ name: "Material #10" },
			{ name: "Material #11" },
			{ name: "Material #12" },
			{ name: "Material #7" },
			{ name: "Material #8" },
			{ name: "Material #9" },
			{ name: "Purple", emissiveColor: 0xFF00FF },
			{ name: "Red", emissiveColor: 0xFF0000 },
			{ name: "Yellow", emissiveColor: 0xFFFF00 }
		]
	}])
