sap.ui.define([
	...
	MockDvl([{
		...
		SceneId: "scene1",
		Nodes: [
			{ id: "n1", NodeName: "colorBox", ChildNodes: [] },
			{ id: "n2", NodeName: "smallBox", ChildNodes: [] },
			{ id: "c1", NodeName: "Camera", ParentNodes: [] }
		],
		Camera: {
			id: "c1",
			name: "Camera",
			origin: [109.09, -129.072, 192.63],
			rotation: [135, -35.3, -0.0003],
			targetDirection: [-0.577096, 0.577096, -0.577858],
			upDirection: [-0.408611, 0.408603, 0.816138],
			matrix: [-0.577096, 0.577096, -0.577858, 0, -0.707105, -0.707109, -0.0000044029, 0, -0.408611, 0.408603, 0.816138, 0, 109.09, -129.072, 192.63, 1],
			fov: 30,
			fovBinding: 0,
			orthoZoomFactor: 0.0197,
			projection: sap.ve.dvl.DVLCAMERAPROJECTION.ORTHOGRAPHIC
		}
	}]);
