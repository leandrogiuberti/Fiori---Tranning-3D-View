		...
		oViewer.attachSceneLoadingSucceeded(function() {
			...
			QUnit.test("Scene.RetrieveNodeInfo", function(assert) {
				...
				assert.ok(
					...
					obj.Flags === 536876033 &&
					obj.HighlightColor === 0 &&
					obj.NodeName == "colorBox" &&
					obj.Opacity === 1 &&
					obj.ParentNodes.length == 0 &&
					obj.URIs.length === 0 &&
					obj.UniqueID == "{C6D85041-5F8C-4A46-8824-320479BE102C}\n#16"
				);
			});
