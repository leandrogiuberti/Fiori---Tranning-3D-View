sap.ui.define([
	...
	MockDvl([{
		...
		SceneId: "scene1",
		Nodes: [
			{ id: "n1", NodeName: "Box #5", Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE, Opacity: 0.75, ChildNodes: ["n2"] },
			{ id: "n2", NodeName: "Box #6", Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE, Opacity: 0.75, ChildNodes: ["n3", "n4", "n5"], ParentNodes: ["n1"] },
			{ id: "n3", NodeName: "Box #22", Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE, Opacity: 0.75, ChildNodes: [], ParentNodes: ["n2", "n1"] },
			{ id: "n4", NodeName: "Box #23", Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE, Opacity: 0.75, ChildNodes: [], ParentNodes: ["n2", "n1"] },
			{ id: "n5", NodeName: "Box #24", Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE, Opacity: 0.75, ChildNodes: [], ParentNodes: ["n2", "n1"] }
		]
	}]);
