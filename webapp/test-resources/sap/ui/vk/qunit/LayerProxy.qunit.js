sap.ui.define([
	...
	MockDvl([{
		Source: "media/9cubes-layers-c.vds",
		SceneId: "scene1",
		Nodes: [
			{ id: "n1", NodeName: "root", ChildNodes: ["n2", "n3", "n4", "n5", "n6", "n7"], flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE },
			{ id: "n2", NodeName: "Box2", ChildNodes: [], Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE },
			{ id: "n3", NodeName: "Box4", ChildNodes: [], Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE },
			{ id: "n4", NodeName: "Box9", ChildNodes: [], Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE },
			{ id: "n5", NodeName: "Box3", ChildNodes: [], Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE },
			{ id: "n6", NodeName: "Box5", ChildNodes: [], Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE },
			{ id: "n7", NodeName: "Box7", ChildNodes: [], Flags: sap.ve.dvl.DVLNODEFLAG.DVLNODEFLAG_VISIBLE },

		],
		Layers: [
			{
				id: "l1", name: "Layer1", description: "Non-diagonal cubes.",
				veid: [{
					fields: [{
						name: "ID",
			...
			{
				id: "l2", name: "Layer2", description: "Diagonal cubes.",
				veid: [{
					fields: [{
						name: "ID",
	...
	QUnit.test("Loading model with layers", function(assertMain) {
		...
		viewer.attachSceneLoadingSucceeded(function(event) {
			...
			var layers = layerIds.map(function(id) { return nodeHierarchy.createLayerProxy(id); });
