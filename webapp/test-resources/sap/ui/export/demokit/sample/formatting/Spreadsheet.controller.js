sap.ui.define([
	...
	return Controller.extend("sap.ui.export.sample.formatting.Spreadsheet", {
		...
		createColumnConfig: function() {
			...
			/* 17. Add a local Timezone column */
			aCols.push({
				label: "Timezone",
				type: EdmType.Timezone,
				property: "TimezoneID",
				width: 20
			});

			/* 18. Add a simple Time column */
			aCols.push({
				label: "Time",
				type: EdmType.Time,
				property: "SampleTime"
			...
			/* 22. Add a simple Currency column */
			aCols.push({
				label: "Currency",
			...
			/* 23. Add a simple Boolean column */
			aCols.push({
				label: "Boolean",
			...
			/* 24. Add a custom Boolean column */
			aCols.push({
