...
import { extractValueWithoutBooleanExprBinding } from "sap/cards/ap/generator/utils/CommonUtils";
...
describe("getArrangements - Text arrangement, validate bindings.", () => {
	...
	test("Boolean property text arranged with a boolean property", async () => {
	...
	test("Boolean property text arranged with a non boolean property", async () => {
		const propertyValue = "{Activation_ac}";
		//Text First
		let mOptions = {
			unitOfMeasures: [
	...
	test("Property without uom and formatter text arranged with a boolean property", async () => {
...
describe("getArrangements - Unit of measure, validate bindings.", () => {
	...
	test("Property without uom and formatter is applied with a boolean unit of measure", async () => {
		const propertyValue = "{bp_id}";
		let mOptions = {
			unitOfMeasures: [
				{
	...
	test("Property with uom and formatter is modified with a boolean unit of measure", async () => {
		const propertyValue = "{gross_amount}";
		let mOptions = {
			unitOfMeasures: [
				{
...
describe("getArrangements - Text arrangement and Unit of measure, validate bindings.", () => {
	...
	test("Property with uom and without formatter is text arranged with a boolean property", async () => {
		const propertyValue = "{bp_id}";
		//Text First
		let mOptions = {
			unitOfMeasures: [
	...
	test("Property with uom and formatter is text arranged with a boolean property", async () => {
		const propertyValue = "{gross_amount}";
		//Text First
		let mOptions = {
			unitOfMeasures: [
	...
	test("Property with a boolean uom and formatter is text arranged with a boolean property", async () => {
		const propertyValue = "{gross_amount}";
		//Text First
		let mOptions = {
			unitOfMeasures: [
