						...
						_adaptiveFooterActionParameters: {
							C_SalesPlanTPCopy: {
								...
								data: {
									...
									contextURL:
										"http://localhost:8080/sap/opu/odata/sap/SD_SALESPLAN/C_SalesPlanTP(SalesPlanUUID=guid'42f2e9af-c3df-1ee9-a0bb-0d6579917880',IsActiveEntity=true)"
								},
								enablePath: "Copy_ac",
								...
								actionParameters: [
									{
										...
										configuration: {
											...
											serviceUrl:
												"/sap/opu/odata/sap/SD_SALESPLAN/ContractTermRenewals?$select=REContractRenewalDecision,REContractRenewalDecision_Text",
