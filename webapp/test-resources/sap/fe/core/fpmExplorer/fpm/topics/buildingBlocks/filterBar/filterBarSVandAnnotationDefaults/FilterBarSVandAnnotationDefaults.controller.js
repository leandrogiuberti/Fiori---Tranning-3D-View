sap.ui.define(
	...
	function (PageController, MessageToast, JSONModel) {
		...
		return PageController.extend("sap.fe.core.fpmExplorer.filterBarSVandAnnotationDefaults.FilterBarSVandAnnotationDefaults", {
			onAfterRendering: function (oEvent) {
				...
				oView.byId("FilterBar").setFilterValues("DateProperty", "LASTWEEKS", 3);
			},
