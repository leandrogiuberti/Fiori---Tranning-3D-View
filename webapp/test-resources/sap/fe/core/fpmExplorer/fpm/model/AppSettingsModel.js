sap.ui.define(
	["sap/base/i18n/Localization", "sap/ui/core/Theming", "sap/ui/model/json/JSONModel"],
	function (Localization, Theming, JSONModel) {
		"use strict";

		//key for local storage
		var sStoreKey = "sap.fe.core.fpmExplorer.AppSettings";
		...
		oJSONModel.applyValues = function () {
			...
			oJSONModel._applyContentDensity(oBody);
			//apply to iFrames
			var iFrames = document.getElementsByClassName("sapUiTopicsIframe");
			for (let iFrame of iFrames) {
				oJSONModel._applyContentDensity(iFrame.contentDocument.body);
			}
		};

		oJSONModel._applyContentDensity = function (oBody) {
		...
		Theming.setTheme(oJSONModel.getTheme());
		Localization.setRTL(oJSONModel.getRTL());
