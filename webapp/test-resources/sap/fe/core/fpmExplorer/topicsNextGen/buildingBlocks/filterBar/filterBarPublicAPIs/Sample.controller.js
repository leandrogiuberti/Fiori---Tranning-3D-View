sap.ui.define(
	...
	function (PageController, JSONModel, MessageToast, SelectionVariant, Log) {
		...
		return PageController.extend("sap.fe.core.fpmExplorer.filterBarPublicAPIs.Sample", {
			...
			filterBarSVToCodeEditor: function () {
				var filterBar = this.getView().byId("SampleFilterBar");
			...
			showFilterField: async function () {
				const filterBar = this.getView().byId("SampleFilterBar");
