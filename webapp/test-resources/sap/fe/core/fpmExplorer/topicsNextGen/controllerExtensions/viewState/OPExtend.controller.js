sap.ui.define(
	...
	function (ControllerExtension, JSONModel, MessageToast) {
		...
		return ControllerExtension.extend("sap.fe.core.fpmExplorer.viewState.OPExtend", {
			...
			override: {
				...
				viewState: {
					...
					adaptStateControls: function (aControls) {
						aControls.push(this.base.getExtensionAPI().byId("fe::CustomSubSection::myCustomSection--myCustomInput"));
					},
