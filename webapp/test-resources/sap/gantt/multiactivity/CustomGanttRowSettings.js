...
sap.ui.define([
	...
	var CustomGanttRowSettings = GanttRowSettings.extend("sap.gantt.multiactivity.test.CustomGanttRowSettings", /** @lends sap.gantt.multiactivity.GanttRowSettings.prototype */{
		metadata: {
			aggregations: {
				/**
