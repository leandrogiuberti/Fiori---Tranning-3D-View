...
sap.ui.define([
	...
	QUnit.test("LinearGradient methods.", function (assert) {
		...
		assert.strictEqual(this.linearGradientA.getStops()[0].getStopOpacity(), 1, "default value of property stop-opacity is 1");
		assert.strictEqual(this.linearGradientA.getStops()[1].getStopOpacity(), 0.4, "stop-opacity value set to 0.4");
	});
});
