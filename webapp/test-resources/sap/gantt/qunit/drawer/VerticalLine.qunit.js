/*global QUnit */
sap.ui.define(["sap/gantt/drawer/VerticalLine", "sap/ui/base/Object", "sap/gantt/utils/GanttChartConfigurationUtils"], function (VerticalLine, BaseObject, GanttChartConfigurationUtils) {
	"use strict";
				...
				return {
					"1week": {
						...
						smallInterval: {
							unit: sap.gantt.config.TimeUnit.week,
							span: 1,
							format: GanttChartConfigurationUtils.getRTL() ? ".d.M" : "d.M."
						}
					}
				};
			}
