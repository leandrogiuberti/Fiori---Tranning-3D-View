...
sap.ui.define([
	...
	"sap/ui/core/Core"
], function (ShapeSelectionModel, qutils, Fragment, Core) {
	"use strict";
	...
	QUnit.module("shape selection module", {
		before: function(){
			return Fragment.load({
				fragmentName: "sap.gantt.qunit.misc.GanttChart",
				type: "JS"
			}).then(function(oFragment){
				oGanttChart = oFragment;
	 ...
	 */
	QUnit.test("basic selection Gantt 1.0", function (assert) {
