...
sap.ui.define([
...
], function (ObjectPath, AxisTime, ProportionZoomStrategy, Format, Locale, library, GanttChartConfigurationUtils) {
	"use strict";
	...
	QUnit.test("test for AxisTime", function (assert) {
		...
		var localeClone = library.config.DEFAULT_LOCALE.clone();
	...
	QUnit.test("test for getNowLabel", function (assert) {
		var oLocale = library.config.DEFAULT_LOCALE.clone();
