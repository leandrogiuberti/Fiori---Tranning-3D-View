...
sap.ui.define([
...
], function (AxisTimeStrategyBase, ProportionZoomStrategy, TimeHorizon, Format, sinon, GanttQUnitUtils, BaseRectangle, AxisTime, nextUIUpdate, ProportionTimeLineOptions) {
	"use strict";
	...
	var oStrategy = new ProportionZoomStrategy({
