...
sap.ui.define([], function(){
	...
	QUnit.test("test for date format", function (assert) {
		...
		//for largeInterval
		var oFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({ pattern: tickTimeIntervalDefinition["5min"]["largeInterval"].pattern }, new sap.ui.core.Locale("en"));
		assert.strictEqual(oFormat.format(date), "Monday, Nov 2, 15", "Test 5min format: largeInterval");

		oFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({ pattern: tickTimeIntervalDefinition["10min"]["largeInterval"].pattern }, new sap.ui.core.Locale("en"));
		assert.strictEqual(oFormat.format(date), "Monday, Nov 2, 15", "Test 10min format: largeInterval");

		oFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({ pattern: tickTimeIntervalDefinition["15min"]["largeInterval"].pattern }, new sap.ui.core.Locale("en"));
		...
		oFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({ pattern: tickTimeIntervalDefinition["2hour"]["largeInterval"].pattern }, new sap.ui.core.Locale("en"));
		assert.strictEqual(oFormat.format(date), "Monday, Nov 2, 15", "Test 2hour format: largeInterval");

		oFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({ pattern: tickTimeIntervalDefinition["4hour"]["largeInterval"].pattern }, new sap.ui.core.Locale("en"));
		assert.strictEqual(oFormat.format(date), "Monday, Nov 2, 15", "Test 4hour format: largeInterval");

		oFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({ pattern: tickTimeIntervalDefinition["6hour"]["largeInterval"].pattern }, new sap.ui.core.Locale("en"));
