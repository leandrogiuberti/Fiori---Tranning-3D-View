...
sap.ui.define(["sap/gantt/test/shape/OrderShape","sap/gantt/library"], function (OrderShape, library) {
	"use strict";
	...
	LegendOrderShape.prototype.getLegend = function(oData) {
		...
		if (sType == library.DIMENSION_LEGEND_NIL) {
			switch (sStatus){
		...
		if (sStatus == library.DIMENSION_LEGEND_NIL) {
			switch (sType){
				//for activity
