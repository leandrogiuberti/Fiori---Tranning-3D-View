...
"sap/ui/core/Element"], function (Rectangle, Element) {
	"use strict";
	...
	OrderShape.prototype.getFill = function(oRawData){
		...
		if (oRawData.status === 0) {
			...
			case 0:
				return Element.getElementById("pattern_slash_grey").getRefString();
			case 1:
				return Element.getElementById("pattern_slash_blue").getRefString();
			case 2:
				return Element.getElementById("pattern_slash_green").getRefString();
			case 3:
				return Element.getElementById("pattern_slash_orange").getRefString();
			case 4:
				return Element.getElementById("pattern_slash_lightblue").getRefString();
			default:
				return Element.getElementById("pattern_slash_grey").getRefString();
			}
		}
