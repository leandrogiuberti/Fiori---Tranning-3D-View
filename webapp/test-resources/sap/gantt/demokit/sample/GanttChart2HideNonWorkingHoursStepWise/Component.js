sap.ui.define([
	...
	return UIComponent.extend("sap.gantt.sample.GanttChart2HideNonWorkingHoursStepWise.Component", {
		metadata: {
			rootView: {
				"id": "GanttChart2HideNonWorkingHoursStepWise",
				"viewName": "sap.gantt.sample.GanttChart2HideNonWorkingHoursStepWise.Gantt",
				"type": "XML",
				"async": true
			},
		...
		init: function () {
			...
			var sODataServiceUrl = "sap.gantt.GanttChart2HideNonWorkingHoursStepWise/";
