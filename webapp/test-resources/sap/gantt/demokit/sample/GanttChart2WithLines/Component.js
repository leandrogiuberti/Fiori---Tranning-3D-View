sap.ui.define([
	...
	return UIComponent.extend("sap.gantt.sample.GanttChart2WithLines.Component", {
		metadata: {
			rootView: {
				"id": "GanttChart2WithLines",
				"viewName": "sap.gantt.sample.GanttChart2WithLines.GanttChart2WithLines",
				"type": "XML",
				"async": true
			},
			...
			config: {
				sample: {
					...
					files: [
						...
						"GanttChart2WithLines.view.xml",
						"localService/mockserver.js",
						"Component.js",
						"GanttChart2WithLines.controller.js"
					]
				}
			}
		},
		init: function () {
			...
			var sODataServiceUrl = "sap.gantt.GanttChart2WithLines/";
