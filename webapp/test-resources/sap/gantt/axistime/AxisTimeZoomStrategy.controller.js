sap.ui.define([
	...
	], async function(CalendarType, jQuery, Controller, JSONModel, settingsModel, ganttConfig, Format, StepwiseZoomStrategy, FullScreenStrategy, TimeHorizon, Fragment, Element, XMLView) {
	"use strict";
	...
	var Controller = Controller.extend("test.sap.gantt.axistime.AxisTimeZoomStrategy", {
		...
		onCalendarTypeSelected: function(oControlEvent) {
			...
			if (oSelectedCalendarType.type === CalendarType.Gregorian) {
