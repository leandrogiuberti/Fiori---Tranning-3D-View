sap.ui.define([
...
], function(JSONModel, FlattenedDataset) {
	var a1a2m1Model = {
	  data : [ {
	    color : "Red",
	    product : "Car",
	...
	var getDataset = function(dataType) {
	  ...
	  switch (dataType) {
	  case 'a1m1':
	    oModel = new JSONModel(a1m1Model);
	    dataJSON = a1m1Data;
	    break;
	  case 'a1m1m2':
	    oModel = new JSONModel(a1m1m2Model);
	    dataJSON = a1m1m2Data;
	    break;
	  case 'a1a2m1':
	    oModel = new JSONModel(a1a2m1Model);
	    dataJSON = a1a2m1Data;
	    break;
	  case 'a1a2m1m1':
	    oModel = new JSONModel(a1a2m1m1Model);
	    dataJSON = a1a2m1m1Data;
	    break;
	  case 'a1a1m1':
	    oModel = new JSONModel(a1a1m1Model);
	    dataJSON = a1a1m1Data;
	    break;
	  case 'a1a1m1m2':
	    oModel = new JSONModel(a1a1m1m2Model);
	    dataJSON = a1a1m1m2Data;
	    break;
	  case 'a1a2m1m2':
	    oModel = new JSONModel(a1a2m1m2Model);
	    dataJSON = a1a2m1m2Data;
	    break;
	  case 'a1m1m2m3m4':
	    oModel = new JSONModel(a1m1m2m3m4Model);
	    dataJSON = a1m1m2m3m4Data;
	    break;
	  case 'a1a2m1m2m3':
	    oModel = new JSONModel(a1a2m1m2m3Model);
	    dataJSON = a1a2m1m2m3Data;
	    break;
	  case 'a1a1a2a2m1m2m3m4':
	    oModel = new JSONModel(a1a1a2a2m1m2m3m4Model);
	    dataJSON = a1a1a2a2m1m2m3m4Data;
	    break;
	  case 'm1m2m3m4':
	    oModel = new JSONModel(m1m2m3m4Model);
	    dataJSON = m1m2m3m4Data;
	    break;
	  case 'a1a2m1_sameDname':
	    oModel = new JSONModel(a1a2m1Model_sameDname);
	    dataJSON = a1a2m1Data_sameDname;
	    break;
	  case 'a1a1m1_sameDname':
	    oModel = new JSONModel(a1a1m1Model_sameDname);
	    dataJSON = a1a1m1Data_sameDname;
	    break;
	  case 'a1m1m2_sameMname':
	    oModel = new JSONModel(a1m1m2Model_sameMname);
	    dataJSON = a1m1m2Data_sameMname;
	    break;
	  case 'a1m1m1_sameMname':
	    oModel = new JSONModel(a1m1m1Model_sameMname);
	    dataJSON = a1m1m1Data_sameMname;
	    break;
	  case 'a1m1_emptyDname':
	    oModel = new JSONModel(a1m1Model_emptyDname);
	    dataJSON = a1m1Data_emptyDname;
	    break;
	  case 'a1m1_nullDname':
	    oModel = new JSONModel(a1m1Model_nullDname);
	    dataJSON = a1m1Data_nullDname;
	    break;
	  case 'a1m1_emptyMname':
	    oModel = new JSONModel(a1m1Model_emptyMname);
	    dataJSON = a1m1Data_emptyMname;
	    break;
	  case 'a1m1_nullMname':
	    oModel = new JSONModel(a1m1Model_nullMname);
	    dataJSON = a1m1Data_nullMname;
	    break;
	  case 'a1m1m2m3m3m3' :
	    oModel = new JSONModel(a1m1m2m3m3m3Model);
	    dataJSON = a1m1m2m3m3m3Data;
	  }
	  oDataset = new FlattenedDataset(dataJSON);
	  oDataset.setModel(oModel);
	  return oDataset;
	};

	var parseDataWithModel = function(data, model) {
	  var dataset = new FlattenedDataset(data);
	...
	var data = {
		a1a2m1Model: a1a2m1Model,
		a1a2m1Data: a1a2m1Data,
		a1m1Model: a1m1Model,
		a1m1Data: a1m1Data,
		a1m1m2Model: a1m1m2Model,
		a1m1m2Data: a1m1m2Data,
		a1m1m2VizDataset: a1m1m2VizDataset,
		a1a1a2a2m1m2Model: a1a1a2a2m1m2Model,
		a1a1a2a2m1m2Data: a1a1a2a2m1m2Data,
		a1a2m1m2m3Model: a1a2m1m2m3Model,
		a1a2m1m2m3Data: a1a2m1m2m3Data,
		a1a2m1m1m2Data: a1a2m1m1m2Data,
		a1a2m1m1Model: a1a2m1m1Model,
		a1a2m1m1Data: a1a2m1m1Data,
		a1a2m1m2Model: a1a2m1m2Model,
		a1a2m1m2Data: a1a2m1m2Data,
		a1m1m2m3m4Model: a1m1m2m3m4Model,
		a1m1m2m3m4Data: a1m1m2m3m4Data,
		a1a1a2a2m1m2m3m4Model: a1a1a2a2m1m2m3m4Model,
		a1a1a2a2m1m2m3m4Data: a1a1a2a2m1m2m3m4Data,
		m1m2m3m4Model: m1m2m3m4Model,
		m1m2m3m4Data: m1m2m3m4Data,
		a1a2m1Model_sameDname: a1a2m1Model_sameDname,
		a1a2m1Data_sameDname: a1a2m1Data_sameDname,
		a1a1m1Model: a1a1m1Model,
		a1a1m1Data: a1a1m1Data,
		a1a1m1Model_sameDname: a1a1m1Model_sameDname,
		a1a1m1Data_sameDname: a1a1m1Data_sameDname,
		a1m1m2Model_sameMname: a1m1m2Model_sameMname,
		a1m1m2Data_sameMname: a1m1m2Data_sameMname,
		a1m1m1Model_sameMname: a1m1m1Model_sameMname,
		a1m1m1Data_sameMname: a1m1m1Data_sameMname,
		a1m1Model_emptyDname: a1m1Model_emptyDname,
		a1m1Data_emptyDname: a1m1Data_emptyDname,
		a1m1Model_nullDname: a1m1Model_nullDname,
		a1m1Data_nullDname: a1m1Data_nullDname,
		a1m1Model_emptyMname: a1m1Model_emptyMname,
		a1m1Data_emptyMname: a1m1Data_emptyMname,
		a1m1Model_nullMname: a1m1Model_nullMname,
		a1m1Data_nullMname: a1m1Data_nullMname,
		a1a1m1m2Model: a1a1m1m2Model,
		a1a1m1m2Data: a1a1m1m2Data,
		a1m1m2m3m3m3Model: a1m1m2m3m3m3Model,
		a1m1m2m3m3m3Data: a1m1m2m3m3m3Data,
		getDataset: getDataset,
		parseDataWithModel: parseDataWithModel,
		simpleDeepEquals: simpleDeepEquals,
		simpleObjectEquals: simpleObjectEquals,
		stringfyJSONCompareMessage: stringfyJSONCompareMessage,
		sleep: sleep
	};

	// export to global to be compatible with existing tests
