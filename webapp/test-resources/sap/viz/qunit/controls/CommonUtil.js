...
/**
 * create vizFrame
 * @param {obj} _options it is json, keyword: viztype
 *
 */
 ...
 * @param {string} input Input color string, e.g. #abc
 * @returns {string} Normalized color string, e.g. #aabbcc
 */
