...
], function(qutils, VizSliderBasic, VizSliderBasicRenderer, RangeSliderData, jQuery, createAndAppendDiv, nextUIUpdate) {

createAndAppendDiv("content").style = "top:100px; left:50px; height: 500px; padding-top: 200px; padding-left: 50px;";
createAndAppendDiv("content1");
createAndAppendDiv("markers");
...
var testFunc = function(assert, done){
    assert.equal(jQuery('.ui5-sap-viz-vizSliderLabel').css('visibility'), "hidden", 
