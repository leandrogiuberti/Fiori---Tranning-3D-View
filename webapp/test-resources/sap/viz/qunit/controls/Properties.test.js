...
sap.ui.define([
	...
	"../js/data"
], function(Bar, Bubble, Column, Combination, Donut, DualBar, DualColumn, DualLine, DualStackedColumn, DualStackedColumn100, Line, Pie, Scatter, StackedColumn, StackedColumn100, FlattenedDataset, ManagedObject, JSONModel, createAndAppendDiv) {

createAndAppendDiv("content").style = "width: 640px; height: 480px;";
...
QUnit.test("Check CSS style", function(assert) {
  ...
  //ok(true, "a1a2m1Model Bar chart.");
    ...
    var oChart = createChart( Bar, {
      dataset : getDataset("a1a2m1"),
      css : ManagedObject.escapeSettingsValue(css),
