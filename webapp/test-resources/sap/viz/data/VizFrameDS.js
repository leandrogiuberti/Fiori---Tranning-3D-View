sap.ui.define([
  ...
  var setBubbleDataset = function (oVizFrame) {
    ...
    var feedPrimaryValues = new FeedItem({
      ...
      "type": "Measure",
      "values": ["Cost"]
    }), feedSecondaryValues = new FeedItem({
      "uid": "secondaryValues",
      "type": "Measure",
      "values": ["Unit Price"]
  ...
  var setBulletDataset = function (oVizFrame) {
    ...
    var feedPrimaryValues = new FeedItem({
      ...
      'type': "Measure",
      'values': ["target"]
    }), feedReferenceVaule = new FeedItem({
      'uid': 'forecastValues',
      'type': 'Measure',
      'values': ['reference']
    });
  ...
  var setWaterfallDataset = function (oVizFrame) {
    ...
    var feedValueAxis = new FeedItem({
      ...
      "type": "Dimension",
      "values": ["Cash"]
    }), feedWaterfallType = new FeedItem({
      "uid": "waterfallType",
      "type": "Dimension",
      "values": ["Type"]
    });
  ...
  var setTimeDataset = function (oVizFrame) {
    ...
    var feeds = [
      ...
      ,
      new FeedItem({ "uid": "color", "type": "Dimension", "values": [] })
      ,
      new FeedItem({ "uid": "valueAxis", "type": "Measure", "values": ["Revenue", "Cost"] })
    ]
  ...
  var setDualTimeDataset = function (oVizFrame) {
    ...
    var feeds = [
      ...
      new FeedItem({ "uid": "color", "type": "Dimension", "values": [] })
      ,
      new FeedItem({ "uid": "valueAxis", "type": "Measure", "values": ["Revenue"] }),
      new FeedItem({ "uid": "valueAxis2", "type": "Measure", "values": ["Cost"] })
    ]
    feeds.forEach(function (feedItem) {
      oVizFrame.addFeed(feedItem);
    });
  ...
  var aamModelWaterfall = new JSONModel({
    'businessData': [{
      'Cash': "Previous",
      'Type': "total",
      'Revenue': 10,
  ...
  var aaaammmmModel = new JSONModel({
    'businessData': [{
      "Sales_Month": "April",
