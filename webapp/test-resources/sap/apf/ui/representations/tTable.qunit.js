...
sap.ui.define([
	...
	async function _createMainContentAndViewSettingDialog(tableRepresentation) {
		var mainContent = tableRepresentation.getMainContent("Table with Filter", 600, 600);
		var oViewSettingDialog = await tableRepresentation.getViewSettingDialog();
	...
	async function _createMainContentAndViewSettingDialogUndefinedSortProperty(tableRepresentation) {
		var mainContent = tableRepresentation.getMainContent("Table with Filter", 600, 600);
		var oViewSettingDialog = await tableRepresentation.getViewSettingDialog();
		return {
			mainContent: mainContent,
	...
	QUnit.test("When getViewSettingDialog is called for the table", async function (assert) {
		var oMainContentViewSetting = await _createMainContentAndViewSettingDialog(this.tableRepresentation);
	...
	QUnit.test("When sort property is not changed", async function (assert) {
		//arrange
		var oMainContentViewSetting = await _createMainContentAndViewSettingDialog(this.tableRepresentation);
		//spy
	...
	QUnit.test("When getViewSettingDialog is called for the table and sort property is not available in table column", async function (assert) {
		var oMainContentViewSetting = await _createMainContentAndViewSettingDialogUndefinedSortProperty(this.tableRepresentation);
		assert.strictEqual(oMainContentViewSetting.oViewSettingDialog instanceof ViewSettingsDialog, true, "Then View setting dialog is created");
	...
	QUnit.test("When switching between chart and paginated table", async function (assert) {
		...
		//arrange
		var oMainContentViewSettingForTable = await _createMainContentAndViewSettingDialog(this.tableRepresentation);
	...
	QUnit.test("When a filter is not available in top N data of table", async function (assert) {
		//arrange
		await _createMainContentAndViewSettingDialog(this.tableRepresentation);
		//assert
	...
	QUnit.test("When a filter is available in the data of table", async function (assert) {
		//arrange
