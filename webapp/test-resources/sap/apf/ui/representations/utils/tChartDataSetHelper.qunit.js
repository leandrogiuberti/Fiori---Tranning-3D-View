sap.ui.define([
	...
	function commonSetup(context, dimensions, measures, metadata, data){
		...
		context.chartDataSetHelper = new ChartDataSetHelper({}, timeAxisConverter);
	...
	QUnit.module("Display value of dimensions or filters", {
		beforeEach : function(assert) {
			...
			createUiApiAsPromise().done(function(oApi) {
				...
				oChartDataSetHelper = new ChartDataSetHelper(oFormatter, oTimeAxisDateConverter);
				done();
			});
		},
		afterEach: function(){
	...
	QUnit.test("get the original fieldname", function(assert){
		var fieldname = ChartDataSetHelper.getFieldNameForOriginalContentOfProperty("propertyName");
