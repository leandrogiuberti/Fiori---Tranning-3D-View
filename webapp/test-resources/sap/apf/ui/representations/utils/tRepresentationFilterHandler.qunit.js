...
sap.ui.define([
	...
	QUnit.module("Representation Filter Handler", {
		beforeEach : function(assert) {
			...
			createUiApiAsPromise().done(function(oGlobalApi) {
				...
				var oTimeAxisDateConverter = new TimeAxisDateConverter();
				oRepresentationFilterHandler = new RepresentationFilterHandler(oTestInstance.oGlobalApi.oApi, oTestInstance.requiredParamter, oTimeAxisDateConverter);
				done();
			});
		},
	...
	QUnit.module("validateFiltersWithDataset", {
		beforeEach: function(){
			this.oRepresentationFilterHandler = new RepresentationFilterHandler({}, {requiredFilters : ["Customer"]});
	...
	QUnit.module("Representation Filter Handler get if selected filter changed", {
		beforeEach : function(assert) {
			...
			createUiApiAsPromise().done(function(oApi) {
				...
				testEnv.oRepresentationFilterHandler = new RepresentationFilterHandler(oApi, parameter);
				done();
			});
		},
		afterEach : function(assert) {
