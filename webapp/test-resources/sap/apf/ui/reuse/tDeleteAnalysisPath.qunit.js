...
sap.ui.define([
...
], function(createUiApiAsPromise, SavedPaths, UiInstance, Element, View, ViewType, nextUIUpdate, sinon, _sinonQunit) {
	'use strict';

	function pressDeleteItem(itemId) {
		Element.getElementById(jQuery(".sapMLIBIconDel")[itemId].getAttribute("id")).firePress();
	}
		...
		beforeEach : function(assert) {
			...
			createUiApiAsPromise().done(async function(api){
				...
				var getDataForPathGallery = async function(data) {
					...
					testContext.oPathGalleryWithDelete = await View.create({
	...
	QUnit.test("when calling openPathGallery function which opens dialog with delete mode ", async function(assert) {
		//arrangement
	...
	QUnit.test("when triggering delete icon and 'No' is pressed on Delete Analysis Path Dialog", async function(assert) {
		//arrangement
		this.oPathGalleryWithDelete.getController().openPathGallery();
		await nextUIUpdate();
		//action
	...
	QUnit.test("when deleting a saved path from the path gallery(Successful UI callback - delete and read success callbacks", async function(assert) {
		//arrangement
		var that = this;
		this.oPathGalleryWithDelete.getController().openPathGallery();
		await nextUIUpdate();
	...
	QUnit.test("when deleting a saved path from the path gallery(Unsuccessful UI callback - Failure of delete callback - oResponse not of type object", async function(assert) {
		//arrangement
		var that = this;
		this.oPathGalleryWithDelete.getController().openPathGallery();
		await nextUIUpdate();
	...
	QUnit.test("when deleting a saved path from the path gallery(Unsuccessful UI callback - Failure of delete callback - oMessageObject is present", async function(assert) {
		//arrangement
		var that = this;
		this.oPathGalleryWithDelete.getController().openPathGallery();
		await nextUIUpdate();
	...
	QUnit.test("when deleting a saved path from the path gallery(Unsuccessful UI callback - Failure of read callback - - oResponse not of type object", async function(assert) {
		//arrangement
		var that = this;
		this.oPathGalleryWithDelete.getController().openPathGallery();
		await nextUIUpdate();
	...
	QUnit.test("when deleting a saved path from the path gallery(Unsuccessful UI callback - Failure of read callback - - oMessage Object present", async function(assert) {
		//arrangement
		var that = this;
		this.oPathGalleryWithDelete.getController().openPathGallery();
		await nextUIUpdate();
	...
	QUnit.test("When current opened path is deleted)", async function(assert) {
		//arrangement
		var that = this;
		this.oPathGalleryWithDelete.getController().openPathGallery();
		await nextUIUpdate();
	...
	QUnit.test("When clicking on Cancel button of delete analysis path Dialog", async function(assert) {
		//arrange
		this.oPathGalleryWithDelete.getController().openPathGallery();
		await nextUIUpdate();
		//action
	...
	QUnit.module("Delete Analysis Path controller", {
		beforeEach : async function() {
			this.deleteAnalysisPathView = await View.create({
				viewName : "module:sap/apf/ui/reuse/view/deleteAnalysisPath.view",
				viewData : {
					oInject : {
						oCoreApi : {
