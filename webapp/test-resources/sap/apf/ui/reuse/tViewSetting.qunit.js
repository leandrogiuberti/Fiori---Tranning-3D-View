...
sap.ui.define([
	...
	function _createTableRepresentationStub(requiredParameter, isAlternateRepresentation, oGlobalApi) {
		...
		aProperties.forEach(function(property) {
			...
			var customDataForColumn = new CustomData({
				value : {
		...
		oContainer.addContent(new ScrollContainer({
	...
	QUnit.module("View Setting dialog for main table representation and alternate table - with no sort criterium", {
		beforeEach : function(assert) {
			...
			createUiApiAsPromise().done(async function(api) {
				that.oGlobalApi = api;
				var requiredParameter = representationHelper.prototype.tableRepresentation();
				...
				var oViewSetting = await View.create({
				...
				// View.create makes a deep clone of its options, therefore update oTableRepresentation after create
				oTableRepresentation = oViewSetting.getViewData().oTableInstance;
				done();
			});
		},
		afterEach : function(assert) {
			Element.getElementById("idViewSettingForAlternateTableOrderbyNotAvailable").destroy();
	...
	QUnit.test("When orderby is undefined and set by the view settings dialog", async function(assert) {
		//arrange
		var done = assert.async();
	...
	QUnit.test("When orderby is undefined and set by the view settings dialog and cancel is pressed", async function(assert) {
	...
	QUnit.module("View Setting dialog for main table representation and alternate table - with one sort criterium", {
		beforeEach : function(assert) {
			...
			createUiApiAsPromise().done(async function(api) {
				that.oGlobalApi = api;
				that.requiredParameter = representationHelper.prototype.tableRepresentation();
	...
	QUnit.test("When orderby has one sort criterium and is changed by the view settings dialog", async function(assert) {
		//arrange
		var done = assert.async();
	...
	QUnit.test("When orderby has more than one sort criterium and is changed by the view settings dialog", async function(assert) {
		//arrange
		var done = assert.async();
		oViewSettingsDialog.open(); //open the view setting dialog
		sinon.stub(oTableRepresentation.oApi, 'selectionChanged', selectionChangedStub);
    ...
    QUnit.module("Multiple View Setting Dialogs", {
		beforeEach : function(assert) {
			...
			createUiApiAsPromise().done(async function(api) {
				...
				that.requiredParameterOne = representationHelper.prototype.tableRepresentation();
				...
				var oViewSettingOne = await View.create({
				...
				// View.create makes a deep clone of its options, therefore update oTableRepresentationOne after create
				that.oTableRepresentationOne = oViewSettingOne.getViewData().oTableInstance;
				that.oTableRepresentationOne.oViewSettingDialog = that.oViewSettingDialogOne;
				//Create first table with view setting dialog
				that.requiredParameterTwo = representationHelper.prototype.tableRepresentation();
				...
				var oViewSettingTwo = await View.create({
				...
				// View.create makes a deep clone of its options, therefore update oTableRepresentationTwo after create
				that.oTableRepresentationTwo = oViewSettingTwo.getViewData().oTableInstance;
				that.oTableRepresentationTwo.oViewSettingDialog = that.oViewSettingDialogTwo;
				done();
			});
		},
		afterEach : function(assert) {
			Element.getElementById("idViewSettingForAlternateTableOrderbyNotAvailableOne").destroy();
			Element.getElementById("idViewSettingForAlternateTableOrderbyNotAvailableTwo").destroy();
			this.oGlobalApi.oCompContainer.destroy();
		}
	});
	QUnit.test("Update path is called when dialog one is switched to same sorting as dialog two", async function(assert) {
