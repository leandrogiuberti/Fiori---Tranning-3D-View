...
sap.ui.define([
	...
	sinon.stub(formatter.prototype, "getFormattedValue", getFormattedValueStub);
	async function _commonInitialization(aSelectedFilterValuesCompanyCode, aSelectedFilterValuesCountry, aSelectedFilterValuesStartDate) {
		...
		oFacetFilterView = await View.create({
	...
	QUnit.module("Facet Filter Controller Tests", {
		beforeEach : async function() {
			...
			await _commonInitialization(aSelectedFilterValuesCompanyCode, aSelectedFilterValuesCountry, aSelectedFilterValuesStartDate);
		},
		afterEach : function() {
