...
sap.ui.define([
...
], function(sessionHandlerStubbedAjax, createUiApiAsPromise, Helper, sinon) {
	"use strict";
	QUnit.module("Utils qUnit", {
		beforeEach : function(assert) {
			...
			createUiApiAsPromise("CompUi", "/apf-test/test-resources/sap/apf/testhelper/config/applicationConfigurationIntegration.json", inject).done(function(api) {
				this.oGlobalApi = api;
				this.oCoreApi = this.oGlobalApi.oCoreApi;
				this.utils = new Helper(this.oCoreApi);
