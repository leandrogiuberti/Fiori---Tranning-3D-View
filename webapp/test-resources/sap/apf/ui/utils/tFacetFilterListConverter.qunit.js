...
sap.ui.define([
...
], function(FacetFilterListConverter, ObjectPath) {
	"use strict";
	QUnit.module("Facet Filter List Converter tests", {
		beforeEach : function() {
			this.oFacetFilterListConverter = new FacetFilterListConverter();
		}
	});
	...
	QUnit.test("Global export exists and is the same as the AMD export", function(assert) {
		var globalExport = ObjectPath.get("sap.apf.ui.utils.FacetFilterListConverter");
		assert.strictEqual(typeof globalExport, "function")
		assert.strictEqual(globalExport, FacetFilterListConverter);
	});
});
