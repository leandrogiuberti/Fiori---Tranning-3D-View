sap.ui.define([
	...
	QUnit.module('Get instances', {
		beforeEach : function(assert) {
			...
			mockServer.activateGenericMetadata2();
			...
			this.metadataFactory = new MetadataFactory(oInject);
		},
	...
	QUnit.module('Propagation of injection', {
		beforeEach : function(assert) {
			...
			this.coreApi = new IfCoreApi();
			var annotationHandler = createDefaultAnnotationHandler();
			var InterceptedHashtable = function(messageHandler) {
				that.numberOfHashtables++;
				var ht = new Hashtable(messageHandler);
			...
			var inject = {
					...
					constructors : {
						Hashtable : InterceptedHashtable,
						Metadata : Metadata,
						EntityTypeMetadata : EntityTypeMetadata,
						MetadataFacade : MetadataFacade,
						MetadataProperty : MetadataProperty,
			...
			this.metadataFactory = new MetadataFactory(inject);
		}
	});
