	...
	QUnit.module('MetadataFacade with core api, message handler and annotation double', {
		beforeEach : function(assert) {
			...
			var MetadataFactory = function() {
				var oMetadataInstances = new Hashtable(that.oIfMessageHandler);
				...
				this.getMetadata = function(pathToServiceDocument) {
					if (oMetadataInstances.hasItem(pathToServiceDocument) === false) {
						oMetadataInstances.setItem(pathToServiceDocument, {
							metadataPromise : new Metadata(oInjectMetadata, pathToServiceDocument).isInitialized()
						});
					}
			...
			this.metadataFacade = new MetadataFacade(oInjectMetadataFacade);
			...
			this.metadataFacadeWithTwoServiceDocuments = new MetadataFacade(oInjectMetadataFacadeWithTwoServiceDocuments);
			this.metadataFacadeWithServiceDocParam = new MetadataFacade(oInjectMetadataFacadeWithTwoServiceDocuments, "/sap/hba/r/apf/core/odata/apf.xsodata");
		},
