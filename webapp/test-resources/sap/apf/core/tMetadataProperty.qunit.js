sap.ui.define([
	...
	var MetadataProperty = metadataProperty.constructor;
	...
	QUnit.test('Simple initialization', function(assert) {
		...
		var oMetadataProperty = new MetadataProperty(oAttributes);
	...
	QUnit.test('Check for key', function(assert) {
		...
		oMetadataProperty = new MetadataProperty(oAttributes);
		assert.equal(oMetadataProperty.isKey(), false, "If property is no key, isKey() returns false");

		oMetadataProperty = new MetadataProperty(oAttributesIsKey);
	...
	QUnit.test('Check for parameter key property', function(assert) {
		...
		oMetadataProperty = new MetadataProperty(oAttributesisParameterEntitySetKeyProperty);
	...
	QUnit.test('Check wrong usage and error behaviour', function(assert) {
		...
		oMetadataProperty = new MetadataProperty(oAttributesWrongKey);
		...
		oMetadataProperty = new MetadataProperty(oAttributesWrongParameterEntitySetKeyProperty);
		...
		oMetadataProperty = new MetadataProperty(oAttributesOverwriteFunction);
		...
		var oNoAttributes = {};
		oMetadataProperty = new MetadataProperty(oNoAttributes);
		...
		oMetadataProperty = new MetadataProperty(undefined);
