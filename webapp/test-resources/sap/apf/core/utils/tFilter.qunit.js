...
sap.ui.define([
...
], function(MessageHandlerDouble, Filter, FilterTerm, constants, Ui5Filter, jQuery){
	'use strict';
	function commonSetup(context) {
		var defineFilterOperators = function() {
			Object.assign(context, constants.FilterOperators);
		};
		context.oMsgHandler = new MessageHandlerDouble().doubleCheckAndMessaging();
	...
	QUnit.module('Filter & EmptyFilter related to simplifyFilter', {
		beforeEach : function(assert) {
			Object.assign(this,	constants.FilterOperators);
	...
	QUnit.module('Filter.mapToSelectOptions()', {
		beforeEach : function (assert){
			this.msgH = new MessageHandlerDouble().doubleCheckAndMessaging();
