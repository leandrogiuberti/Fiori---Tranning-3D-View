...
], function(ExternalContext, MessageHandler, MessageDefinition, MessageHandlerDouble, constants, Filter, ushellHelper, jQuery){
	'use strict';
	function commonSetup(testEnv, evaluationId, xAppState, smartBusinessConfig, messageHandler) {
		testEnv.messageHandler = messageHandler || new MessageHandlerDouble().doubleCheckAndMessaging().spyPutMessage();
		testEnv.inject = {
			instances: {
				startParameter : {
