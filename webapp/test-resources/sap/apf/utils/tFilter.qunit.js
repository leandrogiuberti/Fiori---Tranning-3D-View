...
], function(MessageHandlerDouble, UtilsFilter, Filter, constants, FilterOperator, jQuery){
	'use strict';
	function commonSetupUtilsFilter(oContext) {
		var oMsgHandler = new MessageHandlerDouble().doubleCheckAndMessaging();
		oContext.oMsgHandler = oMsgHandler;
		oContext.oFilter = new UtilsFilter(oMsgHandler);
		Object.assign(oContext, oContext.oFilter.getOperators());
	}
