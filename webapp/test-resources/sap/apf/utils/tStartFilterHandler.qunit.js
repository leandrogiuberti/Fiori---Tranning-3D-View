...
sap.ui.define([
...
], function(StartFilterHandler, StartFilter, MessageHandlerDouble, Filter, UtilsFilter, utils, jQuery){
	'use strict';
	...
	function commonSetup(testEnv, facetFilterConfig, externalContextPromise, StartFilterDouble, onBeforeApfStartupPromise) {
		testEnv.msgH = new MessageHandlerDouble().doubleCheckAndMessaging().spyPutMessage();
