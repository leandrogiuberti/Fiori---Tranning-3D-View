sap.ui.define([
...
], function(StartFilterHandler, StartFilter, UtilsFilter, CoreFilter, MessageHandlerDouble, concurrenceTester, jQuery){
	'use strict';
	
	// === Helpers ===
	
	function setupStartFilterHandler(StartFilterDouble) {
		var msgH = new MessageHandlerDouble().doubleCheckAndMessaging().spyPutMessage();
	...
	function setupStartFilter(sendGetRequest) {
		var messageHandler = new MessageHandlerDouble().doubleCheckAndMessaging().spyPutMessage();
