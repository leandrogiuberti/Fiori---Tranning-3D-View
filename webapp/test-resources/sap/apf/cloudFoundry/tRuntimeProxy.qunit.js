sap.ui.define([
	...
	function(RuntimeProxy, coreConstants, Filter, MessageObject, testConfig, Localization, sinon) {
		'use strict';
		...
		QUnit.module("Reading analytical configuration", {
			beforeEach: function() {
				this.savedLanguage = Localization.getLanguage();
				Localization.setLanguage('de-DE');
			},
			afterEach: function() {
				Localization.setLanguage(this.savedLanguage);
			}
		});
		...
		QUnit.module("Read Texts", {
			...
			createFilter: function() {
				...
				var filter = new Filter(this.messageHandler, 'Language', 'eq', coreConstants.developmentLanguage);
