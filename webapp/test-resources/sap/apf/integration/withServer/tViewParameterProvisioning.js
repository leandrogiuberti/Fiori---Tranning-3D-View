...
sap.ui.define([
	...
	QUnit.module('Add steps to path', {
		beforeEach : function(assert) {
			...
			var sUrl = sap.ui.require.toUrl("test-resources/sap/apf/integration/withServer/viewParameterProvisioningApplicationConfiguration.json");
		...
		callbackErrorHandling : function(oErrorMessage) {
			...
			var bErrorHappened = sErrorSeverity === CoreConstants.message.severity.error;
