...
sap.ui.define([
	...
	QUnit.module("tComponent -- APF API", {
		beforeEach : function(assert) {
			...
			this.oComponent = doubleComponent.create(this, "compId", inject,  path, {}, undefined, afterStartup);
		},
	...
	QUnit.module("Component: Destroy", {
		beforeEach : function() {
			var sId = "Comp1";
			var oComponent;
			sinon.stub(ApfComponent.prototype, "getApiInjections", function() {
				return {
					constructors: {
			...
			this.oCompContainer = new ComponentContainer(sContId, {
