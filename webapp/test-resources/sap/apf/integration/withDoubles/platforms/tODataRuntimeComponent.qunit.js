...
sap.ui.define([
...
], function(AnalysisPathProxy, helper, ComponentFactory, MetadataDouble, Persistence, ComponentContainer, jQuery, sinon) {
	'use strict';
	...
	QUnit.test("WHEN the configuration id is injected in the URL parameters and OData Proxy shall be used per default", function(assert) {
		...
		oCompContainer = new ComponentContainer(sContainerId, {component: oComponent});
