...
sap.ui.define([
...
], function(BaseComponent, ModelerComponent, deepExtend) {
	'use strict';
	...
	function createAComponent(name, Component, inlayCreateContent, inject, componentData, injectedManifest, suppressCreateContent) {
		...
		var manifestWithID = deepExtend({}, manifest);
		...
		var extendedComponent = Component.extend(componentName, {
			...
			init: function() {
				var manifestBefore = deepExtend({}, this.getManifest());
				var fGetManifest = this.getManifest;
