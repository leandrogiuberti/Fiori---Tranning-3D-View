...
sap.ui.define([
	...
	function(AnalysisPathProxy, testTextFiles, helper, ComponentFactory, Persistence, utils, ComponentContainer, jQuery) {
		'use strict';
		...
		QUnit.test("WHEN lrep is activated via manifest", function(assert) {
			...
			componentData.startupParameters = utils.getUriParameters();
