			...
			assertions : {
				iShouldSeeLegend : function(bIsLegendVisible) {
					return this.waitFor({
						...
						success : function() {
							...
							Opa5.assert.ok(true, "Legend is " + sVisibility);
						}
					});
				},
				isFullScreen : function(mode) {
					return this.waitFor({
						...
						success : function(chartToolbar) {
							...
							Opa5.assert.ok(true, "Screen is in " + status + "mode");
						}
					});
				},
				...
				iShouldSeeTheTableThumbnail : function() {
					return this.waitFor({
						...
						success : function() {
							Opa5.assert.ok(true, "The Analysis Path Step contains table image in the thumbnail");
						}
					});
				},
