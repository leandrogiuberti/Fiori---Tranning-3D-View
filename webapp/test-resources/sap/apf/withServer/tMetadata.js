...
sap.ui.define([
	...
	function commonIsolatedSetup(oContext) {
		...
		oContext.oMetadataInject.constructors.Hashtable = Hashtable;
		oContext.oMetadataInject.constructors.EntityTypeMetadata = EntityTypeMetadata;
		oContext.oMetadataInject.instances.annotationHandler = createDefaultAnnotationHandler();
	}
	...
	QUnit.test('Get metadata for property', function(assert) {
		...
		var oMetadata = new Metadata(this.oMetadataInject, "/sap/hba/apps/wca/dso/s/odata/wca.xsodata");
	...
	QUnit.test('Check is "getPropertyMetadata" return the same object reference as before', function(assert) {
		...
		var oMetadata = new Metadata(this.oMetadataInject, "/sap/hba/apps/wca/dso/s/odata/wca.xsodata");
		oMetadata.isInitialized().done(function(metadata) {
			assert.strictEqual(oMetadata.getPropertyMetadata("WCADaysSalesOutstandingQuery", "CompanyCode"), oMetadata.getPropertyMetadata("WCADaysSalesOutstandingQuery", "CompanyCode"), 'Same object reference expected');
			done();
		});
	});
	QUnit.test('Check is "getParameterEntitySetKeyProperties" return the same object reference as before', function(assert) {
		...
		var oMetadata = new Metadata(this.oMetadataInject, "/sap/hba/apps/wca/dso/s/odata/wca.xsodata");
		oMetadata.isInitialized().done(function(metadata) {
			assert.strictEqual(oMetadata.getParameterEntitySetKeyProperties("WCADaysSalesOutstandingQuery"), oMetadata.getParameterEntitySetKeyProperties("WCADaysSalesOutstandingQuery"), 'Same object reference expected');
			done();
		});
	});
	QUnit.test('Check is "getEntityTypeAnnotations" return the same object reference as before', function(assert) {
		...
		var oMetadata = new Metadata(this.oMetadataInject, "/sap/hba/apps/wca/dso/s/odata/wca.xsodata");
		oMetadata.isInitialized().done(function(metadata) {
			assert.strictEqual(oMetadata.getEntityTypeAnnotations("CurrencyQuery"), oMetadata.getEntityTypeAnnotations("CurrencyQuery"), 'Same object reference expected');
			done();
		});
	});
	QUnit.test('Check is "getFilterableProperties" return the same object reference as before', function(assert) {
		...
		var oMetadata = new Metadata(this.oMetadataInject, "/sap/hba/apps/wca/dso/s/odata/wca.xsodata");
		oMetadata.isInitialized().done(function(metadata) {
			assert.strictEqual(oMetadata.getFilterableProperties("WCAClearedReceivableQuery"), oMetadata.getFilterableProperties("WCAClearedReceivableQuery"), 'Same object reference expected');
			done();
		});
	});
});
