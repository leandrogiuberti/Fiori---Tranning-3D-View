...
sap.ui.define([
	...
	function generateBatchRequest(sXsrfToken, sServiceRoot, sEntityType, aCreateEntries, aUpdateEntries, aDeleteEntries) {
		var aChangeRequests = [];
	...
	QUnit.test('Create, Read, Delete Application', function(assert) {
		...
		this.oAuthTestHelper.getXsrfToken().done(function(sXsrfToken){
			...
			var doDeleteApplication = function(sApplication) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnDeleteApplication, fnErrorDeleteApplication);
			};
			...
			var doReadApplicationAfterUpdate = function(sApplication) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnReadApplicationAfterUpdate, fnErrorOnReadApplicationAfterUpdate);
			};
			...
			var doUpdateApplication = function(sApplication) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnUpdateApplication, fnErrorUpdateApplication);
			};
			...
			var doReadAllApplications = function() {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnReadAllApplications, fnErrorOnReadAllApplications);
			};
			...
			var doCreateApplication = function() {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnCreateApplication, fnErrorOnCreateApplication);
			};
			doCreateApplication();
		});
	});
	QUnit.module('Create, Read, Update and Delete Analytical Configurations', {
		beforeEach : function(assert) {
			...
			this.oPostObject = {
					AnalyticalConfiguration : helper.generateGuidForTesting(), // Needs to be a "GUID": the server will check for /[0-9A-F]{32}/
	...
	QUnit.test("Create new Analytical Configuration and read it again", function(assert) {
		...
		this.oAuthTestHelper.getXsrfToken().done(function(sXsrfToken){
			var doDeleteApplication = function(sApplication) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, function() {
			...
			var deleteAnalyticalConfiguration = function(sAnalyticalConfiguration) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnDeleteAnalyticalConfiguration, fnErrorDeleteAnalyticalConfiguration);
			};
			...
			var readAnalyticalConfigurationAfterModify = function(sAnalyticalConfiguration) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnReadAnalyticalConfigurationAfterModify, fnErrorOnReadAnalyticalConfiguration);
			};
			...
			var updateAnalyticalConfiguration = function(sAnalyticalConfiguration) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnUpdateAnalyticalConfiguration, fnErrorUpdateAnalyticalConfiguration);
			};
			...
			var readAnalyticalConfiguration = function(sAnalyticalConfiguration) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnReadAnalyticalConfiguration, fnErrorOnReadAnalyticalConfiguration);
			};
			...
			var readAllAnalyticalConfigurations = function() {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnReadAllAnalyticalConfigurations, fnErrorOnReadAllAnalyticalConfigurations);
			};
			...
			var createAnalyticalConfiguration = function(sApplication) {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnCreate, fnErrorOnCreate);
			};
			var fnSuccessOnCreateApplication = function(oData, oResponse) {
				if (oData && oData.Application && oResponse.statusText === "Created") {
					assert.ok(true, "Application has been created");
	...
	QUnit.test("Analytical Configuration Texts - Create/Update in Batch and Delete", function(assert) {
		...
		this.oAuthTestHelper.getXsrfToken().done(function(sXsrfToken){
			...
			var doDeleteTexts = function() {
				var oBatchRequest = generateBatchRequest(sXsrfToken, sServiceRoot, sEntityType, [], [], that.texts);
			...
			var doReadAllAnalyticalTextsOfApplication = function() {
				...
				var filterExpr = new CoreFilter(messageHandler, 'Application', 'eq', that.ApplicationCreatedByThisTest).toUrlParam();
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, fnSuccessOnReadAllAnalyticalTextsOfApplication, fnErrorOnReadAllAnalyticalTextsOfApplication);
			};
			...
			var doCreateAndDeleteAndModifyTexts = function() {
				...
				var oBatchRequest = generateBatchRequest(sXsrfToken, sServiceRoot, sEntityType, aNewTexts, aTextsForUpdate, aTextsForDelete);
			...
			var modifyCreatedTexts = function(aEntries) {
				...
				var oBatchRequest = generateBatchRequest(sXsrfToken, sServiceRoot, sEntityType, [], aModifiedEntries, []);
			...
			var fnSuccessOnCreateApplication = function(oData, oResponse) {
				if (oData && oData.Application && oResponse.statusText === "Created") {
					...
					var oBatchRequest = generateBatchRequest(sXsrfToken, sServiceRoot, sEntityType, aNewTextEntries, [], []);
		...
		this.oAuthTestHelper.getXsrfToken().done(function(sXsrfToken){
			...
			var fnSuccessOnCreateApplication = function(oData, oResponse) {
				if (oData && oData.Application && oResponse.statusText === "Created") {
					...
					var oBatchRequest = generateBatchRequest(sXsrfToken, sServiceRoot, 'TextElementQueryResults', that.texts, [], []);
					OData.request(oBatchRequest, fnSuccessOnCreateTexts, fnErrorOnCreateTexts, OData.batchHandler);
				} else {
					assert.ok(false, "Create of Application failed.");
					done();
			...
			var doDeleteApplication = function() {
				...
				odataRequestWrapper(oInjectOdataRequest, oRequest, function(oData, oResponse) {
					assert.ok(1, "delete application");
					doCreateApplication();
				}, function(oError) {
