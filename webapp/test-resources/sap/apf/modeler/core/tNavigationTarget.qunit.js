...
sap.ui.define([
	...
	QUnit.module("M Navigation Target", {
		beforeEach : function() {
			...
			this.navigationTarget = new NavigationTarget(this.id, this.inject);
	...
	QUnit.test("navigationTarget instantiation", function(assert) {
		assert.ok(this.navigationTarget instanceof NavigationTarget, "WHEN instantiate THEN an instance of the right type is returned");
	...
	QUnit.test("navigationTarget copy with new id", function(assert) {
		...
		assert.ok(copy instanceof NavigationTarget, "WHEN copy with new id THEN an instance of the right type is returned");
	...
	QUnit.test("navigationTarget copy without new id", function(assert) {
		...
		assert.ok(copy instanceof NavigationTarget, "WHEN copy without new id  THEN an instance of the right type is returned");
