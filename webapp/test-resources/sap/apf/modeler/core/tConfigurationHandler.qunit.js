...
sap.ui.define([
	...
	QUnit.module("M: Instantiation of ConfigurationHandler", {
		beforeEach : function() {
			...
			that.configurationHandler = new ConfigurationHandler(this.inject);
			this.appId = "appId";
			this.existingConfig = {
	...
	QUnit.test("Export configuration", async function(assert) {
		var that = this;
	...
	QUnit.test("Remove buffered configuration", function(assert) {
		...
		var configurationHandler = new ConfigurationHandler(this.inject);
