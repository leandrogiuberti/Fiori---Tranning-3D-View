...
], function(ApplicationHandler, Hashtable, MessageHandlerDouble) {
	"use strict";
		...
		beforeEach : function(assert) {
			...
			var inject = {
				instances : {
					...
					messageHandler : new MessageHandlerDouble().raiseOnCheck()
				},
				constructors : {
					Hashtable : Hashtable
				},
			...
			new ApplicationHandler(inject, initCallback);
		}
	});
