...
sap.ui.define([
	...
	oModelerConstants,
	propertyTypeOrchestrationModule,
	extend
) {
	'use strict';
	...
	function createPropertyTypeController() {
		return Promise.resolve(new PropertyTypeController());
	}
	...
	QUnit.module('Given instance of PropertyType', {
		beforeEach: async function() {
			...
			this.oPropertyTypeController = await createPropertyTypeController();
	...
	QUnit.module('Given instance of PropertyType and a minimal stubbed PropertyType controller and view, editor and orchestration', {
		beforeEach: async function () {
			...
			this.oPropertyTypeController = await createPropertyTypeController();
			extend(this.oPropertyTypeController, this.oStubbedContextContract);
