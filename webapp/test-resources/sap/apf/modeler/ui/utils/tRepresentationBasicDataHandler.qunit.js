sap.ui.define([
	...
	"sap/apf/testhelper/modelerUIHelper"
			...
			propertyTypeOrchestration, utils, VBox, jQuery, modelerUIHelper){
	'use strict';
	...
	function createStepPropertyMetadataHandler(oStep) {
		return {
			...
			getEntityTypeMetadataAsPromise : utils.createPromise,
	...
	function _commonInitialization(testEnv, namedParameters, done) {
		testEnv.oBasicDataLayout = new VBox("idBasicDataLayout");
