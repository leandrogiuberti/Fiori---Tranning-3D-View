...
sap.ui.define([
...
],function(modelerUIHelper, textManipulator, modelerConstants){
	'use strict';
	...
	QUnit.test('when removing prefix text and input property is empty', function(assert) {
		...
		var sProperty = "";
		// act
		var sPropertyWithoutPrefix = textManipulator.removePrefixText(sProperty, oTextReader(modelerConstants.texts.NOTAVAILABLE));
		//assert
