sap.ui.define([
...
], function(RepresentationHandler, RepresentationTypesHandler, fnRepresentationTypes, CoreRepresentation, ElementContainer, Hashtable) {
	QUnit.module("GIVEN a representationType the respective kind dependent mandatory field information is returned", {
		beforeEach : function(assert) {
			...
			this.representationHandler = new RepresentationHandler(oRepresentation, new RepresentationTypesHandler(fnRepresentationTypes()), textReader);
		},
		afterEach : function() {
		}
	});
	...
	QUnit.module("getActual functions when no dimensions/measures are selected on Step level", {
		beforeEach : function(assert) {
			...
			this.representationHandler = new RepresentationHandler(this.oRepresentation, new RepresentationTypesHandler(fnRepresentationTypes()), textReader);
		}
	});
