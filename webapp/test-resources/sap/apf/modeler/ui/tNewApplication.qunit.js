...
sap.ui.define([
	...
	QUnit.module("Adding a new application", {
		beforeEach : async function(assert) {
			var that = this;
			var applicationController = await Controller.create({
				name : "sap.apf.modeler.ui.controller.newApplication"
			});
			...
			this.applicationView = await View.create({
					viewName : "sap.apf.modeler.ui.view.newApplication",
					type : ViewType.XML,
					controller : applicationController,
					viewData : {
						oParentControl : new Table(),
	...
	QUnit.test("When clicking on Save button of Dialog and save is successful", async function(assert) {
		//arrangement
		var appObj = {
	...
	QUnit.test("When clicking on Save button of Dialog and error occured in saving(messageobject is not undefined)", async function(assert) {
		//arrangement
		var appObj = {
			ApplicationName : "Test Application",
			SemanticObject : "FioriApplication"
	...
	QUnit.test("When clicking on Save button of Dialog and service is not available", async function(assert) {
		//arrangement
	...
	QUnit.test("When clicking on Cancel button of Dialog", async function(assert) {
		//action
