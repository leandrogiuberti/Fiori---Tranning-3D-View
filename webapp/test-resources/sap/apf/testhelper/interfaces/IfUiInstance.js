...
sap.ui.define([], function() {
	...
	function IfUiInstance(oInject) {

		/**
		 * Getter for Analysis Path
		...
		/**
		 * Async Getter for Notification Bar
		 * @returns {sap.apf.ui.reuse.view.messageHandler}
		 */
		this.loadNotificationBar = function() {
			throw new Error("loadNotificationBar not implemented");
		};

		/**
		 * Creates a step container to hold representation
