...
sap.ui.define([
	 ...
	 * @param {object} oInject 
	 * @param  oInject.messageHandler 
	 * @param  oInject.coreApi
	 * @alias sap.apf.testhelper.interfaces.IfConfigurationFactory
	 */
	function IfConfigurationFactory(oInject) {
		/**
	...
	exportToGlobal("sap.apf.testhelper.interfaces.IfConfigurationFactory", IfConfigurationFactory);

	return IfConfigurationFactory;
});
