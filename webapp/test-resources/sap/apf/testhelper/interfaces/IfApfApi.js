...
sap.ui.define([
	...
	/**
	 * @alias sap.apf.testhelper.interfaces.IfApfApi
	 */
	function IfApfApi() {
		'use strict';
		this.type = "IfApi";
		 ...
		 * @deprecated As of version 1.31, see {@link sap.apf.core.api#createReadRequestByRequiredFilter}
		 */
	...
	exportToGlobal("sap.apf.testhelper.interfaces.IfApfApi", IfApfApi);
