...
sap.ui.define([
	...
	/**
	 * @alias sap.apf.testhelper.interfaces.IfMessageHandler
	 */
	function IfMessageHandler() {
		'use strict';
		/**
	...
	exportToGlobal("sap.apf.testhelper.interfaces.IfMessageHandler", IfMessageHandler);

	return IfMessageHandler;
});
