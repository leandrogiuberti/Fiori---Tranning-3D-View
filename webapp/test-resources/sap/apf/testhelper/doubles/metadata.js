sap.ui.define([
...
], function(exportToGlobal, ImportedHashtable){
	'use strict';

	function Metadata(oInject, sAbsolutePathToServiceDocument) {
		var Hashtable = (oInject.constructors && oInject.constructors.Hashtable) || ImportedHashtable;
	...
	exportToGlobal("sap.apf.testhelper.doubles.Metadata",  Metadata);
