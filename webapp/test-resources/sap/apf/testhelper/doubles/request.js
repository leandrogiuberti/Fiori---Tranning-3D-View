sap.ui.define([
...
], function(CoreFilter, exportToGlobal, Hashtable, Metadata, SampleServiceData){
	'use strict';
	...
	function Request(oInject, oConfig) {
		 ...
		 */
		CoreFilter.prototype.filterArray = function(aData) {
			var aFilteredData = [];
			var i;
			var j = 0;
			...
			for(oProp in aData[0]) {
				if (aFilterProperties?.includes(oProp)) {
	...
	exportToGlobal("sap.apf.testhelper.doubles.Request", Request);
