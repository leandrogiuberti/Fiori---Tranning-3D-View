...
sap.ui.define([
	...
	/**
	 * @alias sap.apf.testhelper.config.representationHelper
	 */
	function representationHelper() {
	}
	representationHelper.prototype = {
		/**
	...
	exportToGlobal("sap.apf.testhelper.config.representationHelper", representationHelper);
