sap.ui.define([
	...
	/**
	 * @alias sap.apf.testhelper.config.getConfigurationForIntegrationTesting
	 */
	function getConfigurationForIntegrationTesting() {
		return {
			"steps": [{
				"type": "step",
				"id": "stepTemplate1",
	...
	exportToGlobal("sap.apf.testhelper.config.getConfigurationForIntegrationTesting", getConfigurationForIntegrationTesting);

	return getConfigurationForIntegrationTesting;
});
