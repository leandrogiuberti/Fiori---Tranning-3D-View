sap.ui.define([
...
], function(deepExtend, MockServer) {
	"use strict";
	...
	var mockADataService = function(oConfig, bIsAnalytical) {
		...
		if (bIsAnalytical) {
			Object.assign(oMockServer, ANALYTICS);
			oMockServer.destroy = function() {
				Object.keys(ANALYTICS).forEach(function(name) {
					if (this[name] === ANALYTICS[name]) {
						delete this[name];
					}
				}, this);
