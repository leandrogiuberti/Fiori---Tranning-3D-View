...
sap.ui.define([
	...
	"sap/ui/util/Mobile"
], function (InteractiveDonutChartSegment, InteractiveDonutChart, nextUIUpdate, Mobile) {
	"use strict";
	...
	QUnit.test("InteractiveDonutChartSegment standard tooltip", function(assert) {
		...
		$Segment.trigger("mouseleave");
	});

	QUnit.test("InteractiveDonutChartSegment custom tooltip", async function(assert) {
		//Arrange
		...
		$Segments.trigger("mousemove");
		var sFirstSegmentTooltip = $FirstSegment.attr("title");
		...
		$Segments.trigger("mouseleave");
	});

	QUnit.test("InteractiveDonutChartSegment supress tooltip", async function(assert) {
		//Arrange
		var aSegments = this.oChart.getSegments(),
			oFirstSegment = aSegments[0],
			sCustomTooltip = " ";
	...
	QUnit.test("InteractiveDonutChartSegment N/A tooltip", async function(assert) {
		//Arrange
		var aSegments = this.oChart.getSegments(),
			oFirstSegment = aSegments[0];
