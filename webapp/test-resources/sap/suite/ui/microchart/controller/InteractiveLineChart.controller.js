sap.ui.define([], function () {
	...
	var oLineChartData = {
		...
		points: [
			{label: "May", secondaryLabel: "Q1", value: 33.1, color: sap.m.ValueColor.Neutral, selected: true},
			{label: "June", secondaryLabel: "Q1", value: 2.2, color: sap.m.ValueColor.Critical, selected: false},
			{label: "Juli", secondaryLabel: "Q2", value: 51.4, color: sap.m.ValueColor.Good, selected: false},
			{label: "Aug", secondaryLabel: "Q2", value: 19.9, color: sap.m.ValueColor.Neutral, selected: false},
			{label: "Sep", secondaryLabel: "Q2", value: 69.9, color: sap.m.ValueColor.Good, selected: false},
			{label: "Oct", secondaryLabel: "Q2", value: 0.9, color: sap.m.ValueColor.Critical, selected: false}
		],
...
//******************* Point Form ********************************************************
	...
	var fnFormFactoryLC = function(sId) {
