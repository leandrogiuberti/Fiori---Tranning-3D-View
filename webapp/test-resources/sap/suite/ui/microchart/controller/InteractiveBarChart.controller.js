...
//****************** Input Form ****************************************************************
	...
	var oMinInput = new sap.m.Input("min", {
		...
		change : function(oEvent) {
			var sEnteredText = oEvent.getParameter("newValue");
			oIBCData.min = Number.isFinite(parseFloat(sEnteredText)) ? parseFloat(sEnteredText) : null;
			oModel.checkUpdate();
		}
	});
	...
	var oMaxInput = new sap.m.Input("max", {
		...
		change : function(oEvent) {
			var sEnteredText = oEvent.getParameter("newValue");
			oIBCData.max = Number.isFinite(parseFloat(sEnteredText)) ? parseFloat(sEnteredText) : null;
			oModel.checkUpdate();
		}
	});
