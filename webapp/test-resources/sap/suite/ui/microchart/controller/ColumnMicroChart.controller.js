sap.ui.define(["sap/ui/core/mvc/View",
    "sap/ui/core/mvc/XMLView",
    "sap/ui/core/mvc/Controller"
], function (View, XMLView, Controller) {
    "use strict";
    ...
    var oTooltipSwtch = new sap.m.Switch({
        ...
        change: function (oE) {
            ...
            oCmc.setTooltip(bState ?
                new View({ content: new sap.m.Text({ text: oTooltipInput.getValue().split("((AltText))").join(oCmc.getAltText()) }) })
