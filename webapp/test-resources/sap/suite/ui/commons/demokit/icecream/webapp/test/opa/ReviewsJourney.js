sap.ui.require([
...
], function(Opa5, opaTest, MobileLibrary, EnterText, Press, PropertiesMatcher) {
	
	QUnit.module("Reviews Journey");
	...
	opaTest("Customer review data is entered and saved", function(Given, When, Then) {
		...
		When.onTheStartPage.iPressOnATileWithStateAndSize(MobileLibrary.LoadState.Loaded, MobileLibrary.FrameType.TwoByOne);
