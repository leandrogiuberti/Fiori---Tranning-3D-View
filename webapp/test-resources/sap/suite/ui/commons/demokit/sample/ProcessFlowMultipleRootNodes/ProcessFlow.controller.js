sap.ui.define([ 'jquery.sap.global', 'sap/ui/core/mvc/Controller', 'sap/ui/model/json/JSONModel', 'sap/m/MessageToast' ],
	...
	return Controller.extend("sap.suite.ui.commons.sample.ProcessFlowMultipleRootNodes.ProcessFlow", {
		onInit: function () {
			var oDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowMultipleRootNodes/ProcessFlowNodes.json");
		...
		onHighlightPath: function(oEvent) {
			...
			if (oEvent.getParameter("pressed")) {
				sDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowMultipleRootNodes/ProcessFlowNodesHighlighted.json");
				MessageToast.show("Path has been highlighted");
			} else {
				sDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowMultipleRootNodes/ProcessFlowNodes.json");
