sap.ui.define([ 'sap/ui/core/mvc/Controller', 'sap/ui/model/json/JSONModel', 'sap/suite/ui/commons/library', 'sap/m/MessageToast' ],
	...
	return Controller.extend("sap.suite.ui.commons.sample.ProcessFlowScrollable.ProcessFlow", {
		...
		onDisplayProcessFlow: function () {
			var sDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowScrollable/ProcessFlowNodes.json");
		...
		onHighlightPath: function () {
			var sDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowScrollable/ProcessFlowNodesHighlighted.json");
		...
		onUpdateProcessFlow: function () {
			var sDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowScrollable/ProcessFlowUpdatedNodesHighlighted.json");
