sap.ui.define([
	...
	var oPageController = Controller.extend("sap.suite.ui.commons.sample.CloudFilePickerExportDuplicate.CloudFilePicker", {
		onInit: function () {
		...
		onPress: function (oEvent) {
            ...
            var oCloudFilePicker = new CloudFilePicker({
                ...
                select: function (oEvent) {
					...
					MessageToast.show(fileName + "Selected");
					var mParameters = oEvent.getParameters();
                    var sMessage = this._getMessage(mParameters);
                    oResultTextArea.setValue(sMessage);
                }.bind(this),
			...
			oTableControl.attachEvent('itemPress', function (oEvent) {
				Element.getElementById("sample-demokit-cloudfilepicker").getContent()[0].getFixContent()[1].getLinks()[0].setEnabled(false);
			});
