sap.ui.define([ 'jquery.sap.global', 'sap/suite/ui/commons/library', 'sap/ui/core/mvc/Controller', 'sap/ui/model/json/JSONModel', 'sap/m/MessageToast' ],
	...
	return Controller.extend("sap.suite.ui.commons.sample.ProcessFlowAggregation.ProcessFlow", {
		onInit: function () {
			var oDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowAggregation/ProcessFlowNodeRegular.json");
		...
		onHighlight: function() {
			...
			if (this.oProcessFlow.getNodes()[0].getHighlighted()) {
				sDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowAggregation/ProcessFlowNodeRegular.json");
			} else {
				sDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/sample/ProcessFlowAggregation/ProcessFlowNodeHighlighted.json");
			}
