sap.ui.define([
	...
	var oPageController = Controller.extend("sap.suite.ui.commons.sample.CloudFilePickerUpload.CloudFilePicker", {
		onInit: function () {
		...
		onPress: function (oEvent) {
			...
			var oCloudFilePicker = new CloudFilePicker({
				...
				select: function (oEvent) {
					...
					MessageToast.show(fileName + " Uploaded");
				},
