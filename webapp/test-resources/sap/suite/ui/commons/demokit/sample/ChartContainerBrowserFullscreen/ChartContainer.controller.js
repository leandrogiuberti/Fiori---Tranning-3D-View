sap.ui.define([ 'sap/ui/core/mvc/Controller', 'sap/ui/model/json/JSONModel', 'sap/viz/ui5/data/FlattenedDataset', 'sap/viz/ui5/controls/common/feeds/FeedItem' ],
	...
	var oPageController = Controller.extend("sap.suite.ui.commons.sample.ChartContainerBrowserFullscreen.ChartContainer", {
		/* ============================================================ */
		/* Constants                                                    */
		/* ============================================================ */
		/**
		 ...
		 */
		_constants: {
			sampleName: "sap/suite/ui/commons/sample/ChartContainerBrowserFullscreen",
			vizFrame: {
		...
		onInit: function() {
			...
			var oEvent = function () {
				this.byId("chartContainer").getToolbar().addContent(new sap.m.Button({
					text: "Display Dialog",
					press: function() {
						if (! this.oDialog) {
								this.oDialog = new sap.m.Dialog({
								title: "Dialog",
								content: new sap.m.Text({ text: "This is a chart container dialog." }),
							...
							this.byId("chartContainer").addDependent(this.oDialog);
						}
						this.oDialog.open();
					}.bind(this)
				}));
            };
            this.byId("chartContainer").addEventDelegate({
				"onAfterRendering": oEvent.bind(this)
			});
		},
		/* ============================================================ */
		/* Helper Methods                                               */
