sap.ui.define([
...
], function (VizFrame, ChartContainerContent, SelectionDetails, Control, Interface, Item, SelectionDetailsItem, mobileLibrary, nextUIUpdate) {

	var SelectionDetailsActionLevel = mobileLibrary.SelectionDetailsActionLevel;
	...
	QUnit.test("The '_getSelectionDetails' method when content is VizFrame", async function (assert) {
		// Arrange
	...
	QUnit.test("The '_getSelectionDetails' method when content is not VizFrame", async function (assert) {
		// Arrange
	...
	QUnit.test("The 'getSelectionDetails' method", async function (assert) {
		// Assert
	...
	QUnit.test("Registering and deregistering for the '_selectionDetails' event", async function (assert) {
		//Arrange
	...
	QUnit.test("Registering and deregistering for the '_selectionDetails' event, if no content is in ChartContainerContent", async function (assert) {
		//Arrange
		var oDetachSpy = sinon.spy(this.oContent._oSelectionDetails, "detachSelectionHandler");
		var oAttachSpy = sinon.spy(this.oContent._oSelectionDetails, "attachSelectionHandler");
		//Act
	...
	QUnit.test("Event 'actionPress' exposes item's facades", async function (assert) {
	...
	QUnit.test("Event 'navigate' exposes item facade", async function (assert) {
		var oSelectionDetails = this.oContent._getSelectionDetails(),
			oItem = new SelectionDetailsItem(),
			oItemFacade = oItem.getFacade();
		await nextUIUpdate();
