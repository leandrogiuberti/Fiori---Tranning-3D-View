sap.ui.define([
	...
	*/
	...
	QUnit.test("Test successful finish using SemanticColor", function (assert) {

		assert.equal(ThemingUtil.resolveColor("Sequence1"), "Sequence1");
		assert.equal(ThemingUtil.resolveColor("Sequence2"), "Sequence2");
		assert.equal(ThemingUtil.resolveColor("Sequence3"), "Sequence3");
		assert.equal(ThemingUtil.resolveColor("Sequence4"), "Sequence4");
		assert.equal(ThemingUtil.resolveColor("Sequence5"), "Sequence5");
