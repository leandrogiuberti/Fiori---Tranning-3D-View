sap.ui.define([
...
], function (jQuery, HtmlElement, Rectangle, Circle, Path, CustomShape, suiteLibrary, FillingOption,
						 StubsFactory, Log, sinon, sinon_qunit, createAndAppendDiv, nextUIUpdate) {
	"use strict";
	...
	function injectAnimationPropetiesResolverSemantic(oCustomShape) {
		var oResolver = StubsFactory.createDummyPropertiesResolver(true);
		oCustomShape._injectAnimationPropertiesResolver(oResolver);
		return oCustomShape;
	}
	...
	QUnit.test("Test default values for attributes", async function (assert) {
	...
	QUnit.test("Test custom attributes", async function (assert) {
		this.oCustomShape = new CustomShape({
			x: 10,
			y: 20,
			height: "300px",
	...
	QUnit.test("Test no viewBox attribute in definition", async function (assert) {
		this.oCustomShape = new CustomShape({
	...
	QUnit.test("Test viewBox attribute in definition", async function (assert) {
		this.oCustomShape = new CustomShape({
			fillingType: FillingType.None,
	...
	*/
	...
	QUnit.test("Test parsing of SVG with one fillable object (Path) using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var iCircleCx = 1;
		var iCircleCy = 2;
		var iCircleR = 4;
	...
	*/
	...
	QUnit.test("Test parsing of SVG with one fillable object (Circle)", function (assert) {
		...
		injectAnimationPropetiesResolverSemantic(oCustomShape);
	...
	*/
	...
	QUnit.test("Test passing parameters from SVG markup using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var iCircleCx = 1;
		var iCircleCy = 2;
		var iCircleR = 4;
	...
	*/
	...
	QUnit.test("Test multiple fillable shapes using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var oCustomShape = new CustomShape({
			fillColor: "Critical",
			fillingType: FillingType.Linear,
	...
	*/
	...
	QUnit.test("Test updateDom with multiple shapes in default setup using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var oCustomShape = new CustomShape({
			fillColor: "Good",
			fillingType: FillingType.Linear,
	...
	*/
	...
	QUnit.test("Test explicitly setup order using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var oCustomShape = new CustomShape({
			fillColor: "Good",
			fillingType: FillingType.Linear,
	...
	*/
	...
	QUnit.test("Test updateDom with different weight using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var oCustomShape = new CustomShape({
			fillColor: "Critical",
			fillingType: FillingType.Linear,
	...
	*/
	...
	QUnit.test("Test updateDom explicitly setup order using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var oCustomShape = new CustomShape({
			fillColor: "Critical",
			fillingType: FillingType.Linear,
	...
	*/
	...
	QUnit.test("Test FillingOptions with same order using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var oCustomShape = new CustomShape({
			fillColor: "Good",
			fillingType: FillingType.Linear,
	...
	*/
	...
	QUnit.test("Test Distribution of filling using SemanticColor", function (assert) {
		var sPathD = "M 15.93 24.44 a 1.83 1.83 0 1 1 1.83 -1.83 A 1.83 1.83 0 0 1 15.93 24.44 Z";
		var oCustomShape = new CustomShape({
			fillColor: "Good",
			fillingType: FillingType.Linear,
	...
	QUnit.test("Shapes is correctly filled after re-rendering", async function (assert) {
		this.oCustomShape = new CustomShape({
			definition: bulbSvg
		});
		injectAnimationPropetiesResolver(this.oCustomShape);
	...
	QUnit.test("Shapes is correctly filled after changing strokeWidth", async function (assert) {
		this.oCustomShape = new CustomShape({
			definition: bulbSvg
		});
		injectAnimationPropetiesResolver(this.oCustomShape);
