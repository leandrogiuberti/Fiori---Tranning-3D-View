sap.ui.define([
...
], function (ShapeGroup, Shape, Rectangle, Core, Configuration, ControlBehavior, sinon) {
	"use strict";
	...
	QUnit.test("Test _setValue call with disabled animations", function (assert) {
		...
		var oGetConfigurationStub = oSandbox.stub(ControlBehavior, "getAnimationMode");
		oGetConfigurationStub.returns( Configuration.AnimationMode.none);
	...
	QUnit.test("Test _setValue call with enabled animations", function (assert) {
		...
		var oGetConfigurationStub = oSandbox.stub(ControlBehavior, "getAnimationMode").returns(Configuration.AnimationMode.full);
