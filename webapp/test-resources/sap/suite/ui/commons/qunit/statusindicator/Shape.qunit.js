sap.ui.define([
...
], function (library, jQuery, Shape, AnimationPropertiesResolver, sinon, nextUIUpdate) {
	"use strict";
	...
	/**
	* @deprecated As of version 1.54.1.
	*/
	...
	*/
	...
	QUnit.test("Test clearing cache before rendering", async function (assert) {
