...
sap.ui.define([
	...
	"sap/ui/core/Lib"
], function(QUnitUtils, createAndAppendDiv, FeedItem, FeedTile, JSONModel, jQuery, Lib) {
	"use strict";
	...
	createAndAppendDiv("uiArea11").className = "FeedTileuiArea11";


	var pressedItemId = null;
	var emptyFeedCtrlPressActivated = false;
	var cloudItemId = "cloudItem";
	var oResBundle = Lib.getResourceBundleFor("sap.suite.ui.commons");
