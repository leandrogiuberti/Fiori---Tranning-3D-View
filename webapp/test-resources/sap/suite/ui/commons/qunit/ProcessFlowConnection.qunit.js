sap.ui.define([
...
], function(jQuery, suiteLibrary, ProcessFlowConnection, ProcessFlowNode,
            ProcessFlow, createAndAppendDiv, nextUIUpdate) {
	"use strict";
	...
	QUnit.test("Connection rtlb is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection rtl is rendered", async  function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection rtb is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection rlb is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection tlb is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection rt is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection rl is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection rb is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection tl is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection tb is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Connection lb is rendered", async function (assert) {
		this.aPFC.push(
	...
	QUnit.test("Get ARIA details of branch connection", async function (assert) {
		/* Arrange */
		this.aPFC.push(
	...
	QUnit.test("Get ARIA details of horizontal connection", async function (assert) {
		/* Arrange */
		this.aPFC.push(
	...
	QUnit.test("Get ARIA details of vertical connection", async function (assert) {
		/* Arrange */
		this.aPFC.push(
	...
	QUnit.test("Get ARIA details of an ending horizontal connection", async function (assert) {
		/* Arrange */
