sap.ui.define([
	...
	"sap/ui/core/Element"
], function(ChartContainer, Select, nextUIUpdate, Element) {
	"use strict";
	...
	QUnit.module("Overwritten functions for DimensionSelector aggregation", {
		beforeEach : async function() {
			...
			this.oSelect3 = new Select();ChartContainer.js
		},
		afterEach : function() {
			this.oSelect1 = null;
			this.oSelect2 = null;
	...
	QUnit.test("ChartContainer destroyDimensionSelectors is properly using overwritten function of ManagedObject", function(assert) {
		...
		assert.notOk(Element.getElementById(sSelectorId), "The Selector control has been destroyed");
	...
	QUnit.test("ChartContainer removeAllDimensionSelectors is properly using overwritten function of ManagedObject", async function(assert) {
		//Arrange
		this.oChartContainer.addDimensionSelector(this.oSelect1);
		this.oChartContainer.addDimensionSelector(this.oSelect2);
		this.oChartContainer._adjustSelectorDisplay();
