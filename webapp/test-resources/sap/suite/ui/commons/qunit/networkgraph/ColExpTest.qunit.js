sap.ui.define([
...
], function (GraphTestUtils, createAndAppendDiv, nextUIUpdate) {
	"use strict";
	...
	QUnit.test("Some basic collapse/expand stuff.", async function (assert) {
	...
	QUnit.test("Mixed nodes collapsing cycles through collapse states correctly.", async function (assert) {
		var oGraph = GraphTestUtils.buildGraph({
				nodes: [
	...
	QUnit.test("Collapsing/expanding over a group makes it collapse/expand too.", async function (assert) {
		var oGraph = GraphTestUtils.buildGraph(
			{
				nodes: [
					{key: 0, title: "0"},
	...
	QUnit.test("Collapsing/expanding inside a cycle of nodes works correctly.", async function (assert) {
		var oGraph = GraphTestUtils.buildGraph({
				nodes: [
					{key: 0, title: "0"},
					{key: 1, title: "1"},
	...
	QUnit.test("Collapsing/expanding case inspired by FXUBRQ13-305.", async function (assert) {
		var oGraph = GraphTestUtils.buildGraph({
				nodes: [
					{key: 0, title: "0"},
	...
	QUnit.test("Collapsing/expanding test.", async function (assert) {
		var oGraph = GraphTestUtils.buildGraph({
				nodes: [
					{key: 0, title: "0"},
					{key: 1, title: "1"},
	...
	QUnit.test("Collapsing/expanding in specific case (more nodes behind).", async function (assert) {
		var oGraph = GraphTestUtils.buildGraph({
				nodes: [
					{key: 0, title: "0"},
					{key: 1, title: "1"},
	...
	QUnit.skip("Collapsing/expanding test (nodes + groups).", async function(assert) {
		var oGraph = GraphTestUtils.buildGraph({
				nodes: [
