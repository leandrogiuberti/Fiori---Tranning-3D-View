sap.ui.define([
...
], function (GraphTestUtils, suiteLibrary, createAndAppendDiv, nextUIUpdate) {
	"use strict";

	var Status = suiteLibrary.networkgraph.ElementStatus,
		NodeShape = suiteLibrary.networkgraph.NodeShape,
		LineType = suiteLibrary.networkgraph.LineType,
		LineArrowPosition = suiteLibrary.networkgraph.LineArrowPosition,
		LineArrowOrientation = suiteLibrary.networkgraph.LineArrowOrientation;
	...
	QUnit.test("Node data binding without re-layouting.", async function (assert) {
	...
	QUnit.test("Node data binding with re-layouting.", async function (assert) {
		var oGraph = fnGetBasicGraph(),
			fnDone = assert.async(),
			oModel = oGraph.getModel(),
			mAsyncChain = {
	...
	QUnit.test("Line data binding without re-layouting.", async function (assert) {
		var oGraph = fnGetBasicGraph(),
			fnDone = assert.async(),
			oModel = oGraph.getModel();
	...
	QUnit.test("Line data binding with re-layouting.", async function (assert) {
		var oGraph = fnGetBasicGraph(),
			fnDone = assert.async(),
			oModel = oGraph.getModel(),
			mAsyncChain = {
	...
	QUnit.test("Group data binding without re-layouting.", async function (assert) {
		var oGraph = fnGetBasicGraph(),
			fnDone = assert.async(),
			oModel = oGraph.getModel();
	...
	QUnit.test("Group data binding with re-layouting.", async function (assert) {
		var oGraph = fnGetBasicGraph(),
			fnDone = assert.async(),
			oModel = oGraph.getModel(),
			mAsyncChain = {
