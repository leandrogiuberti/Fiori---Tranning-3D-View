sap.ui.define([
...
], function (GraphTestUtils, createAndAppendDiv, TwoColumnsLayout, nextUIUpdate) {
	"use strict";
	...
	QUnit.test("Basic nested.", async function (assert) {
	...
	QUnit.test("Collapsed nested groups", async function (assert) {
	...
	QUnit.test("Collapse expand from start", async function (assert) {
	...
	QUnit.test("Width of two columns", async function (assert) {
		var oGraph = GraphTestUtils.buildGraph(aData),
			fnDone = assert.async(),
			oLayouter = new TwoColumnsLayout();
