sap.ui.define([
	...
	QUnit.test("Move focus based on arrow - check movement function last element on row", function (assert) {
		...
		assert.ok(getComputedStyle(nodes[17].getDomRef()).outline.indexOf(oColor.sapUiContentFocusStyle), "Focus Style applied.");
		assert.ok(getComputedStyle(nodes[17].getDomRef()).outline.indexOf(oColor.sapUiContentFocusColor), "Focus Color applied.");
		assert.ok(getComputedStyle(nodes[17].getDomRef()).outline.indexOf(oColor.sapUiContentFocusWidth), "Focus Width applied.");
