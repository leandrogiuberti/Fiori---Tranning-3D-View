		...
		tests: {
			...
			Collaboration: {
				...
				module: [
					...
					"./collaboration/flpplugins/msplugin/Component.qunit"
				]
			},
			/**
			 ...
			 */
			"Legacy Testsuite": {
				page: "test-resources/sap/suite/ui/commons/qunit/testsuite.legacy.qunit.html"
			},
			"IceCream Machine TestSuite": {
				page: "test-resources/sap/suite/ui/commons/demokit/icecream/webapp/test/testsuite.qunit.html"
			}
		}
	};
});
