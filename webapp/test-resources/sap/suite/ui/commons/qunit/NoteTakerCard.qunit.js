	...
	QUnit.module("note taker card rendering", {
		beforeEach: function(assert) {
			...
			this.eColors = {
				NEUTRAL: {
					value: 1,
					codesHEX: ["#808080", "#999999"],
					codesRGB: ["rgb(128, 128, 128)", "rgb(153, 153, 153)"]
				},
				GREEN: {
					value: 2,
					codesHEX: ["#006e00", "#007833"],
					codesRGB: ["rgb(0, 110, 0)", "rgb(0, 120, 51)"]
				},
				RED: {
					value: 3,
					codesHEX: ["#d60000", "#cc1919"],
					codesRGB: ["rgb(214, 0, 0)", "rgb(204, 25, 25)"]
				}
			};
			this.fnAssertColor = function(oJQueryObject, eColor, sMessage) {
				if (eColor) {
					...
					assert.ok(
						eColor.codesHEX.includes(borderColor) || 
						eColor.codesRGB.includes(borderColor), 
						sMessage
					);
				}
			};
