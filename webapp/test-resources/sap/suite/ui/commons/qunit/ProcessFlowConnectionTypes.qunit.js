sap.ui.define([
...
], function(suiteLibrary, ProcessFlowConnection, createAndAppendDiv, nextUIUpdate) {
	"use strict";
	...
	QUnit.test("Connection is horizontal line", async function (assert) {
		/* Arrange */
		this.aPFC.push(
	...
	QUnit.test("Connection is vertical line", async function (assert) {
		/* Arrange */
		this.aPFC.push(
	...
	QUnit.test("Connection is special line", async function (assert) {
		/* Arrange */
		this.aPFC.push(
