...
sap.ui.define([
	...
	QUnit.test("_destroyDisabledToolbarButtons", function(assert) {
		var aEnabledButtons = [ImageEditorContainerButton.Filter];
		this.oSandbox.spy(this.oImageEditorContainer, "_destroyDisabledToolbarButtons");

		this.oImageEditorContainer.setEnabledButtons(aEnabledButtons);
		assert.ok(this.oImageEditorContainer._destroyDisabledToolbarButtons.calledOnce, "_updateToolbarsContent called");

		assert.equal(this.oImageEditorContainer._oCropButton, null, "crop button destroyed");
		assert.equal(this.oImageEditorContainer._oMobileCropButton, null, "mobile crop button destroyed");
		assert.equal(this.oImageEditorContainer._oTransformButton, null, "transform button destroyed");
		assert.equal(this.oImageEditorContainer._oMobileTransformButton, null, "mobile transform button destroyed");
		assert.ok(!!this.oImageEditorContainer._oFilterButton, "filter button should not be destroyed");
		assert.ok(!!this.oImageEditorContainer._oMobileFilterButton,"mobile filter button should not be destroyed");
	});
