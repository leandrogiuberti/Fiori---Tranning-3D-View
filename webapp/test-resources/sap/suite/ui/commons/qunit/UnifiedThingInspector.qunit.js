...
sap.ui.define([
	...
	styleElement.textContent =
		".UnfiedThingInspectorContentHeightWidth {" +
		"		width: 100%;" +
		"		height: 30%;" +
		"}";
	document.head.appendChild(styleElement);

	document.body.insertBefore(createAndAppendDiv("content"), document.body.firstChild).className = "UnfiedThingInspectorContentHeightWidth";
