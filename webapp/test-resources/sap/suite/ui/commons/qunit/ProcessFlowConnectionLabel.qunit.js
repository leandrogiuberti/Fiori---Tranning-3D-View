sap.ui.define([
...
], function(suiteLibrary, ProcessFlow, ProcessFlowNode, ProcessFlowConnectionLabel, ProcessFlowLaneHeader, ProcessFlowConnection,
            InvisibleText, qutils, nextUIUpdate) {
	"use strict";

	var ProcessFlowConnectionLabelState = suiteLibrary.ProcessFlowConnectionLabelState,
	...
	QUnit.test("Test if mouse down adds the active css class inside the label", async function (assert) {
		//Arrange
		this.oTestLabel = new ProcessFlowConnectionLabel({
			id: "myButtonId1To14",
			text: "first helloworld",
	...
	QUnit.test("Test if mouse up removes the active css class inside the label", async function (assert) {
		//Arrange
		this.oTestLabel = new ProcessFlowConnectionLabel({
			id: "myButtonId1To24",
			text: "first helloworld",
	...
	QUnit.test("Test if mouse leave removes the active css class inside the label", async function (assert) {
		//Arrange
		this.oTestLabel = new ProcessFlowConnectionLabel({
			id: "myButtonId1To34",
			text: "first helloworld",
	...
	QUnit.test("Get correct visible label by state", async function (assert) {
		/* Arrange */
	...
	QUnit.test("Get correct visible label by state and priority", async function (assert) {
		/* Arrange */
		this.oProcessFlowConnection.addAggregation("_labels", new ProcessFlowConnectionLabel({
			id: "myButtonId1",
			text: "first",
	...
	QUnit.test("Overwrite ARIA value using 'addAriaLabelledBy'", async function (assert) {
		/* Arrange */
		this.oTestLabel = new ProcessFlowConnectionLabel({
			id: "myButtonId1To15",
			text: "first helloworld",
	...
	QUnit.test("Use default ARIA value", async function (assert) {
		/* Arrange */
		...
		assert.equal(aAriaLabelledByElements.length, 1, "1 Items available in AriaLabelledElements");
