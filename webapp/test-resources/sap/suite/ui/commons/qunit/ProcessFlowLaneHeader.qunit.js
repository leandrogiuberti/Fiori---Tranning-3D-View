sap.ui.define([
	...
	"sap/ui/core/Lib"
], function(jQuery, suiteLibrary, ProcessFlowLaneHeader, JSONModel, ProcessFlow, ProcessFlowNode, nextUIUpdate, CoreLib) {
	"use strict";
	...
	QUnit.test("ProcessFlow lane map check, strange order of lanes", async function (assert) {
		...
		await nextUIUpdate();
		assert.equal(document.getElementsByClassName('suiteUiProcessFlowLaneHeaderProcessSymbolContainer')[0].ariaLabel, oResourceBundle.getText('PF_ARIA_SYMBOL_LANE_PROCESS'), "Aria-label added successfully");
