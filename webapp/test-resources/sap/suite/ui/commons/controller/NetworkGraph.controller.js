...
sap.ui.define([
    ...
    suiteLibrary, Graph, Node, Line, Group, ElementAttribute,
    ...
    var Orientation = suiteLibrary.networkgraph.Orientation,
        ...
        ArrowPosition = suiteLibrary.networkgraph.LineArrowPosition;
    ...
    var fnUpdateStaticNodes = function () {
        if (oGraph.getLayoutAlgorithm() && oGraph.getLayoutAlgorithm().setStaticNodes) {
            var oData = oGraph.getModel().getData();
    ...
    }).setModel(this.oModelSettings, 'settings').placeAt("controlsLine4");
    ...
    }).setModel(this.oModelSettings, 'settings').placeAt("content");

    oGraph.setModel(oModel);
    oGraph.setModel(this.oModelSettings, "settings");
