sap.ui.define([
    ...
    function generateFooterForNoteTaker1() {
        ...
        var oSetVisButton = new sap.ui.commons.Button("nt1-vis-button", {
            text: "Update",
            press: function () {
                var count = Element.getElementById("nt1-vis-field").getValue();
                if (!isNaN(count)) {
                    Element.getElementById("NT1").setVisibleNotes(parseInt(count));
                }
            }
        });
        ...
        var oViewAllLimitButton = new sap.ui.commons.Button("nt1-viewAll-button", {
            text: "Set",
            press: function () {
                var limit = Element.getElementById("nt1-viewAll-field").getValue();
                if (!isNaN(limit)) {
                    Element.getElementById("NT1").setCardViewAllTrigger(parseInt(limit));
                }
            }
        });
    ...
    function generateFooterForNoteTaker2() {
        ...
        var oSetVisButton = new sap.ui.commons.Button("nt2-set-visible-cards", {
            text: "Update",
            press: function () {
                var count = Element.getElementById("nt2-vis-field").getValue();
                if (isNaN(count)) {
                    return;
                }
                Element.getElementById("NT2").setVisibleNotes(parseInt(count));
            }
        });
        ...
        var oViewAllLimitButton = new sap.ui.commons.Button("nt2-viewAll-btn", {
            text: "Set",
            press: function () {
                var limit = Element.getElementById("nt2-viewAll-field").getValue();
                if (isNaN(limit)) {
                    return;
                }
                Element.getElementById("NT2").setCardViewAllTrigger(parseInt(limit));
            }
        });
    ...
    function generateFooterForNoteTaker3() {
        ...
        var oViewModelButton = new sap.ui.commons.Button("nt3-viewModel-btn", {
            text: "View model",
            press: function (e) {
                var noteTaker2 = Element.getElementById("NT3");
        ...
        var oTagFilterButton = new sap.ui.commons.Button("nt3-tagFilter-btn", {
            text: "Set",
            press: function (e) {
                var sTagCriterion = Element.getElementById("nt3-tagFilter-field").getValue();
                var taker = Element.getElementById("NT3");
                if (sTagCriterion == "") {
    ...
    function generateUid() {
		...
		taker.attachEditCard(function(oEvent) {
			...
			Element.getElementById("NT1_LAST_EDITED").setText("UID: " + uid + "\n\r" + "Title: " + title);
		});
		...
		var taker3 = new sap.suite.ui.commons.NoteTaker({
			...
			addCard: function(e) {
				...
				Element.getElementById("nt3-la-text").setText("UID: " + sUid + "\n" + "Title: " + sTitle);
			},
