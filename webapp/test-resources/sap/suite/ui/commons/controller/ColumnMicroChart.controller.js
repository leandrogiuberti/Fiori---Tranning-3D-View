sap.ui.define([
    ...
    var oWidthInput = new sap.m.Input("scale-width", {
        ...
        liveChange: function (e) {
            ...
            var oItem = Element.getElementById("scale-width-inner");
    ...
    var oHeightInput = new sap.m.Input("scale-height", {
        ...
        liveChange: function (e) {
            ...
            var oItem = Element.getElementById("scale-height-inner");
            if (patt.test(sEnteredText)) {
