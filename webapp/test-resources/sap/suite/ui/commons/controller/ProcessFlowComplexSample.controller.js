sap.ui.define([
    ...
    "sap/m/MessageToast"
], function (Mobile, Element, JSONModel, MessageToast) {
    ...
    function onNodePress(event) {
        ...
        MessageToast.show(textToDisplay, {
    ...
    function onLabelPress(oEvent) {
        ...
        var oResponsivePopover = this.byId("__popover");
    ...
    function onUpdateModel(oEvent) {
        ...
        var oModelUpdated = new JSONModel();
    ...
    var oJModelComplex = new JSONModel(oDataProcessFlowComplex);
