sap.ui.define(["sap/ui/qunit/utils/nextUIUpdate"], async function (nextUIUpdate){
    ...
    var buttonToogleHighlight = new sap.m.Button({
    ...
    this.oProcessFlowMRN2 = new sap.suite.ui.commons.ProcessFlow("pMRN2", {
        foldedCorners: true,
        nodes: {
            path: "/nodes",
    ...
    this.oProcessFlowMRN2.setModel(oJModelMRN2);
    buttonToogleHighlight.placeAt("togglepathbutton");

    this.oProcessFlowMRN2.attachNodePress(function (oEvent) {
        nodeClickEvent(oEvent);
    });


    this.oProcessFlowMRN2.placeAt("processFlowDivMultipleRootNodes2");
    await nextUIUpdate();
