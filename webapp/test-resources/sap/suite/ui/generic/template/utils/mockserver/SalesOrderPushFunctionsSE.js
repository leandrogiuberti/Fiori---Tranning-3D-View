sap.ui.define([
	...
	function (Utils, deepExtend, AjaxHelper, Button, Dialog, MessageBox, MessageToast) {
		...
		function fnSave(aRequests, oMockServer) {
			...
			aRequests.push({
				method: 'GET',
				path: new RegExp("C_STTA_SalesOrderItem_WD_20(.*)\\?.*\\$select=to_Categories&\\$expand=to_Categories"),
				...
				response: function (oXhr, SalesOrder) {
					...
					var sMsgStringnavtarget = sNavTarget + " call Side effect message:Refresh the navigation target to_Categories";
