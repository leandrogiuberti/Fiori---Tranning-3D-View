sap.ui.define(["sap/ui/base/Object", "../Utils", "sap/base/util/extend", "sap/ui/core/Component"], function(BaseObject, Utils, extend, Component) {
	"use strict";
	...
	function getMethods(sComponentId, sBaseURL, oMockServer) {
		...
		function getMetaModel() {
			oMetaModel = oMetaModel || Component.getComponentById(sComponentId).getModel().getMetaModel();
			return oMetaModel;
		}
