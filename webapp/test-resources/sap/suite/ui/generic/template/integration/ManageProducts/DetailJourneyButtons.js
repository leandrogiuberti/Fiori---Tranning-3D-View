sap.ui.define([], function() {
	...
	if (sap.ui.Device.browser.firefox) {
		...
		opaTest("#2 Check The Navigation and the Delete Button", function(Given, When, Then) {
			// Arrangements
	...
	*/
	//	opaTest("#4 Check Delete Button Existence", function(Given, When, Then) {
			//When.onTheDetailPage.clickOverflow();
	//		Then.onTheDetailPage.checkDeleteButton();
	//	});
	
		opaTest("#5 Check Edit Button Existence", function(Given, When, Then) {
	...
	//	});
		...
		opaTest("#6 Check Copy Button Existence", function(Given, When, Then) {
			// When.onTheDetailPage.clickOverflow();
