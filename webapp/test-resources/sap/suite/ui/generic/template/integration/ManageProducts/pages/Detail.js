			...
			actions: {
				...
				clickItemDraft: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							...
							oFirstItem.$().trigger("tap");
							Opa5.assert.ok(true, "Draft item clicked.");
				...
				clickItemForDraft: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							...
							oFirstItem.$().trigger("tap");
							Opa5.assert.ok(true, "Item with draft clicked.");
						},
						errorMessage: "Items not loaded."
					});
				...
				clickOverflow: function() {
					return this.waitFor({
						...
						success: function(aButtons) {
							...
							Opa5.assert.ok(true, "The Overflow button was clicked.");
				...
				clickConfirm: function() {
					return this.waitFor({
						...
						success: function(aButtons) {
							...
							Opa5.assert.ok(true, "The Confirm button was clicked.");
						},
				...
				clickResume: function() {
					...
					return this.waitFor({
						...
						success: function(aButtons) {
							aButtons[0].$().trigger("tap");
							Opa5.assert.ok(true, "Resume button clicked");
				...
				clickDiscard: function() {
					...
					return this.waitFor({
						...
						success: function(aButtons) {
							aButtons[0].$().trigger("tap");
							Opa5.assert.ok(true, "Discard button clicked");
				...
				clickBack: function() {
					...
					return this.waitFor({
						...
						success: function(aButtons) {
							...
							backBtn.$().trigger("tap");
							Opa5.assert.ok(true, "Back button clicked");
						},
				...
				clickLockedIcon: function() {
					...
					return this.waitFor({
						...
						success: function(aButtons) {
							...
							backBtn.$().trigger("tap");
							Opa5.assert.ok(true, "Locked button clicked");
					...
					return this.waitFor({
						...
						success: function (aControl) {
							...
							for (var i = 0; i < aActions.length; i++) {
								oAction = aActions[i];
								if ((oAction.isA("sap.m.Button") || oAction.isA("sap.uxap.ObjectPageHeaderActionButton")) && oAction.getText() === sButtonText) {
									oAction.firePress();
									break;
								}

								if (i === aActions - 1) { // reached end of array and specified button was not found
									Opa5.assert.notOk(true, "The " + sButtonText + "button could not be found");
								}
							}
						},
...
*/
						...
						success: function(oTable) {
							Opa5.assert.notEqual(oTable[0].getItems().length, 0, "Item Loaded.");
						},
						errorMessage: "Items not loaded."
					});
				},
				...
				iShouldSeeThePageTitle: function() {
					return this.waitFor({
						...
						success: function() {
							Opa5.assert.ok(true, "The detail page has a title.");
						},
				...
				thePageTitleIsCorrect: function() {
					return this.waitFor({
						...
						success: function(oTitle) {
							Opa5.assert.ok(oTitle[0].getText() === "Product", "The Detail page title is correct.");
						},
				...
				checkLockedPopup: function() {
					return this.waitFor({
						...
						success: function(oTitle) {
							Opa5.assert.ok(oTitle[0].getText() === "Locked", "The locked popup title is correct.");
						},
				...
				theListIsDisplayed: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							Opa5.assert.notEqual(oTable[0].getItems().length, 0, "The Detail item list is displayed.");
						},
				...
				itemDeleted: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							...
							Opa5.assert.notEqual(itm.ActiveProduct, "HT-1001", "Item deleted successfully");
				...
				checkCopyButton: function() {
					return this.waitFor({
						...
						success: function(oButton) {
							Opa5.assert.ok(true, "The detail page has copy button.");
						},
...
*/
				...
				checkOverflowButton: function() {
					return this.waitFor({
						...
						success: function(oButton) {
							Opa5.assert.ok(true, "The detail page has an Overflow button.");
						},
				...
				checkConfirmDeletePopup: function() {
					return this.waitFor({
						...
						// viewName : sViewName,
						success: function(oTitle) {
							Opa5.assert.ok(true, "Confirm Delete dialog opened with a title");
						},
				...
				checkDraftFilterAdded: function() {
					return this.waitFor({
						...
						success: function(oInputBase) {
							Opa5.assert.ok(true, "DraftFilter added successfully");
							oInputBase[3].setValue(oDraftItem.ActiveProduct);

						},
						errorMessage: "DraftFilter not added successfully."
					});
				},
				...
				checkDraftPopup: function() {
					return this.waitFor({
						...
						success: function(oButton) {
							Opa5.assert.ok(true, "The Draft Popup Open Successfully.");
					...
					return this.waitFor({
						...
						success: function (aControl) {
							...
							for (var i = 0; i < aActions.length; i++) {
								oAction = aActions[i];
								if ((oAction.isA("sap.m.Button") || oAction.isA("sap.uxap.ObjectPageHeaderActionButton")) && oAction.getText() === sButtonText) {
									Opa5.assert.ok(true, "The detail page has " + sButtonText + " button.");
									if (bEnabled !== undefined) {
										Opa5.assert.ok(oAction.getEnabled() === bEnabled , "The " + sButtonText + " has the property 'enabled' set to " + bEnabled + ".");
									}
									break;
								}
