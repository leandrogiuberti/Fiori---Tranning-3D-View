sap.ui.define([
	...
	"sap/suite/ui/generic/template/integration/demoObjectPagePathSupport/pages/PageObjects",
	...
	"sap/suite/ui/generic/template/integration/demoObjectPagePathSupport/journeys/ListReport/ListReport",
	"sap/suite/ui/generic/template/integration/demoObjectPagePathSupport/journeys/ObjectPage/ObjectPage"
],
		...
		Opa5.extendConfig({
			...
			testLibs: {
				fioriElementsTestLibrary: {
					Common: {
						appId: 'demoObjectPagePathSupport',
