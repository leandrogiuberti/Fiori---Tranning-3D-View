			...
			actions: {
				...
				removeFilter: function() {
					return this.waitFor({
						...
						errorMessage: "Filter removed successfully."
					});
				},
			...
			assertions: {
				...
				iShouldSeeTheTable: function() {
					return this.waitFor({
						...
						success: function() {
							Opa5.assert.ok(true, "The main page has a table.");
						},
				...
				checkFilterButtonToRemove: function() {
					return this.waitFor({
						...
						success: function(oButton) {
							Opa5.assert.ok(true, "The Main page has filter set button.");
						},
				...
				checkAddButton: function() {
					...
					return this.waitFor({
						...
						success: function(aButtons) {
							Opa5.assert.ok(true, "The page has a add button.");
				...
				checkHideFilterButton: function() {
					return this.waitFor({
						...
						success: function(oButton2) {
							Opa5.assert.ok(true, "The page has a Hide Filter Bar button.");
						},
				...
				checkFilterButton: function() {
					return this.waitFor({
						...
						success: function(oButton2) {
							Opa5.assert.ok(true, "The page has a Filters button.");
						},
				...
				checkChangePrice: function() {
					return this.waitFor({
						...
						autoWait: false,
						success: function(oButton2) {
							Opa5.assert.ok(true, "The page has a Change Price button.");
						},
				...
				checkCopyWithSupplier: function() {
					return this.waitFor({
						...
						success: function(oButton2) {
							Opa5.assert.ok(true, "The page has a Copy with new supplier button.");
						},
				...
				checkActivate: function() {
					return this.waitFor({
						...
						autoWait: false,
						success: function(oButton2) {
							Opa5.assert.ok(true, "The page has a Activate button.");
						},
				...
				checkValidate: function() {
					return this.waitFor({
						...
						success: function(oButton2) {
							Opa5.assert.ok(true, "The page has a Validate button.");
						},
				...
				checkCopy: function() {
					return this.waitFor({
						...
						success: function(oButton2) {
							Opa5.assert.ok(true, "The page has a Copy button.");
						},
				...
				checkSettingButton: function() {
					...
					return this.waitFor({
						...
						success: function() {
							Opa5.assert.ok(true, "The page has a setting button.");
						},
				...
				checkExportButton: function() {
					...
					return this.waitFor({
						...
						success: function() {
							Opa5.assert.ok(true, "The page has a excel export button.");
						},
				...
				checkNoExportButton: function() {
					...
					return this.waitFor({
						...
						success: function() {
							Opa5.assert.ok(true, "The page has no excel export button.");
						},
				...
				dialogTitle: function() {
					return this.waitFor({
						...
						success: function(oTitle) {
							Opa5.assert.ok(oTitle[0].getText() === "View Settings", "The page title is correct.");
						},
				...
				theListIsDisplayed: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							...
							Opa5.assert.notEqual(oTable[0].getItems().length, 0, "The list is displayed.");
						},
				...
				checkFilterRemoved: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							...
							Opa5.assert.ok(oTable[0].getItems().length > 1, "The filter removed successfully");
						},
				...
				checkFilterPopup: function(sFilterLiteral) {
					return this.waitFor({
						...
						success: function(oTitle) {
							Opa5.assert.ok(true, "Filter Dialog opened with a title");
						},
				...
				selectFilterPopupTitleCorrect: function() {
					return this.waitFor({
						...
						success: function(oTitle) {
							Opa5.assert.ok(true, "Select Filter Dialog opened with a title");
						},
				...
				checkFilterAdded: function() {
					return this.waitFor({
						...
						controlType: "sap.m.InputBase",
						success: function(oInputBase) {
							Opa5.assert.ok(true, "Filter added successfully");
							oInputBase[4].setValue(firstProduct.Product);
						},
						errorMessage: "Filter not added successfully."
					});
				},
				...
				checkDraftItem: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							...
							Opa5.assert.notEqual(oDraftItemFound, false, "The list has draft item");
						},
				...
				checkDraftItemDiscarded: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							...
							Opa5.assert.notEqual(oDraftItemFound, true, "Draft Item Discarded successfully");
						},
						errorMessage: "The list has no draft item"
					});
				},
				...
				checkTableEntriesDraft: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							Opa5.assert.equal(oTable[0].getItems().length, 2, "The list has 2 items, filter working!");
						},
				...
				checkColumnAdded: function() {
					...
					return this.waitFor({
						...
						success: function(oTable) {
							...
							Opa5.assert.equal(columnDiff, 1, "Settings column selection working");
						},
						errorMessage: "Settings column selection not working"
					});
				},
				...
				checkColumnBefore: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							Opa5.assert.ok(true, "columns count calculated" );
						},
				...
				checkTableEntries: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							Opa5.assert.equal(oTable[0].getItems().length, 1, "The list has 1 items, filter working!");
						},
						errorMessage: "Filter not Working"
					});
				},
				...
				checkVariableTableEntries: function(iTableEntries) {
					return this.waitFor({
						...
						success: function(oTable) {
							Opa5.assert.equal(oTable[0].getItems().length, iTableEntries, "The list has " + iTableEntries + " items!");
						},
				...
				checkForHeaderVisibility: function(){
					return this.waitFor({
						...
						success: function(){
							Opa5.assert.ok("Table header is visible");
						},
				...
				checkForToolbarVisibility: function(){
					return this.waitFor({
						...
						success: function(){
							Opa5.assert.ok("Table toolbar is visible");
						},
