	...
	function (opaTest) {
		...
		QUnit.module("Sales Order Item Aggregation - MultiSelectForAnalyticalTable: Single Select", function () {
			...
			opaTest("Starting the app and loading data", function (Given, When, Then) {
				Given.iStartMyAppInSandbox("STTASOWD20-STTASOWD20,SalesOrder-itemaggregation#SalesOrder-itemaggregation", "manifestAnalyticalTable");
			...
			opaTest("External navigation from Analytical Table - Dynamic values for Semantic Object and Action", function (Given, When, Then) {
				When.onTheGenericListReport
		...
		QUnit.module("Sales Order Item Aggregation - MultiSelectForAnalyticalTable: Multi Select with Limit and OP direct edit", function () {
			...
			opaTest("Check the Edit icon visibility on the Analytical table on LR", function (Given, When, Then) {
				Then.onTheListReportPage
					.iCheckTheEditIconVisibilityOnNthRowOfTable(1, true, "analyticalTable-_tab1");
			});

			opaTest("Check the Edit icon not visible for the non editable records", function (Given, When, Then) {
				Then.onTheListReportPage
					.iCheckTheEditIconVisibilityOnNthRowOfTable(4, false, "analyticalTable-_tab1")
			});
			...
			opaTest("Click on Save and check the navigation to LR", function (Given, When, Then) {
				...
				Then.onTheGenericListReport
					.theListReportPageIsVisible();
				Then.onTheListReportPage
					.iShouldSeeTheNavigatedRowHighlightedInUITables(0, true, "analyticalTable-_tab1")
					.and
					.iCheckRenderedColumnTextOnNthRowOfTable(1, [4], ["Test"], "analyticalTable-_tab1", "analyticalTable");
			});
			...
			opaTest("Click on Cancel and check the navigation to LR", function (Given, When, Then) {
				...
				Then.onTheGenericListReport
					.theListReportPageIsVisible();
				Then.onTheListReportPage
					.iShouldSeeTheNavigatedRowHighlightedInUITables(1, true, "analyticalTable-_tab1");
			});
