...
sap.ui.define(["sap/ui/test/opaQunit"], function () {
	...
	QUnit.module("AnalyticalListPage - Regression Test - Journey");
	...
	opaTest("Decimal Precision for Visual Filter Charts in VF Bar and VFD", function (Given, When, Then) {
		Then.onTheFilterBar.iCountVFDecimalPrecision("Line", 0, false);
		Then.onTheFilterBar.iCountVFDecimalPrecision("Bar", 0, false);
		When.onTheFilterBar.iClickTheFilterButton();
	...
	opaTest("Order of visual filters", function (Given, When, Then) {
		Then.onTheFilterBar.iCheckVFSortOrder("Cost Element", "Cost Center", false);
		When.onTheFilterBar.iClickTheFilterButton();
		Then.onTheFilterBar.iCheckVFSortOrder("Cost Element", "Cost Center", true);
		Then.iTeardownMyApp();
	});
	...
	opaTest("TextArrangement:TextLast - All Charts", function (Given, When, Then) {
		Given.iStartMyAppInDemokit("analytics4");
		When.onTheMainPage.iClickTheSegmentedButton("visual");
	...
	opaTest("Ensure OK and  Cancel button show up", function (Given, When, Then) {
		...
		Then.onTheFilterBar.iShouldSeePopOverButtons("OK");
		Then.onTheFilterBar.iShouldSeePopOverButtons("Cancel");
		When.onTheFilterBar.iClickTheFilterButton();
	...
	opaTest("Decimal Precision for Visual Filter Charts in VF Bar and VFD", function (Given, When, Then) {
		Then.onTheFilterBar.iCountVFDecimalPrecision("Line", 1, false);
		When.onTheFilterBar.iClickTheFilterButton();
		Then.onTheFilterBar.iCountVFDecimalPrecision("Line", 1, true);
		When.onTheGenericAnalyticalListPage.iClickTheButtonOnTheDialogWithLabel("Cancel");
		...
		Then.onTheFilterBar.iCountVFDecimalPrecision("Donut", 1, true);
		When.onTheGenericAnalyticalListPage.iClickTheButtonOnTheDialogWithLabel("OK");
		Then.onTheFilterBar.iCountVFDecimalPrecision("Donut", 1, false);
	});
