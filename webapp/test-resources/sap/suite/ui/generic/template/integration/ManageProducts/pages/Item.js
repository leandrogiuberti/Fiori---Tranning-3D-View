			...
			assertions: {
				...
				iShouldSeeThePageTitle: function() {
					return this.waitFor({
						...
						success: function() {
							Opa5.assert.ok(true, "The Item page has a title.");
						},
				...
				thePageTitleIsCorrect: function() {
					return this.waitFor({
						...
						success: function(oTitle) {
							Opa5.assert.ok(oTitle[0].getText() === "Product Text", "The Item page title is correct.");
						},
				...
				theListIsDisplayed: function() {
					return this.waitFor({
						...
						success: function(oTable) {
							...
							Opa5.assert.notEqual(oTable[0].getItems().length, 0, "The Item list is displayed.");
						},
