sap.ui.define(["sap/ui/test/opaQunit"],
    function (opaTest) {
        ...
        QUnit.module("Sales Order SmartList Master Details - Standard List");

        opaTest("Starting the Master Details app and loading data - Standard List on LR", function (Given, When, Then) {
            Given.iStartMyAppInDemokit("sttasalesordersmartlist", "manifest_StdList_MD");
        ...
        opaTest("Open a different Object from the Standard List", function (Given, When, Then) {
