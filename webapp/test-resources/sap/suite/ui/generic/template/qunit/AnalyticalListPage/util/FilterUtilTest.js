...
sap.ui.define(
	[ 
		...
		*/
		...
		var messageMapping = {
			oDimFieldDisplay: "date",
			bIsChartType: "chart type",
			bIsSecondaryLabel: "show second label",
			timezone: "timezone",
			expectedResult: "expected result",
		};
		[
			{
				method: "formatStringDateYearMonth",
				data: [
					{oDimFieldDisplay: undefined, bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: undefined},
					{oDimFieldDisplay: null, bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: null},
					{oDimFieldDisplay: "", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: ""},
					{oDimFieldDisplay: "202401", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: "Jan 2024"},
					{oDimFieldDisplay: "202401", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "America/New_York", expectedResult: "Jan 2024"},
					{oDimFieldDisplay: "202401", bIsChartType: "Line", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: "Jan"},
					{oDimFieldDisplay: "202401", bIsChartType: "Line", bIsSecondaryLabel: false, timezone: "America/New_York", expectedResult: "Jan"},
					{oDimFieldDisplay: "202401", bIsChartType: "Line", bIsSecondaryLabel: true, timezone: "Asia/Tokyo", expectedResult: "2024"},
					{oDimFieldDisplay: "202401", bIsChartType: "Line", bIsSecondaryLabel: true, timezone: "America/New_York", expectedResult: "2024"},
				]
			},
			{
				method: "formatStringDateYearQuarter",
				data: [
					{oDimFieldDisplay: undefined, bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: undefined},
					{oDimFieldDisplay: null, bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: null},
					{oDimFieldDisplay: "", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: ""},
					{oDimFieldDisplay: "20241", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: "Q1 2024"},
					{oDimFieldDisplay: "20241", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "America/New_York", expectedResult: "Q1 2024"},
					{oDimFieldDisplay: "202401", bIsChartType: "Line", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: "Q1"},
					{oDimFieldDisplay: "202401", bIsChartType: "Line", bIsSecondaryLabel: false, timezone: "America/New_York", expectedResult: "Q1"},
					{oDimFieldDisplay: "202401", bIsChartType: "Line", bIsSecondaryLabel: true, timezone: "Asia/Tokyo", expectedResult: 2024},
					{oDimFieldDisplay: "202401", bIsChartType: "Line", bIsSecondaryLabel: true, timezone: "America/New_York", expectedResult: 2024},
				]
			},
			{
				method: "formatStringDateYearWeek",
				data: [
					{oDimFieldDisplay: undefined, bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: undefined},
					{oDimFieldDisplay: null, bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: null},
					{oDimFieldDisplay: "", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: ""},
					{oDimFieldDisplay: "202415", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: "CW 15 2024"},
					{oDimFieldDisplay: "202415", bIsChartType: "Donut", bIsSecondaryLabel: false, timezone: "America/New_York", expectedResult: "CW 15 2024"},
					{oDimFieldDisplay: "202415", bIsChartType: "Line", bIsSecondaryLabel: false, timezone: "Asia/Tokyo", expectedResult: "CW 15"},
					{oDimFieldDisplay: "202415", bIsChartType: "Line", bIsSecondaryLabel: false, timezone: "America/New_York", expectedResult: "CW 15"},
					{oDimFieldDisplay: "202415", bIsChartType: "Line", bIsSecondaryLabel: true, timezone: "Asia/Tokyo", expectedResult: "2024"},
					{oDimFieldDisplay: "202415", bIsChartType: "Line", bIsSecondaryLabel: true, timezone: "America/New_York", expectedResult: "2024"},
				]
			}
		].forEach(function(test) {
			var method = test.method;
			test.data.forEach(function(data) {
				var message = Object.keys(messageMapping).map(function(key) {
					return messageMapping[key] + " - " + data[key]
				}).join(", ");
	
				QUnit.test(method + " with " + message, function(assert) {
					UI5Configuration.setTimezone(data.timezone);
					var result = FilterUtil[method](data.oDimFieldDisplay, data.bIsChartType, data.bIsSecondaryLabel);
					assert.ok(result === data.expectedResult, result + " === " + data.expectedResult);
				});
			});
		});
	}
