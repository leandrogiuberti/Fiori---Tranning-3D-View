...
sap.ui.define(
	...
	function(SmartVisualFilterBar, sinon, AjaxHelper) {
		"use strict";
		...
		QUnit.module("Test Smart Visual Filter Bar for Variant Management", {
			...
			beforeEach: function() {
				...
				oSandbox.stub(oSmartVisualFilterBar, '_getAnnotationSettings', function() {
...
/*		QUnit.test("Check variant object when there is no previous variant objects and annotations for filter item are present", function(assert) {
		...
		QUnit.test('addVisualFiltersToBasicArea tests', function (assert) {
		...
		QUnit.test('lazyLoadVisualFilter test', function (assert) {
