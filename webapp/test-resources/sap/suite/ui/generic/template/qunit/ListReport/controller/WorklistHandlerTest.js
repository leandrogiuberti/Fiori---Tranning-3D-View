...
var oStubForPrivate;
	...
	QUnit.test("Initialization",fnPerformTestForWorklist.bind(null,oSettings));
	...
	QUnit.test("Check for valid Settings",fnTestForSettings.bind(null,oSettings));
	...
	QUnit.test("Check for invalid Settings",fnTestForInvalidSettings.bind(null,""));
