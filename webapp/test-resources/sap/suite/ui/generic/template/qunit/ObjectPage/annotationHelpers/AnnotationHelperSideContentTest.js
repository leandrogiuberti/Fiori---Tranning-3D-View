...
sap.ui.define([
	...
	QUnit.test("Check getSideContentExtensionPoint function", function(assert) {
	...
	QUnit.test("Check getSideContentPosition function", function(assert) {
		var sEntitySet = "STTA_C_MP_Product";
		var oManifestExtend = {
			"BeforeMainContent|STTA_C_MP_Product|to_ProductSalesData::com.sap.vocabularies.UI.v1.Chart":{
				"className": "sap.ui.core.Fragment",
	...
	QUnit.test("Check getEqualSplit function", function(assert) {
		var sEntitySet = "STTA_C_MP_Product";
		var oManifestExtend = {
			"BeforeMainContent|STTA_C_MP_Product|to_ProductSalesData::com.sap.vocabularies.UI.v1.Chart":{
				"className": "sap.ui.core.Fragment",
