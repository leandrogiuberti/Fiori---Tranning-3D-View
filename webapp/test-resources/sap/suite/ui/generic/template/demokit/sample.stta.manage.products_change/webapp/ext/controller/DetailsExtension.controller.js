sap.ui.define("STTA_MP_CHANGE.ext.controller.DetailsExtension", [
	"sap/base/Log",
	"sap/m/MessageBox",
	...
	return {
		onInit: function () {
			...
			var fnFunction = function (oEvent) {
				...
				var myId = "STTA_MP_CHANGE::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--to_ProductText::com.sap.vocabularies.UI.v1.LineItem::responsiveTable";
				if (tableId === myId) {
		...
		onShowDetailsExt: function () {
			...
			var aContext = oApi.getSelectedContexts("STTASTTA_MP_CHANGE_MP::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--to_ProductText::com.sap.vocabularies.UI.v1.LineItem::responsiveTable");
		...
		onCustomFilterChange: function (oEvent) {
			var smartTable = Element.getElementById("STTA_MP_CHANGE::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--to_ProductText::com.sap.vocabularies.UI.v1.LineItem::Table");
		...
		onBeforeRebindTableExtension: function (oEvent) {
			var customFilter = Element.getElementById("STTA_MP_CHANGE::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--CustomFilter-Language");
			if (customFilter) {
			...
			var tableId = "STTA_MP_CHANGE::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--to_ProductText::com.sap.vocabularies.UI.v1.LineItem::Table";
