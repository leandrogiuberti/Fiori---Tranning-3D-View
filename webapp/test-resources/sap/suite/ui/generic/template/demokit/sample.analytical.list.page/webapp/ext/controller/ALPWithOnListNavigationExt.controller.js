sap.ui.define("analytics2.ext.controller.AnalyticalListPageExt",[
	...
	return {
		...
		onBeforeRebindTableExtension: function(oEvent) {
			...
			oEvent.mParameters.bindingParams.parameters.select = oEvent.mParameters.bindingParams.parameters.select + ",ID";
		},
		...
		onListNavigationExtension: function(oEvent) {
			...
			oNavigationController.navigateInternal(oObject.ID, {
				routeName : "NavigateToCanvasPage"
			});

			return true;
		},
		onChildOpenedExtension: function(oSelectedInfo, fnSetPath) {
			var sPath = "/ZCOSTCENTERCOSTSQUERY0020('" + oSelectedInfo.keys[1] + "')";
			fnSetPath(sPath);
		},
