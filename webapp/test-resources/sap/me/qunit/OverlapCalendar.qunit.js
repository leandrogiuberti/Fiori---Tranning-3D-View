...
sap.ui.define([
	...
	QUnit.test("Month Titles - BCP 002075129500003097872016", function (assert) {
		...
		assert.equal(getMonthTitleDivText().replace(/\s/g, " "), "Aug – Sep 2016",
			"There should be an interval displayed spanning from August to September 2016");
		oCalendar.setStartDate("2016-12-28");
		assert.equal(getMonthTitleDivText().replace(/\s/g, " "), "Dec 2016 – Jan 2017",
			"There should be an interval displayed spanning from December 2016 to January 2017");
	});
