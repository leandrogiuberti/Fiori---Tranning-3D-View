...
sap.ui.define("sap.ushell.shells.demo.fioriDemoConfig", [
    ...
    const oTestContent = {
        ...
        applications: {
            ...
            "Action-toLetterBoxing": {
                additionalInformation: "SAPUI5.Component=sap.ushell.demo.AppLetterBoxing",
                applicationType: "URL",
    ...
    function writeToUshellConfig (oConfig) {
        ...
        const oVisualizationDataProviderAdapterConfig = ObjectPath.create("sap-ushell-config.services.VisualizationDataProvider.adapter.config");
        ...
        const oPersonalizationV2AdapterConfig = ObjectPath.create("sap-ushell-config.services.PersonalizationV2.adapter.config");
    ...
    const sEasyAccessRealDataParameter = oUriParameters.get("easy-access-real-data");
    if (!sEasyAccessRealDataParameter || sEasyAccessRealDataParameter === "false") {
        // mock data for easyAccess
        const oConfig = ObjectPath.create("sap-ushell-config.renderers.fiori2.componentData.config.applications.Shell-home");

        if (oConfig) {
            oConfig.easyAccessNumbersOfLevels = 1;
        }

        const baseUrl = sap.ui.require.toUrl("sap/ushell/shells/demo");
