...
sap.ui.define([
    ...
    [{
        ...
        const bTestFormat = typeof oFixture.testFormat === "boolean"
            ? oFixture.testFormat
            : true;

        const bTestParse = typeof oFixture.testParse === "boolean"
            ? oFixture.testParse
            : true;

        // inbound -> string
        if (bTestFormat) {
            QUnit.test(`formatInbound: can format #SO-action{${oFixture.sSignature}}`, function (assert) {
        ...
        // string -> inbound
        if (bTestParse) {
            QUnit.test(`parseInbound: can format #SO-action{${oFixture.sSignature}}`, function (assert) {
                assert.deepEqual(
    ...
    QUnit.test("parseInbound: can parse #SO-action with no parameters", function (assert) {
    ...
    QUnit.test("formatInbound: can format #SO-action (no parameters)", function (assert) {
        assert.deepEqual(
