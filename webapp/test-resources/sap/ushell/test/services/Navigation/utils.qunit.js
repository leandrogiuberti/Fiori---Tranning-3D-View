...
sap.ui.define([
...
], (navigationUtils, Container, TechnicalParameters) => {
    "use strict";
    ...
    QUnit.test("Returns oParams.args when it is undefined", function (assert) {
        ...
        // Action
        const oResult = navigationUtils.injectParameters(oParams);
    ...
    QUnit.test("Self-invoke when oParam.args is like { target: { shellHash : string}}", function (assert) {
        ...
        const oInjectParametersStub = sandbox.stub(navigationUtils, "injectParameters");
