...
sap.ui.define([
    ...
    QUnit.module("The function addCustomBookmark with the function _hasRequiredBookmarkParameters", {
        beforeEach: function () {
            ...
            this.oLps = new LaunchPageMock({});
            this.oLogErrorStub = sandbox.stub(Log, "error");
            this.oIsGroupLockedStub = sandbox.stub(oFlpLaunchPageService, "isGroupLocked").withArgs(this.oGroup).returns(false);
            this.oGetGroupTitleStub = sandbox.stub(oFlpLaunchPageService, "getGroupTitle").returns(this.sGroupTitle);
            ...
            this.oGetAdapterStub = sandbox.stub(oFlpLaunchPageService, "_getAdapter").returns({
