...
sap.ui.define([
    ...
    QUnit.test("Can handle ABAP apps.", function (assert) {
        // Arrange
        const sInboundPermanentKey = "4711";
        const oInbound = {
            resolutionResult: {
                applicationType: "TR"
            }
        ...
        // Act
        const oApp = AppForInbound.get(sInboundPermanentKey, oInbound);
    ...
    QUnit.test("Raises an exception if the application type is unknown.", function (assert) {
        // Arrange
        const sInboundPermanentKey = "4711";
        const oInboundUnknownApplicationType = {
            resolutionResult: {
                applicationType: "XXX"
            }
        };
    ...
    QUnit.test("Creates a CDM app for an SAPUI5 inbound as expected.", function (assert) {
        // Arrange
        const sInboundPermanentKey = "ui5App";
        const oSignature = {};
        const oInbound = {
        ...
        // Act
        const oUI5App = AppForInbound._getUI5App(sInboundPermanentKey, oInbound);
    ...
    QUnit.test("Creates a CDM app for a URL inbound as expected.", function (assert) {
        // Arrange
        const sInboundPermanentKey = "urlApp";
        const oInbound = {
            id: sInboundPermanentKey,
            semanticObject: "semantic-object",
            action: "action",
        ...
        // Act
        const oUrlApp = AppForInbound._getURLApp(sInboundPermanentKey, oInbound);
    ...
    QUnit.test("Creates a CDM app for an ABAP transaction inbound as expected.", function (assert) {
        // Arrange
        const sInboundPermanentKey = "abapApp";
        const oInbound = {
            id: sInboundPermanentKey,
        ...
        // Act
        const oTrApp = AppForInbound._getTRApp(sInboundPermanentKey, oInbound);
    ...
    QUnit.test("Creates a CDM app for a Web Dynpro ABAP inbound as expected.", function (assert) {
        // Arrange
        const sInboundPermanentKey = "wdaApp";
        const oInbound = {
            id: sInboundPermanentKey,
            semanticObject: "semantic-object",
            action: "action",
        ...
        // Act
        const oWdaApp = AppForInbound._getWDAApp(sInboundPermanentKey, oInbound);
    ...
    QUnit.test("Creates a CDM app for a Web Client inbound as expected.", function (assert) {
        // Arrange
        const sInboundPermanentKey = "wcfApp";
        const oInbound = {
            id: sInboundPermanentKey,
            semanticObject: "semantic-object",
            action: "action",
        ...
        // Act
        const oWcfApp = AppForInbound._getWCFApp(sInboundPermanentKey, oInbound);
