...
sap.ui.define([
     ...
     *
     * @param {object} oResponses the response.
     */
    ...
    QUnit.test("PersonalizationV2Adapter", function (assert) {
        ...
        const oPersAdapter = new PersonalizationV2Adapter(oSystem, null, oConfig);
    ...
    [{
        ...
        QUnit.test(`#load ${oFixture.testDescription}`, function (assert) {
            ...
            oAdapterInternals
                ...
                .catch(afterLoading.bind(this, false))
    ...
    [{
        ...
        QUnit.test(`#del ${oFixture.testDescription}`, function (assert) {
            ...
            oAdapterInternals
                ...
                .catch((oError) => {
                    afterDeleting.call(this, false);
                    throw oError;
                })
                .then(afterDeleting.bind(this, true));
        });
    });
