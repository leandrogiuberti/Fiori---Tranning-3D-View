...
sap.ui.define(["sap/base/util/ObjectPath"], (ObjectPath) => {
    "use strict";

    const oLpaData = ObjectPath.create("sap.ushell.test.data.cdm.FlpLaunchPageAdapter");
    const oCdmData = ObjectPath.create("sap.ushell.test.data.cdm.cdmSiteService");
    const oCstrData = ObjectPath.create("sap.ushell.test.data.cdm.ClientSideTargetResolution");
