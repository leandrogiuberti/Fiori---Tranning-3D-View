...
sap.ui.define([
    ...
    QUnit.test("dump() returns the state", function (assert) {
        ...
        // Act
        const oStateDump = state.dump();

        // Assert
        const oStateDumpModuleStatus = oStateDump.ofModule[state.id.module.schedulingAgent.id].status;
    ...
    QUnit.test(
        ...
        function (assert) {
            ...
            // Assert
            const oState = state.getForLoadingBlock("BLOCK_A");
    ...
    QUnit.test(
        ...
        function (assert) {
            ...
            // Assert
            const oState = state.getForLoadingStep("STEP_A");
    ...
    QUnit.test("setForModule() sets the module state, getForModule() reads it", function (assert) {
        ...
        // Assert
        const oState = state.getForModule(
    ...
    QUnit.test("state.dump available", function (assert) {
        const bFunctionExists = typeof state.dump === "function";
    ...
    QUnit.test("isBlockLoaded() returns the expected result, if the block is unknown", function (assert) {
        // Act
        const bResult = state.isBlockLoaded("UNKNOWN");
    ...
    QUnit.test("isBlockLoaded() returns the expected result, if the block is known and has status BLOCK_DONE", function (assert) {
        ...
        // Act
        const bResult = state.isBlockLoaded("BLOCK_A");
    ...
    QUnit.test("isStepLoaded() returns the expected result, if the step is known and has status STEP_LOADED", function (assert) {
        ...
        // Act
        const bResult = state.isStepLoaded("STEP_1");
