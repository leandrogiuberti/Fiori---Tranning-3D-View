...
sap.ui.define([
    ...
    const oIsExpressionTestFixture = {
        "{*}": true,
        "{&/}": false,
        "{var}": true,
        "{v}": true,
    ...
    Object.keys(oIsExpressionTestFixture).forEach((sString) => {
    ...
    [{
        ...
        QUnit.test(`#_parseList: ${oFixture.sString}`, function (assert) {
            const aResult = oTemplateParameterParser._parseList("intentParams", oFixture.sString, "|");
