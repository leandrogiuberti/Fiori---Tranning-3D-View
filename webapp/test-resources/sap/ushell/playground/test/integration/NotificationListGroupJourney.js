...
sap.ui.define([
    ...
    opaTest("should see the Notification List Group Playground", (Given, When, Then) => {
        Given.iStartMyApp();
        When.onTheNavContainer.iPressTheNotificationListGroup();
        Then.onTheNavContainer.iShouldSeeTheNotificationListGroup();
    });

    opaTest("should see the notification list group", (Given, When, Then) => {
        Then.onTheNotificationListGroup.iShouldSeeTheGroup();
    });

    opaTest("should see two notification list items", (Given, When, Then) => {
    ...
    opaTest("should see the collapsed notification list group", (Given, When, Then) => {
        When.onTheNotificationListGroup.iTurnOnTheCollapsedSwitch();
        Then.onTheNotificationListGroup.iShouldSeeTheCollapsedGroup();
    });

    opaTest("should see the show empty group notification list group", (Given, When, Then) => {
    ...
    opaTest("should see the High Priority List Group", (Given, When, Then) => {
        When.onTheNotificationListGroup.iPickTheHighPriority();
        Then.onTheNotificationListGroup.iShouldSeeTheHighPriorityGroup();
    });

    opaTest("should see the auto priority notification list group", (Given, When, Then) => {
    ...
    opaTest("should see the invisible notification list group", (Given, When, Then) => {
