...
sap.ui.define([
    ...
    opaTest("should see the navigation menu playground", (Given, When, Then) => {
        Given.iStartMyApp();
    ...
    opaTest("should see the title", (Given, When, Then) => {
    ...
    opaTest("should see a navigation menu item", (Given, When, Then) => {
    ...
    opaTest("should see no navigation memu item", (Given, When, Then) => {
    ...
    opaTest("should see the mini tile", (Given, When, Then) => {
    ...
    opaTest("should see no mini tile", (Given, When, Then) => {
