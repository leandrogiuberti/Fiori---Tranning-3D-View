...
sap.ui.define([
    ...
    "sap/ui/core/library",
    "./Common"
], (Opa5, AggregationContainsPropertyEqual, AggregationLengthEquals, Properties, PropertyStrictEquals, library, Common) => {
    "use strict";

    // shortcut for sap.ui.core.Priority
    const Priority = library.Priority;
    function fnSeeTheNumberOfItems (sAggregationName, iNumber) {
        return this.waitFor({
    ...
    function fnCheckAttributeValue (sAttribute, sValue, sMessage) {
        return this.waitFor({
            controlType: "sap.m.NotificationListGroup",
