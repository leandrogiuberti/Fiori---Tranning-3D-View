...
sap.ui.define([
    ...
    return UIComponent.extend("sap.ushell.demo.AppStateSample2.Component", {
        ...
        extractInnerAppStateFromURL: async function (sInnerAppStateKey, sCurrentRouteName) {
            ...
            this.oInnerAppStateDeferred.promise().then(() => {
        ...
        markOurComponent: function () {
            ...
            const oAppStateSampleComponent = ObjectPath.create("sap.ushell.demo.AppStateSample2.Component");
        ...
        init: function () {
            ...
            this.oInnerAppStateDeferred.promise().then((sInitialRouteName) => {
