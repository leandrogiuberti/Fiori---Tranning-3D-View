...
sap.ui.define([
    ...
    "sap/ui/Device",
    "sap/ushell/demo/RTATestApp/model/models",
    "sap/ushell/demo/RTATestApp/controller/ErrorHandler"
], (
    View,
    ViewType,
    UIComponent,
    ...
    return UIComponent.extend("sap.ushell.demo.RTATestApp.Component", {
        metadata: {
            manifest: "json",
        ...
        createContent: async function () {
            ...
            return this.runAsOwner(() => {
                return View.create({
                    type: ViewType.XML,
                    viewName: "sap.ushell.demo.RTATestApp.view.App",
