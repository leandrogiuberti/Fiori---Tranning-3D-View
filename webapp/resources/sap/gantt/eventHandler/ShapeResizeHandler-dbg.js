	...
	ShapeResizeHandler.prototype._handleShapeResizeStart = function (oEvent) {
		...
		if (shapeData) {
			...
			if (rowInfo) {
				...
				jQuery(document.body).off("mousemove.shapeResizing");
				jQuery(document.body).off("mouseup.shapeResizing");
				jQuery(document.body).on("mousemove.shapeResizing", this._handleShapeResizing.bind(this));
				jQuery(document.body).on("mouseup.shapeResizing", this._handleShapeResizeEnd.bind(this));
			}
		}
	};
