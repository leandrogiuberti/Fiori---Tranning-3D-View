...
sap.ui.define([
	...
	TimePopoverHandler.prototype._handleTimePopoverDragStart = function(oEvent) {
		...
		jQuery(document.body).on("mousemove.shapeDragDrop", this._handleTimePopoverDragging.bind(this));
		jQuery(document).on("mouseup.shapeDragDrop", this._handleTimePopoverEnd.bind(this));
	...
	TimePopoverHandler.prototype._handleTimePopoverEnd = function() {
		...
		jQuery(document.body).off("mousemove.shapeDragDrop");
		jQuery(document.body).off("mouseup.shapeDragDrop");
	};
