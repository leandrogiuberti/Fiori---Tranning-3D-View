...
sap.ui.define([
	...
	TimePeriodZoomHandler.prototype.handleDragStart = function (oEvent, bSuppressEvent){
		...
		$GanttSvg.off("mousemove.timePeriodZoomDragDrop");
		jQuery(document.body).off("mouseup.timePeriodZoomDragDrop");
		oGantt.detachHorizontalScroll(this.handleAutoScroll, this);

		$GanttSvg.on("mousemove.timePeriodZoomDragDrop", this.handleDragging.bind(this));
		jQuery(document.body).on("mouseup.timePeriodZoomDragDrop", this.handleDragEnd.bind(this));
	...
	TimePeriodZoomHandler.prototype.attachEvents = function(){
		...
		$GanttSvg.on("mouseenter.timePeriodZoomDragDrop", this.handleMouseEnter.bind(this));
		$GanttSvg.on("mouseleave.timePeriodZoomDragDrop", this.handleMouseLeave.bind(this));
	};

	TimePeriodZoomHandler.prototype.detachEvents = function(){
		var $GanttSvg = jQuery(this._oSourceChart.getDomSelectorById("svg"));
		$GanttSvg.off("mouseenter.timePeriodZoomDragDrop");
		$GanttSvg.off("mouseleave.timePeriodZoomDragDrop");
	};
