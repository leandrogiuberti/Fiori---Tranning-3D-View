...
], function (Log, library, AxisTimeStrategyBase, Utility, Format, TimeHorizon, GanttUtils, ProportionTimeLineOptions) {
	"use strict";
	...
	ProportionZoomStrategy.prototype._updateTimeLineOption = function(){
		...
		if (oAxisTime) {
			...
			for (i in oTimeLineOptions) {
				...
				var end = oAxisTime.timeToView(GanttUtils.getObjectFromPath(interval.unit).offset(startTime, interval.span), undefined, oAxisTime.continuousScale);
