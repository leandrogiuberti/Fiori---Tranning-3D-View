	...
	BaseDiamond.prototype.getShapeAnchors = function () {
		...
		return {
			head: {
				...
				y: this.getY() + this.getHeight() * leftAnchorPosition + mBias.y, //Change Shape Anchor position based on AlignShape
				dx: this.getWidth() / 2,
				dy: this.getHeight() * leftAnchorPosition
			},
			tail: {
				x: this.getX() + this.getWidth() / 2 + mBias.x,
				y: this.getY() + this.getHeight() * rightAnchorPosition + mBias.y, //Change Shape Anchor position based on AlignShape
				dx: this.getWidth() / 2,
