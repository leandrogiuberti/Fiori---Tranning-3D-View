...
sap.ui.define([
...
], function(jQuery, Core, UtilizationChart, BackSlashPattern, Element,Parameters){
	"use strict";
	...
	UtilizationLineChart.prototype._createDefaultDefs = function() {
		...
		var oParameterColors = Parameters.get({
			name: ["sapChart_ContrastLineColor", "sapContent_ForegroundColor"],
		...
		this.mDefaultDefs = new sap.gantt.def.SvgDefs({
			defs: [
				new BackSlashPattern({
					...
					tileWidth: 5,
					tileHeight: 9,
					backgroundColor: oParameterColors.sapChart_ContrastLineColor,
					stroke: oParameterColors.sapContent_ForegroundColor,
					strokeWidth: 1
				})
			]
		});
