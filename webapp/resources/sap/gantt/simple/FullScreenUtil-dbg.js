						...
						oControl._oHTML = new HTML({
							...
							afterRendering: function() {
								if (oControl && oControl._oHTML) {
									...
									if (oHTMLContent) {
										var oContentDom = oControl._oFullScreenDialog.getDomRef().querySelector(".sapMDialogSection");
										if (oContentDom) {
											oContentDom.classList.add("sapFullScreenGanttDialogContent");
										}
										var oDialogScrollDom = oControl._oFullScreenDialog.getDomRef().querySelector(".sapMDialogScroll");
										if (oDialogScrollDom) {
											oDialogScrollDom.classList.add("sapFullScreenGanttDialogScroll");
										}
