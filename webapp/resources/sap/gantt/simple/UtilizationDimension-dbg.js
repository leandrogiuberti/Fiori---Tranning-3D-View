 ...
 */
sap.ui.define(["sap/ui/core/Element","sap/gantt/library"], function(Element,library){
	"use strict";
	...
	var UtilizationDimension = Element.extend("sap.gantt.simple.UtilizationDimension", {
		metadata: {
			...
			properties: {
				 ...
				 */
				dimensionColor: {type: "sap.gantt.ValueSVGPaintServer", defaultValue:"sapContent_ForegroundBorderColor"}
			},
	...
	/**
	 * @returns the value of the dimensionColor property.
	 */
	UtilizationDimension.prototype.getDimensionColor = function() {
		return library.ValueSVGPaintServer.normalize(this.getProperty("dimensionColor"));
	};
