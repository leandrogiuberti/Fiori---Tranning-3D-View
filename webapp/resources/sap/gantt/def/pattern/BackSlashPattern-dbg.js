...
sap.ui.define([
	...
	var BackSlashPattern = PatternBase.extend("sap.gantt.def.pattern.BackSlashPattern", /** @lends sap.gantt.def.pattern.BackSlashPattern.prototype  */ {
		metadata : {
			...
			properties: {
				 ...
				 */
				stroke : {type : "sap.gantt.ValueSVGPaintServer", defaultValue:"sapContent_ForegroundBorderColor"},
	...
	BackSlashPattern.prototype.getStroke = function () {
	...
	BackSlashPattern.prototype.getDefString = function () {
		...
		return "<pattern class='pattern' id='" + sId +
