...
function (
	...
	GanttChart.prototype._detachEvents = function () {
		...
		// off wheel event
		$svgCtn.off("MozMousePixelScroll.sapUiTableMouseWheel", this._onMouseWheel);
		$svgCtn.off("wheel.sapUiTableMouseWheel", this._onMouseWheel);
		$chartHeaderSvgCnt.off("MozMousePixelScroll.sapUiTableMouseWheel", this._onMouseWheel);
		$chartHeaderSvgCnt.off("wheel.sapUiTableMouseWheel", this._onMouseWheel);

		$svgCtn.off("contextmenu", this._onContextMenu);
		// off mouse events
		$svgCtn.off("mouseleave", this._onSvgMouseLeave);
		$svgCtn.off("mouseenter", this._onSvgMouseEnter);
		$svgCtn.off("mousedown", this._onSvgMouseDown);
		$svgCtn.off("mousemove", this._onSvgMouseMove);
		$svgCtn.off("mouseup", this._onSvgMouseUp);
		$svgCtn.off("dblclick", this._onSvgDoubleClick);

		// off keyboard events
		var sGanttKeyDown = "keydown." + this.getId();
		jQuery(document.body).off(sGanttKeyDown);

		// off touch events
		if (Device.support.touch) {
			$svgCtn.off("touchstart", this._onSvgTouchstart);
			$svgCtn.off("touchend", this._onSvgTouchend);
			$svgCtn.off("touchmove", this._onSvgTouchmove);
			$chartHeaderSvgCnt.off("touchstart", this._onSvgTouchstart);
			$chartHeaderSvgCnt.off("touchend", this._onSvgTouchend);
			$chartHeaderSvgCnt.off("touchmove", this._onSvgTouchmove);
		}
	...
	GanttChart.prototype._attachEvents = function () {
		...
		if (Device.browser.firefox) {
			$svgCtn.on("MozMousePixelScroll.sapUiTableMouseWheel", this._onMouseWheel.bind(this));
			$chartHeaderSvgCnt.on("MozMousePixelScroll.sapUiTableMouseWheel", this._onMouseWheel.bind(this));
		} else {
			$svgCtn.on("wheel.sapUiTableMouseWheel", this._onMouseWheel.bind(this));
			$chartHeaderSvgCnt.on("wheel.sapUiTableMouseWheel", this._onMouseWheel.bind(this));
		}
		$svgCtn.on("contextmenu", this._onContextMenu);
		// register mouse events
		$svgCtn.on("mouseenter", this._onSvgMouseEnter.bind(this));
		$svgCtn.on("mouseleave", this._onSvgMouseLeave.bind(this));
		$svgCtn.on("mousedown", this._onSvgMouseDown.bind(this));
		$svgCtn.on("mousemove", this._onSvgMouseMove.bind(this));
		$svgCtn.on("mouseup", this._onSvgMouseUp.bind(this));
		$svgCtn.on("dblclick", this._onSvgDoubleClick.bind(this));

		// register keyboard events
		var sGanttKeyDown = "keydown." + this.getId();
		jQuery(document.body).on(sGanttKeyDown, this._onKeyDown.bind(this));

		// register touch events
		if (Device.support.touch) {
			$svgCtn.on("touchstart", this._onSvgTouchstart.bind(this));
			$svgCtn.on("touchend", this._onSvgTouchend.bind(this));
			$svgCtn.on("touchmove", this._onSvgTouchmove.bind(this));
			$chartHeaderSvgCnt.on("touchstart", this._onSvgTouchstart.bind(this));
			$chartHeaderSvgCnt.on("touchend", this._onSvgTouchend.bind(this));
			$chartHeaderSvgCnt.on("touchmove", this._onSvgTouchmove.bind(this));
		}
	...
	GanttChart.prototype._handleShapeDragStart = function (oEvent) {
		...
		if (oSourceShapeData && bEnableDnD) {
			...
			if (rowInfo) {
				...
				jQuery(document.body).off("mousemove.ganttChartDragDrop");
				jQuery(document).off("mouseup.ganttChartDragDrop");//change document.body to document
				jQuery(document.body).on("mousemove.ganttChartDragDrop", this._handleShapeDragging.bind(this));
				jQuery(document).on("mouseup.ganttChartDragDrop", this._handleShapeDragEnd.bind(this));
	...
	GanttChart.prototype._handleShapeDragEnd = function (oEvent) {
		...
		jQuery(document.body).off("mousemove.ganttChartDragDrop");
		jQuery(document).off("mouseup.ganttChartDragDrop");
	...
	GanttChart.prototype.setDraggingData = function (oDraggingSource) {
		...
		if (this._oDraggingData !== undefined) {
			...
			jQuery(document.body).off("mousemove.shapeDragDrop");
			jQuery(document).off("mouseup.shapeDragDrop");
			jQuery(document.body).on("mousemove.shapeDragDrop", this._oTimePopoverHandler._handleTimePopoverDragging.bind(this._oTimePopoverHandler));
			jQuery(document).on("mouseup.shapeDragDrop", this._oTimePopoverHandler._handleTimePopoverEnd.bind(this._oTimePopoverHandler));
	...
	GanttChart.prototype._bindHorizontalScroll = function () {
		...
		$hsb.off("scroll.sapUiTableHScrollForGanttChart", this._onHSbScroll);
		$hsb.on("scroll.sapUiTableHScrollForGanttChart", this._onHSbScroll.bind(this));
	};

	GanttChart.prototype._bindVerticalScroll = function (){
		var $vsb = jQuery(this.getTTVsbDom());
		$vsb.off("scroll.sapUiTableVScrollForGanttChart", this._onVSbScroll);
		$vsb.on("scroll.sapUiTableVScrollForGanttChart", this._onVSbScroll.bind(this));
	};
