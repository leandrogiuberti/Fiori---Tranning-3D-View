        ...
        getPayLoadForRemoveCard: function (oComponentContainer) {
            ...
            if (
                ...
                var oAppComponent = oComponentData.appComponent,
                    sDataSource = oAppComponent.getManifestEntry("sap.ui5").models[oComponentData.modelName].dataSource,
                    aAnnotationNames = oAppComponent.getManifestEntry("sap.app").dataSources[sDataSource].settings.annotations;
