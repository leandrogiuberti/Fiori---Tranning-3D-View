...
sap.ui.define([
    ...
    function _checkIfModelExists(oCardManifest) {
        ...
        if (
            (oCardManifest.template === "sap.ovp.cards.error" || oCardManifest.template === "sap.ovp.cards.v4.error") ||
                                    ...
                                    getMetaModelPromise.then(
                                        function () {
                                            ...
                                            if (oComponentContainer ) {
                                                // If the component container is already present, we will destroy it
                                                oComponentContainer.getComponentInstance() && oComponentContainer.getComponentInstance().destroy();
                                            }
