...
sap.ui.define([
    ...
    return CardController.extend("sap.ovp.cards.stack.Stack", {
            ...
            if (Device.system.phone) {
                ...
                if (!this.bAfterColumnUpdateAttached) {
                    ...
                    if (
                        ...
                        oLayout.attachAfterColumnUpdate(
                            function () {
                                that._setObjectStreamCardsSize.call(that, false);
                            }
                        );
                ...
                if (!this.bDeviceOrientationAttached) {
                    ...
                    Device.orientation.attachHandler(
                        function () {
                            that._setObjectStreamCardsSize.call(that, true);
                        }
                    );
                }
            }
        ...
        _createObjectStream: function () {
            ...
            this.getOwnerComponent().combineBatch(this.oModel, this.getOwnerComponent().oComponentData);
