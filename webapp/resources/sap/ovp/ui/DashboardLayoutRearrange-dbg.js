...
sap.ui.define([
    ...
    Rearrange.prototype.drawLayout = function (aCardsLayout) {
        ...
        function updateCSS(domElement) {
            ...
            domElement.style[that.layoutUtil.cssVendorTransition] = "all 300ms ease";
            domElement.style[that.layoutUtil.cssVendorTransform] =
                "translate3d(" + $element.left + "," + $element.top + ", 0px) ";
        }

        var requestAnimationFrameHandler = function (domElement) {
            requestAnimationFrame(function () {
                updateCSS(domElement);
            });
        };
        ...
        if (iCardsLength > 0) {
            aCardsLayout.forEach(function (domElement) {
                requestAnimationFrameHandler(domElement);
            });
        }
    };
