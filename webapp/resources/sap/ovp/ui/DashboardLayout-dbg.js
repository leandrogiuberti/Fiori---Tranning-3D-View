...
sap.ui.define([
    ...
    KeyboardNavigation.prototype.init = function (ovpLayout) {
        ...
        this.jqElement
            ...
            .on("focus.keyboardNavigation", function(oEvent) {
                that.layoutFocusHandler.call(that, oEvent);
            });
        this.jqElement.on(
        ...
        var layoutClickHandler = function(oEvent) {
            that.layoutClickHandler.call(that, oEvent);
        };
        for (var i = 0; i < dynamicPageContent.length; i++) {
            dynamicPageContent[i].addEventListener("click", layoutClickHandler);
        }
        this.jqElement.find(".after").on("focus.keyboardNavigation", function(oEvent) {
            that.afterFocusHandler.call(that, oEvent);
        });
    };
