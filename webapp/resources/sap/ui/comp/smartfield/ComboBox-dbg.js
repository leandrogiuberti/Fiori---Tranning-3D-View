...
function (
	...
	ComboBox.prototype.updateDomValue = function (sValue) {
		const vItem = this.getItemByKey(sValue);

		// SNOW: DINC0496338 We should not show zeroes as a value
		if (!vItem && sValue && rZero.test(sValue)) {
			sValue = "";
		}
		BaseComboBox.prototype.updateDomValue.apply(this, [sValue]);
	};
