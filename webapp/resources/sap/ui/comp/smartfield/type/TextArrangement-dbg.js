...
sap.ui.define([
	...
	TextArrangement.prototype.parseDescriptionOnly = function(vValue, sSourceType, aCurrentValues, oFormatOptions, oSettings) {
		...
		function handleSuccess(oPromise, aData) {
			...
			if (!this.bValueListNoValidation) {
				...
				this.oSmartField?._addAdditionalInfo("descriptionCount", aIDsLength);
	...
	TextArrangement.prototype.validateIDOnly = function (aValue, oData) {
		...
		if (this.getSettings().valueList && oData) {
			...
			this.oSmartField?._addAdditionalInfo("descriptionCount", oResult.length);
	...
	TextArrangement.prototype.validateIDAndDescription = function(aValues, oSettings) {
		...
		this.oSmartField?._addAdditionalInfo("descriptionCount", aDescription.length);
	...
	TextArrangement.prototype.formatValue = function(aValues, sTargetType) {
		...
		if (sKey === null &&
			!(this._isKeyPropertyMissingInModel(aValues) && this.oFormatOptions.textArrangement === "descriptionOnly")) {
			return sKey;
		}
	...
	TextArrangement.prototype._isKeyPropertyMissingInModel = function(aBindingValues) {
		return aBindingValues[0] === undefined && aBindingValues[1] !== undefined ? true : false;
	};
