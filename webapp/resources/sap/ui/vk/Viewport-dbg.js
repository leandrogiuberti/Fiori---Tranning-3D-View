...
sap.ui.define([
	...
	Viewport.prototype.setShowAllDynamicContents = function(value) {
		basePrototype.setShowAllDynamicContents.call(this, value);
		if (this._implementation) {
			this._implementation.setShowAllDynamicContents(value);
		}
		return this;
	};

	Viewport.prototype.getShowAllDynamicContents = function() {
		if (this._implementation) {
			return this._implementation.getShowAllDynamicContents();
		}
		return basePrototype.getShowAllDynamicContents.call(this);
	};
