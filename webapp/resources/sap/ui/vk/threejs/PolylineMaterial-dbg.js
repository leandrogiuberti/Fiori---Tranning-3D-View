...
sap.ui.define([
	...
	var vertexShader = [
		...
		"#ifdef USE_ILLUSTRATION",
		"attribute vec3 normal1;",
		"attribute vec3 normal2;",
		"varying float edgeVisibility;",
		"#endif",
		"",
		"varying vec2 vTC;",
		"",
		...
		"	edgeVisibility = dot(normal1, normal2) <= 0.5 ? 1.0 : step(dot(eyeDirection, n1) * dot(eyeDirection, n2), 0.0);",
		"#endif",
		"}"
	].join("\n");
	...
	var fragmentShader = [
		...
		"",
		"#ifdef USE_ILLUSTRATION",
		"	if (edgeVisibility < 0.01) discard;",
		"	diffuseColor.a = 1.0;",
		"#endif",
		...
		Object.defineProperties(_this, {
			...
			illustration: {
				...
				set: function(value) {
					...
					if (value) {
						this.defines.USE_ILLUSTRATION = 1;
					} else {
						delete this.defines.USE_ILLUSTRATION;
					}
				}
			},
	...
	PolylineMaterial.prototype.copy = function(source) {
		...
		this._illustration = source._illustration;
