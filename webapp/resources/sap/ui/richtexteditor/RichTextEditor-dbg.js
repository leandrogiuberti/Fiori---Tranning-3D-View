...
sap.ui.define([
	...
	var RichTextEditor = Control.extend("sap.ui.richtexteditor.RichTextEditor", /** @lends sap.ui.richtexteditor.RichTextEditor.prototype */ {
		metadata: {
			...
			properties: {
				 ...
				 * <li>TinyMCE 5 and TinyMCE 6 will be removed in future releases.</li>
				 * </ul>
				 */
				 ...
				 */
				editorLocation: { type: "string", group: "Misc", defaultValue: 'js/tiny_mce7/tinymce.js', deprecated: true },
				...
				/**
				 * Determines whether a Fiori Toolbar is used instead of the TinyMCE default toolbar one. It is applied only when the EditorType is TinyMCE5, TinyMCE6 or TinyMCE7 and sap.m library is loaded.
	...
	RichTextEditor.DEFAULT_PLUGINS_TINYMCE7 = [
		"emoticons",
		"directionality",
		"image",
		"table",
	...
	RichTextEditor.SUPPORTED_LANGUAGES_DEFAULT_REGIONS_TINYMCE7 = {
		"zh": "CN",
		"fr": "FR",
		"bn": "BD",
		"bg": "BG",
	...
	RichTextEditor.prototype._shouldLoadTinyMCE = function () {
		...
		if (sEditorType === RichTextEditor.EDITORTYPE_TINYMCE7) {
			return window.tinymce.majorVersion != "7";
		}
		return false;
	};
