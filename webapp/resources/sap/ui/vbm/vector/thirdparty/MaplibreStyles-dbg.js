...
sap.ui.define([
    ...
    var MaplibreStyles = BaseObject.extend("sap.ui.vbm.vector.MaplibreStyles", /** @lends sap.ui.vbm.vector.MaplibreStyles.prototype */ {
    });

    MaplibreStyles.loadStyles = () => {
        const styles = ` 
        .my-custom-control {
                pointer-events: auto;
            }
        ...
        .vbi-nav.my-custom-control:hover {
        opacity: 1;
        ...
        pointer-events: none; /* Make sure the box doesn't interfere with map interactions */
        display: none;
        }
