...
sap.ui.define(["sap/fe/navigation/PresentationVariant", "./NavError"],
	 ...
	 */
	var PresentationVariant = FEPresentationVariant.extend("sap.ui.generic.app.navigation.service.PresentationVariant", /** @lends sap.ui.generic.app.navigation.service.PresentationVariant.prototype */ {
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#getID} instead.
		 */
		getID : function() {
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#setID} instead.
		 */
		setID : function(sId) {
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#setText} instead.
		 * @throws An instance of {@link sap.ui.generic.app.navigation.service.NavError} in case of input errors. Valid error codes are:
		 * <table>
		 * <tr><th>Error code</th><th>Description</th></tr>
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#getText} instead.
		 */
		getText : function() {
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#setContextUrl} instead.
		 * @throws An instance of {@link sap.ui.generic.app.navigation.service.NavError} in case of input errors. Valid error codes are:
		 * <table>
		 * <tr><th>Error code</th><th>Description</th></tr>
		 * <tr><td>PresentationVariant.INVALID_INPUT_TYPE</td><td>Indicates that an input parameter has an invalid type</td></tr>
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#getContextUrl} instead.
		 */
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#isEmpty} instead.
		 */
		isEmpty : function() {
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#setProperties} instead.
		 */
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#getProperties} instead.
		 */
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#setTableVisualization} instead.
		 */
		 ...
		 *
		 * @returns {sap.fe.navigation.PresentationVariant.Visualization | undefined} mProperties to be used for the table visualization.
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#getTableVisualization} instead.
		 */
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#setChartVisualization} instead.
		 */
		 ...
		 *
		 * @returns {sap.fe.navigation.PresentationVariant.Visualization | undefined} mProperties to be used for the chart visualization.
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#getChartVisualization} instead.
		 */
		 ...
		 * @return {sap.fe.navigation.PresentationVariant.ExternalPresentationVariant} The external representation of this instance as a JSON object
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#toJSONObject} instead.
		 */
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.PresentationVariant#toJSONString} instead.
		 */
