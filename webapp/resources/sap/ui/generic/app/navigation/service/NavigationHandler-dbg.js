...
function (FENavHandler, NavLibrary, NavError, SelectionVariant) {
	 ...
	 */
	var NavigationHandler = FENavHandler.extend("sap.ui.generic.app.navigation.service.NavigationHandler", /** @lends sap.ui.generic.app.navigation.service.NavigationHandler.prototype */
	{
		metadata: {
			publicMethods: [
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#navigate} instead. <br>
		 ...
		 * @returns {jQuery.Promise} A Promise object to monitor when all the actions of the function have been executed. If the execution is successful, the
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#parseNavigation} instead.
		 * @example <code>
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#setTechnicalParameters} instead.
		 */
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#getTechnicalParameters} instead.
		 */
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#replaceHash} instead.
		 */
		 ...
		 * @returns {jQuery.Promise<string>} A Promise object to monitor when all the actions of the function have been executed; if the execution is successful, the
		 *          app state key is returned; if an error occurs, an object of type {@link sap.ui.generic.app.navigation.service.NavError} is
		 *          returned
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#storeInnerAppStateAsync} instead.
		 * @example <code>
		 * sap.ui.define(["sap/ui/generic/app/navigation/service/NavigationHandler"], function (NavigationHandler) {
		 * 	var oNavigationHandler = new NavigationHandler(oController);
		 * 	var mInnerAppData = {
		 ...
		 * @returns {jQuery.Promise<any>} A Promise object to monitor when all actions of the function have been executed; if the execution is successful, the
		 ...
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#processBeforeSmartLinkPopoverOpens} instead. <br>
		 *         <b>Node:</b> If the <code>oExternalAppData</code> parameter is not supplied, the external app data will be calculated based on
		 ...
		 *        (|)
		 * @returns {sap.ui.generic.app.navigation.service.SelectionVariant} Instance of {@link sap.ui.generic.app.navigation.service.SelectionVariant}
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#mixAttributesAndSelectionVariant} instead.
		 * @example <code>
		 * sap.ui.define(["sap/ui/generic/app/navigation/service/NavigationHandler"], function (NavigationHandler) {
		 ...
		 * @since 1.60.0
		 * @public
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#setModel} instead.
		 ...
		 * @protected
		 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavigationHandler#constructContextUrl} instead.
		 */
