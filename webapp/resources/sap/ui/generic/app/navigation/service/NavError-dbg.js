...
sap.ui.define(["sap/fe/navigation/NavError"], function(FENavError) {
	 ...
	 */
	var NavError = FENavError.extend("sap.ui.generic.app.navigation.service.NavError", /** @lends sap.ui.generic.app.navigation.service.NavError.prototype */
	{
	 ...
	 * @public
	 * @deprecated Since version 1.83.0. Please use {@link sap.fe.navigation.NavError#getErrorCode} instead.
