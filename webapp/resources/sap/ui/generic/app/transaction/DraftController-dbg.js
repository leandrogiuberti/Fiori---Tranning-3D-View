...
sap.ui.define(["sap/base/util/merge", "./BaseController", "./DraftContext", "sap/base/Log", "sap/ui/model/Context", "sap/ui/generic/app/util/ActionUtil"
], function(merge, BaseController, DraftContext, Log, Context, ActionUtil) {
	"use strict";
	...
	DraftController.prototype.activateDraftEntity = function(oContext, bIsLenient, sExpand) {
		...
		var oActivateParameters = Object.assign({}, oPrepareParameters); // copy the parameters that are identical for preparation and activation
