...
sap.ui.define(["sap/ui/core/Lib", "sap/ui/model/resource/ResourceModel"], function (CoreLib, ResourceModel) {
  "use strict";

  const getFormatterConfiguration = function () {
    ...
    return [{
      ...
      parameters: [{
        ...
        properties: [{
          name: "UTC",
          displayName: i18nModel.getObject("UTC"),
          type: "boolean",
          defaultValue: false
        }]
      }],
      ...
      parameters: [{
        ...
        properties: [{
          ...
          options: [{
            value: "short",
            name: i18nModel.getObject("SHORT")
          }, {
            value: "long",
            name: i18nModel.getObject("LONG")
          }]
        }]
      }],
      type: "numeric",
      ...
      parameters: [{
        name: "currency",
        displayName: i18nModel.getObject("CURRENCY"),
        type: "string",
        defaultValue: ""
      }, {
        name: "options",
      ...
      parameters: [{
        name: "iTargetValue",
        displayName: i18nModel.getObject("TARGET_VALUE"),
        type: "number",
        defaultValue: ""
      }, {
        name: "mStaticValues",
      ...
      parameters: [{
        name: "value2",
        displayName: i18nModel.getObject("VALUE"),
        type: "number",
        defaultValue: ""
      }, {
        name: "mStaticValues",
        ...
        properties: [{
          ...
          name: "showScale",
          displayName: i18nModel.getObject("SCALE"),
          type: "boolean",
          defaultValue: true
        }, {
          name: "scaleFactor",
          displayName: i18nModel.getObject("SCALE_FACTOR"),
          type: "number",
          defaultValue: 0
        }]
      }, {
        ...
        selectedKey: [0],
        options: [{
          name: i18nModel.getObject("INDEX_ZERO"),
          value: "[0]"
        }, {
          name: i18nModel.getObject("INDEX_ONE"),
          value: "[1]"
        }, {
          name: i18nModel.getObject("INDEX_ZERO_ONE"),
          value: "[0, 1]"
        }, {
          name: i18nModel.getObject("INDEX_ONE_ZERO"),
          value: "[1, 0]"
        }]
      }],
      type: "string | numeric",
      ...
      parameters: [{
        name: "target",
        displayName: i18nModel.getObject("TARGET_INDICATORS_TEXT"),
        type: "string",
        defaultValue: ""
      }, {
        name: "sUnit",
        ...
        options: [{
          value: "",
          name: i18nModel.getObject("NO_UNIT")
        }, {
          value: "%",
          name: i18nModel.getObject("PERCENT")
        }]
      }],
      type: "string | numeric",
      visible: false
      ...
      parameters: [{
        ...
        name: "bIncludeText",
        displayName: i18nModel.getObject("INCLUDE_TEXT"),
        type: "boolean",
        defaultValue: false
      }, {
        name: "sCurrency",
      ...
      parameters: [{
        name: "sType",
        displayName: i18nModel.getObject("Criticality_States"),
        type: "string",
        defaultValue: ""
      }],
      type: "string | numeric",
      ...
      parameters: [{
        ...
        options: [{
          name: i18nModel.getObject("YEAR_MONTH"),
          value: "yearmonth"
        }, {
          name: i18nModel.getObject("YEAR_WEEK"),
          value: "yearweek"
        }, {
          name: i18nModel.getObject("YEAR_QUARTER"),
          value: "yearquarter"
        }]
      }],
      type: "string",
  ...
  __exports.getFormatterConfiguration = getFormatterConfiguration;
  return __exports;
});
//# sourceMappingURL=FormatterOptions-dbg-dbg.js.map
