sap.ui.define((function () { 'use strict';
	...
	utils.clearElementChildren = utils.getFitStatus = utils.truncate = utils.stringToCssColor = utils.renderSeparation = utils.parseEnum = utils.getEnumValueByName = utils.parseBool = utils.parseNumber = utils.parseString = utils.appendChild = utils.generateUniqueId = utils.isMobileOS = utils.isInternetExplorer = void 0;
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var Enums$5 = enums;
	var Shared$1 = shared;
	...
	utils.isMobileOS = isMobileOS;
	/**
	 * Generate a UUID prepended with "__ac-"
	 */
	function generateUniqueId() {
	    return "__ac-" + Shared$1.UUID.generate();
	}
	...
	utils.getEnumValueByName = getEnumValueByName;
	...
	function renderSeparation(hostConfig, separationDefinition, orientation) {
	    if (separationDefinition.spacing > 0 || (separationDefinition.lineThickness && separationDefinition.lineThickness > 0)) {
	        ...
	        separator.className = hostConfig.makeCssClassName("ac-" + (orientation == Enums$5.Orientation.Horizontal ? "horizontal" : "vertical") + "-separator");
	        separator.setAttribute("aria-hidden", "true");
	        var color = separationDefinition.lineColor ? stringToCssColor(separationDefinition.lineColor) : "";
	        if (orientation == Enums$5.Orientation.Horizontal) {
	...
	function getFitStatus(element, containerEnd) {
	    ...
	    if (end <= containerEnd) {
	        return Enums$5.ContainerFitStatus.FullyInContainer;
	    }
	    else if (start < containerEnd) {
	        return Enums$5.ContainerFitStatus.Overflowing;
	    }
	    else {
	        return Enums$5.ContainerFitStatus.FullyOutOfContainer;
	    }
	}
	...
	utils.clearElementChildren = clearElementChildren;

	var strings = {};

	Object.defineProperty(strings, "__esModule", { value: true });
	strings.Strings = void 0;
	...
	serialization.SerializableObject = serialization.property = serialization.SerializableObjectSchema = serialization.CustomProperty = serialization.SerializableObjectCollectionProperty = serialization.SerializableObjectProperty = serialization.EnumProperty = serialization.ValueSetProperty = serialization.StringArrayProperty = serialization.PixelSizeProperty = serialization.NumProperty = serialization.BoolProperty = serialization.StringProperty = serialization.PropertyDefinition = serialization.BaseSerializationContext = serialization.isVersionLessOrEqual = serialization.Versions = serialization.Version = void 0;
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var shared_1$3 = shared;
	var Utils$3 = utils;
	var Enums$4 = enums;
	var strings_1$3 = strings;
	var Version = /** @class */ (function () {
	    ...
	    Version.parse = function (versionString, context) {
	        ...
	        if (!result._isValid) {
	            context.logParseEvent(undefined, Enums$4.ValidationEvent.InvalidPropertyValue, strings_1$3.Strings.errors.invalidVersionString(result._versionString));
	        }
	        return result;
	    };
	...
	serialization.Versions = Versions;
	...
	serialization.isVersionLessOrEqual = isVersionLessOrEqual;
	var BaseSerializationContext = /** @class */ (function () {
	    ...
	    BaseSerializationContext.prototype.serializeValue = function (target, propertyName, propertyValue, defaultValue, forceDeleteIfNullOrDefault) {
	        ...
	        if (propertyValue === null || propertyValue === undefined || propertyValue === defaultValue) {
	            if (!shared_1$3.GlobalSettings.enableFullJsonRoundTrip || forceDeleteIfNullOrDefault) {
	    ...
	    BaseSerializationContext.prototype.logParseEvent = function (source, event, message) {
	        this.logEvent(source, Enums$4.ValidationPhase.Parse, event, message);
	    };
	...
	serialization.BaseSerializationContext = BaseSerializationContext;
	var SimpleSerializationContext = /** @class */ (function (_super) {
	    __extends$5(SimpleSerializationContext, _super);
	...
	serialization.PropertyDefinition = PropertyDefinition;
	var StringProperty = /** @class */ (function (_super) {
	    __extends$5(StringProperty, _super);
	    ...
	    StringProperty.prototype.parse = function (sender, source, context) {
	        var parsedValue = Utils$3.parseString(source[this.name], this.defaultValue);
	        ...
	        if (!isUndefined && this.regEx !== undefined) {
	            ...
	            if (!matches) {
	                context.logParseEvent(sender, Enums$4.ValidationEvent.InvalidPropertyValue, strings_1$3.Strings.errors.invalidPropertyValue(parsedValue, this.name));
	                return undefined;
	            }
	        }
	        return parsedValue;
	...
	serialization.StringProperty = StringProperty;
	var BoolProperty = /** @class */ (function (_super) {
	    __extends$5(BoolProperty, _super);
	    function BoolProperty() {
	        return _super !== null && _super.apply(this, arguments) || this;
	    }
	    BoolProperty.prototype.parse = function (sender, source, context) {
	        return Utils$3.parseBool(source[this.name], this.defaultValue);
	    };
	...
	serialization.BoolProperty = BoolProperty;
	var NumProperty = /** @class */ (function (_super) {
	    __extends$5(NumProperty, _super);
	    function NumProperty() {
	        return _super !== null && _super.apply(this, arguments) || this;
	    }
	    NumProperty.prototype.parse = function (sender, source, context) {
	        return Utils$3.parseNumber(source[this.name], this.defaultValue);
	    };
	...
	serialization.NumProperty = NumProperty;
	var PixelSizeProperty = /** @class */ (function (_super) {
	    __extends$5(PixelSizeProperty, _super);
	    ...
	    PixelSizeProperty.prototype.parse = function (sender, source, context) {
	        ...
	        if (typeof value === "string") {
	            var isValid = false;
	            try {
	                var size = shared_1$3.SizeAndUnit.parse(value, true);
	                if (size.unit == Enums$4.SizeUnit.Pixel) {
	            ...
	            if (!isValid) {
	                context.logParseEvent(sender, Enums$4.ValidationEvent.InvalidPropertyValue, strings_1$3.Strings.errors.invalidPropertyValue(source[this.name], "minHeight"));
	            }
	        }
	        return result;
	    };
	...
	serialization.PixelSizeProperty = PixelSizeProperty;
	var StringArrayProperty = /** @class */ (function (_super) {
	    __extends$5(StringArrayProperty, _super);
	    ...
	    StringArrayProperty.prototype.parse = function (sender, source, context) {
	        ...
	        for (var _i = 0, sourceValue_1 = sourceValue; _i < sourceValue_1.length; _i++) {
	            ...
	            if (typeof value === "string") {
	                ...
	                context.logParseEvent(sender, Enums$4.ValidationEvent.InvalidPropertyValue, "Invalid array value \"" + value + "\" of type \"" + typeof value + "\" ignored for \"" + this.name + "\".");
	            }
	        }
	        return result;
	    };
	...
	serialization.StringArrayProperty = StringArrayProperty;
	var ValueSetProperty = /** @class */ (function (_super) {
	    __extends$5(ValueSetProperty, _super);
	            ...
	            for (var _i = 0, _a = this.values; _i < _a.length; _i++) {
	                ...
	                if (sourceValue.toLowerCase() === versionedValue.value.toLowerCase()) {
	                    ...
	                    if (targetVersion.compareTo(context.targetVersion) <= 0) {
	                        ...
	                        context.logParseEvent(sender, Enums$4.ValidationEvent.InvalidPropertyValue, strings_1$3.Strings.errors.propertyValueNotSupported(sourceValue, this.name, targetVersion.toString(), context.targetVersion.toString()));
	                        return this.defaultValue;
	                    }
	                }
	            }
	        }
	        context.logParseEvent(sender, Enums$4.ValidationEvent.InvalidPropertyValue, strings_1$3.Strings.errors.invalidPropertyValue(sourceValue, this.name));
	        return this.defaultValue;
	    };
	        ...
	        for (var _i = 0, _a = this.values; _i < _a.length; _i++) {
	            ...
	            if (versionedValue.value === value) {
	                ...
	                if (targetVersion.compareTo(context.targetVersion) <= 0) {
	                    ...
	                    context.logEvent(sender, Enums$4.ValidationPhase.ToJSON, Enums$4.ValidationEvent.InvalidPropertyValue, strings_1$3.Strings.errors.propertyValueNotSupported(value, this.name, targetVersion.toString(), context.targetVersion.toString()));
	                }
	            }
	        }
	        if (valueFound) {
	...
	serialization.ValueSetProperty = ValueSetProperty;
	var EnumProperty = /** @class */ (function (_super) {
	    __extends$5(EnumProperty, _super);
	    ...
	    EnumProperty.prototype.parse = function (sender, source, context) {
	        ...
	        var enumValue = Utils$3.getEnumValueByName(this.enumType, sourceValue);
	            ...
	            for (var _i = 0, _a = this.values; _i < _a.length; _i++) {
	                ...
	                if (versionedValue.value === value) {
	                    ...
	                    if (targetVersion.compareTo(context.targetVersion) <= 0) {
	                        ...
	                        context.logEvent(sender, Enums$4.ValidationPhase.ToJSON, Enums$4.ValidationEvent.InvalidPropertyValue, strings_1$3.Strings.errors.invalidPropertyValue(value, this.name));
	                    }
	                }
	            }
	            if (valueFound) {
	...
	serialization.EnumProperty = EnumProperty;
	var SerializableObjectProperty = /** @class */ (function (_super) {
	    __extends$5(SerializableObjectProperty, _super);
	...
	serialization.SerializableObjectProperty = SerializableObjectProperty;
	var SerializableObjectCollectionProperty = /** @class */ (function (_super) {
	    __extends$5(SerializableObjectCollectionProperty, _super);
	...
	serialization.SerializableObjectCollectionProperty = SerializableObjectCollectionProperty;
	var CustomProperty = /** @class */ (function (_super) {
	    __extends$5(CustomProperty, _super);
	...
	serialization.CustomProperty = CustomProperty;
	...
	serialization.SerializableObjectSchema = SerializableObjectSchema;
	...
	var SerializableObject = /** @class */ (function () {
	    ...
	    SerializableObject.prototype.internalParse = function (source, context) {
	        this._propertyBag = {};
	        this._rawProperties = shared_1$3.GlobalSettings.enableFullJsonRoundTrip ? (source ? source : {}) : {};
	        if (source) {
	            var s = this.getSchema();
	            for (var i = 0; i < s.getCount(); i++) {
	                ...
	                if (property_3.isSerializationEnabled) {
	                    ...
	                    if (source.hasOwnProperty(property_3.name)) {
	                        if (property_3.targetVersion.compareTo(context.targetVersion) <= 0) {
	                            ...
	                            context.logParseEvent(this, Enums$4.ValidationEvent.UnsupportedProperty, strings_1$3.Strings.errors.propertyNotSupported(property_3.name, property_3.targetVersion.toString(), context.targetVersion.toString()));
	                        }
	                    }
	    ...
	    SerializableObject.prototype.toJSON = function (context) {
	        ...
	        if (this.shouldSerialize(effectiveContext)) {
	            var result = void 0;
	            if (shared_1$3.GlobalSettings.enableFullJsonRoundTrip && this._rawProperties && typeof this._rawProperties === "object") {
	...
	serialization.SerializableObject = SerializableObject;

	var registry = {};

	Object.defineProperty(registry, "__esModule", { value: true });
	registry.CardObjectRegistry = void 0;
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var serialization_1$4 = serialization;
	var CardObjectRegistry = /** @class */ (function () {
	    ...
	    CardObjectRegistry.prototype.register = function (typeName, objectType, schemaVersion) {
	        if (schemaVersion === void 0) { schemaVersion = serialization_1$4.Versions.v1_0; }
	...
	registry.CardObjectRegistry = CardObjectRegistry;
	...
	Object.defineProperty(hostCapabilities, "__esModule", { value: true });
	hostCapabilities.HostCapabilities = void 0;
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var serialization_1$3 = serialization;
	var HostCapabilities = /** @class */ (function (_super) {
	    __extends$4(HostCapabilities, _super);
	            ...
	            for (var name_1 in source) {
	                ...
	                if (typeof jsonVersion === "string") {
	                    if (jsonVersion == "*") {
	                        ...
	                        var version = serialization_1$3.Version.parse(jsonVersion, context);
	    ...
	    return HostCapabilities;
	}(serialization_1$3.SerializableObject));
	...
	Object.defineProperty(cardObject, "__esModule", { value: true });
	cardObject.CardObject = cardObject.ValidationResults = void 0;
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var Enums$3 = enums;
	var strings_1$2 = strings;
	var shared_1$2 = shared;
	var host_capabilities_1$1 = hostCapabilities;
	...
	var ValidationResults = /** @class */ (function () {
	    ...
	    ValidationResults.prototype.addFailure = function (cardObject, event, message) {
	        this.validationEvents.push({
	            phase: Enums$3.ValidationPhase.Validation,
	            source: cardObject,
	            event: event,
	            message: message
	        });
	...
	cardObject.ValidationResults = ValidationResults;
	var CardObject = /** @class */ (function (_super) {
	    __extends$3(CardObject, _super);
	    function CardObject() {
	        //#region Schema
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        //#endregion
	    ...
	    CardObject.prototype.preProcessPropertyValue = function (property, propertyValue) {
	        ...
	        if (shared_1$2.GlobalSettings.allowPreProcessingPropertyValues) {
	        ...
	        if (this.id) {
	            if (context.allIds.hasOwnProperty(this.id)) {
	                if (context.allIds[this.id] == 1) {
	                    context.addFailure(this, Enums$3.ValidationEvent.DuplicateId, strings_1$2.Strings.errors.duplicateId(this.id));
	                }
	    ...
	    CardObject.typeNameProperty = new serialization_1$2.StringProperty(serialization_1$2.Versions.v1_0, "type", undefined, undefined, undefined, function (sender) {
	        return sender.getJsonTypeName();
	    });
	    CardObject.idProperty = new serialization_1$2.StringProperty(serialization_1$2.Versions.v1_0, "id");
	    CardObject.requiresProperty = new serialization_1$2.SerializableObjectProperty(serialization_1$2.Versions.v1_2, "requires", host_capabilities_1$1.HostCapabilities, false, new host_capabilities_1$1.HostCapabilities());
	    __decorate$1([
	        serialization_1$2.property(CardObject.idProperty)
	    ], CardObject.prototype, "id", void 0);
	    __decorate$1([
	        serialization_1$2.property(CardObject.requiresProperty)
	    ], CardObject.prototype, "requires", null);
	    return CardObject;
	}(serialization_1$2.SerializableObject));
	...
	hostConfig.defaultHostConfig = hostConfig.HostConfig = hostConfig.FontTypeSet = hostConfig.FontTypeDefinition = hostConfig.ContainerStyleSet = hostConfig.ContainerStyleDefinition = hostConfig.ColorSetDefinition = hostConfig.ActionsConfig = hostConfig.ShowCardActionConfig = hostConfig.FactSetConfig = hostConfig.FactTitleDefinition = hostConfig.FactTextDefinition = hostConfig.InputConfig = hostConfig.InputLabelConfig = hostConfig.RequiredInputLabelTextDefinition = hostConfig.BaseTextDefinition = hostConfig.MediaConfig = hostConfig.ImageSetConfig = hostConfig.AdaptiveCardConfig = hostConfig.TextColorDefinition = hostConfig.ColorDefinition = void 0;
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var Enums$2 = enums;
	var Utils$2 = utils;
	var Shared = shared;
	var host_capabilities_1 = hostCapabilities;
	function parseHostConfigEnum(targetEnum, value, defaultValue) {
	    if (typeof value === "string") {
	        var parsedValue = Utils$2.parseEnum(targetEnum, value, defaultValue);
	...
	var ImageSetConfig = /** @class */ (function () {
	    function ImageSetConfig(obj) {
	        this.imageSize = Enums$2.Size.Medium;
	        this.maxImageHeight = 100;
	        if (obj) {
	            this.imageSize = obj["imageSize"] != null ? obj["imageSize"] : this.imageSize;
	            this.maxImageHeight = Utils$2.parseNumber(obj["maxImageHeight"], 100);
	        }
	    }
	    ImageSetConfig.prototype.toJSON = function () {
	        return {
	            imageSize: Enums$2.Size[this.imageSize],
	...
	var BaseTextDefinition = /** @class */ (function () {
	    function BaseTextDefinition(obj) {
	        this.size = Enums$2.TextSize.Default;
	        this.color = Enums$2.TextColor.Default;
	        this.isSubtle = false;
	        this.weight = Enums$2.TextWeight.Default;
	        if (obj) {
	            this.size = parseHostConfigEnum(Enums$2.TextSize, obj["size"], this.size);
	            this.color = parseHostConfigEnum(Enums$2.TextColor, obj["color"], this.color);
	            this.isSubtle = obj["isSubtle"] || this.isSubtle;
	            this.weight = parseHostConfigEnum(Enums$2.TextWeight, obj["weight"], this.getDefaultWeight());
	        }
	    }
	    BaseTextDefinition.prototype.getDefaultWeight = function () {
	        return Enums$2.TextWeight.Default;
	    };
	    BaseTextDefinition.prototype.toJSON = function () {
	        return {
	            size: Enums$2.TextSize[this.size],
	            color: Enums$2.TextColor[this.color],
	            isSubtle: this.isSubtle,
	            weight: Enums$2.TextWeight[this.weight]
	        };
	    };
	    return BaseTextDefinition;
	}());
	hostConfig.BaseTextDefinition = BaseTextDefinition;
	var RequiredInputLabelTextDefinition = /** @class */ (function (_super) {
	    __extends$2(RequiredInputLabelTextDefinition, _super);
	    function RequiredInputLabelTextDefinition(obj) {
	        var _this = _super.call(this, obj) || this;
	        _this.suffix = " *";
	        _this.suffixColor = Enums$2.TextColor.Attention;
	        if (obj) {
	            _this.suffix = obj["suffix"] || _this.suffix;
	            _this.suffixColor = parseHostConfigEnum(Enums$2.TextColor, obj["suffixColor"], _this.suffixColor);
	        }
	        return _this;
	    }
	    RequiredInputLabelTextDefinition.prototype.toJSON = function () {
	        ...
	        result["suffixColor"] = Enums$2.TextColor[this.suffixColor];
	        return result;
	    };
	    return RequiredInputLabelTextDefinition;
	}(BaseTextDefinition));
	hostConfig.RequiredInputLabelTextDefinition = RequiredInputLabelTextDefinition;
	var InputLabelConfig = /** @class */ (function () {
	    function InputLabelConfig(obj) {
	        this.inputSpacing = Enums$2.Spacing.Small;
	        this.requiredInputs = new RequiredInputLabelTextDefinition();
	        this.optionalInputs = new BaseTextDefinition();
	        if (obj) {
	            this.inputSpacing = parseHostConfigEnum(Enums$2.Spacing, obj["inputSpacing"], this.inputSpacing);
	...
	hostConfig.InputLabelConfig = InputLabelConfig;
	var InputConfig = /** @class */ (function () {
	    function InputConfig(obj) {
	        this.label = new InputLabelConfig();
	        this.errorMessage = new BaseTextDefinition({ color: Enums$2.TextColor.Attention });
	        if (obj) {
	...
	hostConfig.InputConfig = InputConfig;
	var FactTextDefinition = /** @class */ (function (_super) {
	    __extends$2(FactTextDefinition, _super);
	...
	var FactTitleDefinition = /** @class */ (function (_super) {
	    ...
	    function FactTitleDefinition(obj) {
	        var _this = _super.call(this, obj) || this;
	        _this.maxWidth = 150;
	        _this.weight = Enums$2.TextWeight.Bolder;
	        if (obj) {
	            _this.maxWidth = obj["maxWidth"] != null ? obj["maxWidth"] : _this.maxWidth;
	            _this.weight = parseHostConfigEnum(Enums$2.TextWeight, obj["weight"], Enums$2.TextWeight.Bolder);
	        }
	        return _this;
	    }
	    FactTitleDefinition.prototype.getDefaultWeight = function () {
	        return Enums$2.TextWeight.Bolder;
	    };
	...
	var ShowCardActionConfig = /** @class */ (function () {
	    function ShowCardActionConfig(obj) {
	        this.actionMode = Enums$2.ShowCardActionMode.Inline;
	        this.inlineTopMargin = 16;
	        this.style = Enums$2.ContainerStyle.Emphasis;
	        if (obj) {
	            this.actionMode = parseHostConfigEnum(Enums$2.ShowCardActionMode, obj["actionMode"], Enums$2.ShowCardActionMode.Inline);
	            this.inlineTopMargin = obj["inlineTopMargin"] != null ? obj["inlineTopMargin"] : this.inlineTopMargin;
	            this.style = obj["style"] && typeof obj["style"] === "string" ? obj["style"] : Enums$2.ContainerStyle.Emphasis;
	        }
	    }
	    ShowCardActionConfig.prototype.toJSON = function () {
	        return {
	            actionMode: Enums$2.ShowCardActionMode[this.actionMode],
	...
	var ActionsConfig = /** @class */ (function () {
	    function ActionsConfig(obj) {
	        this.maxActions = 5;
	        this.spacing = Enums$2.Spacing.Default;
	        this.buttonSpacing = 20;
	        this.showCard = new ShowCardActionConfig();
	        this.preExpandSingleShowCardAction = false;
	        this.actionsOrientation = Enums$2.Orientation.Horizontal;
	        this.actionAlignment = Enums$2.ActionAlignment.Left;
	        this.iconPlacement = Enums$2.ActionIconPlacement.LeftOfTitle;
	        this.allowTitleToWrap = false;
	        this.iconSize = 16;
	        if (obj) {
	            this.maxActions = obj["maxActions"] != null ? obj["maxActions"] : this.maxActions;
	            this.spacing = parseHostConfigEnum(Enums$2.Spacing, obj.spacing && obj.spacing, Enums$2.Spacing.Default);
	            this.buttonSpacing = obj["buttonSpacing"] != null ? obj["buttonSpacing"] : this.buttonSpacing;
	            this.showCard = new ShowCardActionConfig(obj["showCard"]);
	            this.preExpandSingleShowCardAction = Utils$2.parseBool(obj["preExpandSingleShowCardAction"], false);
	            this.actionsOrientation = parseHostConfigEnum(Enums$2.Orientation, obj["actionsOrientation"], Enums$2.Orientation.Horizontal);
	            this.actionAlignment = parseHostConfigEnum(Enums$2.ActionAlignment, obj["actionAlignment"], Enums$2.ActionAlignment.Left);
	            this.iconPlacement = parseHostConfigEnum(Enums$2.ActionIconPlacement, obj["iconPlacement"], Enums$2.ActionIconPlacement.LeftOfTitle);
	            this.allowTitleToWrap = obj["allowTitleToWrap"] != null ? obj["allowTitleToWrap"] : this.allowTitleToWrap;
	            try {
	                var sizeAndUnit = Shared.SizeAndUnit.parse(obj["iconSize"]);
	                if (sizeAndUnit.unit == Enums$2.SizeUnit.Pixel) {
	    ...
	    ActionsConfig.prototype.toJSON = function () {
	        return {
	            ...
	            spacing: Enums$2.Spacing[this.spacing],
	            buttonSpacing: this.buttonSpacing,
	            showCard: this.showCard,
	            preExpandSingleShowCardAction: this.preExpandSingleShowCardAction,
	            actionsOrientation: Enums$2.Orientation[this.actionsOrientation],
	            actionAlignment: Enums$2.ActionAlignment[this.actionAlignment]
	        };
	    };
	...
	var ContainerStyleSet = /** @class */ (function () {
	    function ContainerStyleSet(obj) {
	        this._allStyles = {};
	        this._allStyles[Enums$2.ContainerStyle.Default] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$2.ContainerStyle.Emphasis] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$2.ContainerStyle.Accent] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$2.ContainerStyle.Good] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$2.ContainerStyle.Attention] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$2.ContainerStyle.Warning] = new BuiltInContainerStyleDefinition();
	        if (obj) {
	            this._allStyles[Enums$2.ContainerStyle.Default].parse(obj[Enums$2.ContainerStyle.Default]);
	            this._allStyles[Enums$2.ContainerStyle.Emphasis].parse(obj[Enums$2.ContainerStyle.Emphasis]);
	            this._allStyles[Enums$2.ContainerStyle.Accent].parse(obj[Enums$2.ContainerStyle.Accent]);
	            this._allStyles[Enums$2.ContainerStyle.Good].parse(obj[Enums$2.ContainerStyle.Good]);
	            this._allStyles[Enums$2.ContainerStyle.Attention].parse(obj[Enums$2.ContainerStyle.Attention]);
	            this._allStyles[Enums$2.ContainerStyle.Warning].parse(obj[Enums$2.ContainerStyle.Warning]);
	    ...
	    ContainerStyleSet.prototype.getStyleByName = function (name, defaultValue) {
	        if (name && this._allStyles.hasOwnProperty(name)) {
	            ...
	            return defaultValue ? defaultValue : this._allStyles[Enums$2.ContainerStyle.Default];
	        }
	    };
	    Object.defineProperty(ContainerStyleSet.prototype, "default", {
	        get: function () {
	            return this._allStyles[Enums$2.ContainerStyle.Default];
	        },
	        enumerable: false,
	        configurable: true
	    });
	    Object.defineProperty(ContainerStyleSet.prototype, "emphasis", {
	        get: function () {
	            return this._allStyles[Enums$2.ContainerStyle.Emphasis];
	        },
	        enumerable: false,
	        configurable: true
	    });
	...
	var FontTypeSet = /** @class */ (function () {
	    ...
	    FontTypeSet.prototype.getStyleDefinition = function (style) {
	        switch (style) {
	            case Enums$2.FontType.Monospace:
	                return this.monospace;
	            case Enums$2.FontType.Default:
	            default:
	                return this.default;
	        }
	    };
	...
	var HostConfig = /** @class */ (function () {
	    ...
	    HostConfig.prototype.getFontTypeDefinition = function (style) {
	        if (this.fontTypes) {
	            ...
	            return style == Enums$2.FontType.Monospace ? FontTypeDefinition.monospace : this._legacyFontType;
	        }
	    };
	    HostConfig.prototype.getEffectiveSpacing = function (spacing) {
	        switch (spacing) {
	            case Enums$2.Spacing.Small:
	                return this.spacing.small;
	            case Enums$2.Spacing.Default:
	                return this.spacing.default;
	            case Enums$2.Spacing.Medium:
	                return this.spacing.medium;
	            case Enums$2.Spacing.Large:
	                return this.spacing.large;
	            case Enums$2.Spacing.ExtraLarge:
	                return this.spacing.extraLarge;
	            case Enums$2.Spacing.Padding:
	...
	hostConfig.defaultHostConfig = new HostConfig({
	    ...
	    inputs: {
	        label: {
	            requiredInputs: {
	                color: Enums$2.TextColor.Accent,
	                size: Enums$2.TextSize.ExtraLarge,
	                weight: Enums$2.TextWeight.Bolder,
	                isSubtle: true,
	                suffix: " (required)",
	                suffixColor: Enums$2.TextColor.Good
	            },
	            optionalInputs: {
	                color: Enums$2.TextColor.Warning,
	                size: Enums$2.TextSize.Medium,
	                weight: Enums$2.TextWeight.Lighter,
	                isSubtle: false
	            }
	        },
	        errorMessage: {
	            color: Enums$2.TextColor.Accent,
	            size: Enums$2.TextSize.Small,
	            weight: Enums$2.TextWeight.Bolder
	        }
	    },
	    actions: {
	        maxActions: 5,
	        spacing: Enums$2.Spacing.Default,
	        buttonSpacing: 10,
	        showCard: {
	            actionMode: Enums$2.ShowCardActionMode.Inline,
	            inlineTopMargin: 16
	        },
	        actionsOrientation: Enums$2.Orientation.Horizontal,
	        actionAlignment: Enums$2.ActionAlignment.Left
	    },
	    adaptiveCard: {
	        allowCustomStyle: false
	    },
	    imageSet: {
	        imageSize: Enums$2.Size.Medium,
	        maxImageHeight: 100
	    },
	    factSet: {
	        title: {
	            color: Enums$2.TextColor.Default,
	            size: Enums$2.TextSize.Default,
	            isSubtle: false,
	            weight: Enums$2.TextWeight.Bolder,
	            wrap: true,
	            maxWidth: 150,
	        ...
	        value: {
	            ...
	            size: Enums$2.TextSize.Default,
	            isSubtle: false,
	            weight: Enums$2.TextWeight.Default,
	            wrap: true,
	        },
	        spacing: 10
	    }
	...
	textFormatters.formatText = void 0;
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	...
	cardElements.SerializationContext = cardElements.GlobalRegistry = cardElements.AdaptiveCard = cardElements.Authentication = cardElements.TokenExchangeResource = cardElements.AuthCardButton = cardElements.RefreshDefinition = cardElements.RefreshActionProperty = cardElements.ContainerWithActions = cardElements.ColumnSet = cardElements.Column = cardElements.Container = cardElements.BackgroundImage = cardElements.StylableCardElementContainer = cardElements.ActionSet = cardElements.ShowCardAction = cardElements.HttpAction = cardElements.HttpHeader = cardElements.ToggleVisibilityAction = cardElements.OpenUrlAction = cardElements.ExecuteAction = cardElements.SubmitAction = cardElements.SubmitActionBase = cardElements.Action = cardElements.TimeInput = cardElements.TimeProperty = cardElements.DateInput = cardElements.NumberInput = cardElements.ChoiceSetInput = cardElements.Choice = cardElements.ToggleInput = cardElements.TextInput = cardElements.Input = cardElements.Media = cardElements.MediaSource = cardElements.ImageSet = cardElements.CardElementContainer = cardElements.Image = cardElements.FactSet = cardElements.Fact = cardElements.RichTextBlock = cardElements.TextRun = cardElements.TextBlock = cardElements.BaseTextBlock = cardElements.ActionProperty = cardElements.CardElement = void 0;
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var Enums$1 = enums;
	var shared_1$1 = shared;
	var Utils$1 = utils;
	var host_config_1 = hostConfig;
	var TextFormatters = textFormatters;
	var card_object_1 = cardObject;
	var serialization_1$1 = serialization;
	var registry_1 = registry;
	var strings_1$1 = strings;
	var CardElement = /** @class */ (function (_super) {
	    ...
	    Object.defineProperty(CardElement.prototype, "isVisible", {
	        ...
	        set: function (value) {
	            ...
	            if (shared_1$1.GlobalSettings.useAdvancedCardBottomTruncation && !value) {
	    ...
	    CardElement.prototype.internalRenderSeparator = function () {
	        var renderedSeparator = Utils$1.renderSeparation(this.hostConfig, {
	            spacing: this.hostConfig.getEffectiveSpacing(this.spacing),
	            lineThickness: this.separator ? this.hostConfig.separator.lineThickness : undefined,
	            lineColor: this.separator ? this.hostConfig.separator.lineColor : undefined
	        }, this.separatorOrientation);
	        if (shared_1$1.GlobalSettings.alwaysBleedSeparators && renderedSeparator && this.separatorOrientation == Enums$1.Orientation.Horizontal) {
	    ...
	    CardElement.prototype.createPlaceholderElement = function () {
	        ...
	        var foregroundCssColor = Utils$1.stringToCssColor(styleDefinition.foregroundColors.default.subtle);
	    ...
	    CardElement.prototype.applyPadding = function () {
	        if (this.separatorElement && this.separatorOrientation === Enums$1.Orientation.Horizontal) {
	            if (shared_1$1.GlobalSettings.alwaysBleedSeparators && !this.isBleeding()) {
	                var padding = new shared_1$1.PaddingDefinition();
	    ...
	    CardElement.prototype.getDefaultPadding = function () {
	        return new shared_1$1.PaddingDefinition();
	    };
	    ...
	    Object.defineProperty(CardElement.prototype, "separatorOrientation", {
	        get: function () {
	            return Enums$1.Orientation.Horizontal;
	        },
	        enumerable: false,
	        configurable: true
	    });
	    Object.defineProperty(CardElement.prototype, "defaultStyle", {
	        get: function () {
	            return Enums$1.ContainerStyle.Default;
	        },
	        enumerable: false,
	        configurable: true
	    });
	    ...
	    CardElement.prototype.getImmediateSurroundingPadding = function (result, processTop, processRight, processBottom, processLeft) {
	        ...
	        if (this.parent) {
	            ...
	            if (effectivePadding) {
	                if (doProcessTop && effectivePadding.top != Enums$1.Spacing.None) {
	                    result.top = effectivePadding.top;
	                    doProcessTop = false;
	                }
	                if (doProcessRight && effectivePadding.right != Enums$1.Spacing.None) {
	                    result.right = effectivePadding.right;
	                    doProcessRight = false;
	                }
	                if (doProcessBottom && effectivePadding.bottom != Enums$1.Spacing.None) {
	                    result.bottom = effectivePadding.bottom;
	                    doProcessBottom = false;
	                }
	                if (doProcessLeft && effectivePadding.left != Enums$1.Spacing.None) {
	    ...
	    CardElement.prototype.getActionAt = function (index) {
	        throw new Error(strings_1$1.Strings.errors.indexOutOfRange(index));
	    };
	    ...
	    CardElement.langProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_1, "lang", true, /^[a-z]{2,3}$/ig);
	    CardElement.isVisibleProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_2, "isVisible", true);
	    CardElement.separatorProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_0, "separator", false);
	    CardElement.heightProperty = new serialization_1$1.ValueSetProperty(serialization_1$1.Versions.v1_1, "height", [
	        { value: "auto" },
	        { value: "stretch" }
	    ], "auto");
	    CardElement.horizontalAlignmentProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "horizontalAlignment", Enums$1.HorizontalAlignment, Enums$1.HorizontalAlignment.Left);
	    CardElement.spacingProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "spacing", Enums$1.Spacing, Enums$1.Spacing.Default);
	    __decorate([
	        serialization_1$1.property(CardElement.horizontalAlignmentProperty)
	    ], CardElement.prototype, "horizontalAlignment", void 0);
	    __decorate([
	        serialization_1$1.property(CardElement.spacingProperty)
	    ], CardElement.prototype, "spacing", void 0);
	    __decorate([
	        serialization_1$1.property(CardElement.separatorProperty)
	    ], CardElement.prototype, "separator", void 0);
	    __decorate([
	        serialization_1$1.property(CardElement.heightProperty)
	    ], CardElement.prototype, "height", void 0);
	    __decorate([
	        serialization_1$1.property(CardElement.langProperty)
	    ], CardElement.prototype, "lang", null);
	    __decorate([
	        serialization_1$1.property(CardElement.isVisibleProperty)
	...
	}(serialization_1$1.PropertyDefinition));
	cardElements.ActionProperty = ActionProperty;
	var BaseTextBlock = /** @class */ (function (_super) {
	    __extends(BaseTextBlock, _super);
	    function BaseTextBlock(text) {
	        var _this = _super.call(this) || this;
	        _this.size = Enums$1.TextSize.Default;
	        _this.weight = Enums$1.TextWeight.Default;
	        _this.color = Enums$1.TextColor.Default;
	    ...
	    BaseTextBlock.prototype.getFontSize = function (fontType) {
	        switch (this.size) {
	            case Enums$1.TextSize.Small:
	                return fontType.fontSizes.small;
	            case Enums$1.TextSize.Medium:
	                return fontType.fontSizes.medium;
	            case Enums$1.TextSize.Large:
	                return fontType.fontSizes.large;
	            case Enums$1.TextSize.ExtraLarge:
	    ...
	    BaseTextBlock.prototype.getColorDefinition = function (colorSet, color) {
	        switch (color) {
	            case Enums$1.TextColor.Accent:
	                return colorSet.accent;
	            case Enums$1.TextColor.Dark:
	                return colorSet.dark;
	            case Enums$1.TextColor.Light:
	                return colorSet.light;
	            case Enums$1.TextColor.Good:
	                return colorSet.good;
	            case Enums$1.TextColor.Warning:
	                return colorSet.warning;
	            case Enums$1.TextColor.Attention:
	    ...
	    BaseTextBlock.prototype.applyStylesTo = function (targetElement) {
	        ...
	        targetElement.style.color = Utils$1.stringToCssColor(this.isSubtle ? colorDefinition.subtle : colorDefinition.default);
	        var fontWeight;
	        switch (this.weight) {
	            case Enums$1.TextWeight.Lighter:
	                fontWeight = fontType.fontWeights.lighter;
	                break;
	            case Enums$1.TextWeight.Bolder:
	    ...
	    Object.defineProperty(BaseTextBlock.prototype, "effectiveColor", {
	        get: function () {
	            return this.color ? this.color : Enums$1.TextColor.Default;
	        },
	        enumerable: false,
	        configurable: true
	    });
	    //#region Schema
	    BaseTextBlock.textProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "text", true);
	    BaseTextBlock.sizeProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "size", Enums$1.TextSize, Enums$1.TextSize.Default);
	    BaseTextBlock.weightProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "weight", Enums$1.TextWeight, Enums$1.TextWeight.Default);
	    BaseTextBlock.colorProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "color", Enums$1.TextColor, Enums$1.TextColor.Default);
	    BaseTextBlock.isSubtleProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_0, "isSubtle", false);
	    BaseTextBlock.fontTypeProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_2, "fontType", Enums$1.FontType);
	    BaseTextBlock.selectActionProperty = new ActionProperty(serialization_1$1.Versions.v1_1, "selectAction", ["Action.ShowCard"]);
	    __decorate([
	        serialization_1$1.property(BaseTextBlock.sizeProperty)
	    ], BaseTextBlock.prototype, "size", void 0);
	    __decorate([
	        serialization_1$1.property(BaseTextBlock.weightProperty)
	    ], BaseTextBlock.prototype, "weight", void 0);
	    __decorate([
	        serialization_1$1.property(BaseTextBlock.colorProperty)
	    ], BaseTextBlock.prototype, "color", void 0);
	    __decorate([
	        serialization_1$1.property(BaseTextBlock.fontTypeProperty)
	    ], BaseTextBlock.prototype, "fontType", void 0);
	    __decorate([
	        serialization_1$1.property(BaseTextBlock.isSubtleProperty)
	    ], BaseTextBlock.prototype, "isSubtle", void 0);
	    __decorate([
	        serialization_1$1.property(BaseTextBlock.textProperty)
	    ], BaseTextBlock.prototype, "text", null);
	    __decorate([
	        serialization_1$1.property(BaseTextBlock.selectActionProperty)
	...
	var TextBlock = /** @class */ (function (_super) {
	    ...
	    TextBlock.prototype.truncateIfSupported = function (maxHeight) {
	        if (this.renderedElement !== undefined) {
	            ...
	            if (truncationSupported) {
	                ...
	                Utils$1.truncate(element, maxHeight, this._computedLineHeight);
	                return true;
	            }
	        }
	        return false;
	        ...
	        if (this.text) {
	            ...
	            if (!this._processedText) {
	                ...
	                if (this.useMarkdown && formattedText) {
	                    if (shared_1$1.GlobalSettings.allowMarkForTextHighlighting) {
	                    ...
	                    if (markdownProcessingResult.didProcess && markdownProcessingResult.outputHtml) {
	                        ...
	                        if (shared_1$1.GlobalSettings.allowMarkForTextHighlighting && this._processedText) {
	                            var markStyle = "";
	            ...
	            if (this.wrap) {
	                ...
	                if (this.maxLines && this.maxLines > 0) {
	                    element.style.overflow = "hidden";
	                    if (Utils$1.isInternetExplorer() || !shared_1$1.GlobalSettings.useWebkitLineClamp) {
	            ...
	            if (shared_1$1.GlobalSettings.useAdvancedTextBlockTruncation || shared_1$1.GlobalSettings.useAdvancedCardBottomTruncation) {
	    ...
	    TextBlock.prototype.undoOverflowTruncation = function () {
	        ...
	        if (shared_1$1.GlobalSettings.useAdvancedTextBlockTruncation && this.maxLines) {
	    ...
	    TextBlock.prototype.applyStylesTo = function (targetElement) {
	        ...
	        switch (this.horizontalAlignment) {
	            case Enums$1.HorizontalAlignment.Center:
	                targetElement.style.textAlign = "center";
	                break;
	            case Enums$1.HorizontalAlignment.Right:
	    ...
	    TextBlock.prototype.updateLayout = function (processChildren) {
	        ...
	        if (shared_1$1.GlobalSettings.useAdvancedTextBlockTruncation && this.maxLines && this.isDisplayed()) {
	    ...
	    TextBlock.wrapProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_0, "wrap", false);
	    TextBlock.maxLinesProperty = new serialization_1$1.NumProperty(serialization_1$1.Versions.v1_0, "maxLines");
	    __decorate([
	        serialization_1$1.property(TextBlock.wrapProperty)
	    ], TextBlock.prototype, "wrap", void 0);
	    __decorate([
	        serialization_1$1.property(TextBlock.maxLinesProperty)
	...
	var TextRun = /** @class */ (function (_super) {
	    ...
	    TextRun.prototype.applyStylesTo = function (targetElement) {
	        ...
	        if (this.highlight) {
	            var colorDefinition = this.getColorDefinition(this.getEffectiveStyleDefinition().foregroundColors, this.effectiveColor);
	            targetElement.style.backgroundColor = Utils$1.stringToCssColor(this.isSubtle ? colorDefinition.highlightColors.subtle : colorDefinition.highlightColors.default);
	        }
	        if (this.underline) {
	    ...
	    TextRun.italicProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_2, "italic", false);
	    TextRun.strikethroughProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_2, "strikethrough", false);
	    TextRun.highlightProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_2, "highlight", false);
	    TextRun.underlineProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_3, "underline", false);
	    __decorate([
	        serialization_1$1.property(TextRun.italicProperty)
	    ], TextRun.prototype, "italic", void 0);
	    __decorate([
	        serialization_1$1.property(TextRun.strikethroughProperty)
	    ], TextRun.prototype, "strikethrough", void 0);
	    __decorate([
	        serialization_1$1.property(TextRun.highlightProperty)
	    ], TextRun.prototype, "highlight", void 0);
	    __decorate([
	        serialization_1$1.property(TextRun.underlineProperty)
	...
	var RichTextBlock = /** @class */ (function (_super) {
	    ...
	    RichTextBlock.prototype.internalAddInline = function (inline, forceAdd) {
	        ...
	        if (!inline.isInline) {
	            throw new Error(strings_1$1.Strings.errors.elementCannotBeUsedAsInline());
	        }
	        var doAdd = inline.parent === undefined || forceAdd;
	        if (!doAdd && inline.parent != this) {
	            throw new Error(strings_1$1.Strings.errors.inlineAlreadyParented());
	        }
	        else {
	...
	var Fact = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    Fact.titleProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "title");
	    Fact.valueProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "value");
	    __decorate([
	        serialization_1$1.property(Fact.titleProperty)
	    ], Fact.prototype, "name", void 0);
	    __decorate([
	        serialization_1$1.property(Fact.valueProperty)
	    ], Fact.prototype, "value", void 0);
	    return Fact;
	}(serialization_1$1.SerializableObject));
	...
	var FactSet = /** @class */ (function (_super) {
	    ...
	    FactSet.prototype.internalRender = function () {
	        ...
	        if (this.facts.length > 0) {
	            ...
	            for (var i = 0; i < this.facts.length; i++) {
	                ...
	                textBlock.spacing = Enums$1.Spacing.None;
	                Utils$1.appendChild(tdElement, textBlock.render());
	                Utils$1.appendChild(trElement, tdElement);
	                // Spacer column
	                ...
	                Utils$1.appendChild(tdElement, textBlock.render());
	                Utils$1.appendChild(trElement, tdElement);
	                Utils$1.appendChild(element, trElement);
	            }
	        }
	        return element;
	    };
	    ...
	    //#region Schema
	    FactSet.factsProperty = new serialization_1$1.SerializableObjectCollectionProperty(serialization_1$1.Versions.v1_0, "facts", Fact);
	    __decorate([
	        serialization_1$1.property(FactSet.factsProperty)
	...
	var ImageDimensionProperty = /** @class */ (function (_super) {
	    ...
	    ImageDimensionProperty.prototype.parse = function (sender, source, context) {
	        ...
	        if (typeof sourceValue === "string") {
	            try {
	                var size = shared_1$1.SizeAndUnit.parse(sourceValue, true);
	                if (size.unit == Enums$1.SizeUnit.Pixel) {
	                    result = size.physicalSize;
	                    isValid = true;
	                }
	            }
	        ...
	        if (!isValid) {
	            context.logParseEvent(sender, Enums$1.ValidationEvent.InvalidPropertyValue, strings_1$1.Strings.errors.invalidPropertyValue(sourceValue, this.name));
	        }
	        return result;
	    };
	...
	var Image = /** @class */ (function (_super) {
	    ...
	    function Image() {
	        //#region Schema
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.size = Enums$1.Size.Auto;
	        _this.style = Enums$1.ImageStyle.Default;
	        return _this;
	    }
	    ...
	    Image.prototype.applySize = function (element) {
	        if (this.pixelWidth || this.pixelHeight) {
	            ...
	            if (this.maxHeight) {
	                ...
	                switch (this.size) {
	                    case Enums$1.Size.Small:
	                        element.style.height = this.hostConfig.imageSizes.small + "px";
	                        break;
	                    case Enums$1.Size.Large:
	                ...
	                switch (this.size) {
	                    case Enums$1.Size.Stretch:
	                        element.style.width = "100%";
	                        break;
	                    case Enums$1.Size.Auto:
	    ...
	    Image.prototype.internalRender = function () {
	        ...
	        if (this.url) {
	            ...
	            if (this.style === Enums$1.ImageStyle.Person) {
	                imageElement.style.borderRadius = "50%";
	                imageElement.style.backgroundPosition = "50% 50%";
	                imageElement.style.backgroundRepeat = "no-repeat";
	            }
	            imageElement.style.backgroundColor = Utils$1.stringToCssColor(this.backgroundColor);
	    ...
	    Image.urlProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "url");
	    Image.altTextProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "altText");
	    Image.backgroundColorProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_1, "backgroundColor");
	    Image.styleProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "style", Enums$1.ImageStyle, Enums$1.ImageStyle.Default);
	    Image.sizeProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "size", Enums$1.Size, Enums$1.Size.Auto);
	    Image.pixelWidthProperty = new ImageDimensionProperty(serialization_1$1.Versions.v1_1, "width", "pixelWidth");
	    Image.pixelHeightProperty = new ImageDimensionProperty(serialization_1$1.Versions.v1_1, "height", "pixelHeight", CardElement.heightProperty);
	    Image.selectActionProperty = new ActionProperty(serialization_1$1.Versions.v1_1, "selectAction", ["Action.ShowCard"]);
	    __decorate([
	        serialization_1$1.property(Image.urlProperty)
	    ], Image.prototype, "url", void 0);
	    __decorate([
	        serialization_1$1.property(Image.altTextProperty)
	    ], Image.prototype, "altText", void 0);
	    __decorate([
	        serialization_1$1.property(Image.backgroundColorProperty)
	    ], Image.prototype, "backgroundColor", void 0);
	    __decorate([
	        serialization_1$1.property(Image.sizeProperty)
	    ], Image.prototype, "size", void 0);
	    __decorate([
	        serialization_1$1.property(Image.styleProperty)
	    ], Image.prototype, "style", void 0);
	    __decorate([
	        serialization_1$1.property(Image.pixelWidthProperty)
	    ], Image.prototype, "pixelWidth", void 0);
	    __decorate([
	        serialization_1$1.property(Image.pixelHeightProperty)
	    ], Image.prototype, "pixelHeight", void 0);
	    __decorate([
	        serialization_1$1.property(Image.selectActionProperty)
	...
	var CardElementContainer = /** @class */ (function (_super) {
	    ...
	    CardElementContainer.prototype.applyPadding = function () {
	        ...
	        var physicalPadding = new shared_1$1.SpacingDefinition();
	    ...
	    CardElementContainer.prototype.internalValidateProperties = function (context) {
	        ...
	        for (var i = 0; i < this.getItemCount(); i++) {
	            ...
	            if (!this.hostConfig.supportsInteractivity && item.isInteractive) {
	                context.addFailure(this, Enums$1.ValidationEvent.InteractivityNotAllowed, strings_1$1.Strings.errors.interactivityNotAllowed());
	            }
	            if (!this.isElementAllowed(item)) {
	                context.addFailure(this, Enums$1.ValidationEvent.InteractivityNotAllowed, strings_1$1.Strings.errors.elementTypeNotAllowed(item.getJsonTypeName()));
	            }
	    ...
	    CardElementContainer.selectActionProperty = new ActionProperty(serialization_1$1.Versions.v1_1, "selectAction", ["Action.ShowCard"]);
	    __decorate([
	        serialization_1$1.property(CardElementContainer.selectActionProperty)
	...
	var ImageSet = /** @class */ (function (_super) {
	    ...
	    function ImageSet() {
	        ...
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this._images = [];
	        _this.imageSize = Enums$1.ImageSize.Medium;
	        return _this;
	    }
	    //#endregion
	        ...
	        if (this._images.length > 0) {
	            ...
	            for (var _i = 0, _a = this._images; _i < _a.length; _i++) {
	                ...
	                switch (this.imageSize) {
	                    case Enums$1.ImageSize.Small:
	                        image.size = Enums$1.Size.Small;
	                        break;
	                    case Enums$1.ImageSize.Large:
	                        image.size = Enums$1.Size.Large;
	                        break;
	                    default:
	                        image.size = Enums$1.Size.Medium;
	                        break;
	                }
	                ...
	                if (renderedImage) {
	                    ...
	                    Utils$1.appendChild(element, renderedImage);
	                }
	            }
	        }
	        return element;
	    ...
	    ImageSet.imagesProperty = new serialization_1$1.SerializableObjectCollectionProperty(serialization_1$1.Versions.v1_0, "images", Image, function (sender, item) { item.setParent(sender); });
	    ImageSet.imageSizeProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "imageSize", Enums$1.ImageSize, Enums$1.ImageSize.Medium);
	    __decorate([
	        serialization_1$1.property(ImageSet.imagesProperty)
	    ], ImageSet.prototype, "_images", void 0);
	    __decorate([
	        serialization_1$1.property(ImageSet.imageSizeProperty)
	...
	var MediaSource = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    MediaSource.mimeTypeProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_1, "mimeType");
	    MediaSource.urlProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_1, "url");
	    __decorate([
	        serialization_1$1.property(MediaSource.mimeTypeProperty)
	    ], MediaSource.prototype, "mimeType", void 0);
	    __decorate([
	        serialization_1$1.property(MediaSource.urlProperty)
	...
	var Media = /** @class */ (function (_super) {
	    ...
	    Media.prototype.renderPoster = function () {
	        ...
	        posterRootElement.setAttribute("aria-label", this.altText ? this.altText : strings_1$1.Strings.defaults.mediaPlayerAriaLabel());
	        ...
	        if (this.hostConfig.supportsInteractivity && this._selectedSources.length > 0) {
	            ...
	            playButtonOuterElement.setAttribute("aria-label", strings_1$1.Strings.defaults.mediaPlayerPlayMedia());
	    ...
	    Media.prototype.renderMediaPlayer = function () {
	        ...
	        mediaElement.setAttribute("aria-label", this.altText ? this.altText : strings_1$1.Strings.defaults.mediaPlayerAriaLabel());
	        mediaElement.setAttribute("webkit-playsinline", "");
	        mediaElement.setAttribute("playsinline", "");
	        mediaElement.autoplay = true;
	        mediaElement.controls = true;
	        if (Utils$1.isMobileOS()) {
	        ...
	        for (var _i = 0, _a = this.sources; _i < _a.length; _i++) {
	            ...
	            Utils$1.appendChild(mediaElement, renderedSource);
	        }
	        return mediaElement;
	    };
	    ...
	    Media.sourcesProperty = new serialization_1$1.SerializableObjectCollectionProperty(serialization_1$1.Versions.v1_1, "sources", MediaSource);
	    Media.posterProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_1, "poster");
	    Media.altTextProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_1, "altText");
	    //#endregion
	    Media.supportedMediaTypes = ["audio", "video"];
	    __decorate([
	        serialization_1$1.property(Media.sourcesProperty)
	    ], Media.prototype, "sources", void 0);
	    __decorate([
	        serialization_1$1.property(Media.posterProperty)
	    ], Media.prototype, "poster", void 0);
	    __decorate([
	        serialization_1$1.property(Media.altTextProperty)
	...
	var Input = /** @class */ (function (_super) {
	    ...
	    Input.prototype.overrideInternalRender = function () {
	        ...
	        var renderedInputControlId = Utils$1.generateUniqueId();
	        if (this.label) {
	            ...
	            if (this._renderedLabelElement) {
	                this._renderedLabelElement.id = Utils$1.generateUniqueId();
	    ...
	    Input.prototype.showValidationErrorMessage = function () {
	        if (this.renderedElement && this.errorMessage && shared_1$1.GlobalSettings.displayInputValidationErrors) {
	            ...
	            if (this._renderedErrorMessageElement) {
	                this._renderedErrorMessageElement.id = Utils$1.generateUniqueId();
	    ...
	    Input.prototype.internalValidateProperties = function (context) {
	        _super.prototype.internalValidateProperties.call(this, context);
	        if (!this.id) {
	            context.addFailure(this, Enums$1.ValidationEvent.PropertyCantBeNull, strings_1$1.Strings.errors.inputsMustHaveUniqueId());
	        }
	        if (this.isRequired) {
	            if (!this.label) {
	                context.addFailure(this, Enums$1.ValidationEvent.RequiredInputsShouldHaveLabel, "Required inputs should have a label");
	            }
	            if (!this.errorMessage) {
	                context.addFailure(this, Enums$1.ValidationEvent.RequiredInputsShouldHaveErrorMessage, "Required inputs should have an error message");
	            }
	        }
	    };
	    ...
	    //#region Schema
	    Input.labelProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_3, "label", true);
	    Input.isRequiredProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_3, "isRequired", false);
	    Input.errorMessageProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_3, "errorMessage", true);
	    __decorate([
	        serialization_1$1.property(Input.labelProperty)
	    ], Input.prototype, "label", void 0);
	    __decorate([
	        serialization_1$1.property(Input.isRequiredProperty)
	    ], Input.prototype, "isRequired", void 0);
	    __decorate([
	        serialization_1$1.property(Input.errorMessageProperty)
	...
	var TextInput = /** @class */ (function (_super) {
	    ...
	    function TextInput() {
	        ...
	        _this.style = Enums$1.InputTextStyle.Text;
	        return _this;
	    }
	    //#endregion
	    ...
	    TextInput.prototype.internalRender = function () {
	        ...
	        if (this.isMultiline) {
	            ...
	            result.type = Enums$1.InputTextStyle[this.style].toLowerCase();
	        }
	        ...
	        if (this.inlineAction) {
	            ...
	            if (this.inlineAction.iconUrl) {
	                ...
	                icon_1.onerror = function () {
	                    ...
	                    button_1.textContent = _this.inlineAction && _this.inlineAction.title ? _this.inlineAction.title : strings_1$1.Strings.defaults.inlineActionTitle();
	                };
	                icon_1.src = this.inlineAction.iconUrl;
	                button_1.appendChild(icon_1);
	                button_1.title = this.inlineAction.title ? this.inlineAction.title : strings_1$1.Strings.defaults.inlineActionTitle();
	            }
	            else {
	                button_1.classList.add("textOnly");
	                button_1.textContent = this.inlineAction.title ? this.inlineAction.title : strings_1$1.Strings.defaults.inlineActionTitle();
	            }
	    ...
	    TextInput.valueProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "value");
	    TextInput.maxLengthProperty = new serialization_1$1.NumProperty(serialization_1$1.Versions.v1_0, "maxLength");
	    TextInput.isMultilineProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_0, "isMultiline", false);
	    TextInput.placeholderProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "placeholder");
	    TextInput.styleProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_0, "style", Enums$1.InputTextStyle, Enums$1.InputTextStyle.Text);
	    TextInput.inlineActionProperty = new ActionProperty(serialization_1$1.Versions.v1_0, "inlineAction", ["Action.ShowCard"]);
	    TextInput.regexProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_3, "regex", true);
	    __decorate([
	        serialization_1$1.property(TextInput.valueProperty)
	    ], TextInput.prototype, "defaultValue", void 0);
	    __decorate([
	        serialization_1$1.property(TextInput.maxLengthProperty)
	    ], TextInput.prototype, "maxLength", void 0);
	    __decorate([
	        serialization_1$1.property(TextInput.isMultilineProperty)
	    ], TextInput.prototype, "isMultiline", void 0);
	    __decorate([
	        serialization_1$1.property(TextInput.placeholderProperty)
	    ], TextInput.prototype, "placeholder", void 0);
	    __decorate([
	        serialization_1$1.property(TextInput.styleProperty)
	    ], TextInput.prototype, "style", void 0);
	    __decorate([
	        serialization_1$1.property(TextInput.inlineActionProperty)
	    ], TextInput.prototype, "inlineAction", void 0);
	    __decorate([
	        serialization_1$1.property(TextInput.regexProperty)
	...
	var ToggleInput = /** @class */ (function (_super) {
	    ...
	    ToggleInput.prototype.internalRender = function () {
	        ...
	        this._checkboxInputElement.id = Utils$1.generateUniqueId();
	        ...
	        Utils$1.appendChild(element, this._checkboxInputElement);
	        if (this.title || this.isDesignMode()) {
	            ...
	            label.useMarkdown = shared_1$1.GlobalSettings.useMarkdownInRadioButtonAndCheckbox;
	            label.wrap = this.wrap;
	            this._checkboxInputLabelElement = label.render();
	            if (this._checkboxInputLabelElement) {
	                this._checkboxInputLabelElement.id = Utils$1.generateUniqueId();
	                ...
	                Utils$1.appendChild(element, spacerElement);
	                Utils$1.appendChild(element, this._checkboxInputLabelElement);
	            }
	        }
	        return element;
	    };
	    ...
	    ToggleInput.valueProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "value");
	    ToggleInput.titleProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "title");
	    ToggleInput.valueOnProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "valueOn", true, undefined, "true", function (sender) { return "true"; });
	    ToggleInput.valueOffProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "valueOff", true, undefined, "false", function (sender) { return "false"; });
	    ToggleInput.wrapProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_2, "wrap", false);
	    __decorate([
	        serialization_1$1.property(ToggleInput.valueProperty)
	    ], ToggleInput.prototype, "defaultValue", void 0);
	    __decorate([
	        serialization_1$1.property(ToggleInput.titleProperty)
	    ], ToggleInput.prototype, "title", void 0);
	    __decorate([
	        serialization_1$1.property(ToggleInput.valueOnProperty)
	    ], ToggleInput.prototype, "valueOn", void 0);
	    __decorate([
	        serialization_1$1.property(ToggleInput.valueOffProperty)
	    ], ToggleInput.prototype, "valueOff", void 0);
	    __decorate([
	        serialization_1$1.property(ToggleInput.wrapProperty)
	...
	var Choice = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    Choice.titleProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "title");
	    Choice.valueProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "value");
	    __decorate([
	        serialization_1$1.property(Choice.titleProperty)
	    ], Choice.prototype, "title", void 0);
	    __decorate([
	        serialization_1$1.property(Choice.valueProperty)
	...
	var ChoiceSetInput = /** @class */ (function (_super) {
	    ...
	    ChoiceSetInput.prototype.renderCompoundInput = function (cssClassName, type, defaultValues) {
	        ...
	        for (var _i = 0, _a = this.choices; _i < _a.length; _i++) {
	            ...
	            input.id = Utils$1.generateUniqueId();
	            input.type = type;
	            ...
	            Utils$1.appendChild(compoundInput, input);
	            var label = new TextBlock();
	            label.setParent(this);
	            ...
	            if (labelElement) {
	                labelElement.id = Utils$1.generateUniqueId();
	                ...
	                var spacerElement = document.createElement("div");
	                spacerElement.style.width = "6px";
	                Utils$1.appendChild(compoundInput, spacerElement);
	                Utils$1.appendChild(compoundInput, labelElement);
	            }
	            Utils$1.appendChild(element, compoundInput);
	        }
	        return element;
	    };
	    ...
	    ChoiceSetInput.prototype.internalRender = function () {
	        ...
	        if (this.isMultiSelect) {
	            ...
	            if (this.style === "expanded") {
	                ...
	                Utils$1.appendChild(this._selectElement, option);
	                for (var _i = 0, _a = this.choices; _i < _a.length; _i++) {
	                    var choice = _a[_i];
	                    ...
	                    Utils$1.appendChild(this._selectElement, option_1);
	                }
	    ...
	    ChoiceSetInput.prototype.internalValidateProperties = function (context) {
	        ...
	        if (this.choices.length == 0) {
	            context.addFailure(this, Enums$1.ValidationEvent.CollectionCantBeEmpty, strings_1$1.Strings.errors.choiceSetMustHaveAtLeastOneChoice());
	        }
	        for (var _i = 0, _a = this.choices; _i < _a.length; _i++) {
	            var choice = _a[_i];
	            if (!choice.title || !choice.value) {
	                context.addFailure(this, Enums$1.ValidationEvent.PropertyCantBeNull, strings_1$1.Strings.errors.choiceSetChoicesMustHaveTitleAndValue());
	            }
	        }
	    };
	    ...
	    ChoiceSetInput.valueProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "value");
	    ChoiceSetInput.choicesProperty = new serialization_1$1.SerializableObjectCollectionProperty(serialization_1$1.Versions.v1_0, "choices", Choice);
	    ChoiceSetInput.styleProperty = new serialization_1$1.ValueSetProperty(serialization_1$1.Versions.v1_0, "style", [
	        { value: "compact" },
	        { value: "expanded" }
	    ], "compact");
	    ChoiceSetInput.isMultiSelectProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_0, "isMultiSelect", false);
	    ChoiceSetInput.placeholderProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "placeholder");
	    ChoiceSetInput.wrapProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_2, "wrap", false);
	    //#endregion
	    ChoiceSetInput.uniqueCategoryCounter = 0;
	    __decorate([
	        serialization_1$1.property(ChoiceSetInput.valueProperty)
	    ], ChoiceSetInput.prototype, "defaultValue", void 0);
	    __decorate([
	        serialization_1$1.property(ChoiceSetInput.styleProperty)
	    ], ChoiceSetInput.prototype, "style", void 0);
	    __decorate([
	        serialization_1$1.property(ChoiceSetInput.isMultiSelectProperty)
	    ], ChoiceSetInput.prototype, "isMultiSelect", void 0);
	    __decorate([
	        serialization_1$1.property(ChoiceSetInput.placeholderProperty)
	    ], ChoiceSetInput.prototype, "placeholder", void 0);
	    __decorate([
	        serialization_1$1.property(ChoiceSetInput.wrapProperty)
	    ], ChoiceSetInput.prototype, "wrap", void 0);
	    __decorate([
	        serialization_1$1.property(ChoiceSetInput.choicesProperty)
	...
	var NumberInput = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    NumberInput.valueProperty = new serialization_1$1.NumProperty(serialization_1$1.Versions.v1_0, "value");
	    NumberInput.placeholderProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "placeholder");
	    NumberInput.minProperty = new serialization_1$1.NumProperty(serialization_1$1.Versions.v1_0, "min");
	    NumberInput.maxProperty = new serialization_1$1.NumProperty(serialization_1$1.Versions.v1_0, "max");
	    __decorate([
	        serialization_1$1.property(NumberInput.valueProperty)
	    ], NumberInput.prototype, "defaultValue", void 0);
	    __decorate([
	        serialization_1$1.property(NumberInput.minProperty)
	    ], NumberInput.prototype, "min", void 0);
	    __decorate([
	        serialization_1$1.property(NumberInput.maxProperty)
	    ], NumberInput.prototype, "max", void 0);
	    __decorate([
	        serialization_1$1.property(NumberInput.placeholderProperty)
	...
	var DateInput = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    DateInput.valueProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "value");
	    DateInput.placeholderProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "placeholder");
	    DateInput.minProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "min");
	    DateInput.maxProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "max");
	    __decorate([
	        serialization_1$1.property(DateInput.valueProperty)
	    ], DateInput.prototype, "defaultValue", void 0);
	    __decorate([
	        serialization_1$1.property(DateInput.minProperty)
	    ], DateInput.prototype, "min", void 0);
	    __decorate([
	        serialization_1$1.property(DateInput.maxProperty)
	    ], DateInput.prototype, "max", void 0);
	    __decorate([
	        serialization_1$1.property(DateInput.placeholderProperty)
	...
	var TimeProperty = /** @class */ (function (_super) {
	    ...
	    return TimeProperty;
	}(serialization_1$1.CustomProperty));
	cardElements.TimeProperty = TimeProperty;
	var TimeInput = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    TimeInput.valueProperty = new TimeProperty(serialization_1$1.Versions.v1_0, "value");
	    TimeInput.placeholderProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "placeholder");
	    TimeInput.minProperty = new TimeProperty(serialization_1$1.Versions.v1_0, "min");
	    TimeInput.maxProperty = new TimeProperty(serialization_1$1.Versions.v1_0, "max");
	    __decorate([
	        serialization_1$1.property(TimeInput.valueProperty)
	    ], TimeInput.prototype, "defaultValue", void 0);
	    __decorate([
	        serialization_1$1.property(TimeInput.minProperty)
	    ], TimeInput.prototype, "min", void 0);
	    __decorate([
	        serialization_1$1.property(TimeInput.maxProperty)
	    ], TimeInput.prototype, "max", void 0);
	    __decorate([
	        serialization_1$1.property(TimeInput.placeholderProperty)
	    ...
	    ActionButton.prototype.updateCssStyle = function () {
	        ...
	        if (this.action.parent && this.action.renderedElement) {
	            ...
	            if (this.action.style) {
	                if (this.action.style === Enums$1.ActionStyle.Positive) {
	...
	var Action = /** @class */ (function (_super) {
	    ...
	    function Action() {
	        //#region Schema
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.style = Enums$1.ActionStyle.Default;
	        return _this;
	    }
	    ...
	    Action.prototype.render = function (baseCssClass) {
	        ...
	        if (!(hostConfig.actions.iconPlacement == Enums$1.ActionIconPlacement.AboveTitle || hostConfig.actions.allowTitleToWrap)) {
	        ...
	        if (!this.iconUrl) {
	            ...
	            if (hostConfig.actions.iconPlacement == Enums$1.ActionIconPlacement.AboveTitle) {
	    ...
	    Object.defineProperty(Action.prototype, "isPrimary", {
	        get: function () {
	            return this.style == Enums$1.ActionStyle.Positive;
	        },
	        set: function (value) {
	            if (value) {
	                this.style = Enums$1.ActionStyle.Positive;
	            }
	            else {
	                if (this.style == Enums$1.ActionStyle.Positive) {
	                    this.style = Enums$1.ActionStyle.Default;
	                }
	            }
	        },
	        enumerable: false,
	    ...
	    Action.titleProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "title");
	    Action.iconUrlProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_1, "iconUrl");
	    Action.styleProperty = new serialization_1$1.ValueSetProperty(serialization_1$1.Versions.v1_2, "style", [
	        { value: Enums$1.ActionStyle.Default },
	        { value: Enums$1.ActionStyle.Positive },
	        { value: Enums$1.ActionStyle.Destructive }
	    ], Enums$1.ActionStyle.Default);
	    __decorate([
	        serialization_1$1.property(Action.titleProperty)
	    ], Action.prototype, "title", void 0);
	    __decorate([
	        serialization_1$1.property(Action.iconUrlProperty)
	    ], Action.prototype, "iconUrl", void 0);
	    __decorate([
	        serialization_1$1.property(Action.styleProperty)
	...
	var SubmitActionBase = /** @class */ (function (_super) {
	    ...
	    SubmitActionBase.dataProperty = new serialization_1$1.PropertyDefinition(serialization_1$1.Versions.v1_0, "data");
	    SubmitActionBase.associatedInputsProperty = new serialization_1$1.CustomProperty(serialization_1$1.Versions.v1_3, "associatedInputs", function (sender, property, source, context) {
	        var value = source[property.name];
	    ...
	    __decorate([
	        serialization_1$1.property(SubmitActionBase.dataProperty)
	    ], SubmitActionBase.prototype, "_originalData", void 0);
	    __decorate([
	        serialization_1$1.property(SubmitActionBase.associatedInputsProperty)
	    ], SubmitActionBase.prototype, "associatedInputs", void 0);
	    return SubmitActionBase;
	}(Action));
	cardElements.SubmitActionBase = SubmitActionBase;
	...
	var ExecuteAction = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    ExecuteAction.verbProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "verb");
	    __decorate([
	        serialization_1$1.property(ExecuteAction.verbProperty)
	    ], ExecuteAction.prototype, "verb", void 0);
	    return ExecuteAction;
	}(SubmitActionBase));
	cardElements.ExecuteAction = ExecuteAction;
	var OpenUrlAction = /** @class */ (function (_super) {
	    ...
	    OpenUrlAction.prototype.internalValidateProperties = function (context) {
	        _super.prototype.internalValidateProperties.call(this, context);
	        if (!this.url) {
	            context.addFailure(this, Enums$1.ValidationEvent.PropertyCantBeNull, strings_1$1.Strings.errors.propertyMustBeSet("url"));
	        }
	    };
	    ...
	    //#region Schema
	    OpenUrlAction.urlProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "url");
	    //#endregion
	    // Note the "weird" way this field is declared is to work around a breaking
	    // change introduced in TS 3.1 wrt d.ts generation. DO NOT CHANGE
	    OpenUrlAction.JsonTypeName = "Action.OpenUrl";
	    __decorate([
	        serialization_1$1.property(OpenUrlAction.urlProperty)
	...
	var ToggleVisibilityAction = /** @class */ (function (_super) {
	    ...
	    ToggleVisibilityAction.prototype.internalValidateProperties = function (context) {
	        _super.prototype.internalValidateProperties.call(this, context);
	        if (!this.targetElements) {
	            context.addFailure(this, Enums$1.ValidationEvent.PropertyCantBeNull, strings_1$1.Strings.errors.propertyMustBeSet("targetElements"));
	        }
	    };
	    ...
	    ToggleVisibilityAction.targetElementsProperty = new serialization_1$1.CustomProperty(serialization_1$1.Versions.v1_2, "targetElements", function (sender, property, source, context) {
	        var result = {};
	            ...
	            for (var _i = 0, _a = source[property.name]; _i < _a.length; _i++) {
	                ...
	                if (typeof item === "string") {
	                    ...
	                    if (typeof elementId === "string") {
	                        result[elementId] = Utils$1.parseBool(item["isVisible"]);
	                    }
	                }
	            }
	        }
	    ...
	    __decorate([
	        serialization_1$1.property(ToggleVisibilityAction.targetElementsProperty)
	...
	var StringWithSubstitutionProperty = /** @class */ (function (_super) {
	    ...
	    function StringWithSubstitutionProperty(targetVersion, name) {
	        var _this = _super.call(this, targetVersion, name, undefined, function () { return new shared_1$1.StringWithSubstitutions(); }) || this;
	        _this.targetVersion = targetVersion;
	        _this.name = name;
	        return _this;
	    }
	    StringWithSubstitutionProperty.prototype.parse = function (sender, source, context) {
	        var result = new shared_1$1.StringWithSubstitutions();
	        result.set(Utils$1.parseString(source[this.name]));
	        return result;
	    };
	...
	var HttpHeader = /** @class */ (function (_super) {
	    ...
	    HttpHeader.prototype.prepareForExecution = function (inputs) {
	        this._value.substituteInputValues(inputs, shared_1$1.ContentTypes.applicationXWwwFormUrlencoded);
	    };
	    ...
	    //#region Schema
	    HttpHeader.nameProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "name");
	    HttpHeader.valueProperty = new StringWithSubstitutionProperty(serialization_1$1.Versions.v1_0, "value");
	    __decorate([
	        serialization_1$1.property(HttpHeader.nameProperty)
	    ], HttpHeader.prototype, "name", void 0);
	    __decorate([
	        serialization_1$1.property(HttpHeader.valueProperty)
	...
	var HttpAction = /** @class */ (function (_super) {
	    ...
	    HttpAction.prototype.internalPrepareForExecution = function (inputs) {
	        if (inputs) {
	            this._url.substituteInputValues(inputs, shared_1$1.ContentTypes.applicationXWwwFormUrlencoded);
	            var contentType = shared_1$1.ContentTypes.applicationJson;
	            for (var _i = 0, _a = this.headers; _i < _a.length; _i++) {
	                var header = _a[_i];
	    ...
	    HttpAction.prototype.internalValidateProperties = function (context) {
	        ...
	        if (this.headers.length > 0) {
	            for (var _i = 0, _a = this.headers; _i < _a.length; _i++) {
	                var header = _a[_i];
	                if (!header.name) {
	                    context.addFailure(this, Enums$1.ValidationEvent.PropertyCantBeNull, strings_1$1.Strings.errors.actionHttpHeadersMustHaveNameAndValue());
	                }
	            }
	        }
	    };
	    ...
	    HttpAction.urlProperty = new StringWithSubstitutionProperty(serialization_1$1.Versions.v1_0, "url");
	    HttpAction.bodyProperty = new StringWithSubstitutionProperty(serialization_1$1.Versions.v1_0, "body");
	    HttpAction.methodProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "method");
	    HttpAction.headersProperty = new serialization_1$1.SerializableObjectCollectionProperty(serialization_1$1.Versions.v1_0, "headers", HttpHeader);
	    HttpAction.ignoreInputValidationProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_3, "ignoreInputValidation", false);
	    //#endregion
	    // Note the "weird" way this field is declared is to work around a breaking
	    // change introduced in TS 3.1 wrt d.ts generation. DO NOT CHANGE
	    HttpAction.JsonTypeName = "Action.Http";
	    __decorate([
	        serialization_1$1.property(HttpAction.urlProperty)
	    ], HttpAction.prototype, "_url", void 0);
	    __decorate([
	        serialization_1$1.property(HttpAction.bodyProperty)
	    ], HttpAction.prototype, "_body", void 0);
	    __decorate([
	        serialization_1$1.property(HttpAction.methodProperty)
	    ], HttpAction.prototype, "method", void 0);
	    __decorate([
	        serialization_1$1.property(HttpAction.headersProperty)
	    ], HttpAction.prototype, "headers", void 0);
	    __decorate([
	        serialization_1$1.property(HttpAction.ignoreInputValidationProperty)
	...
	var ShowCardAction = /** @class */ (function (_super) {
	    ...
	    ShowCardAction.prototype.internalParse = function (source, context) {
	        ...
	        if (jsonCard) {
	            ...
	            context.logParseEvent(this, Enums$1.ValidationEvent.PropertyCantBeNull, strings_1$1.Strings.errors.showCardMustHaveCard());
	        }
	    };
	    ...
	    ShowCardAction.prototype.raiseExecuteActionEvent = function () {
	        if (this.hostConfig.actions.showCard.actionMode === Enums$1.ShowCardActionMode.Popup) {
	...
	var ActionCollection = /** @class */ (function () {
	    ...
	    ActionCollection.prototype.refreshContainer = function () {
	        ...
	        if (this._actionCard) {
	            ...
	            Utils$1.appendChild(this._actionCardContainer, this._actionCard);
	        }
	    };
	    ...
	    ActionCollection.prototype.validateProperties = function (context) {
	        if (this._owner.hostConfig.actions.maxActions && this.items.length > this._owner.hostConfig.actions.maxActions) {
	            context.addFailure(this._owner, Enums$1.ValidationEvent.TooManyActions, strings_1$1.Strings.errors.tooManyActions(this._owner.hostConfig.actions.maxActions));
	        }
	        if (this.items.length > 0 && !this._owner.hostConfig.supportsInteractivity) {
	            context.addFailure(this._owner, Enums$1.ValidationEvent.InteractivityNotAllowed, strings_1$1.Strings.errors.interactivityNotAllowed());
	        }
	        for (var _i = 0, _a = this.items; _i < _a.length; _i++) {
	            var item = _a[_i];
	            if (!this.isActionAllowed(item)) {
	                context.addFailure(this._owner, Enums$1.ValidationEvent.ActionTypeNotAllowed, strings_1$1.Strings.errors.actionTypeNotAllowed(item.getJsonTypeName()));
	            }
	            item.internalValidateProperties(context);
	        }
	    };
	    ActionCollection.prototype.render = function (orientation, isDesignMode) {
	        ...
	        if (hostConfig.actions.preExpandSingleShowCardAction && maxActions == 1 && this.items[0] instanceof ShowCardAction && this.isActionAllowed(this.items[0])) {
	            ...
	            if (orientation == Enums$1.Orientation.Horizontal) {
	                buttonStrip.style.flexDirection = "row";
	                if (this._owner.horizontalAlignment && hostConfig.actions.actionAlignment != Enums$1.ActionAlignment.Stretch) {
	                    ...
	                    switch (hostConfig.actions.actionAlignment) {
	                        case Enums$1.ActionAlignment.Center:
	                            buttonStrip.style.justifyContent = "center";
	                            break;
	                        case Enums$1.ActionAlignment.Right:
	                            buttonStrip.style.justifyContent = "flex-end";
	                            break;
	                        default:
	                            buttonStrip.style.justifyContent = "flex-start";
	                ...
	                if (this._owner.horizontalAlignment && hostConfig.actions.actionAlignment != Enums$1.ActionAlignment.Stretch) {
	                    ...
	                    switch (hostConfig.actions.actionAlignment) {
	                        ...
	                        case Enums$1.ActionAlignment.Right:
	                            buttonStrip.style.alignItems = "flex-end";
	                            break;
	                        case Enums$1.ActionAlignment.Stretch:
	            ...
	            if (parentContainer) {
	                ...
	                for (var i = 0; i < allowedActions.length; i++) {
	                    ...
	                    if (actionButton.action.renderedElement) {
	                        ...
	                        if (hostConfig.actions.actionsOrientation == Enums$1.Orientation.Horizontal && hostConfig.actions.actionAlignment == Enums$1.ActionAlignment.Stretch) {
	                        ...
	                        if (this._renderedActionCount >= hostConfig.actions.maxActions || i == this.items.length - 1) {
	                            ...
	                            Utils$1.appendChild(buttonStrip, spacer);
	                        }
	                    }
	                }
	            }
	            ...
	            Utils$1.appendChild(element, buttonStripContainer);
	        }
	        Utils$1.appendChild(element, this._actionCardContainer);
	        for (var _i = 0, _a = this.buttons; _i < _a.length; _i++) {
	            var button = _a[_i];
	    ...
	    ActionCollection.prototype.addAction = function (action) {
	        ...
	        if ((!action.parent || action.parent === this._owner) && this.items.indexOf(action) < 0) {
	            ...
	            throw new Error(strings_1$1.Strings.errors.actionAlreadyParented());
	        }
	    };
	...
	var ActionSet = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    ActionSet.orientationProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_1, "orientation", Enums$1.Orientation);
	    __decorate([
	        serialization_1$1.property(ActionSet.orientationProperty)
	...
	var StylableCardElementContainer = /** @class */ (function (_super) {
	    ...
	    StylableCardElementContainer.prototype.applyBackground = function () {
	        if (this.renderedElement) {
	            ...
	            if (styleDefinition.backgroundColor) {
	                var bgColor = Utils$1.stringToCssColor(styleDefinition.backgroundColor);
	    ...
	    StylableCardElementContainer.prototype.getDefaultPadding = function () {
	        return this.getHasBackground() ?
	            new shared_1$1.PaddingDefinition(Enums$1.Spacing.Padding, Enums$1.Spacing.Padding, Enums$1.Spacing.Padding, Enums$1.Spacing.Padding) : _super.prototype.getDefaultPadding.call(this);
	    };
	    ...
	    StylableCardElementContainer.prototype.internalValidateProperties = function (context) {
	        ...
	        if (explicitStyle !== undefined) {
	            ...
	            if (!styleDefinition) {
	                context.addFailure(this, Enums$1.ValidationEvent.InvalidPropertyValue, strings_1$1.Strings.errors.invalidPropertyValue(explicitStyle, "style"));
	            }
	        }
	    };
	    ...
	    StylableCardElementContainer.styleProperty = new serialization_1$1.ValueSetProperty(serialization_1$1.Versions.v1_0, "style", [
	        { value: Enums$1.ContainerStyle.Default },
	        { value: Enums$1.ContainerStyle.Emphasis },
	        { targetVersion: serialization_1$1.Versions.v1_2, value: Enums$1.ContainerStyle.Accent },
	        { targetVersion: serialization_1$1.Versions.v1_2, value: Enums$1.ContainerStyle.Good },
	        { targetVersion: serialization_1$1.Versions.v1_2, value: Enums$1.ContainerStyle.Attention },
	        { targetVersion: serialization_1$1.Versions.v1_2, value: Enums$1.ContainerStyle.Warning }
	    ]);
	    StylableCardElementContainer.bleedProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_2, "bleed", false);
	    StylableCardElementContainer.minHeightProperty = new serialization_1$1.PixelSizeProperty(serialization_1$1.Versions.v1_2, "minHeight");
	    __decorate([
	        serialization_1$1.property(StylableCardElementContainer.styleProperty)
	    ], StylableCardElementContainer.prototype, "style", null);
	    __decorate([
	        serialization_1$1.property(StylableCardElementContainer.bleedProperty)
	    ], StylableCardElementContainer.prototype, "_bleed", void 0);
	    __decorate([
	        serialization_1$1.property(StylableCardElementContainer.minHeightProperty)
	...
	var BackgroundImage = /** @class */ (function (_super) {
	    ...
	    BackgroundImage.prototype.apply = function (element) {
	        if (this.url && element.renderedElement) {
	            ...
	            switch (this.fillMode) {
	                case Enums$1.FillMode.Repeat:
	                    element.renderedElement.style.backgroundRepeat = "repeat";
	                    break;
	                case Enums$1.FillMode.RepeatHorizontally:
	                    element.renderedElement.style.backgroundRepeat = "repeat-x";
	                    break;
	                case Enums$1.FillMode.RepeatVertically:
	                    element.renderedElement.style.backgroundRepeat = "repeat-y";
	                    break;
	                case Enums$1.FillMode.Cover:
	                default:
	            ...
	            switch (this.verticalAlignment) {
	                case Enums$1.VerticalAlignment.Center:
	                    element.renderedElement.style.backgroundPositionY = "center";
	                    break;
	                case Enums$1.VerticalAlignment.Bottom:
	    ...
	    //#region Schema
	    BackgroundImage.urlProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "url");
	    BackgroundImage.fillModeProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_2, "fillMode", Enums$1.FillMode, Enums$1.FillMode.Cover);
	    BackgroundImage.horizontalAlignmentProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_2, "horizontalAlignment", Enums$1.HorizontalAlignment, Enums$1.HorizontalAlignment.Left);
	    BackgroundImage.verticalAlignmentProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_2, "verticalAlignment", Enums$1.VerticalAlignment, Enums$1.VerticalAlignment.Top);
	    __decorate([
	        serialization_1$1.property(BackgroundImage.urlProperty)
	    ], BackgroundImage.prototype, "url", void 0);
	    __decorate([
	        serialization_1$1.property(BackgroundImage.fillModeProperty)
	    ], BackgroundImage.prototype, "fillMode", void 0);
	    __decorate([
	        serialization_1$1.property(BackgroundImage.horizontalAlignmentProperty)
	    ], BackgroundImage.prototype, "horizontalAlignment", void 0);
	    __decorate([
	        serialization_1$1.property(BackgroundImage.verticalAlignmentProperty)
	...
	var Container = /** @class */ (function (_super) {
	    ...
	    function Container() {
	        //#region Schema
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.verticalContentAlignment = Enums$1.VerticalAlignment.Top;
	        //#endregion
	        _this._items = [];
	    ...
	    Container.prototype.insertItemAt = function (item, index, forceInsert) {
	        if (!item.parent || forceInsert) {
	            if (item.isStandalone) {
	                ...
	                throw new Error(strings_1$1.Strings.errors.elementTypeNotStandalone(item.getJsonTypeName()));
	            }
	        }
	        else {
	            throw new Error(strings_1$1.Strings.errors.elementAlreadyParented());
	        }
	    };
	    ...
	    Container.prototype.internalRender = function () {
	        ...
	        if (shared_1$1.GlobalSettings.useAdvancedCardBottomTruncation) {
	            ...
	            for (var _i = 0, _a = this._items; _i < _a.length; _i++) {
	                ...
	                if (renderedItem) {
	                    if (this._renderedItems.length > 0 && item.separatorElement) {
	                        ...
	                        Utils$1.appendChild(element, item.separatorElement);
	                    }
	                    Utils$1.appendChild(element, renderedItem);
	    ...
	    Container.prototype.truncateOverflow = function (maxHeight) {
	        if (this.renderedElement) {
	            ...
	            var handleElement_1 = function (cardElement) {
	                ...
	                if (elt) {
	                    switch (Utils$1.getFitStatus(elt, boundary_1)) {
	                        case Enums$1.ContainerFitStatus.FullyInContainer:
	                            ...
	                            break;
	                        case Enums$1.ContainerFitStatus.Overflowing:
	                            var maxHeight_1 = boundary_1 - elt.offsetTop;
	                            cardElement['handleOverflow'](maxHeight_1);
	                            break;
	                        case Enums$1.ContainerFitStatus.FullyOutOfContainer:
	    ...
	    Container.backgroundImageProperty = new serialization_1$1.SerializableObjectProperty(serialization_1$1.Versions.v1_0, "backgroundImage", BackgroundImage);
	    Container.verticalContentAlignmentProperty = new serialization_1$1.EnumProperty(serialization_1$1.Versions.v1_1, "verticalContentAlignment", Enums$1.VerticalAlignment, Enums$1.VerticalAlignment.Top);
	    Container.rtlProperty = new serialization_1$1.BoolProperty(serialization_1$1.Versions.v1_0, "rtl");
	    __decorate([
	        serialization_1$1.property(Container.backgroundImageProperty)
	    ], Container.prototype, "backgroundImage", null);
	    __decorate([
	        serialization_1$1.property(Container.verticalContentAlignmentProperty)
	    ], Container.prototype, "verticalContentAlignment", void 0);
	    __decorate([
	        serialization_1$1.property(Container.rtlProperty)
	...
	var Column = /** @class */ (function (_super) {
	    ...
	    Column.prototype.adjustRenderedElementSize = function (renderedElement) {
	        ...
	        else if (this.width instanceof shared_1$1.SizeAndUnit) {
	            if (this.width.unit == Enums$1.SizeUnit.Pixel) {
	                renderedElement.style.flex = "0 0 auto";
	    ...
	    Object.defineProperty(Column.prototype, "separatorOrientation", {
	        get: function () {
	            return Enums$1.Orientation.Vertical;
	        },
	        enumerable: false,
	        configurable: true
	    });
	    ...
	    //#region Schema
	    Column.widthProperty = new serialization_1$1.CustomProperty(serialization_1$1.Versions.v1_0, "width", function (sender, property, source, context) {
	        var result = property.defaultValue;
	        var value = source[property.name];
	        var invalidWidth = false;
	        if (typeof value === "number" && !isNaN(value)) {
	            result = new shared_1$1.SizeAndUnit(value, Enums$1.SizeUnit.Weight);
	        }
	            ...
	            try {
	                result = shared_1$1.SizeAndUnit.parse(value);
	                if (result.unit === Enums$1.SizeUnit.Pixel && property.targetVersion.compareTo(context.targetVersion) > 0) {
	                    invalidWidth = true;
	                }
	            }
	            catch (e) {
	        ...
	        if (invalidWidth) {
	            context.logParseEvent(sender, Enums$1.ValidationEvent.InvalidPropertyValue, strings_1$1.Strings.errors.invalidColumnWidth(value));
	            result = "auto";
	        }
	        return result;
	    }, function (sender, property, target, value, context) {
	        if (value instanceof shared_1$1.SizeAndUnit) {
	            if (value.unit === Enums$1.SizeUnit.Pixel) {
	    ...
	    __decorate([
	        serialization_1$1.property(Column.widthProperty)
	...
	var ColumnSet = /** @class */ (function (_super) {
	    ...
	    ColumnSet.prototype.createColumnInstance = function (source, context) {
	        ...
	        !this.isDesignMode(), function (typeName) {
	            ...
	            context.logParseEvent(undefined, Enums$1.ValidationEvent.ElementTypeNotAllowed, strings_1$1.Strings.errors.elementTypeNotAllowed(typeName));
	        });
	    };
	    ColumnSet.prototype.internalRender = function () {
	        ...
	        if (this._columns.length > 0) {
	            ...
	            for (var _i = 0, _a = this._columns; _i < _a.length; _i++) {
	                var column = _a[_i];
	                if (column.width instanceof shared_1$1.SizeAndUnit && (column.width.unit == Enums$1.SizeUnit.Weight)) {
	                    totalWeight += column.width.physicalSize;
	                }
	            }
	            for (var _b = 0, _c = this._columns; _b < _c.length; _b++) {
	                var column = _c[_b];
	                if (column.width instanceof shared_1$1.SizeAndUnit && column.width.unit == Enums$1.SizeUnit.Weight && totalWeight > 0) {
	                ...
	                if (renderedColumn) {
	                    if (this._renderedColumns.length > 0 && column.separatorElement) {
	                        ...
	                        Utils$1.appendChild(element, column.separatorElement);
	                    }
	                    Utils$1.appendChild(element, renderedColumn);
	    ...
	    ColumnSet.prototype.internalValidateProperties = function (context) {
	        ...
	        if (weightedColumns > 0 && stretchedColumns > 0) {
	            context.addFailure(this, Enums$1.ValidationEvent.Hint, strings_1$1.Strings.hints.dontUseWeightedAndStrecthedColumnsInSameSet());
	        }
	    };
	    ColumnSet.prototype.addColumn = function (column) {
	        if (!column.parent) {
	            ...
	            throw new Error(strings_1$1.Strings.errors.columnAlreadyBelongsToAnotherSet());
	        }
	    };
	...
	var ContainerWithActions = /** @class */ (function (_super) {
	    ...
	    ContainerWithActions.prototype.internalRender = function () {
	        ...
	        if (element) {
	            ...
	            if (renderedActions) {
	                Utils$1.appendChild(element, Utils$1.renderSeparation(this.hostConfig, {
	                    spacing: this.hostConfig.getEffectiveSpacing(this.hostConfig.actions.spacing)
	                }, Enums$1.Orientation.Horizontal));
	                Utils$1.appendChild(element, renderedActions);
	            }
	...
	var RefreshActionProperty = /** @class */ (function (_super) {
	    ...
	    RefreshActionProperty.prototype.parse = function (sender, source, context) {
	        ...
	        if (action !== undefined) {
	            ...
	            context.logParseEvent(sender, Enums$1.ValidationEvent.ActionTypeNotAllowed, strings_1$1.Strings.errors.actionTypeNotAllowed(action.getJsonTypeName()));
	        }
	        context.logParseEvent(sender, Enums$1.ValidationEvent.PropertyCantBeNull, strings_1$1.Strings.errors.propertyMustBeSet("action"));
	        return undefined;
	    };
	...
	cardElements.RefreshActionProperty = RefreshActionProperty;
	var RefreshDefinition = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    RefreshDefinition.actionProperty = new RefreshActionProperty(serialization_1$1.Versions.v1_4, "action");
	    RefreshDefinition.userIdsProperty = new serialization_1$1.StringArrayProperty(serialization_1$1.Versions.v1_4, "userIds");
	    __decorate([
	        serialization_1$1.property(RefreshDefinition.actionProperty)
	    ], RefreshDefinition.prototype, "action", null);
	    __decorate([
	        serialization_1$1.property(RefreshDefinition.userIdsProperty)
	    ], RefreshDefinition.prototype, "userIds", void 0);
	    return RefreshDefinition;
	}(serialization_1$1.SerializableObject));
	cardElements.RefreshDefinition = RefreshDefinition;
	var AuthCardButton = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    AuthCardButton.typeProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "type");
	    AuthCardButton.titleProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "title");
	    AuthCardButton.imageProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "image");
	    AuthCardButton.valueProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "value");
	    __decorate([
	        serialization_1$1.property(AuthCardButton.typeProperty)
	    ], AuthCardButton.prototype, "type", void 0);
	    __decorate([
	        serialization_1$1.property(AuthCardButton.titleProperty)
	    ], AuthCardButton.prototype, "title", void 0);
	    __decorate([
	        serialization_1$1.property(AuthCardButton.imageProperty)
	    ], AuthCardButton.prototype, "image", void 0);
	    __decorate([
	        serialization_1$1.property(AuthCardButton.valueProperty)
	    ], AuthCardButton.prototype, "value", void 0);
	    return AuthCardButton;
	}(serialization_1$1.SerializableObject));
	cardElements.AuthCardButton = AuthCardButton;
	var TokenExchangeResource = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    TokenExchangeResource.idProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "id");
	    TokenExchangeResource.uriProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "uri");
	    TokenExchangeResource.providerIdProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "providerId");
	    __decorate([
	        serialization_1$1.property(TokenExchangeResource.idProperty)
	    ], TokenExchangeResource.prototype, "id", void 0);
	    __decorate([
	        serialization_1$1.property(TokenExchangeResource.uriProperty)
	    ], TokenExchangeResource.prototype, "uri", void 0);
	    __decorate([
	        serialization_1$1.property(TokenExchangeResource.providerIdProperty)
	    ], TokenExchangeResource.prototype, "providerId", void 0);
	    return TokenExchangeResource;
	}(serialization_1$1.SerializableObject));
	cardElements.TokenExchangeResource = TokenExchangeResource;
	var Authentication = /** @class */ (function (_super) {
	    ...
	    //#region Schema
	    Authentication.textProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "text");
	    Authentication.connectionNameProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_4, "connectionName");
	    Authentication.buttonsProperty = new serialization_1$1.SerializableObjectCollectionProperty(serialization_1$1.Versions.v1_4, "buttons", AuthCardButton);
	    Authentication.tokenExchangeResourceProperty = new serialization_1$1.SerializableObjectProperty(serialization_1$1.Versions.v1_4, "tokenExchangeResource", TokenExchangeResource, true);
	    __decorate([
	        serialization_1$1.property(Authentication.textProperty)
	    ], Authentication.prototype, "text", void 0);
	    __decorate([
	        serialization_1$1.property(Authentication.connectionNameProperty)
	    ], Authentication.prototype, "connectionName", void 0);
	    __decorate([
	        serialization_1$1.property(Authentication.buttonsProperty)
	    ], Authentication.prototype, "buttons", void 0);
	    __decorate([
	        serialization_1$1.property(Authentication.tokenExchangeResourceProperty)
	    ], Authentication.prototype, "tokenExchangeResource", void 0);
	    return Authentication;
	}(serialization_1$1.SerializableObject));
	cardElements.Authentication = Authentication;
	// @dynamic
	var AdaptiveCard = /** @class */ (function (_super) {
	    ...
	    Object.defineProperty(AdaptiveCard, "processMarkdown", {
	        get: function () {
	            throw new Error(strings_1$1.Strings.errors.processMarkdownEventRemoved());
	        },
	        set: function (value) {
	            throw new Error(strings_1$1.Strings.errors.processMarkdownEventRemoved());
	        },
	    ...
	    AdaptiveCard.applyMarkdown = function (text) {
	        ...
	        if (AdaptiveCard.onProcessMarkdown) {
	            ...
	            console.warn(strings_1$1.Strings.errors.markdownProcessingNotEnabled);
	        }
	        return result;
	    };
	    ...
	    AdaptiveCard.prototype.internalRender = function () {
	        ...
	        if (shared_1$1.GlobalSettings.useAdvancedCardBottomTruncation && renderedElement) {
	    ...
	    AdaptiveCard.prototype.getDefaultPadding = function () {
	        return new shared_1$1.PaddingDefinition(Enums$1.Spacing.Padding, Enums$1.Spacing.Padding, Enums$1.Spacing.Padding, Enums$1.Spacing.Padding);
	    };
	    ...
	    AdaptiveCard.prototype.internalValidateProperties = function (context) {
	        ...
	        if (this.getValue(CardElement.typeNameProperty) !== "AdaptiveCard") {
	            context.addFailure(this, Enums$1.ValidationEvent.MissingCardType, strings_1$1.Strings.errors.invalidCardType());
	        }
	        if (!this.bypassVersionCheck && !this.version) {
	            context.addFailure(this, Enums$1.ValidationEvent.PropertyCantBeNull, strings_1$1.Strings.errors.propertyMustBeSet("version"));
	        }
	        else if (!this.isVersionSupported()) {
	            context.addFailure(this, Enums$1.ValidationEvent.UnsupportedCardVersion, strings_1$1.Strings.errors.unsupportedCardVersion(this.version.toString(), this.maxVersion.toString()));
	        }
	    };
	    AdaptiveCard.prototype.render = function (target) {
	        ...
	        if (this.shouldFallback() && this._fallbackCard) {
	            ...
	            if (renderedCard) {
	                ...
	                // by default.
	                if (shared_1$1.GlobalSettings.setTabIndexAtCardRoot) {
	        ...
	        if (target) {
	            Utils$1.appendChild(target, renderedCard);
	            this.updateLayout();
	        }
	        return renderedCard;
	    };
	    AdaptiveCard.prototype.updateLayout = function (processChildren) {
	        if (processChildren === void 0) { processChildren = true; }
	        _super.prototype.updateLayout.call(this, processChildren);
	        if (shared_1$1.GlobalSettings.useAdvancedCardBottomTruncation && this.isDisplayed()) {
	            var padding = this.hostConfig.getEffectiveSpacing(Enums$1.Spacing.Default);
	    ...
	    //#region Schema
	    AdaptiveCard.$schemaProperty = new serialization_1$1.CustomProperty(serialization_1$1.Versions.v1_0, "$schema", function (sender, property, source, context) {
	        return AdaptiveCard.schemaUrl;
	    }, function (sender, property, target, value, context) {
	        context.serializeValue(target, property.name, AdaptiveCard.schemaUrl);
	    });
	    AdaptiveCard.versionProperty = new serialization_1$1.CustomProperty(serialization_1$1.Versions.v1_0, "version", function (sender, property, source, context) {
	        var version = serialization_1$1.Version.parse(source[property.name], context);
	        if (version === undefined) {
	            version = serialization_1$1.Versions.latest;
	            context.logParseEvent(sender, Enums$1.ValidationEvent.InvalidPropertyValue, strings_1$1.Strings.errors.invalidCardVersion(version.toString()));
	        }
	        return version;
	    }, function (sender, property, target, value, context) {
	        if (value !== undefined) {
	    ...
	    }, serialization_1$1.Versions.v1_0);
	    AdaptiveCard.fallbackTextProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "fallbackText");
	    AdaptiveCard.speakProperty = new serialization_1$1.StringProperty(serialization_1$1.Versions.v1_0, "speak");
	    AdaptiveCard.refreshProperty = new serialization_1$1.SerializableObjectProperty(serialization_1$1.Versions.v1_4, "refresh", RefreshDefinition, true);
	    AdaptiveCard.authenticationProperty = new serialization_1$1.SerializableObjectProperty(serialization_1$1.Versions.v1_4, "authentication", Authentication, true);
	    __decorate([
	        serialization_1$1.property(AdaptiveCard.versionProperty)
	    ], AdaptiveCard.prototype, "version", void 0);
	    __decorate([
	        serialization_1$1.property(AdaptiveCard.fallbackTextProperty)
	    ], AdaptiveCard.prototype, "fallbackText", void 0);
	    __decorate([
	        serialization_1$1.property(AdaptiveCard.speakProperty)
	    ], AdaptiveCard.prototype, "speak", void 0);
	    __decorate([
	        serialization_1$1.property(AdaptiveCard.refreshProperty)
	    ], AdaptiveCard.prototype, "refresh", null);
	    __decorate([
	        serialization_1$1.property(AdaptiveCard.authenticationProperty)
	...
	var InlineAdaptiveCard = /** @class */ (function (_super) {
	    ...
	    InlineAdaptiveCard.prototype.getDefaultPadding = function () {
	        return new shared_1$1.PaddingDefinition(this.suppressStyle ? Enums$1.Spacing.None : Enums$1.Spacing.Padding, Enums$1.Spacing.Padding, this.suppressStyle ? Enums$1.Spacing.None : Enums$1.Spacing.Padding, Enums$1.Spacing.Padding);
	    };
	    ...
	    Object.defineProperty(InlineAdaptiveCard.prototype, "defaultStyle", {
	        get: function () {
	            if (this.suppressStyle) {
	                ...
	                return this.hostConfig.actions.showCard.style ? this.hostConfig.actions.showCard.style : Enums$1.ContainerStyle.Emphasis;
	            }
	        },
	        enumerable: false,
	        configurable: true
	...
	var GlobalRegistry = /** @class */ (function () {
	    ...
	    GlobalRegistry.populateWithDefaultElements = function (registry) {
	        ...
	        registry.register("RichTextBlock", RichTextBlock, serialization_1$1.Versions.v1_2);
	        registry.register("TextRun", TextRun, serialization_1$1.Versions.v1_2);
	        registry.register("Image", Image);
	        registry.register("ImageSet", ImageSet);
	        registry.register("Media", Media, serialization_1$1.Versions.v1_1);
	        registry.register("FactSet", FactSet);
	        registry.register("ColumnSet", ColumnSet);
	        registry.register("ActionSet", ActionSet, serialization_1$1.Versions.v1_2);
	    ...
	    GlobalRegistry.populateWithDefaultActions = function (registry) {
	        ...
	        registry.register(ToggleVisibilityAction.JsonTypeName, ToggleVisibilityAction, serialization_1$1.Versions.v1_2);
	        registry.register(ExecuteAction.JsonTypeName, ExecuteAction, serialization_1$1.Versions.v1_4);
	    };
	...
	cardElements.GlobalRegistry = GlobalRegistry;
	...
	var SerializationContext = /** @class */ (function (_super) {
	    ...
	    SerializationContext.prototype.internalParseCardObject = function (parent, source, forbiddenTypeNames, allowFallback, createInstanceCallback, logParseEvent) {
	        ...
	        if (source && typeof source === "object") {
	            var typeName = Utils$1.parseString(source["type"]);
	            if (typeName) {
	                if (forbiddenTypeNames.indexOf(typeName) >= 0) {
	                    ...
	                    if (!result) {
	                        tryToFallback = shared_1$1.GlobalSettings.enableFallback && allowFallback;
	                        logParseEvent(typeName, 0 /* UnknownType */);
	                    }
	                    else {
	                        result.setParent(parent);
	                        result.parse(source, this);
	                        tryToFallback = shared_1$1.GlobalSettings.enableFallback && allowFallback && result.shouldFallback();
	                    }
	                    if (tryToFallback) {
	    ...
	    SerializationContext.prototype.parseElement = function (parent, source, allowFallback) {
	        ...
	        allowFallback, function (typeName) {
	            ...
	            if (errorType === 0 /* UnknownType */) {
	                _this.logParseEvent(undefined, Enums$1.ValidationEvent.UnknownElementType, strings_1$1.Strings.errors.unknownElementType(typeName));
	            }
	            else {
	                _this.logParseEvent(undefined, Enums$1.ValidationEvent.ElementTypeNotAllowed, strings_1$1.Strings.errors.elementTypeNotAllowed(typeName));
	            }
	        });
	    };
	    SerializationContext.prototype.parseAction = function (parent, source, forbiddenActionTypes, allowFallback) {
	        ...
	        return this.parseCardObject(parent, source, forbiddenActionTypes, allowFallback, function (typeName) {
	            ...
	            if (errorType == 0 /* UnknownType */) {
	                _this.logParseEvent(undefined, Enums$1.ValidationEvent.UnknownActionType, strings_1$1.Strings.errors.unknownActionType(typeName));
	            }
	            else {
	                _this.logParseEvent(undefined, Enums$1.ValidationEvent.ActionTypeNotAllowed, strings_1$1.Strings.errors.actionTypeNotAllowed(typeName));
	            }
	        });
	    };
	...
	}(serialization_1$1.BaseSerializationContext));
	cardElements.SerializationContext = SerializationContext;

	var channelAdapter = {};

	Object.defineProperty(channelAdapter, "__esModule", { value: true });
	channelAdapter.ChannelAdapter = void 0;
	...
	Object.defineProperty(adaptiveApplet, "__esModule", { value: true });
	adaptiveApplet.AdaptiveApplet = void 0;
	var Enums = enums;
	var Utils = utils;
	var shared_1 = shared;
	var activity_request_1 = activityRequest;
	var strings_1 = strings;
	var card_elements_1 = cardElements;
	...
	adaptiveApplet.AdaptiveApplet = AdaptiveApplet;
	...
	Object.defineProperty(adaptivecards, "__" + "esModule", { value: true });
