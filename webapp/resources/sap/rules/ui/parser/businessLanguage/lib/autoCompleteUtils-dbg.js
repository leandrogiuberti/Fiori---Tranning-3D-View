sap.ui.define([
	...
	"sap/base/Log"
], function(parseModel, constantsLib, parseUtils, vocabularyUtil, parserTokens, utils, org, hrfException, Log) {
    "use strict";
	...
	autoCompleteUtilsLib.prototype.addNavigationSuggestions = function(vocaRTServices, parser, valueListAttribute) {
		...
		if (this.parsingOutputInfo.navigationCompleteion) {
			...
			Log.debug("Autocopmlete: End : this.navigationCompletionInfo.navSuggestions - " + this.navigationCompletionInfo.navSuggestions);
