sap.ui.define([
	...
	"sap/base/Log"
], function(constantsLib, parseUtils, parseModel, utils, entityModelConstractorLib, Log) {
    "use strict";
 ...
 function SetOfValues() {
    try {
        ...
        this.setValueType = function (valueTypeInput) {
            Log.debug("setValueType: add property of " + valueTypeInput);
 ...
 function DateValue() {
    try {
        ...
        this.resolveType = function (dateString) {
            Log.debug("resolveType func,  dateString - " + dateString);
            ...
            Log.debug("Date string - " + dateString + " and type - " + this.type);
        ...
        this.subtractDateString = function () {
            Log.debug("subtractDateString func,  start - " + this.date.start.str + ", and end - " + this.date.end.str);
        ...
        this.getString = function () {
            ...
            if (this.interval.constant !== null && this.interval.constant instanceof Object) {
                Log.debug("**** DateValue, getString - " + this.interval.constant.toString());
