sap.ui.define([
	...
	"sap/rules/ui/parser/businessLanguage/lib/termsUtils",
...
], function(org, vocabularyUtilLib, parseModel, constantsLib, parseUtils, termsUtils, utilsLib,
		localeConversionLib, numberConversionLib) {
    "use strict";
    ...
    var IDPLexer = function(input, state) {
    	...
    	// public IDPLexer(CharStream input, RecognizerSharedState state) {
    	    ...
    	    (function(){
    	                        ...
    	                        this.localeConversionLib = localeConversionLib;
    	                        this.numberConversionLib = numberConversionLib;
