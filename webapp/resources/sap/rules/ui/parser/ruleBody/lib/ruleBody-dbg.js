sap.ui.define([
	...
	RuleBody.prototype.traverse = function traverse(ruleBody, vocabulary, vocaRTServ, traversalParts, pathPrefix) {
		...
		Logger.debug("Traverse rule --> " + JSON.stringify(ruleBody));
	...
	RuleBody.prototype.getParserAST = function getParserAST(expression, parserMode, variables, contentType, flags) {
		...
		Logger.debug("****************************************************************************************************");
		Logger.debug("expresstion to parser: " + expression + " type: " + contentType + " vocabulary: " + this.vocabulary + " " + parserMode);
		Logger.debug("*****************************************************************************************************");
		...
		Logger.debug (JSON.stringify(parsedBusinessRule));
