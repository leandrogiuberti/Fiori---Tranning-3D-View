sap.ui.define([
	...
	"sap/rules/ui/parser/ruleBody/lib/ruleBodyServices",
	"sap/rules/ui/parser/ruleBody/lib/decisionTableCell",
	"sap/rules/ui/parser/ruleBody/lib/constants",
	"sap/rules/ui/parser/resources/common/lib/oDataHandler",
	"sap/rules/ui/parser/businessLanguage/lib/constants",
	"sap/rules/ui/parser/resources/dependencies/lib/constants"
], function(ResponseCollector, resourceConvertor, vocabularyDataProviderInitiator, vocabularyConstants,
		ruleBodyServLib, decisionTableCellLib, ruleBodyConstants, oDataHandler, parserConstantsLib,
		depConstants) {
    "use strict";
    
    var resCollector = ResponseCollector.ResponseCollector.getInstance();
