sap.ui.define([
	...
	"sap/rules/ui/parser/ruleBody/lib/constantsBase",
...
], function(vocaUtilsBase, utilConstants, parser, constantsLib, ruleBodyConstantsLib, ResponseCollectorLib,
		constantsParserLib, hrfException, resourcesConstants, vocaRuntimeServicesFactory) {
    "use strict";
	...
	utilsLib.prototype.getValidatorInstance = function(aliasType) {
		...
		if (aliasType === constantsLib.ALIAS_CONTENT_DECISION_TABLE) {
			var ruleBodyValidatorLib = sap.ui.require("sap/rules/ui/parser/ruleBody/lib/ruleBodyValidator");
			...
			var parser = new parser.parsingBackendMediatorLib();
			validator = parser;
		}
