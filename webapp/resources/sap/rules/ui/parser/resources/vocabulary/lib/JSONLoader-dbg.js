sap.ui.define([
	...
	"sap/rules/ui/parser/resources/vocabulary/lib/utilsBase",
	"sap/rules/ui/parser/resources/common/lib/constants",
	"sap/rules/ui/parser/resources/vocabulary/lib/utils",
	...
	"sap/rules/ui/parser/resources/vocabulary/lib/termGeneration",
	"sap/rules/ui/parser/resources/vocabulary/lib/vocaObjects",
	"sap/rules/ui/parser/resources/vocabulary/lib/runtimeServicesUtils",
	"sap/rules/ui/parser/resources/vocabulary/lib/vocabularyDataProviderFactory"
], function(infraUtilsBase, vocaUtilsBase, resourcesConstants, vocUtils, vocabularyConstants,
		businessLanguageConstantsLib, ResponseCollectorLib, hrfException, termGenerator, vocaObjects,
		runtimeServicesUtils, vocaRuntimeServicesFactory) {
    "use strict";
...
function JSONLoaderLib(){
	...
	JSONLoaderLib.prototype.loadAll = function(rtAll, originalResourceContent, isPrivate, dbConn, resourceID, versionId, writeDependecies) {  //TBD: add the writeDependecies param to current hybrid caller !!!
		...
		if(dbConn){
			ruleBodyValidatorLib = sap.ui.require("sap/rules/ui/parser/ruleBody/lib/ruleBodyValidator");
		...
		var parserLib = sap.ui.require("sap/rules/ui/parser/businessLanguage/lib/parsingBackendMediator");
		var parser = new parserLib.parsingBackendMediatorLib();
		//Avoid from importing the following libs in case this run in client side, by checking the writeDependecies flag
		if(writeDependecies){
			dependencyConstantsLib = sap.ui.require("sap/rules/ui/parser/resources/dependencies/lib/constants");
			//dependencyConstantsLib = sap.rules.ui.parser.resources.dependencies.lib.constants.lib;
			dependencyUtilsLib = sap.ui.require("sap/rules/ui/parser/resources/dependencies/lib/dependenciesUtils");
			//dependencyUtilsLib = sap.rules.ui.parser.resources.dependencies.lib.dependenciesUtils;
			dependecyManager = sap.ui.require("sap/rules/ui/parser/resources/dependencies/lib/dependencyManager");
