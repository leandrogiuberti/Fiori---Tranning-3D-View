...
sap.ui.define([
	...
	"sap/ui/core/Lib"
], function (Element, library, astBundleLibrary, Token,
	utilsBase, AutoComplete, TermsBuilder, TermsProvider, OperatorBuilder, FunctionBuilder, Constants, LocaleData, DateFormat, Formatting, coreLib) {
	...
	AstExpressionLanguage.prototype.init = function () {
		...
		this._infraUtils = new utilsBase.utilsBaseLib();
