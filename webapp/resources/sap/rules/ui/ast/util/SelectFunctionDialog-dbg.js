sap.ui.define([
    ...
    "sap/ui/core/Lib",
    "sap/ui/core/Element"
], function (Control, List, JSONModel, Constants, infraUtils, utilsBase, Select,GridData, ListItem, ColumnListItem, HorizontalLayout, mobileLibrary, Button, IconPool, TextArea, Table,
Column,/*GridContainerData,*/ Text, SimpleForm, Label, Dialog, coreLib, Element) {
    "use strict";
    ...
    SelectFunctionDialog.prototype._createFunctionSelectionDropDown = function (selectFunction, sAriaValue) {
        ...
        var model = new JSONModel(selectFunction);

        this.functionSelect = new Select({
            width: "200px",
    ...
    SelectFunctionDialog.prototype._getAttributeAstExpressionBasic = function (sAriaValue, AstExpressionBasic) {
        var that = this;
        this.astExpressionBasicForAttribute = new AstExpressionBasic({
    ...
    SelectFunctionDialog.prototype._tableColumnsFactory = function (AstExpressionBasic) {
        var that = this;
        var itemTemplate = new ColumnListItem({
            cells: [that._getAttributeAstExpressionBasic("selectAttributeLabelId" + that.selectLabelUUID, AstExpressionBasic),
                new Select({
    ...
    SelectFunctionDialog.prototype._createDataObjectDropDown = function (sAriaValue) {
        ...
        var model = new JSONModel(aDataObject);
    ...
    SelectFunctionDialog.prototype._createWhereAstExpressionBasic = function (sAriaValue, AstExpressionBasic) {
        var that = this;
    ...
    SelectFunctionDialog.prototype._createTable = function (AstExpressionBasic) {
        var that = this;
    ...
    SelectFunctionDialog.prototype._createSelectFunctionDialog = function (data, callBack, AstExpressionLanguage, dialogOpenedCallbackReference, jsonData) {
        ...
        sap.ui.require([
                ...
                if (jsonData) {
                        ...
                        var attributeTable = that._createTable(AstExpressionBasic);
                        var oWhereControl = that._createWhereAstExpressionBasic("selectWhereLabelId" + that.selectLabelUUID, AstExpressionBasic);
                        var oFunctionLabelControl = that._createFunctionLabel();

                        var verticalLayoutForSelectFunction = new SimpleForm({
                            layout: "ResponsiveGridLayout",
                            editable: true,
                            content: [
                                new Label("selectFunctionSelectionLabelId" + that.selectLabelUUID ,{
                                ...
                                oVocabularyText,
                                that._createDataObjectDropDown(oVocabularyText.getId(), AstExpressionBasic),

                                new Label("selectAttributeLabelId" + that.selectLabelUUID ,{
                                ...
                                attributeTable,
                                new Label("selectWhereLabelId" + that.selectLabelUUID,{
                        ...
                        var selectFunctionsDialog = new Dialog({
