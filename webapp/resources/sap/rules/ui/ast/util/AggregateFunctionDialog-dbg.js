sap.ui.define([
    ...
    "sap/ui/core/Lib",
    "sap/ui/core/Element"
], function (Control, List, JSONModel, Constants, Select, GridData, ListItem, MultiComboBox, TextArea, Text, SimpleForm, Button, Label, Dialog, coreLib, Element) {
    "use strict";
    ...
    AggregateFunctionDialog.prototype._createFunctionSelectionDropDown = function (aggregateFunction, sAriaValue) {
        ...
        var model = new JSONModel(aggregateFunction);
    ...
    AggregateFunctionDialog.prototype._createVocabularyAstExpression = function (sAriaValue, AstExpressionBasic) {
        var that = this;
        var jsonData = [];
        this.astExpressionBasicForVocabulary = new AstExpressionBasic({
	...
	AggregateFunctionDialog.prototype._createAttributeAstExpressionBasic = function (sAriaValue,AstExpressionBasic) {
        var that = this;
        this.astExpressionBasicForAttributes = new AstExpressionBasic({
    ...
    AggregateFunctionDialog.prototype._createWhereAstExpressionBasic = function (sAriaValue, AstExpressionBasic) {
        var that = this;
    ...
    AggregateFunctionDialog.prototype._createGroupByDropDown = function (sAriaValue) {
        var that = this;
        this.groupBySelect = new MultiComboBox({
            showSecondaryValues: true,
    ...
    AggregateFunctionDialog.prototype._bindGroupByDropDown = function () {
        ...
        if (this.dataObjectId) {
            ...
            var model = new JSONModel(attributeJson);
        ...
        sap.ui.require([
                "sap/rules/ui/AstExpressionBasic"
                    ...
                    if (jsonData) {
                            ...
                            var oWhereControl = that._createWhereAstExpressionBasic("aggregateWhereLabelId", AstExpressionBasic);
                            var oGroupByControl = that._createGroupByDropDown("aggregateGroupByLabelId");
                            var oAttributeControl = that._createAttributeAstExpressionBasic("aggregateAttributeLabelId", AstExpressionBasic);
                            var oFunctionLabelControl = that._createFunctionLabel("aggregateFunctionLabelId");

                            var verticalLayoutForAggregateFunction = new SimpleForm({
                                layout: "ResponsiveGridLayout",
                                editable: true,
                                content: [
                                    new Label("aggregateFunctionSelectLabelId",{
                                    ...
                                    oVocabularyText,
                                    that._createVocabularyAstExpression(oVocabularyText.getId(), AstExpressionBasic),

                    				new Label("aggregateAttributeLabelId",{
