sap.ui.define([
...
], function (jQuery, library, Control, List, JSONModel, mobileLibrary, CustomData, Sorter, infraUtils, DisplayListItem, Panel, coreLib, AutoSuggestionLogicalOperatorPanelRenderer) {
    "use strict";
    ...
    var autoSuggestionLogicalOperatorPanel = Control.extend("sap.rules.ui.ast.autoCompleteContent.AutoSuggestionLogicalOperatorPanel", {
        ...
        _createLayout: function () {
            ...
            // create a list 
            this.logicalOperatorslist = new List({
                growing: true,
            ...
            var logicalOperatorsListPanel = new Panel({
