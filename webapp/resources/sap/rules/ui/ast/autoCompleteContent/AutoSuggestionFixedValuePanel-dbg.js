sap.ui.define([
	...
	LocaleData, Constants, DatePicker , DateTimePicker , TimePicker, Dialog, Button, Formatting, CalendarType, DateFormat, InvisibleText, Input, Panel, ToolbarSpacer, SmartFilterBar,
	ValueHelpDialog, ODataModel, ControlConfiguration, TableColumn, Filter, FilterOperator, Label, Text, Link, coreLib, BusyIndicator, Element, AutoSuggestionFixedValuePanelRenderer) {
	"use strict";
