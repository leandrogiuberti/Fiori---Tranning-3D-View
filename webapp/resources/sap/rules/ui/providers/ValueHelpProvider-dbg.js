...
// -----------------------------------------------------------------------------
sap.ui.define([
	'sap/m/List', 'sap/m/ResponsivePopover', 'sap/m/StandardListItem',
	'sap/ui/comp/providers/ValueHelpProvider', 'sap/ui/model/json/JSONModel',"sap/m/MultiInput"
	/*'sap/rules/ui/ExpressionAdvanced',*/ /*'sap/rules/ui/DecisionTableCellExpressionAdvanced'*/
], function(List,ResponsivePopover, StandardListItem, ValueListProvider, JSONModel, MultiInput /*ExpressionAdvanced,*/ /*DecisionTableCellExpressionAdvanced*/) {
	"use strict";
	...
	ValueHelpProvider.prototype._onOK = function(oControlEvent) {
		...
		if (this.oControl instanceof MultiInput) {
            ...
            if (this.oControl /*instanceof ExpressionAdvanced TODO:Change by Harsh*/) {
	...
	ValueHelpProvider.prototype._onInitialise = function(oControlEvent) {
		...
		if (oExpressionAdvanced /*instanceof DecisionTableCellExpressionAdvanced TODO:Change by Harsh*/) {
