...
sap.ui.define([
...
], (ServiceFactoryRegistry, ServiceFactory, Service, EventProvider) => {
    "use strict";
     ...
     * @deprecated since 1.70. Support for this service has been discontinued.
     */
    const UserStatus = Service.extend("sap.ushell.ui5service.UserStatus", /** @lends sap.ushell.ui5service.UserStatus.prototype */ {
        init: function () {
            // Service injection
