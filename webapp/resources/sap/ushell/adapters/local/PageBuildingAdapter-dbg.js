...
sap.ui.define([
    ...
    function PageBuildingAdapter (oSystem, sParameter, oConfig) {
    ...
    PageBuildingAdapter.prototype.createChipInstance = function (oChipRawData) {
        const oImplementation = this.oCache[oChipRawData.chipId];
        const oSimplifiedChip = oChipRawData;
        ...
        const oContracts = {
            ...
            bag: {
                getBag: function (sBagName) {
                    let oBag = oSimplifiedChip.bags[sBagName];
                    if (!oBag) {
                        oBag = {};
