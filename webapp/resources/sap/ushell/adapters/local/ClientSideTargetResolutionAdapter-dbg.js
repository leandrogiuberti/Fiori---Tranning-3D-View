...
sap.ui.define([
     ...
     * @private
     */
    function ClientSideTargetResolutionAdapter (oSystem, sParameters, oConfig) {
        ...
        const sProductName = Container.getLogonSystem().getProductName() || "";
    ...
    ClientSideTargetResolutionAdapter.prototype.resolveSystemAlias = function (sSystemAlias) {
        ...
        setTimeout(() => {
            if (this._oSystemAliases.hasOwnProperty(sSystemAlias)) {
                ...
                oDeferred.reject(new Error("No system alias value available"));
            }
        }, 0);
        return oDeferred.promise();
    };
