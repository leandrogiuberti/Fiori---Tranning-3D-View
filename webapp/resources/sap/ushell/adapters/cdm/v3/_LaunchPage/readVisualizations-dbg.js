...
sap.ui.define([
    ...
    readVisualizations.getTarget = function (oVisualization) {
        const oVizConfig = this.getConfig(oVisualization);
    ...
    readVisualizations.getAppId = function (oVisualization) {
        const oTarget = this.getTarget(oVisualization);
    ...
    readVisualizations.getKeywords = function (aCdmParts) {
        const aClonedCdmParts = deepClone(aCdmParts, 20); // do not modify input parameter
    ...
    readVisualizations.getDataSource = function (aCdmParts, sDataSourceId) {
        ...
        const oDataSources = utils.getNestedObjectProperty(
            aClonedCdmParts,
