...
sap.ui.define([
...
], (Config, System, FeaturedGroupMock) => {
    "use strict";
    ...
    const aConfig = [{
        ...
        configHandler: function () {
            const bRecentActivityEnabled = Config.last("/core/shell/enableRecentActivity") &&
                Config.last("/core/shell/model/showRecentActivity");
            const bEnableFrequentCard = bRecentActivityEnabled && Config.last("/core/home/featuredGroup/frequentCard");
            const bEnableRecentCard = bRecentActivityEnabled && Config.last("/core/home/featuredGroup/recentCard");
