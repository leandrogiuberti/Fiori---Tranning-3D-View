...
sap.ui.define([
     ...
     * @param {object} oContextContainer the context container.
     *
     * @since 1.22.0
     * @public
     * @deprecated since 1.120. Please use {@link sap.ushell.services.PersonalizationV2.VariantSet} instead.
    ...
    function VariantSet (sVariantSetKey, oContextContainer) {
        ...
        let sVariantName;
        let oVariantData;
        const oVariantNameMap = new utils.Map();
    ...
    VariantSet.prototype.getVariantKeys = function () {
        const oVariantMap = new utils.Map();
    ...
    VariantSet.prototype.addVariant = function (sVariantName) {
        ...
        iMaxKey = parseInt(aKeys.sort((a, b) => {
            return a - b;
