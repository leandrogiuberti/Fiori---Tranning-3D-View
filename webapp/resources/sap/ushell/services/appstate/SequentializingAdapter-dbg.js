...
sap.ui.define([
    ...
    SequentializingAdapter.prototype.saveAppState = function (sKey, sSessionKey, sData, sAppname, sComponent, iPersistencyMethod, oPersistencySettings) {
        const fn = this._oUnderlyingAdapter.saveAppState.bind(this._oUnderlyingAdapter, sKey, sSessionKey, sData, sAppname, sComponent, iPersistencyMethod, oPersistencySettings);
