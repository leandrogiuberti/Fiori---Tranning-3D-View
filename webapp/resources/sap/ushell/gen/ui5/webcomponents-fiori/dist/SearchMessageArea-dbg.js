...
sap.ui.define(
  [
    ...
    "sap/ushell/thirdparty/SearchMessageArea",
  ],
    ...
    const WrapperClass = WebComponentBaseClass.extend(
      "sap.ushell.gen.ui5.webcomponents-fiori.dist.SearchMessageArea",
      {
        metadata: {
          ...
          tag: "ui5-search-message-area-16d3c820",
          interfaces: [],
          properties: {
            text: {
              type: "string",
          ...
          methods: [],
          designtime:
            "sap/ushell/gen/ui5/webcomponents-fiori/designtime/SearchMessageArea.designtime",
        },
      },
    )
