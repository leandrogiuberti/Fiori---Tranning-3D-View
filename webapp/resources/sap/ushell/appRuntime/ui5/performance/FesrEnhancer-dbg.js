...
sap.ui.define([
    ...
    const oFesrEnhancer = {
         ...
         *
         * @param {object} oUi5FesrHandle the UI5 FESR handler object.
         * @param {object} oUi5Interaction a UI5 Interaction.
         * @returns {object} the enhanced UI5 FESR handler object.
         *
         * @private
         */
         ...
         *
         * @param {object} componentHandle the component handle.
         *
         * @private
         */
        setAppShortId: function (componentHandle) {
            function getValueFromManifest (oComponentHandle, sPath) {
                let vValue = oComponentHandle.getManifestEntry(sPath) || [];
            ...
            if (FESR.getActive()) {
                try {
                    if (componentHandle) {
                        const oComponentData = componentHandle.getInstance().getComponentData().technicalParameters || {};
