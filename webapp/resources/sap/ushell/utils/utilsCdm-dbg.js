...
sap.ui.define([
    ...
    function mapOne (sKey, oSrc, oApp) {
        ...
        let sTileSize;
        let sTileDescription;
        let sTileTechnicalInformation;
        let oTargetOutbound;
        let oDataSource;
        let sAppId;
        let bIsCustomTile = false;

        const oSapPlatformRuntime = getMember(oApp, "sap|platform|runtime");
        ...
        const indicatorDataSource = oSrc.indicatorDataSource || getMember(oApp, `sap|app.crossNavigation.inbounds.${sKey}.indicatorDataSource`);

        let oTempTileComponent = indicatorDataSource ? "#Shell-dynamicTile" : "#Shell-staticTile";
    ...
    function formatApplicationType (oResolutionResult, oApp) {
        ...
        const sComponentName = getMember(oApp, "sap|platform|runtime.componentProperties.name") || getMember(oApp, "sap|ui5.componentName");
        ...
        try {
            ...
            aSiteApplications.forEach((sApplicationKey) => {
                try {
                    ...
                    const oApplicationInbounds = getMember(oApp, "sap|app.crossNavigation.inbounds");
                    if (oApplicationInbounds) {
                        ...
                        lst2.forEach((sInboundKey) => {
                            ...
                            const r = this.mapOne(sInboundKey, oInbound, oApp);
                            if (r) {
                                aInbounds.push(r);
                            }
                        });
