...
sap.ui.define([
    ...
    const CustomGroupHeaderListItem = GroupHeaderListItem.extend("sap.ushell.ui.CustomGroupHeaderListItem", {
        metadata: {
            library: "sap.ushell",
            properties: {
                /**
    ...
    CustomGroupHeaderListItem.prototype.setTitle = function (sTitle) {
        ...
        const oTitleAggregation = this.getAggregation("_titleText");
    ...
    CustomGroupHeaderListItem.prototype.setDescription = function (sDescription) {
        ...
        const oDescriptionAggregation = this.getAggregation("_descriptionText");
