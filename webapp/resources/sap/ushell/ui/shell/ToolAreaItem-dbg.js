...
sap.ui.define([
    ...
    const ToolAreaItem = Control.extend("sap.ushell.ui.shell.ToolAreaItem", /** @lends sap.ushell.ui.shell.ToolAreaItem.prototype */ {
        metadata: {
            library: "sap.ushell",
            properties: {
                /**
        ...
        renderer: {
            ...
            render: function (rm, oToolAreaItem) {
                ...
                const tooltip = oToolAreaItem.getTooltip_AsString();
                if (tooltip) {
            ...
            renderExpandable: function (rm) {
                const oIcon = IconPool.createControlByURI("sap-icon://icon-dropdown");
    ...
    ToolAreaItem.prototype.setSelected = function (bSelected) {
        bSelected = !!bSelected;
        if (bSelected) {
            const jqSelected = jQuery(".sapUshellToolAreaItemSelected");
    ...
    ToolAreaItem.prototype.setVisible = function (bVisible) {
        const bRendered = this.getParent() && this.getParent().getDomRef();
