...
sap.ui.define([
    ...
    const oShellHeadItemProperties = ShellHeadItem.getMetadata().getProperties();
     ...
     */
    const OverflowListItem = StandardListItem.extend("sap.ushell.ui.shell.OverflowListItem", /** @lends sap.ushell.ui.shell.OverflowListItem.prototype */ {
        metadata: {
            library: "sap.ushell",
            properties: {
                floatingNumber: {
