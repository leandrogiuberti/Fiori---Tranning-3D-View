...
sap.ui.define([
    ...
    const NavigationMiniTile = Control.extend("sap.ushell.ui.shell.NavigationMiniTile", {
        metadata: {
            library: "sap.ushell",
            properties: {
                title:
        ...
        renderer: {
            ...
            render: function (oRm, oControl) {
                ...
                const sSubtitle = oControl.getSubtitle();
                const sIcon = oControl.getIcon();
                const oIcon = IconPool.createControlByURI(sIcon);
