sap.ui.define(['exports', 'sap/ushell/thirdparty/generateHighlightedMarkup', 'sap/ushell/thirdparty/ShellBarSearch2', 'sap/ushell/thirdparty/webcomponents-base', 'sap/ushell/thirdparty/ListItemGroup', 'sap/ushell/thirdparty/ListBoxItemGroupTemplate', 'sap/ushell/thirdparty/parameters-bundle.css2', 'sap/ushell/thirdparty/Icon', 'sap/ushell/thirdparty/information', 'sap/ushell/thirdparty/List', 'sap/ushell/thirdparty/ResponsivePopover', 'sap/ushell/thirdparty/Button2', 'sap/ushell/thirdparty/i18n-defaults2', 'sap/ushell/thirdparty/encodeXML', 'sap/ushell/thirdparty/webcomponents', 'sap/ushell/thirdparty/Icons', 'sap/ushell/thirdparty/webcomponents-fiori', 'sap/ushell/thirdparty/event-strict', 'sap/ushell/thirdparty/ListItemBase', 'sap/ushell/thirdparty/parameters-bundle.css', 'sap/ushell/thirdparty/ListItemAdditionalText.css', 'sap/ushell/thirdparty/AccessibilityTextsHelper', 'sap/ushell/thirdparty/ValueState', 'sap/ushell/thirdparty/Label', 'sap/ushell/thirdparty/slim-arrow-down', 'sap/ushell/thirdparty/Title', 'sap/ushell/thirdparty/BusyIndicator', 'sap/ushell/thirdparty/willShowContent', 'sap/ushell/thirdparty/information2', 'sap/ushell/thirdparty/sys-enter-2', 'sap/ushell/thirdparty/parameters-bundle.css3', 'sap/ushell/thirdparty/i18n-defaults', 'sap/ushell/thirdparty/toLowercaseEnumValue', 'sap/ushell/thirdparty/WrappingType', 'sap/ushell/thirdparty/FocusableElements'], (function (exports, generateHighlightedMarkup, ShellBarSearch, webcomponentsBase, ListItemGroup, ListBoxItemGroupTemplate, parametersBundle_css, Icon, information, List, ResponsivePopover, Button, i18nDefaults, encodeXML, webcomponents, Icons, webcomponentsFiori, eventStrict, ListItemBase, parametersBundle_css$1, ListItemAdditionalText_css, AccessibilityTextsHelper, ValueState, Label, slimArrowDown, Title, BusyIndicator, willShowContent, information$1, sysEnter2, parametersBundle_css$2, i18nDefaults$1, toLowercaseEnumValue, WrappingType, FocusableElements) { 'use strict';
    ...
    function InputSuggestionsTemplate(hooks) {
        ...
        return (parametersBundle_css.jsxs(ResponsivePopover.ResponsivePopover, { class: this.classes.popover, hideArrow: true, preventFocusRestore: true, preventInitialFocus: true, placement: "Bottom", horizontalAlign: "Start", tabindex: -1, style: this.styles.suggestionsPopover, onOpen: this._afterOpenPicker, onClose: this._afterClosePicker, onScroll: this._scroll, open: this.open, opener: this, accessibleName: this._popupLabel, children: [this._isPhone &&
                    parametersBundle_css.jsxs(parametersBundle_css.Fragment, { children: [parametersBundle_css.jsxs("div", { slot: "header", class: "ui5-responsive-popover-header", children: [parametersBundle_css.jsxs("div", { class: "row", children: [parametersBundle_css.jsx("span", { children: this._headerTitleText }), parametersBundle_css.jsx(Button.Button, { class: "ui5-responsive-popover-close-btn", icon: information.decline, design: "Transparent", onClick: this._closePicker })] }), parametersBundle_css.jsx("div", { class: "row", children: parametersBundle_css.jsx("div", { class: "input-root-phone native-input-wrapper", children: parametersBundle_css.jsx(ShellBarSearch.Input, { class: "ui5-input-inner-phone", type: this.inputType, value: this.value, showClearIcon: this.showClearIcon, placeholder: this.placeholder, onInput: this._handleInput, onChange: this._handleChange }) }) })] }), this.hasValueStateMessage &&
                    ...
                    parametersBundle_css.jsx("div", { slot: "footer", class: "ui5-responsive-popover-footer", children: parametersBundle_css.jsx(Button.Button, { design: "Transparent", onClick: this._closePicker, children: this._suggestionsOkButtonText }) })] }));
    }
