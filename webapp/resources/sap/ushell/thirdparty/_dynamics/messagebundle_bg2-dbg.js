sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var MESSAGE_STRIP_CLOSE_BUTTON_INFORMATION = "Затваряне на лента с информационно съобщение";
	var MESSAGE_STRIP_CLOSE_BUTTON_POSITIVE = "Затваряне на лента с положително съобщение";
	var MESSAGE_STRIP_CLOSE_BUTTON_NEGATIVE = "Затваряне на лента с отрицателно съобщение";
	var MESSAGE_STRIP_CLOSE_BUTTON_CRITICAL = "Затваряне на лента с критично съобщение";
	var MESSAGE_STRIP_CLOSE_BUTTON_CUSTOM = "Затваряне на лента с потребителско съобщение";
