sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var MESSAGE_STRIP_CLOSE_BUTTON_INFORMATION = "Трака информативне поруке – затвори";
	var MESSAGE_STRIP_CLOSE_BUTTON_POSITIVE = "Трака за позитивне поруке - затвори";
	var MESSAGE_STRIP_CLOSE_BUTTON_NEGATIVE = "Трака за негативне поруке - затвори";
	var MESSAGE_STRIP_CLOSE_BUTTON_CRITICAL = "Трака за критичне поруке - затвори";
	var MESSAGE_STRIP_CLOSE_BUTTON_CUSTOM = "Трака за прилагођене поруке - затвори";
