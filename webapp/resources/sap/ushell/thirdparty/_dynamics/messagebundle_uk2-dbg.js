sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var MESSAGE_STRIP_CLOSE_BUTTON_INFORMATION = "Закриття рядка інформаційних повідомлень";
	var MESSAGE_STRIP_CLOSE_BUTTON_POSITIVE = "Закриття рядка позитивних повідомлень";
	var MESSAGE_STRIP_CLOSE_BUTTON_NEGATIVE = "Закриття рядка негативних повідомлень";
	var MESSAGE_STRIP_CLOSE_BUTTON_CRITICAL = "Закриття рядка критичних повідомлень";
	var MESSAGE_STRIP_CLOSE_BUTTON_CUSTOM = "Закриття рядка користувацьких повідомлень";
