...
sap.ui.define([
    ...
    // Note: as of 2025-05-07, no usage in ManagedObject properties was found
    ...
    DataType.registerEnum("sap.ushell.appIntegration.contracts.StatefulType", oUshellLibrary.appIntegration.contracts.StatefulType);
    ...
    DataType.registerEnum("sap.ushell.components.container.ApplicationType", oUshellLibrary.components.container.ApplicationType);
    ...
    DataType.registerEnum("sap.ushell.DisplayFormat", oUshellLibrary.DisplayFormat);
    ...
    DataType.registerEnum("sap.ushell.ui.tile.State", oUshellLibrary.ui.tile.State);
    ...
    DataType.registerEnum("sap.ushell.ui.tile.StateArrow", oUshellLibrary.ui.tile.StateArrow);
    ...
    DataType.registerEnum("sap.ushell.FloatingNumberType", oUshellLibrary.FloatingNumberType);
