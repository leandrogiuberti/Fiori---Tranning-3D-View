...
sap.ui.define([
    ...
    const oStateModule = {
        ...
        isBlockWaitingForDependencies: function (id) {
            const oStateLoadingBlock = this.getForLoadingBlock(id);
        ...
        isStepWaitingForDependencies: function (id) {
            const oStateLoadingStep = this.getForLoadingStep(id);
        ...
        isAgentIdle: function () {
            const oStateOfModule = this.getForModule(oId.module.schedulingAgent.id);
        ...
        dump: function () {
            ...
            const oStateCopy = fnClone(this.oState);
            return oStateCopy;
        },
