...
sap.ui.define([
    ...
    const aHistory = [];
    let bVerbose = true;
    const COMPONENT_NAME = "FLPScheduler";
    ...
    return {
        ...
        dumpHistory: function (id) {
            ...
            if (id) {
                _aHistory = aHistory.filter((oEntry) => {
                    return oEntry.id === id;
                });
        ...
        /**
         * Logs an error
         * @param {{time: int, type: string, id: string, status: string, parameter: object, remark: string, byModule: string}} error
        ...
        /**
         * Logs a warning
         * @param {{time: int, type: string, id: string, status: string, parameter: object, remark: string, byModule: string}} warning
         *   State object to log: use fixed values for type, status and byModule as defined in the state module.
         * @returns {boolean} true: Indicates a log entry has been written
         * @protected
         */
         ...
         *
         * @param {{time: int, type: string, id: string, status: string, parameter: object, remark: string, byModule: string}} status
         *   State object to log: use fixed values for type, status and byModule as defined in the state module.
