...
sap.ui.define([
     ...
     */
    const WorkPage = Control.extend("sap.ushell.components.workPageBuilder.controls.WorkPage", /** @lends sap.ushell.components.workPageBuilder.controls.WorkPage.prototype */ {
        metadata: {
            library: "sap.ushell",
            properties: {
                /**
