...
sap.ui.define([
    ...
    const WorkPageColumnResizer = Control.extend("sap.ushell.components.workPageBuilder.controls.WorkPageColumnResizer", /** @lends sap.ushell.components.workPageBuilder.controls.WorkPageColumnResizer.prototype */ {
        metadata: {
            library: "sap.ushell",
            events: {
                /**
    ...
    WorkPageColumnResizer.prototype.onkeydown = function (oEvent) {
        ...
        const oParentRowControl = this.getParent().getParent();
        let iSingleColumnWidth = oParentRowControl.getSingleColumnWidth();
    ...
    WorkPageColumnResizer.prototype.getXOrigin = function () {
        const oBoundingClientRect = this.$().get(0).getBoundingClientRect();
