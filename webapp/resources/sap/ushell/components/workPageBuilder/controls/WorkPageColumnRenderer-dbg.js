...
sap.ui.define([
    ...
    const WorkPageColumnRenderer = {
        ...
        render: function (rm, workPageColumn) {
            ...
            const iIndex = workPageColumn.getIndex();
            const iMaxColumns = workPageColumn.getMaxColumns();
            const iColumnCount = workPageColumn.getCappedColumnCount();
            const aCells = workPageColumn.getCells();
            const bIsEmpty = aCells.length === 0;
