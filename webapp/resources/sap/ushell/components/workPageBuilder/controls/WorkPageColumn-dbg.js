...
sap.ui.define([
     ...
     */
    const WorkPageColumn = Control.extend("sap.ushell.components.workPageBuilder.controls.WorkPageColumn", /** @lends sap.ushell.components.workPageBuilder.controls.WorkPageColumn.prototype */ {
        metadata: {
            library: "sap.ushell",
            properties: {
                /**
    ...
    WorkPageColumn.prototype._createAddButton = function (sPosition) {
        const sClass = sPosition === "left" ? "workPageColumnButtonLeft" : "workPageColumnButtonRight";
    ...
    WorkPageColumn.prototype.getCappedColumnCount = function () {
        const oWorkPageRow = this.getParent();
