...
sap.ui.define([
     ...
     */
    const WorkPageButton = Control.extend("sap.ushell.components.workPageBuilder.controls.WorkPageButton", /** @lends sap.ushell.components.workPageBuilder.controls.WorkPageButton.prototype */ {
        metadata: {
            library: "sap.ushell",
            properties: {
                /**
