...
sap.ui.define([
    ...
    const TileSizeBehavior = mLibrary.TileSizeBehavior;
    ...
    LayoutHelper.prototype.onResize = async function (oEvent) {
        ...
        const oBreakpoint = await this._getBreakpointSettingsForWidth(oEvent.size.width);
    ...
    LayoutHelper.prototype._getBreakpointSettingsForWidth = async function (iWidth) {
        const aBreakpoints = await this._getBreakpointSettings();
        for (const i in aBreakpoints) {
    ...
    LayoutHelper.prototype._getBreakpointSettings = async function () {
        const sCurrentConfigSizeBehavior = Config.last("/core/home/sizeBehavior");
        const sSizeBehaviorResponsive = sCurrentConfigSizeBehavior === TileSizeBehavior.Small
            ? TileSizeBehavior.Small
            : TileSizeBehavior.Responsive;

        const sSpacingParamResponsive = sCurrentConfigSizeBehavior === TileSizeBehavior.Small
            ? "_sap_ushell_Tile_SpacingXS"
            : "_sap_ushell_Tile_Spacing";

        const sTileWidthParamResponsive = sCurrentConfigSizeBehavior === TileSizeBehavior.Small
            ? "_sap_ushell_Tile_WidthXS"
            : "_sap_ushell_Tile_Width";

        const mColumnMinFlex = {
