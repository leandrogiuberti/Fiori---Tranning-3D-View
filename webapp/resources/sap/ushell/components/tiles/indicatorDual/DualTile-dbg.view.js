    ...
    sap.ui.jsview("sap.ushell.components.tiles.indicatorDual.DualTile", {
        ...
        createContent: function () {
            ...
            sap.ushell.components.tiles.indicatorTileUtils.util.getParsedChip(
                that.getViewData().chip.configuration.getParameterValueAsString("tileConfiguration"), that.getViewData().chip.preview.isEnabled(), (config) => {
                    that.oConfig = config;
                });
            ...
            switch (that.tileType) {
                ...
                case "DT-TT":
                    const areaChart = new AreaMicroChart({
                        width: "{/width}",
                        height: "{/height}",
                        size: "{/size}",
                ...
                case "DT-AT":
                    const oBCDataTmpl = new BulletMicroChartData({
                        value: "{value}",
                        color: "{color}"
                    });

                    const oBChart = new BulletMicroChart({
                        size: Size.Auto,
                        scale: "{/scale}",
                        actual: {
                            value: "{/actual/value}",
