...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.pages.controller.MyHome", {
        ...
        onInit: function () {
            ...
            const fnSetEnableImport = function (bFlag) {
                this.oViewModel.setProperty("/personalizationAvailable", !!bFlag);
            }.bind(this);

            this.getView().setModel(ushellResources.i18nModel, "i18n");
        ...
        onMessageStripClose: function () {
            ...
            sap.ui.require(["sap/m/MessageBox"], (MessageBox) => {
                MessageBox.information(ushellResources.i18n.getText("MyHome.InitialPage.MessageStrip.Popup"));
            });
        }
    });
});
