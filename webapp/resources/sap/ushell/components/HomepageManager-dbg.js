    ...
    const oHomepageManager = BaseObject.extend("sap.ushell.components.HomepageManager", {
        ...
        _deleteGroup: function (sChannelId, sEventId, oData) {
            ...
            function deleteGroup () {
                this.oPageOperationAdapter.deleteGroup(oDeletedGroupModel)
                    .then(() => {
        ...
        _resetGroup: function (sChannelId, sEventId, oData) {
            ...
            function resetGroup () {
                that.oPageOperationAdapter.resetGroup(oGroupModel, bDefaultGroup)
                    .then((oResetedObject) => {
        ...
        _moveGroup: function (sChannelId, sEventId, oData) {
            ...
            function moveGroup () {
                ...
                that.oPageOperationAdapter.getOriginalGroupIndex(oDestinationGroup, aGroups).then(
                    ...
                    .then(that._checkRequestQueue.bind(that))
                    .catch(() => {
        ...
        _changeGroupTitle: function (sChannelId, sEventId, oData) {
            ...
            function renameGroup () {
                this.oPageOperationAdapter.renameGroup(oGroupModel, sNewTitle, sOldTitle)
                    .then(() => {
                        that._checkRequestQueue();
                    })
                    .catch(() => {
        ...
        _deleteTile: function (sChannelId, sEventId, oData) {
            ...
            function deleteTile (group, tileModel) {
                this.oPageOperationAdapter.removeTile(group, tileModel)
                    .then(this._checkRequestQueue.bind(this))
                    .catch(this._resetGroupsOnFailure.bind(this, "fail_to_remove_tile_msg"));
            }
        ...
        loadPersonalizedGroups: function () {
            ...
            if (this.bIsGroupsRequestPending) {
                ...
                oDeferred.reject(new Error("loadPersonalizedGroups was skipped because there is already a pending request."));
            ...
            this.oServiceLoadingPromise
                ...
                .catch((oError) => {
                    Log.error("Loading of personalized groups failed.", oError, "sap.ushell.components.HomepageManager");
