	...
	function ExternalContext(inject) {
		...
		this.getCombinedContext = function() {
			...
			function resolveContextFromXAppState() {
				sap.ui.require("sap/ushell/Container")?.getService("CrossApplicationNavigation").getAppState(inject.instances.component, xAppStateId).done(function(appContainer) {
