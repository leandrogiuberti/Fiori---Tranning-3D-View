...
sap.ui.define([
	...
	"sap/apf/utils/utils"
], function(UtilsFilter, CoreFilter, exportToGlobal, OriginalStartFilter, utils){
	'use strict';
	/**
	 * @private
	 ...
	 * @alias sap.apf.utils.StartFilterHandler
	 */
	function StartFilterHandler(inject) {
		var startFilters = [ {
			isLevel : true
		} ];
	...
	exportToGlobal("sap.apf.utils.StartFilterHandler", StartFilterHandler);
