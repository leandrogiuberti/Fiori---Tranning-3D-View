...
sap.ui.define([
	 ...
	 * @alias sap.apf.utils.SerializationMediator
	 */
	function SerializationMediator(inject) {
		/**
		 * @private
		 * @function
	...
	exportToGlobal("sap.apf.utils.SerializationMediator", SerializationMediator);
