...
sap.ui.define([
	...
	function NavigationHandler(oInject) {
		...
		this.getNavigationTargets = function() {
			...
			var navigationService = sap.ui.require("sap/ushell/Container")?.getService("CrossApplicationNavigation");
		...
		this.navigateToApp = function(navigationId) {
			...
			oInject.functions.getCumulativeFilterUpToActiveStep().done(function(oCumulativeFilter) {
				...
				function callbackForFilterMapping(oFilterFromFilterMapping, oMessageObject) {
					...
					var oCrossAppNavigator = sap.ui.require("sap/ushell/Container")?.getService("CrossApplicationNavigation");
		...
		this.checkMode = function() {
			...
			if (innerAppStateKey) {
				sap.ui.require("sap/ushell/Container").getService("CrossApplicationNavigation").getAppState(oInject.instances.component, innerAppStateKey).done(function(appContainer) {
				...
				sap.ui.require("sap/ushell/Container").getService("CrossApplicationNavigation").getAppState(oInject.instances.component, crossAppStateKey).done(function(appContainer) {
					containerData = appContainer.getData();
