sap.ui.define([
 ...
 ], function (Controller, IconPool, Item, coreLibrary, JSONModel, ODataModel, Filter, FilterOperator, Sorter, MessageToast, ODataServiceUtils) {
    "use strict";
    ...
    return Controller.extend(PACKAGE + ".controller.CatalogBrowser", {
        ...
        initializeDialog: async function() {
            var oDialog = this.oDialog = await this.loadFragment({
                name: PACKAGE + ".fragment.CatalogBrowser"
            });
        ...
        getDialog: function() {
            return this.getView().byId("catalogBrowser");
        }
    });
});
