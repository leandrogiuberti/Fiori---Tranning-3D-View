sap.ui.define([
	...
	function generateRuntimeHash(configurationId) {
		return sap.ui.require("sap/ushell/Container").getServiceAsync("CrossApplicationNavigation").then( function (oService) {
	...
	function setBookmarkTile(link, title, subtitle, icon, group) {
		sap.ui.require("sap/ushell/Container").getService("LaunchPage").getGroups().then(function(pageGroups) {
			var pageGroup;
			if (group) {
			...
			var bookmarkService = sap.ui.require("sap/ushell/Container").getService("Bookmark");
