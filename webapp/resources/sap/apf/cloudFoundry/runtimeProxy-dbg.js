...
sap.ui.define([
...
], function(Utils, exportToGlobal, Localization) {
	'use strict';
	...
	function RuntimeProxy(serviceConfiguration, inject) {
		...
		var language = Localization.getLanguage(); // TODO shouldn't this rather be getLanguageTag ?
		var defaultHeaders = {
	...
	exportToGlobal("sap.apf.cloudFoundry.RuntimeProxy", RuntimeProxy);
	return RuntimeProxy;
