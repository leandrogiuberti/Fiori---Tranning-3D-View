...
sap.ui.define([
	...
	'sap/m/Tree',
	'sap/m/TreeRenderer'
], function(constants, exportToGlobal, isEmptyObject, Tree, TreeRenderer){
	'use strict';
	 ...
	 * @alias sap.apf.modeler.ui.utils.APFTree
	 */
	var APFTree = Tree.extend("sap.apf.modeler.ui.utils.APFTree", {
		...
		isConfigurationSwitched : function(oPreviousSelectedNode, oCurrentSelectedNode) {
			...
			if (oPreviousSelectedNodeParentDetails && !isEmptyObject(oPreviousSelectedNodeParentDetails) && oPreviousSelectedNodeParentDetails.configId === undefined) {
	...
	/* BEGIN COMPABILITY */
	exportToGlobal("sap.apf.modeler.ui.utils.APFTree", APFTree);
	/* END COMPABILITY */
	return APFTree;
}, true /* GLOBAL_EXPORT */);