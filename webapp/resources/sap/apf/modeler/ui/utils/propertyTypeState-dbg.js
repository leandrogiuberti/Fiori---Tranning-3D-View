...
sap.ui.define([
	...
	function(mNullObjectChecker, Element) {
		'use strict';

		/**
		 * @class
		 * @alias module:sap/apf/modeler/ui/utils/propertyTypeState
		 */
		...
		constructor.prototype.getViewAt = function(nIndex) {
			...
			return Element.getElementById(this.aPropertyTypeViewIds[nIndex]);
		};
