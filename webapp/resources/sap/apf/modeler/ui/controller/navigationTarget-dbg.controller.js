sap.ui.define([
	...
	async function _instantiateSubView(oController) {
		...
		requestOptionsContextMappingController = await Controller.create({
			name: "sap.apf.modeler.ui.controller.navTargetContextMapping"
		});
		oContextMappingView = await View.create({
	...
	return Controller.extend("sap.apf.modeler.ui.controller.navigationTarget", {
		...
		onInitAsync : async function() {
			...
			await _instantiateSubView(oController);
