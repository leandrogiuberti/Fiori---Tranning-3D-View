...
/*global sap*/
sap.ui.define([
	"sap/apf/modeler/ui/controller/facetFilterVHR.controller",
	...
	FacetFilterVHRController,
	FacetFilterFRRController,
	modelerConstants,
	nullObjectChecker,
	...
	async function _instantiateSubViews(oController) {
		...
		const [oVHRView, oFRRView] = await Promise.all([
			View.create({
				viewName : "sap.apf.modeler.ui.view.requestOptions",
				type : ViewType.XML,
				id : oController.createId("idVHRView"),
				viewData : oViewData,
				controller: new FacetFilterVHRController()
			}),
			View.create({
				viewName : "sap.apf.modeler.ui.view.requestOptions",
				type : ViewType.XML,
				...
				viewData : oViewData,
				controller: new FacetFilterFRRController()
			})
		]);
