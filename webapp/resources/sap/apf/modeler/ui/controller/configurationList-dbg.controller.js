...
sap.ui.define([
	...
	return Controller.extend("sap.apf.modeler.ui.controller.configurationList", /** @lends sap.apf.modeler.ui.controller.configurationList.prototype */ {
		...
		onInitAsync : async function() {
			...
			await this._instantiateToolbarView();
			this._instantiateAPFTree();
			await this._instantiateTitleAndBreadCrumbView();
		},
		/**
		 ...
		 * @private
		 */
		_instantiateToolbarView : async function() {
			var toolbarView = await View.create({
		 ...
		 * @private
		 */
		_instantiateTitleAndBreadCrumbView : async function() {
			this.oTitleBreadCrumbView = await View.create({
		 ...
		 * @param {sap.ui.core.mvc.View} oSubView Subview instance 
		 */
		_setSubView : async function(oSubView) {
		 ...
		 */
		updateSubView : async function(oParams) {
			var self = this;
			var oPrevSubView = await this._getSubView();
			...
			var oSubView =  await View.create({
			...
			if (oParams.name !== "applicationList") {
				...
				await this._setSubView(oSubView);
				//Set the sub view instance
				return oSubView;
			}
			return null;
