...
sap.ui.define([
	...
	"sap/apf/utils/utils"
], function(BaseController, modelerConstants, DisplayOptionsValueBuilder, oTextManipulator, constants, utils) {
	"use strict";
	...
	return BaseController.extend("sap.apf.modeler.ui.controller.representationMeasure", {
		...
		getAllPropertiesAsPromise : function() {
			...
			var oConstants = modelerConstants;
		...
		removePropertyFromParentObject : function() {
			var oController = this;
			oController.oRepresentation.removeMeasure(oTextManipulator.removePrefixText(oController.byId("idPropertyType").getSelectedKey(), oController.oTextReader(modelerConstants.texts.NOTAVAILABLE)));
		},
