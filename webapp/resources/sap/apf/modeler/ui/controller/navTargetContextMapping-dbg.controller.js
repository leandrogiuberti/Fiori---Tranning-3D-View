...
sap.ui.define(
	...
	function(BaseController, modelerConstants, textManipulator) {
		"use strict";
		var navTargetContextMapping = BaseController.extend("sap.apf.modeler.ui.controller.navTargetContextMapping", {
			...
			handleChangeForOptionalProperty : function(){
				...
				selectedProperty = textManipulator.removePrefixText(selectedProperty, oTextReader(modelerConstants.texts.NOTAVAILABLE));
