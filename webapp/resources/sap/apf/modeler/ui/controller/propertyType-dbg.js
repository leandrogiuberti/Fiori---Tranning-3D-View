sap.ui.define([
	...
	function _setVisibilityForAddAndRemoveIcons(oController) {
		...
		if (nIndex > 0){
			// TODO due to async loading, the previousPropertyView might not be fully loaded yet.
			// when to hide the add icon then?
	...
	var constructor = Controller.extend("sap.apf.modeler.ui.controller.propertyType", {
		...
		handleSuggestions : function(oEvent) {
			var oController = this;
			var oSuggestionTextHandler = new textPoolHelper.SuggestionTextHandler(oController.oTextPool);
