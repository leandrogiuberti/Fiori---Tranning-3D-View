...
sap.ui.define([
...
], function(nullObjectChecker, optionsValueModelBuilder, textManipulator, textPoolHelper,
			ViewValidator, modelerConstants, uiHandler, utils, coreLibrary, Controller, View, ViewType) {
	"use strict";
	...
	/**
	 * General controller for VHR, FRR,navigation target,step request,step filter mapping
	 ...
	 * @class Request options controller.
	 * @alias sap.apf.modeler.ui.controller.requestOptions
	 */
	var constructor = Controller.extend("sap.apf.modeler.ui.controller.requestOptions", {
		...
		handleShowValueHelpRequest : function(oEvent) {
			...
			if (oViewData.oCoreApi && oViewData.oCoreApi.isUsingCloudFoundryProxy()) {
				...
				// Note: view controller opens the dialog
				View.create({
