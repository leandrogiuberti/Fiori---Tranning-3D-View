sap.ui.define([
	...
	async function _createView(oController, oControllerName, oViewData, oViewName, sUniqueId) {
		return View.create({
			viewName : oViewName,
			type : ViewType.XML,
	...
	async function _instantiateSubViews(oController) {
		...
		stepCornerTextController = await Controller.create({
			name: "sap.apf.modeler.ui.controller.stepCornerTexts"
		});
		await _createView(oController, stepCornerTextController, oViewData, "sap.apf.modeler.ui.view.cornerTexts", "idStepCornerTextView");
		...
		if (bIsHierarchicalStep) {
			stepRequestController = await Controller.create({
		...
		await _createView(oController, stepRequestController, oViewData, "sap.apf.modeler.ui.view.requestOptions", "idStepRequestView");
		...
		stepFilterMappingController = await Controller.create({
			name: "sap.apf.modeler.ui.controller.stepFilterMapping"
		});
		await _createView(oController, stepFilterMappingController, oViewData, "sap.apf.modeler.ui.view.requestOptions", "idStepFilterMappingView");
