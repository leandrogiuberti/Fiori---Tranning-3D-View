...
sap.ui.define([
	...
	function _setSortDirection(oController) {
		...
		var staticValuesBuilder = new StaticValuesBuilder(oController.oTextReader, optionsValueModelBuilder);
	...
	var sortPropertyType = Controller.extend("sap.apf.modeler.ui.controller.sortPropertyType", {
		...
		handleChangeForSortProperty : function(event) {
			...
			var sSelectedPropertyName = oTextManipulator.removePrefixText(oController.byId(propertiesSelectionControlNameConst)
				.getSelectedKey(), oController.oTextReader(modelerConstants.texts.NOTAVAILABLE));
