...
sap.ui.define([
	...
	async function _instantiateCornerTexts(oController) {
		...
		var representationCornerTextController = await MvcController.create({
	...
	async function _instantiateSubViewsAsPromise(oController) {
		oSortDataHandler.instantiateRepresentationSortData();
		await _instantiateCornerTexts(oController);
