...
], function(BaseController, modelerConstants, oTextManipulator, jQuery) {
	"use strict";

	var representationSortPropertyType = BaseController.extend("sap.apf.modeler.ui.controller.representationSortPropertyType", {
		...
		removePropertyFromParentObject : function() {
			var oController = this;
			oController.oParentObject.removeOrderbySpec(oTextManipulator.removePrefixText(oController.byId("idSortProperty").getSelectedKey(), oController.oTextReader(modelerConstants.texts.NOTAVAILABLE)));
		},
