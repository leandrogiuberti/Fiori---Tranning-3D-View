sap.ui.define([
...
], function(BaseController, modelerConstants, oTextManipulator, utils, jQuery) {
	"use strict";
	...
	return BaseController.extend("sap.apf.modeler.ui.controller.representationProperty", {
		...
		removePropertyFromParentObject : function() {
			var oController = this;
			oController.oRepresentation.removeProperty(oTextManipulator.removePrefixText(oController.byId("idPropertyType").getSelectedKey(), oController.oTextReader(modelerConstants.texts.NOTAVAILABLE)));
		},
