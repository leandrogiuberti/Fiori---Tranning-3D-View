...
sap.ui.define([
	...
	"sap/apf/modeler/core/configurationObjects",
	"sap/ui/Global"
], function(configurationEditor, ConfigurationObjects, exportToGlobal, hashtable, utils, configurationObjects, Global) {
	"use strict";
	/**
	 * @private
	...
	function ConfigurationHandler(inject) {
		...
		this.copyConfiguration = function(id, callback) {
			...
			function callbackAfterLoad(configEditor) {
				...
				newConfigObject = ConfigurationObjects.deepDataCopy(configObject);
				newId = getTempId();
