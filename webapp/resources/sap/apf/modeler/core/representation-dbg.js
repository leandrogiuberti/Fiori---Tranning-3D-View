...
sap.ui.define([
...
], function(ConfigurationObjects, exportToGlobal){
	'use strict';
	/**
	 * @private
	...
	var Representation = function(representationId, inject, dataFromCopy) {
		...
		this.copy = function(newIdForCopy) {
			...
			var dataFromCopy = ConfigurationObjects.deepDataCopy(dataForCopy);
			return new Representation((newIdForCopy || this.getId()), inject, dataFromCopy);
		};
	};
	exportToGlobal("sap.apf.modeler.core.Representation", Representation);
