...
sap.ui.define([
	...
	/**
	 * @private
	 * @alias sap.apf.modeler.core.lazyLoader
	 ...
	 * @constructor
	 */
	function LazyLoader(inject, fnLoadInstance, dataForInstantiation) {
	...
	exportToGlobal("sap.apf.modeler.core.LazyLoader", LazyLoader);
