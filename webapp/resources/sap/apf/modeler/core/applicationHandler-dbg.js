...
sap.ui.define([
	 ...
	 * @alias sap.apf.modeler.core.ApplicationHandler
	 */
	function ApplicationHandler(inject, initCallback) {
		var that = this;
	...
	exportToGlobal("sap.apf.modeler.core.ApplicationHandler", ApplicationHandler);
