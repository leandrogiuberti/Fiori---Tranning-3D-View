...
sap.ui.define([
	...
	PaginationHandler.prototype.constructor = PaginationHandler;
	...
	*/
	PaginationHandler.prototype.attachPaginationOnTable = function(oTableInstance) {
	...
	*/
	PaginationHandler.prototype.getPagingOption = function(topN) {
		var top, skip;
	...
	*/
	PaginationHandler.prototype.resetPaginationOption = function() {
		this.pagingOption = { //update the paging option
			top : 100,
			skip : 0
		};
	...
	exportToGlobal("sap.apf.ui.representations.utils.PaginationHandler", PaginationHandler);
