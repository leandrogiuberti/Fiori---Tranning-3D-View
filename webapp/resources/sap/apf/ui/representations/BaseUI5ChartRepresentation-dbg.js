...
sap.ui.define([
	...
	var BaseUI5ChartRepresentation = function(oApi, oParameters) {
		...
		this.oTimeAxisDateConverter = new TimeAxisDateConverter();
		this.oRepresentationFilterHandler = new RepresentationFilterHandler(oApi, this.parameter, this.oTimeAxisDateConverter);
		this.chartInstance = {};
		this.chartParam = "";
		this.thumbnailChartParam = "";
		this.oApi = oApi;
		this.axisType = uiConstants.axisTypes.AXIS;
	...
	BaseUI5ChartRepresentation.prototype = {
		...
		*/
		setData : function(aDataResponse, metadata) {
			if (this.bIsAlternateView && this.toggleInstance && typeof this.toggleInstance.setData === "function") {
				...
				this.oChartDataSetHelper = new ChartDataSetHelper(this.formatter, this.oTimeAxisDateConverter);
				this.oChartDataSetHelper.createFlattenDataSet(this.parameter, metadata, aDataResponse, this.oApi);
				if(this.chartType === uiConstants.vizFrameChartTypes.SCATTERPLOT || this.chartType === uiConstants.vizFrameChartTypes.BUBBLE){
		...
		*/
		getRequestOptions : function(bFilterChanged) {
			if (this.bIsAlternateView && this.toggleInstance && typeof this.toggleInstance.getRequestOptions === "function") {
		...
		*/
		getFilterMethodType : function() {
			return coreConstants.filterMethodTypes.filter; // returns the filter method type the representation supports
		},
		getFilter : function() {
