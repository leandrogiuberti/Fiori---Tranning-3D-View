...
sap.ui.define([
	...
	function _createTreeTableAndBindColumns(aTreeTableColumns, oStepTitle, oTreeTableInstance) {
		...
		aTreeTableColumns.name.forEach(function(columnName, nColumnIndex) {
			oColumnText = new Text({
				text: {
					path: aTreeTableColumns.value[nColumnIndex],
					formatter: formatCellValue(aTreeTableColumns.value[nColumnIndex]),
		...
		//oTreeTableInstance.oTreeTableControlObject.parameters.numberOfExpandedLevels = 99;
