...
sap.ui.define([
	...
	var representationInterface = function(dependencies, configuration) {
		 ...
		 * @param {object|string} controlObject Contains filters and parameters for treetable request handling
		 ...
		 * @param {object|string} oSourceRepresentation Source representation implementing the representationInterface.
		 */
		...
		this.getFilterMethodType = function() {
			return coreConstants.filterMethodTypes.selectionAsArray; // returns the filter method type the representation supports
		};
		/**
		 * @public
		 * @function
		...
		*}
		 ...
		 * @returns {object|string} oParameters
		 */
		 ...
		 * @returns {object|string} oUiObject The UI object that has to be shown in main representation area. Example: Line chart instance for a line chart representation.
		 */
		 ...
		 * @returns {object|string} oUiObject The UI object that has to be shown in thumbnail area. Example: Line chart instance for a line chart representation.
		 */
		 ...
		 * @returns {object|string} oUiObject The UI object that has to be printed. Example: Line chart instance for a line chart representation.
		 */
		 ...
		 * @returns {object|string} oUiObject The UI object that has to be shown as tooltip for a thumbnail. Example: Detailed content of a form representation.
		 */
		 ...
		 * @returns {object|string} oSerializationInformation
		 */
		 ...
		 * @param {object|string} oSerializationInformation
		 */
		 ...
		 * @returns {object|string} oAlternateRepresentation
		 */
