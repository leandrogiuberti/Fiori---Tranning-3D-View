...
], function(mobileLibrary, List, StandardListItem, View) {
	"use strict";

	const ListType = mobileLibrary.ListType;

	/**
	 * layout holds the Toolbar buttons: new , save, open, print.
	 * @class toolbar view
	 * @name sap.apf.ui.reuse.view.toolbar
	 */
	return View.extend("sap.apf.ui.reuse.view.toolbar", /** @lends sap.apf.ui.reuse.view.toolbar.prototype */ {
