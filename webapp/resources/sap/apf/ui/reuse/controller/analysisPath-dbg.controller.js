...
sap.ui.define([
	...
	/**
	 * Controller for view.analysisPath.
	 * @class analysisPath controller
	...
	return BaseController.extend("sap.apf.ui.reuse.controller.analysisPath", {
		...
		/**
		 * Adds loading sign to the active step when the path update has not yet reached that step.
		...
		/**
		 * Performs the update of the main chart and path carousel after the update of the step in the core path.
		...
		/**
		 * Updates a step in the analysis path if step has changed.
		...
		/**
		 * Gets chartArea of application from API sap.apf.ui.getStepConatiner() and draws Chart
		 * @param {boolean} bStepChanged returns true if step has changed
...
//		},
		/**
		 * Navigates to the step with the given index: sets the step to active and draws it in the stepContainer
