...
sap.ui.define([
...
], function(StringToDateFormatter, DateTimeFormatter, TimeFormatter, DecimalFormatter, deepExtend, VizEnvFormat, ChartFormatter) {
	"use strict";
	...
	formatter.prototype.getFormattedValue = function(fieldName, originalFieldValue) {
		...
		var metadataObject = deepExtend({}, oMetadata);
	...
	formatter.prototype.getFormatString = function(measure) {
		...
		VizEnvFormat.numericFormatter(formatterInstance);
	...
	formatter.prototype.getFormattedValueForTextProperty = function(fieldName, oTextToBeFormatted) {
		...
		var metadataObject = deepExtend({}, _getPropertyMetadata(this, fieldName));
