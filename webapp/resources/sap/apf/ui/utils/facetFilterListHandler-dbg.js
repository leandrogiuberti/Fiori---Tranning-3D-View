...
sap.ui.define([
	...
	function FacetFilterListHandler(oCoreApi, oUiApi, oConfiguredFilter) {
		...
		var oFacetFilterListConverter = new FacetFilterListConverter();
		/**
		* @private
		* @function
		...
		* */
		function _populateValues(aFilterValues, sSelectProperty, oPropertyMetadata, bFilterChanged) {
			var aFFValueFormatter = new FacetFilterValueFormatter(oUiApi, oCoreApi);
		...
		this.createFacetFilterList = function () {
			...
			oFacetFilterList = new FacetFilterList({
				...
				mode : oConfiguredFilter.isMultiSelection() ? ListMode.MultiSelect : ListMode.SingleSelectMaster,
