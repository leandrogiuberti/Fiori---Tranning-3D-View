...
sap.ui.define([
	...
	"sap/ui/core/Icon",
	"sap/ui/core/library"
], function (mVBox, mFlexBox, mLibrary, mText, UiUtilsConstants, trace, Icon, coreLibrary) {
	'use strict'

	const mFlexAlignItems = mLibrary.FlexAlignItems;
	const mFlexJustifyContent = mLibrary.FlexJustifyContent;
