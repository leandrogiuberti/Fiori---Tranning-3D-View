...
sap.ui.define([
...
],	function(exportToGlobal, utils, MetadataProperty, jQuery) {
	'use strict';
	/** 
	 ...
	 * @alias sap.apf.core.MetadataFacade
	 */
	function MetadataFacade(oInject, sAbsolutePathToServiceDocument) {
		/**
	...
	exportToGlobal("sap.apf.core.MetadataFacade", MetadataFacade);
