...
sap.ui.define([
...
], function(constants, exportToGlobal, utils, Ui5Filter, EncodeURL){
	'use strict';
	/**
	 * @private
	...
	var FilterTerm = function(oMsgHandler, propertyName, operatorName, value, highValue) {
		...
		oMsgHandler.check(constants.aSelectOpt.includes(this.operator), "sap.apf.core.utils.FilterTerm operator " + this.operator + " not supported");
	...
	exportToGlobal("sap.apf.core.utils.FilterTerm", FilterTerm);
