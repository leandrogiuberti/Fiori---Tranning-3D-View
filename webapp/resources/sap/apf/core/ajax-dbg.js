...
sap.ui.define([
...
], function(checkForTimeout, exportToGlobal, deepExtend, ODataUtils, jQuery) {
	'use strict';
	...
	function _ajax(settingsAndInject) {
		...
		var oAjaxSettings = deepExtend({}, settingsAndInject);
	...
	/*BEGIN_COMPATIBILITY*/
	exportToGlobal("sap.apf.core.ajax", _ajax);
	/*END_COMPATIBILITY*/
