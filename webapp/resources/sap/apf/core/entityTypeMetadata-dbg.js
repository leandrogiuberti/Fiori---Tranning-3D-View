...
sap.ui.define([
	 ...
	 * @alias sap.apf.core.EntityTypeMetadata
	 */
	function EntityTypeMetadata(oMessageHandler, sEntityType, oMetadata) {
		/**
	...
	exportToGlobal("sap.apf.core.EntityTypeMetadata", EntityTypeMetadata);
