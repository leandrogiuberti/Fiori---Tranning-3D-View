 ...
 */
sap.ui.define([ 'sap/ui/commons/RowRepeaterRenderer', 'sap/ui/commons/library', 'sap/ui/core/Renderer', "sap/ui/core/Element"],
	function(RowRepeaterRenderer, CommonsLibrary, Renderer, Element) {
	"use strict";
	...
	ViewRepeaterRenderer.render = function(oRm, oControl) {
		...
		if (oControl.getExternal() !== true) {
			...
			oRm.renderControl(Element.getElementById(oControl.getAssociation("externalRepresentation")));
		}
