 ...
 */
sap.ui.define(['sap/ui/core/Renderer', 'sap/ui/ux3/NavigationBarRenderer', "sap/ui/core/Element"],
	function(Renderer, NavigationBarRenderer, Element) {
	"use strict";

	/**
	 * VerticalNavigationBar renderer.
	 * @namespace
	 */
	...
	VerticalNavigationBarRenderer.getItemsHtml = function(oRm, oControl) {
		...
		for (var i = 0; i < iNoOfItems; i++) {
			var oItem = bNeedToGetInstances ? Element.getElementById(aItems[i]) : aItems[i];
