...
sap.ui.define([
	...
	"sap/ui/core/Locale"
			 ...
			 CommonsHorizontalLayout, LayoutHorizontalLayout, HTML, TextField, InPlaceEdit, Label, ListBox, TextArea, encodeXML, URLListValidator, NoteTakerCardRenderer, Element, Lib, Localization, Locale) {
	"use strict";
	...
	NoteTakerCard.prototype._handleAddTag = function (sTag) {
		...
		var oTagPanel = Element.getElementById(this.getId() + '-overlayTagPanel');
	...
	NoteTakerCard.prototype._prepareAttachmentPanel = function (bIsInOverlay) {
		...
		var oCurrentControl = Element.getElementById(sId);
		if (oCurrentControl) {
