...
sap.ui.define([
		...
		var that = this, //eslint-disable-line
			...
			fnGetLimitValue = function (asc) {
				...
				if (BaseObject.isA(oListBinding, "sap.ui.model.json.JSONListBinding") && aContexts.length === 0) {
					return Promise.reject();
				} else if (aContexts.length > 0 && aContexts[0].getProperty(sDateTimePath)) {
	...
	Timeline.prototype._bindGroupingAndSorting = function (oBindingInfo) {
		...
		if (this._isGrouped()) {
			...
			oBindingInfo.groupHeaderFactory = this._createGroupHeader.bind(this);
	...
	Timeline.prototype.setData = function (oData) {
		...
		oBindOptions = {
			...
			factory: fnDefaultItemsFactory.bind(this)
		};

		if (this._isGrouped()) {
			oBindOptions.groupHeaderFactory = this._getGroupHeader.bind(this);
		}
