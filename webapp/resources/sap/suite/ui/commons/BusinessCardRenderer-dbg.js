...
sap.ui.define([ 'sap/ui/commons/library', 'sap/ui/commons/Label', 'sap/ui/core/ControlBehavior' ],
	function(CommonsLibrary, Label, ControlBehavior) {
	"use strict";
	...
	BusinessCardRenderer.render = function(rm, oControl) {
		// accessibility
		var bAcc = ControlBehavior.isAccessibilityEnabled;
