...
sap.ui.define([ "sap/ui/thirdparty/jquery", './library', 'sap/ui/ux3/library', 'sap/ui/ux3/NavigationBar', 'sap/ui/commons/library', 'sap/ui/commons/RichTooltip', "./VerticalNavigationBarRenderer", "sap/ui/core/Element", "sap/ui/core/Lib" ],
	function(jQuery, library, Ux3Library, NavigationBar, CommonsLibrary, RichTooltip, VerticalNavigationBarRenderer, Element, Lib) {
	"use strict";
	...
	VerticalNavigationBar.prototype.init = function() {
		...
		if (!this._oResBundle) {
			this._oResBundle = Lib.getResourceBundleFor("sap.suite.ui.commons");
		}
	};
	...
	VerticalNavigationBar.prototype._showTooltip = function(sTargetId) {
		...
		if (!oItem) {
			oItem = Element.getElementById(sTargetId);
