...
sap.ui.define(['./util/FeedItemUtils', 'sap/ui/core/Lib', "sap/base/i18n/Localization"],
	function(FeedItemUtils, Lib, Localization) {
	"use strict";
	...
	FeedTileRenderer.render = function(oRm, oControl) {
		...
		var oResBundle = Lib.getResourceBundleFor("sap.suite.ui.commons", oLocale);
