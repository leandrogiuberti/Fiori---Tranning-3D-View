sap.ui.define([
...
], function(Controller, SelectionVariant, MessageBox, oData4Analytics) {
	"use strict";
	...
	var cController = Controller.extend("sap.suite.ui.generic.template.AnalyticalListPage.controller.KpiCard", {
