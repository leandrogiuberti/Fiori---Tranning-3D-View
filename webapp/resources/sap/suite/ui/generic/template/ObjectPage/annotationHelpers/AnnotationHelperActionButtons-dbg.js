...
sap.ui.define([
	...
	function getEasyFillButtonVisibility(oInterface, mRestrictions, oEntitySet, oAppComponent, oTreeNode, aAncestortreeNodes) {
		...
		return fnCombineByAnd(sGeneralExpression, sFCLExpression, sPathExpression, sParentPath);
	}
	getEasyFillButtonVisibility.requiresIContext = true;
