sap.ui.define(["sap/ui/base/Object",
	...
	function getMethods(oTemplateUtils, oController, oState) {
		...
		return /** @lends sap.suite.ui.generic.template.extensionAPI.NavigationController.prototype */ {
			 ...
			 * @param {sap.suite.ui.generic.template.displayMode} [oNavigationData.displayMode] This gives the provision to the application developer to choose between "display"/"edit" mode for target page
			...
			navigateInternal: function(vContext, oNavigationData) {
				// In case where internal navigation is triggered from our side i.e. navigation within the same parent entity set, for example, navigation from 
				// object page to sub object page, draft is not synchronized. However, as of now, call to navigateInternal API does not check the type of navigation
				// (whether it triggers a navigation within the same parent entity set context or moves out of the parent entity set context) and always synchronise
				// the draft data.
