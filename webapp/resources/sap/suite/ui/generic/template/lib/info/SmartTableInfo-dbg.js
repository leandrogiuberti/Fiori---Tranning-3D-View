            ...
            if (typeof (vExpression) === "string") {
                ...
                if (sPath && sPath.indexOf("/") > 0 && oEntityType.navigationProperty) {
                    ...
                    */
                    ...
                    if (!aHiddenColumnInfo.columnKeyToCellHiddenPath) {
                        var mColumnKeyToDynamicHiddenPath = Object.create(null);
                        aHiddenColumnInfo.columnKeyToCellHiddenPath = mColumnKeyToDynamicHiddenPath;
                    }
                    aHiddenColumnInfo.columnKeyToCellHiddenPath[sColumnKey] = sPath;
                }
            } else if (!vExpression) {
                aStaticHiddenColumns.push(sColumnKey);
            }
