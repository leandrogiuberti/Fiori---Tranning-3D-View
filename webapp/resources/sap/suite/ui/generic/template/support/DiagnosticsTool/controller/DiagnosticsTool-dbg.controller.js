sap.ui.define([
	...
	"sap/ui/VersionInfo"
], function (Controller, MessageToast, MessageBox, FeLogger, Documentation, VersionInfo) {
	"use strict";
	...
	function fnOnInit() {
		...
		VersionInfo.load().then(function (oCurrentVersionInfo) {
			oUI5VersionInfo = oCurrentVersionInfo;
		});
	}
	...
	function fnOnCopyDataPlain() {
		...
		sContent += sPrefix + "Documentation: " + Documentation.getDocuURL(oUI5VersionInfo) + sNewLine;
		sContent += sNewLine;
	...
	function fnOnCopyDataHTML() {
		...
		sContent += sPrefix + "Documentation: " + "<a href=\"" + Documentation.getDocuURL(oUI5VersionInfo) + "\" rel=\"noopener noreferrer\">" + Documentation.getDocuURL(oUI5VersionInfo) + "</a>" + sSuffix;
		sContent += sNewLine;
	...
	function fnOnShowDocumentation() {
		Documentation.openDocumentation(oUI5VersionInfo);
	}
