sap.ui.define([
	...
	function getMethods(oSupportStub) {
		...
		function fnAddVersionInfo(iSortOrder) {
			if (oUI5VersionInfo && CommonMethods.hasObjectContent(oUI5VersionInfo)) {
				fnAddStringToData("OpenUI5 Version", iSortOrder, oUI5VersionInfo.version + " (built at " + fnFormatDate(oUI5VersionInfo.buildTimestamp) + ")");
				return true;
			} else {
