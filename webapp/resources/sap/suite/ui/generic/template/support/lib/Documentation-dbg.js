...
sap.ui.define([
	 ...
	 */
	function fnGetDocuURL(oUI5VersionInfo) {
		var sUI5Version = oUI5VersionInfo.version;
	 ...
	 */
	function fnOpenDocumentation(oUI5VersionInfo) {
		mLibrary.URLHelper.redirect(fnGetDocuURL(oUI5VersionInfo), true);
	}
