sap.ui.define(["sap/suite/ui/generic/template/lib/StableIdDefinition", 	"sap/suite/ui/generic/template/genericUtilities/FeLogger"
	...
	function getStableId(oParameters){
		...
		if (!StableIdDefinition.types[oParameters.type]) {return handleError("Invalid type " + oParameters.type + " provided");}
		if (!StableIdDefinition.types[oParameters.type][oParameters.subType]) {return handleError("Invalid subType " + oParameters.subType + " provided");}
