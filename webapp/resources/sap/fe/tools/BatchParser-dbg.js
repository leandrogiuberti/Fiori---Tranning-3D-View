...
sap.ui.define([], function () {
   ...
   *
   */
  let BatchContent = /*#__PURE__*/function () {
    ...
    _exports.BatchContent = BatchContent;
    var _proto = BatchContent.prototype;
    _proto.lookLine = function lookLine() {
  ...
  _exports.BatchContent = BatchContent;
  let Batch = function Batch(isChangeSet, boundary) {
  ...
  _exports.getBoundary = getBoundary;
  ...
  function parseBatch(content, boundary) {
    let isChangeset = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    const boundaryNext = "--" + boundary;
    const boundaryEnd = "--" + boundary + "--";
  ...
  _exports.parseBatch = parseBatch;
  return _exports;
}, false);
//# sourceMappingURL=BatchParser-dbg.js.map
