...
sap.ui.define([
    ...
    function Bag (oFactory, oAlterEgo, oParentBag, fnChangeListener) {
        ...
        function fillPropertyMap (oBagData, oAcceptedNames) {
            const aProperties = (oBagData.Properties && oBagData.Properties.results)
            ...
            aProperties.forEach((oPropertyData) => {
                const sName = oPropertyData.name;
                let oOldProperty;
        ...
        this.getPropertyNames = function () {
            const aPropertyNames = oParentBag ? oParentBag.getPropertyNames() : [];
        ...
        this.getText = function (sTextName) {
            const oProperty = oPropertiesByName.get(sTextName);
        ...
        this.getTextNames = function () {
            const aTextNames = oParentBag ? oParentBag.getTextNames() : [];
        ...
        this.reset = function (fnSuccess, fnFailure) {
            ...
            oPbs.deleteBag(oParent, oAlterEgo.id, () => {
                oAlterEgo.$tmp = true;
        ...
        this.save = function (fnSuccess, fnFailure) {
            ...
            const mErrorResponseByName = {};
            const oParentMock = getParentMock();
            const oPbs = oFactory.getPageBuildingService();
            ...
            oPropertiesByName.keys().forEach((sName) => {
                let oUpdatedProperty;
                const oProperty = oPropertiesByName.get(sName);
