...
sap.ui.define(["sap/ui/core/mvc/View", "sap/m/List", "sap/m/VBox"], function(View, List, VBox) {
	"use strict";

	return View.extend("sap.collaboration.components.fiori.sharing.FolderSelectionView", {
