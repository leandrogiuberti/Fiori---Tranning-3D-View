...
sap.ui.define(["sap/ui/core/mvc/View", "sap/m/VBox", "sap/ui/layout/VerticalLayout", "sap/ui/core/HTML", "sap/m/library", "sap/m/Link"], function(View, VBox, VerticalLayout, HTML, mobileLibrary, Link) {
	"use strict";

	// shortcut for sap.m.FlexAlignItems
	var FlexAlignItems = mobileLibrary.FlexAlignItems;

	return View.extend("sap.collaboration.components.fiori.sharing.NoGroupsView", {
