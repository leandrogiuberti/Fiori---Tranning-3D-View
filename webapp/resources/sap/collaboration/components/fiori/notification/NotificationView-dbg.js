...
sap.ui.define(['./NotificationContainer', 'sap/collaboration/library', 'sap/ui/core/mvc/View', 'sap/m/Image', 'sap/m/Text', 'sap/m/VBox', 'sap/ui/core/library'],
	function(NotificationContainer, library, View, Image, Text, VBox, coreLibrary) {
	"use strict";

	// shortcut for sap.ui.core.TextAlign
	var TextAlign = coreLibrary.TextAlign;

	return View.extend("sap.collaboration.components.fiori.notification.NotificationView", {
