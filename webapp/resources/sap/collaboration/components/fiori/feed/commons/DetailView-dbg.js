...
* @private
*/
sap.ui.define(["sap/ui/core/mvc/View", "sap/m/Page", "sap/m/ScrollContainer"], function(View, Page, ScrollContainer) {
	"use strict";

	return View.extend("sap.collaboration.components.fiori.feed.commons.DetailView",
