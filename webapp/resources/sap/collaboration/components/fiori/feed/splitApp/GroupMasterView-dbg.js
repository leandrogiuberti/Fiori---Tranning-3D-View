...
sap.ui.define(["sap/ui/core/mvc/View", "sap/m/Page", "sap/m/List"], function(View, Page, List) {
	"use strict";

	return View.extend("sap.collaboration.components.fiori.feed.splitApp.GroupMasterView", {
