...
sap.ui.define([
	...
	return Controller.extend("sap.collaboration.components.fiori.feed.splitApp.SplitApp", {
			...
			createMasterDetail : function() {
				...
				this.sJamToken = oODataUtil.getJamToken(this.oOdataModel);
				 ...
				 View.create({
					...
					viewName: "module:sap/collaboration/components/fiori/feed/splitApp/FeedTypeMasterView"
				}).then((oMasterView)=>{
				...
				View.create({
					...
					viewName: "module:sap/collaboration/components/fiori/feed/commons/DetailView"
				}).then((oDetailView)=>{
					this.oSplitApp.addMasterPage(oDetailView);
					this.oSplitApp.setInitialMaster(oDetailView);
				});
