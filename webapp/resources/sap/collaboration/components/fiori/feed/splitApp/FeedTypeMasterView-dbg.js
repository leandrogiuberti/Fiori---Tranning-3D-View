...
sap.ui.define(["sap/ui/core/mvc/View", "sap/m/Page", "sap/m/List", "sap/m/StandardListItem", "sap/m/library"], function(View, Page, List, StandardListItem, mobileLibrary) {
	"use strict";

	// shortcut for sap.m.ListType
	var ListType = mobileLibrary.ListType;

	View.extend("sap.collaboration.components.fiori.feed.splitApp.FeedTypeMasterView", {
