...
sap.ui.define(["sap/ui/core/mvc/View", "sap/m/SplitApp"], function(View, SplitApp) {
	"use strict";

	return View.extend("sap.collaboration.components.fiori.feed.splitApp.SplitAppView", {
		...
		*/
		createContent : async function(oController) {
			oController.createMasterDetail();
