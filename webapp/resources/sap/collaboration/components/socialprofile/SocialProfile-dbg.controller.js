...
], function(Log, encodeURL, isEmptyObject, CommonUtil, Controller, ODataModel, JSONModel) {
	"use strict";

	return Controller.extend("sap.collaboration.components.socialprofile.SocialProfile", {
		...
		*/
		...
		_getMember: function(){
			...
			this._oJamODataModel.metadataLoaded().then(() => {
