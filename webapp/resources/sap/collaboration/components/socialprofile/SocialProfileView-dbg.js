 ...
 */
sap.ui.define(["sap/ui/core/mvc/View", "sap/m/VBox", "sap/m/Label", "sap/m/Text", "sap/m/Link", "sap/m/HBox", "sap/m/Image", "sap/m/ObjectStatus"], function(View, VBox, Label, Text, Link, HBox, Image, ObjectStatus) {
	"use strict";

	return View.extend("sap.collaboration.components.socialprofile.SocialProfileView", {
