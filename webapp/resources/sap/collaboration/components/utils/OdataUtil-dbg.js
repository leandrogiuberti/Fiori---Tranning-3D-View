...
sap.ui.define([
	...
	var OdataUtil = BaseObject.extend("sap.collaboration.components.utils.OdataUtil",{
		 ...
		 * @private
		 * @deprecated As of version 1.120 as all usages are in deprecated code (fiori/feed)
		 */
		 ...
		 * @return {request} a request object for this end point
		 * @private
		 * @deprecated As of version 1.120 as there are no more usages of this private method
		 */
		 ...
		 * @private
		 * @deprecated As of version 1.120 as all usages are in deprecated code (fiori/feed, fiori/notification)
		 */
		 ...
		 * @deprecated As of version 1.120 as all usages are in deprecated code (#executeODataBatchRequest, socialtimeline)
		 */
		 ...
		 * @return {request} a request object for this end point
		 * @private
		 * @deprecated As of version 1.120 as all usages are in deprecated code (fiori/notification)
		 */
		 ...
		 * @param oPromise
		 * @public
		 * @deprecated As of version 1.120 as all usages are in deprecated code (fiori/feed, socialtimeline)
		 */
