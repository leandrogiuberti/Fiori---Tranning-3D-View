...
sap.ui.define(["../../../../i18n", "sap/ui/thirdparty/d3", "sap/ui/core/Control", "../../FacetTypeUI", "sap/ui/core/Element"], function (__i18n, thirdpartyD3, Control, ____FacetTypeUI, Element) {
  ...
  const SearchFacetPieChart = Control.extend("sap.esh.search.ui.controls.SearchFacetPieChart", {
    ...
    getFacetIndexByIdForLargePieChart: function _getFacetIndexByIdForLargePieChart(chartId) {
      ...
      const ar = Array.from(document.querySelectorAll(".searchFacetLargeChartContainer"));
    ...
    getDataForPieChartLarge: function _getDataForPieChartLarge(facetItems, model, facetTotalCount, maxItemsToShow) {
      const group = [];
      let itemValue = 0;
      const searchResultTotal = model.oData.count;
      let overallTotal;
    ...
    directUpdate: function _directUpdate(facetItems, piechartParent, model, facetTotalCount, options) {
      let model1;
      const fewerData = [];
      ...
      this.chartElements = this.getDataForPieChartLarge(facetItems, model1, facetTotalCount, maxItemsToShow);
    ...
    onAfterRendering: function _onAfterRendering() {
      ...
      if (model) {
        ...
        } else if (piechartParent && piechartParent.className === "largeChart2piechart") {
          // pie chart
          piechartParent.setAttribute("tabindex", "0");
        }
      }
    }
  });
...
//# sourceMappingURL=SearchFacetPieChart-dbg.js.map
