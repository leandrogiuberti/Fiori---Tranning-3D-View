 ...
 * 
 */
sap.ui.define(["./performancelogging/PerformanceLogger", "./SelectionMode"], function (__PerformanceLogger, ___SelectionMode) {
  "use strict";
  ...
  class SearchConfigurationSettings {
     ...
     */
    searchResultTablePersonalization = true;
    ...
    getSpaceFacetId = undefined; // obsolete since there is no space facet any longer (DSP, stakeholder coding clean-up)
    getFirstSpaceCondition = null; // obsolete since there is no space facet any longer (DSP, stakeholder coding clean-up)
    cleanUpSpaceFilters = null; // replaced by 'adjustFilters'
  ...
  const deprecatedParameters = {
    ...
    bNoAppSearch: {},
    selectionChange: {
      replacementInfo: "Subscribe to event 'selectionChanged' of SearchCompositeControl. As of version 1.137.0, this setting is ignored."
    },
    nlq: {
      replacedBy: "aiNlq"
    },
    displayFacetPanelInCaseOfNoResults: {
      replacementInfo: "Setting is ignored as of version 1.134.0. The facet panel visibility is controlled by user or personalization."
    },
    getSpaceFacetId: {
      replacementInfo: "Setting is ignored as of version 1.136.0. There is no space facet any longer (DSP, stakeholder coding clean-up)"
    },
    ...
    enableMultiSelectionResultItems: {
      ...
      replacementInfo: "Setting replaced as of version 1.141.0. The new property 'resultviewSelectionMode' supports single-select as well as multi-select ('None', 'OneItem', 'MultipleItems').\nFor master-detail scenarios, use in combination with 'resultviewMasterDetailMode'.\nTo show a button for switching selection mode on/off, see 'showSelectionToggleButton'."
    },
    extendTableColumn: {
      replacementInfo: "Make use of formatters to add custom attributes (see config.sinaConfiguration, 'metadataFormatters' and 'searchResultSetFormatters').\nDeprecated as of version 1.141."
    }
  };
   ...
   */
  const urlForbiddenParameters = ["modulePaths"];
  ...
  SearchConfigurationSettings.urlForbiddenParameters = urlForbiddenParameters;
...
//# sourceMappingURL=SearchConfigurationSettings-dbg.js.map
