 ...
 * 
 */
sap.ui.define(["sap/base/Log", "../i18n", "./AppSuggestionProvider", "./RecentlyUsedSuggestionProvider", "./SinaSuggestionProvider", "./SuggestionType", "./TimeMerger", "sap/esh/search/ui/SearchHelper", "../eventlogging/UserEvents", "sap/ui/core/Element"], function (Log, __i18n, __AppSuggestionProvider, __RecentlyUsedSuggestionProvider, __SinaSuggestionProvider, ___SuggestionType, __TimeMerger, SearchHelper, ___eventlogging_UserEvents, Element) {
  "use strict";
  ...
  const TimeMerger = _interopRequireDefault(__TimeMerger); // import TransactionSuggestionProvider, { TransactionSuggestion } from "./TransactionSuggestionProvider";
  ...
  class SuggestionHandler {
    ...
    isSuggestionPopupVisible() {
      ...
      return Array.from(suggestions).some(suggestion => suggestion.offsetParent !== null);
    }

    // do suggestions
    // ===================================================================
    doSuggestion(filter) {
      if (filter?.searchTerm?.toLocaleLowerCase().indexOf("/o") === 0 || filter?.searchTerm?.toLocaleLowerCase().indexOf("/n") === 0) {
        ...
        this.timeMerger.process(results => {
          ...
          for (let j = 0; j < results.length; ++j) {
            ...
            if (typeof result !== "object") {
              this._oLogger.error("A suggestion provider returned a bad response " + filter.searchTerm + "'\n" + result);
              continue;
            }
...
//# sourceMappingURL=SuggestionHandler-dbg.js.map
