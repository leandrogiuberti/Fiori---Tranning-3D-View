 ...
 * 
 */
sap.ui.define(["./controls/resultview/SearchResultListSelectionHandler", "./controls/resultview/SearchResultListItemNote", "./SearchConfigurationSettings", "sap/base/Log", "sap/base/assert", "./SelectionMode"], function (__SearchResultListSelectionHandler, __SearchResultListItemNote, __SearchConfigurationSettings, Log, assert, ___SelectionMode) {
  "use strict";
  ...
  const urlForbiddenParameters = __SearchConfigurationSettings["urlForbiddenParameters"];
  ...
  class SearchConfiguration extends SearchConfigurationSettings {
    ...
    checkForDeprecatedParameters(configuration) {
    ...
    static extendSearchConfiguration(target, ...sources) {
    ...
    isWebCompSearchFieldGroupEnabled() {
      // check feature flag
...
//# sourceMappingURL=SearchConfiguration-dbg.js.map
