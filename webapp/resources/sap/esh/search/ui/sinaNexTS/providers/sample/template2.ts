...
export function createTemplate(oContext: Provider): ITemplate {
    const gen: ITemplate = {} as ITemplate;
    gen.metadata = [];
    gen.metadata2 = [];
    ...
    if (
        ...
        detailAttributes = [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/scientist_hannah.jpg",
                metadata: gen.getMetadataById(gen.metadata, "PIC"),
            }),
        ];

        gen.searchResultSetItemArray.push(
            oContext.sina._createSearchResultSetItem({
                attributes: [],
        ...
        detailAttributes = [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/scientist_RobertSarmast.jpg",
                metadata: gen.getMetadataById(gen.metadata, "PIC"),
            }),
        ];
        ...
        detailAttributes = [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    '"I heard the sound of a baby crying... I heard the sound of a baby crying... I heard the sound of a baby crying... I heard the sound of a baby crying... "',
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/galapagos.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ];

        gen.searchResultSetItemArray2.push(
            oContext.sina._createSearchResultSetItem({
                attributes: [],
        ...
        detailAttributes = [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    '"The discovery could mean a tourism bonanza for Cyprus once the word gets out"',
                metadata: gen.getMetadataById(gen.metadata2, "DESC"),
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: "PIC",
        ...
        detailAttributes = [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "it would be impossible for ancient humans with their limited technology to accomplish such a thing",
                metadata: gen.getMetadataById(gen.metadata2, "DESC"),
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: "PIC",
        ...
        detailAttributes = [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "Was the temple platorm a huge landing site for the aliens who once visited our planet?",
                metadata: gen.getMetadataById(gen.metadata2, "DESC"),
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: "PIC",
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/heliopolis.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ];
        ...
        detailAttributes = [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "Numerous people have reported seeing strange lights in the sky while staying a Wycliffe.",
                metadata: gen.getMetadataById(gen.metadata2, "DESC"),
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: "PIC",
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/Wycliffe_Well.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ];
        ...
        detailAttributes = [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "11,000 year old stone structures that predate stonehenge by 6,000 years - crafted and arranged by prehistoric people who had not yet developed metal tools or even pottery; but no evidence that people resided there.",
                metadata: gen.getMetadataById(gen.metadata2, "SCIENTIST"),
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: "PIC",
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/Goebekli_Tepe_Urfa.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ];
