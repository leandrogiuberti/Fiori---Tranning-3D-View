...
import { Provider as SampleProvider } from "./Provider";
import { createTemplateMetadata } from "./template_metadata";
import { createTemplateDetails as createTemplateDetailsFolklorists } from "./template_details_folklorists";
import { createTemplateDetails as createTemplateDetailsLegends } from "./template_details_legends";
import { createTemplateDetails as createTemplateDetailsPublications } from "./template_details_publications";

export function createTemplate(oContext: SampleProvider): ITemplate {
    ...
    gen._init = function (metadataRoot: ITemplate) {
        // folklorists
    ...
    if (
        ...
        */
        ...
        gen.searchResultSetItemArray3.push(
            oContext.sina._createSearchResultSetItem({
                attributes: titleAttributes.concat(detailAttributes),
