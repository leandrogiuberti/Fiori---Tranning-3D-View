...
export function createTemplateDetails(
    oContext: Provider,
    gen: ITemplate
): {
    alligator: Array<SearchResultSetItemAttribute>;
    slenderman: Array<SearchResultSetItemAttribute>;
    chupacabra: Array<SearchResultSetItemAttribute>;
    hitchhiker: Array<SearchResultSetItemAttribute>;
    hitchhiker2: Array<SearchResultSetItemAttribute>;
    babytrain: Array<SearchResultSetItemAttribute>;
} {
    const res: {
        alligator: Array<SearchResultSetItemAttribute>;
        slenderman: Array<SearchResultSetItemAttribute>;
        ...
        alligator: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    'In "The World Beneath The City" (1959), Robert Daley describes the history of the problems encountered while developing the network of utilities beneath Manhattan island, and reports that sewer inspectors first saw aligators in 1935, and that their average length was about 2 feet.',
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/alligator.jpg",
        ...
        slenderman: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/slender_man.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ],
        ...
        chupacabra: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "The first sightings of the Chupacabra were reported in Puerto Rico. The name originates from the their reported habit of attacking and drinking the blood of livestock, including goats.",
                metadata: gen.getMetadataById(gen.metadata2, "DESC"),
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: "PIC",
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/chupacabra.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ],
        ...
        hitchhiker: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "People traveling by vehicle encounter a hitchhiker who later vanishes without explanation, sometimes from the moving vehicle. The vanishing hitchhiker can also leave information that encourages the motorist to later try to make contact with them.",
                metadata: gen.getMetadataById(gen.metadata2, "DESC"),
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: "PIC",
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/hitchhiker.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ],
        ...
        hitchhiker2: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    'The general public became widely aware of the legend after the publication of the book "The Vanishing Hitchhiker" (1981) in which the author, Harold Brunvan, suggests that the legend can be traced as far back as the 1870s and has parallels in Korea, Russia, China, and among Mormons and people living in Arkansas mountains.',
                metadata: gen.getMetadataById(gen.metadata2, "DESC"),
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: "PIC",
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/vanishing.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ],
        ...
        babytrain: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/babytrain.jpg",
                metadata: gen.getMetadataById(gen.metadata2, "PIC"),
            }),
        ],
    };
