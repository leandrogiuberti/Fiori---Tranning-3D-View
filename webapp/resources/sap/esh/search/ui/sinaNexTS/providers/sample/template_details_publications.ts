...
export function createTemplateDetails(
    ...
    alligatorbook: Array<SearchResultSetItemAttribute>;
    slendermanbook: Array<SearchResultSetItemAttribute>;
    chupacabrabook: Array<SearchResultSetItemAttribute>;
    hitchhikerbook: Array<SearchResultSetItemAttribute>;
    hitchhiker2book: Array<SearchResultSetItemAttribute>;
    babytrainbook: Array<SearchResultSetItemAttribute>;
} {
    const res: {
        alligatorbook: Array<SearchResultSetItemAttribute>;
        slendermanbook: Array<SearchResultSetItemAttribute>;
        ...
        alligatorbook: [
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/suv_thumbnail.jpg",
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    'Robert Daley\'s "The World Beneath The City" (1959), a history of the problems said aware to be involved in developing the network of utilities beneath Manhattan island, aware of reports that sewer inspectors first saw aligators in 1935, and confirms that their average length was about 2 feet. ',
        ...
        chupacabrabook: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    " The first purported sightings were reported in Puerto Rico. The name comes from the animal's reported habit of attacking and drinking the blood of livestock, including goats.",
                metadata: gen.getMetadataById(gen.metadata3, "DESC"),
            }),
        ],
        ...
        hitchhikerbook: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "People traveling by vehicle meet with or are accompanied by a hitchhiker who subsequently vanishes without explanation, often from a moving vehicle. The vanishing hitchhiker can also leave some form of information that encourages the motorist to make subsequent contact.",
                metadata: gen.getMetadataById(gen.metadata3, "DESC"),
            }),
        ],
