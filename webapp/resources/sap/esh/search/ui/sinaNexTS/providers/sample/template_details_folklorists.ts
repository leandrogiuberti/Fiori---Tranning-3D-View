...
export function createTemplateDetails(
    ...
    george: Array<SearchResultSetItemAttribute>;
    shira: Array<SearchResultSetItemAttribute>;
    benjamin: Array<SearchResultSetItemAttribute>;
    richard: Array<SearchResultSetItemAttribute>;
    rosalie: Array<SearchResultSetItemAttribute>;
    bill: Array<SearchResultSetItemAttribute>;
    fureys: Array<SearchResultSetItemAttribute>;
} {
    const res: {
        george: Array<SearchResultSetItemAttribute>;
        shira: Array<SearchResultSetItemAttribute>;
        ...
        george: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "https://www.abebooks.com/Journal-American-Folklore-Society-Vol-368/22552416159/bd",
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "While most legends are based on rumors, embellished half truths or unsubstantiated claims, the legend of aligators in the sewers can be traced back to historical documentation.",
        ...
        shira: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/folklorist_chess.jpg",
                metadata: gen.getMetadataById(gen.metadata, "PIC"),
            }),
        ],
        ...
        benjamin: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/folklorist_radford.jpg",
                metadata: gen.getMetadataById(gen.metadata, "PIC"),
            }),
        ],
        ...
        richard: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/folklorist_beardsley.jpg",
                metadata: gen.getMetadataById(gen.metadata, "PIC"),
            }),
        ],
        ...
        rosalie: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "/resources/sap/esh/search/ui/sinaNexTS/providers/sample/images/folklorist_handkey.jpg",
                metadata: gen.getMetadataById(gen.metadata, "PIC"),
            }),
        ],
        ...
        fureys: [
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                valueFormatted:
                    "https://en.wikipedia.org/wiki/The_Fureys#/media/File:Finbar_&_Eddie_Furey.jpg",
                metadata: gen.getMetadataById(gen.metadata, "PIC"),
            }),
        ],
    };
