...
import { ITemplateMetadata } from "./ITemplateMetadata";
import { Provider } from "./Provider";

export function createTemplateMetadata(oContext: Provider): ITemplateMetadata {
    const res: ITemplateMetadata = {
        /*
            folklorists
        */
        metadata: [
            ...
            oContext.sina._createAttributeMetadata({
                id: "LOCATION",
                label: "Location", // ToDo: has no effect??
                type: oContext.sina.AttributeType.String,
                usage: {
                    Detail: {},
                    AdvancedSearch: {
            ...
            oContext.sina._createAttributeMetadata({
                id: "WEBSITE",
                label: "Website", // ToDo: has no effect??
                type: oContext.sina.AttributeType.String,
                usage: {
                    Detail: {},
                    AdvancedSearch: {
            ...
            oContext.sina._createAttributeMetadata({
                id: "SUMMARY",
                label: "Summary", // ToDo: has no effect??
            ...
            oContext.sina._createAttributeMetadata({
                id: "LOC_4326",
                label: "LOC_4326", // ToDo: has no effect??
