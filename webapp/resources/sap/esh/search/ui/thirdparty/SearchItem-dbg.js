sap.ui.define(['sap/esh/search/ui/thirdparty/webcomponents-fiori', 'sap/esh/search/ui/thirdparty/parameters-bundle.css', 'sap/esh/search/ui/thirdparty/decline', 'sap/esh/search/ui/thirdparty/toLowercaseEnumValue', 'sap/esh/search/ui/thirdparty/SearchItem.css', 'sap/esh/search/ui/thirdparty/generateHighlightedMarkup', 'sap/esh/search/ui/thirdparty/i18n-defaults', 'sap/esh/search/ui/thirdparty/encodeXML'], (function (webcomponentsBase, parametersBundle_css, decline, toLowercaseEnumValue, SearchItem_css, generateHighlightedMarkup, i18nDefaults, encodeXML) { 'use strict';
    ...
    function content() {
        return (parametersBundle_css.jsxs(parametersBundle_css.Fragment, { children: [parametersBundle_css.jsx("slot", { name: "icon" }), this._semanticIconName &&
                    parametersBundle_css.jsx(decline.Icon, { class: "ui5-tag-semantic-icon", name: this._semanticIconName }), parametersBundle_css.jsx("span", { class: "ui5-hidden-text", children: this.tagDescription }), this.hasText &&
...
`;
    ...
    let Tag = Tag_1 = class Tag extends webcomponentsBase.b {
        ...
        get _roleDescription() {
            return Tag_1.i18nBundle.getText(toLowercaseEnumValue.TAG_ROLE_DESCRIPTION);
        }
        get _valueState() {
            switch (this.design) {
                case TagDesign$1.Positive:
                    return Tag_1.i18nBundle.getText(toLowercaseEnumValue.TAG_SUCCESS);
                case TagDesign$1.Negative:
                    return Tag_1.i18nBundle.getText(toLowercaseEnumValue.TAG_ERROR);
                case TagDesign$1.Critical:
                    return Tag_1.i18nBundle.getText(toLowercaseEnumValue.TAG_WARNING);
                case TagDesign$1.Information:
                    return Tag_1.i18nBundle.getText(toLowercaseEnumValue.TAG_INFORMATION);
            }
            return undefined;
        }
        get hasText() {
        ...
        get tagDescription() {
            ...
            let description = Tag_1.i18nBundle.getText(toLowercaseEnumValue.TAG_DESCRIPTION_TAG);
            if (valueState) {
    ...
    function SearchFieldTemplate() {
        return (parametersBundle_css.jsx("li", { part: "native-li", class: "ui5-li-root ui5-li--focusable", "aria-selected": this.selected, role: "option", "data-sap-focus-ref": true, draggable: this.movable, tabindex: this._effectiveTabIndex, onFocusIn: this._onfocusin, onFocusOut: this._onfocusout, onKeyUp: this._onkeyup, onKeyDown: this._onkeydown, onClick: this._onclick, children: parametersBundle_css.jsx("div", { part: "content", class: "ui5-search-item-content", children: parametersBundle_css.jsxs("div", { class: "ui5-search-item-begin-content", children: [this.image.length > 0 && !this.icon &&
                            ...
                            parametersBundle_css.jsx(decline.Icon, { class: "ui5-search-item-icon", name: this.icon }), this.scopeName &&
                            parametersBundle_css.jsx(Tag$1, { design: TagDesign$1.Set2, colorScheme: "10", children: this.scopeName }), parametersBundle_css.jsxs("div", { class: "ui5-search-item-titles-container", children: [parametersBundle_css.jsx("span", { part: "title", class: "ui5-search-item-text", dangerouslySetInnerHTML: { __html: this._markupText } }), parametersBundle_css.jsx("span", { part: "subtitle", class: "ui5-search-item-description", children: this.description })] }), this.deletable &&
                            parametersBundle_css.jsx(decline.Button, { class: "ui5-search-item-selected-delete", design: decline.ButtonDesign.Transparent, icon: decline.decline, onClick: this._onDeleteButtonClick, tooltip: this._deleteButtonTooltip })] }) }) }));
    }
     ...
     * @experimental
     */
    let SearchItem = SearchItem_1 = class SearchItem extends parametersBundle_css.ListItemBase {
        constructor() {
            super(...arguments);
            /**
