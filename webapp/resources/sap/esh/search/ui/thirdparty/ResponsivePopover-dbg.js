sap.ui.define(['exports', 'sap/esh/search/ui/thirdparty/webcomponents-fiori', 'sap/esh/search/ui/thirdparty/parameters-bundle.css', 'sap/esh/search/ui/thirdparty/toLowercaseEnumValue', 'sap/esh/search/ui/thirdparty/decline'], (function (exports, webcomponentsBase, parametersBundle_css, toLowercaseEnumValue, decline) { 'use strict';
...
`;
     ...
     * ### ES6 Module Import
     *
     * `import "sap/esh/search/ui/gen/ui5/webcomponents/dist/Title.js";`
     * @constructor
     * @extends UI5Element
    ...
    function beforeContent$1() {
        return (parametersBundle_css.jsxs(parametersBundle_css.Fragment, { children: [parametersBundle_css.jsx("span", { class: "ui5-popover-arrow", style: this.styles.arrow }), this._displayHeader &&
                    parametersBundle_css.jsx("header", { class: "ui5-popup-header-root", id: "ui5-popup-header", part: "header", children: this.header.length ?
                            ...
                            :
                                parametersBundle_css.jsx(Title$1, { level: "H1", class: "ui5-popup-header-text", children: this.headerText }) })] }));
    }
    ...
    const c=e=>e.hasAttribute("data-ui5-focus-trap"),d$1=e=>{const l=getComputedStyle(e);return e.scrollHeight>e.clientHeight&&["scroll","auto"].indexOf(l.overflowY)>=0||e.scrollWidth>e.clientWidth&&["scroll","auto"].indexOf(l.overflowX)>=0},b=async(e,l)=>!e||parametersBundle_css.i$1(e)?null:u(e,true),H=async(e,l)=>!e||parametersBundle_css.i$1(e)?null:u(e,false),T=e=>e.hasAttribute("data-ui5-focus-redirect")||!parametersBundle_css.i$1(e),L=e=>{if(webcomponentsBase.v(e)){const l=e.getAttribute("tabindex");if(l!==null&&parseInt(l)<0)return  true}return  false},u=async(e,l,r)=>{let t,s,n=-1;e.shadowRoot?t=l?e.shadowRoot.firstElementChild:e.shadowRoot.lastElementChild:e instanceof HTMLSlotElement&&e.assignedNodes()?(s=e.assignedElements(),n=l?0:s.length-1,t=s[n]):t=l?e.firstElementChild:e.lastElementChild;let i;for(;t;){const m=t;if(!parametersBundle_css.i$1(m)&&!L(m)){if(webcomponentsBase.v(t)&&(await t._waitForDomRef(),t=t.getDomRef()),!t||parametersBundle_css.i$1(t))return null;if(t.nodeType===1&&T(t)&&!c(t)){if(r$1(t)||(i=await u(t,l),!webcomponentsBase.h()&&!i&&d$1(t)))return t&&typeof t.focus=="function"?t:null;if(i)return i&&typeof i.focus=="function"?i:null}}t=l?m.nextElementSibling:m.previousElementSibling,s&&!s[n].contains(t)&&(n=l?n+1:n-1,t=s[n]);}return null};
    ...
    const openUI5Support = webcomponentsBase.n$2("OpenUI5Support");
...
`;
    ...
    let Popup = Popup_1 = class Popup extends webcomponentsBase.b {
        ...
        onBeforeRendering() {
            ...
            this.onDesktop = webcomponentsBase.f();
        }
        onAfterRendering() {
            webcomponentsBase.f$2().then(() => {
        ...
        onExitDOM() {
            ...
            webcomponentsBase.f$3.deregister(this, this._resizeHandler);
            decline.T(this);
        }
        /**
        ...
        _registerResizeHandler() {
            if (!this._resizeHandlerRegistered) {
                webcomponentsBase.f$3.register(this, this._resizeHandler);
    ...
    Popup = Popup_1 = __decorate$3([
         ...
         */
        ,
        parametersBundle_css.l("before-open", {
            cancelable: true,
        })
        /**
         ...
         */
        ,
        parametersBundle_css.l("before-close", {
            cancelable: true,
        })
        /**
    ...
    function beforeContent() {
        return (parametersBundle_css.jsx(parametersBundle_css.Fragment, { children: !!this._displayHeader &&
                parametersBundle_css.jsx("header", { children: parametersBundle_css.jsxs("div", { class: "ui5-popup-header-root", id: "ui5-popup-header", role: "group", "aria-describedby": this.effectiveAriaDescribedBy, "aria-roledescription": this.ariaRoleDescriptionHeaderText, tabIndex: this._headerTabIndex, onKeyDown: this._onDragOrResizeKeyDown, onMouseDown: this._onDragMouseDown, part: "header", children: [this.hasValueState &&
                                parametersBundle_css.jsx(decline.Icon, { class: "ui5-dialog-value-state-icon", name: this._dialogStateIcon }), this.header.length ?
                                parametersBundle_css.jsx("slot", { name: "header" })
                                :
                                    parametersBundle_css.jsx(Title$1, { level: "H1", id: "ui5-popup-header-text", class: "ui5-popup-header-text", children: this.headerText }), this.resizable ?
                                this.draggable ?
    ...
    function afterContent() {
        return (parametersBundle_css.jsxs(parametersBundle_css.Fragment, { children: [!!this.footer.length &&
                    ...
                    parametersBundle_css.jsx("div", { class: "ui5-popup-resize-handle", onMouseDown: this._onResizeMouseDown, children: parametersBundle_css.jsx(decline.Icon, { name: resizeCorner }) })] }));
    }
...
`;
     ...
     * ### ES6 Module Import
     *
     * `import "sap/esh/search/ui/gen/ui5/webcomponents/dist/Dialog";`
     *
     * @constructor
     * @extends Popup
     * @public
    ...
    let Dialog = Dialog_1 = class Dialog extends Popup$1 {
        ...
        get ariaRoleDescriptionHeaderText() {
            return (this.resizable || this.draggable) ? Dialog_1.i18nBundle.getText(toLowercaseEnumValue.DIALOG_HEADER_ARIA_ROLE_DESCRIPTION) : undefined;
        }
        get effectiveAriaDescribedBy() {
            return (this.resizable || this.draggable) ? `${this._id}-descr` : undefined;
        }
        get ariaDescribedByHeaderTextResizable() {
            return Dialog_1.i18nBundle.getText(toLowercaseEnumValue.DIALOG_HEADER_ARIA_DESCRIBEDBY_RESIZABLE);
        }
        get ariaDescribedByHeaderTextDraggable() {
            return Dialog_1.i18nBundle.getText(toLowercaseEnumValue.DIALOG_HEADER_ARIA_DESCRIBEDBY_DRAGGABLE);
        }
        get ariaDescribedByHeaderTextDraggableAndResizable() {
            return Dialog_1.i18nBundle.getText(toLowercaseEnumValue.DIALOG_HEADER_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE);
        }
        /**
        ...
        get _role() {
            ...
            if (this.state === o.Negative || this.state === o.Critical) {
        ...
        _onDragOrResizeKeyDown(e) {
            ...
            if (this.draggable && [webcomponentsBase.P, webcomponentsBase._, webcomponentsBase.D$2, webcomponentsBase.R].some(key => key(e))) {
                this._dragWithEvent(e);
                return;
            }
            if (this.resizable && [webcomponentsBase.O, webcomponentsBase.N, webcomponentsBase.h$1, webcomponentsBase.I].some(key => key(e))) {
        ...
        return (parametersBundle_css.jsxs(Dialog$1, { "root-element": true, accessibleName: this.accessibleName, accessibleNameRef: this.accessibleNameRef, accessibleDescription: this.accessibleDescription, accessibleDescriptionRef: this.accessibleDescriptionRef, accessibleRole: this.accessibleRole, stretch: true, preventInitialFocus: this.preventInitialFocus, preventFocusRestore: this.preventFocusRestore, initialFocus: this.initialFocus, onBeforeOpen: this._beforeDialogOpen, onOpen: this._afterDialogOpen, onBeforeClose: this._beforeDialogClose, onClose: this._afterDialogClose, exportparts: "content, header, footer", open: this.open, children: [!this._hideHeader && parametersBundle_css.jsx(parametersBundle_css.Fragment, { children: this.header.length ?
                        ...
                        :
                            parametersBundle_css.jsxs("div", { class: this.classes.header, slot: "header", children: [this.headerText &&
                                        parametersBundle_css.jsx(Title$1, { level: "H1", wrappingType: "None", class: "ui5-popup-header-text ui5-responsive-popover-header-text", children: this.headerText }), !this._hideCloseButton &&
                                        parametersBundle_css.jsx(decline.Button, { icon: decline.decline, design: "Transparent", accessibleName: this._closeDialogAriaLabel, onClick: this._dialogCloseButtonClick })] }) }), parametersBundle_css.jsx("slot", {}), parametersBundle_css.jsx("slot", { slot: "footer", name: "footer" })] }));
    }
...
`;
     ...
     * ### ES6 Module Import
     *
     * `import "sap/esh/search/ui/gen/ui5/webcomponents/dist/Popover.js";`
     *
     * @constructor
     * @extends Popup
     * @since 1.0.0-rc.6
...
`;
     ...
     * ### ES6 Module Import
     *
     * `import "sap/esh/search/ui/gen/ui5/webcomponents/dist/ResponsivePopover.js";`
     * @constructor
     * @extends Popover
     * @since 1.0.0-rc.6
     * @public
    ...
    let ResponsivePopover = ResponsivePopover_1 = class ResponsivePopover extends Popover$1 {
        ...
        handleOpenOnEnterDOM() {
            if (this.open && !webcomponentsBase.d$2()) {
                this.showPopover();
                this.openPopup();
            }
        }
        ...
        get _closeDialogAriaLabel() {
            return ResponsivePopover_1.i18nBundle.getText(toLowercaseEnumValue.RESPONSIVE_POPOVER_CLOSE_DIALOG_BUTTON);
        }
        _beforeDialogOpen() {
            this._opened = true;
            this.open = true;
