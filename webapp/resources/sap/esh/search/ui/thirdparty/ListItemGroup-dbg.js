sap.ui.define(['require', 'exports', 'sap/esh/search/ui/thirdparty/webcomponents-fiori', 'sap/esh/search/ui/thirdparty/parameters-bundle.css', 'sap/esh/search/ui/thirdparty/toLowercaseEnumValue'], (function (require, exports, webcomponentsBase, parametersBundle_css, toLowercaseEnumValue) { 'use strict';

    function i(t,o,n,m,r={}){const a=webcomponentsBase.D.getDraggedElement(),e={targetReference:null,placement:null};if(!a&&!r?.crossDnD)return e;const s=n.placements;return e.targetReference=t.target,s.some(l=>{const c=r.originalEvent?{originalEvent:t}:{};return o.fireDecoratorEvent("move-over",{...c,source:{element:a},destination:{element:m,placement:l}})?false:(t.preventDefault(),e.targetReference=n.element,e.placement=l,true)})||(e.targetReference=null),e}

    function m(t,r,o,a,n={}){t.preventDefault();const e=webcomponentsBase.D.getDraggedElement();if(!e&&n?.crossDnD)return;const i=n.originalEvent?{originalEvent:t}:{};r.fireDecoratorEvent("move",{...i,source:{element:e},destination:{element:o,placement:a}}),e?.focus();}
    ...
    class DragAndDropHandler {
        ...
        ondragover(e) {
            ...
            const draggedElement = webcomponentsBase.D.getDraggedElement();
            const dropIndicator = this.config.getDropIndicator();
...
`;
     ...
     * @private
     */
    let ListItemGroupHeader = ListItemGroupHeader_1 = class ListItemGroupHeader extends parametersBundle_css.ListItemBase {
        constructor() {
            super(...arguments);
        ...
        get groupHeaderText() {
            return ListItemGroupHeader_1.i18nBundle.getText(toLowercaseEnumValue.GROUP_HEADER_TEXT);
        }
        get defaultSlotText() {
        ...
        onBeforeRendering() {
            ...
            if (this.wrappingType === "Normal") {
                ...
                if (ListItemGroupHeader_1.ExpandableTextTemplate) {
                    ...
                    new Promise(function (resolve, reject) { require(['sap/esh/search/ui/thirdparty/_dynamics/ListItemStandardExpandableTextTemplate'], resolve, reject); }).then(module => {
    ...
    ListItemGroupHeader = ListItemGroupHeader_1 = __decorate$2([
        webcomponentsBase.m({
            ...
            styles: [parametersBundle_css.ListItemBase.styles, ListItemGroupHeaderCss],
        })
    ], ListItemGroupHeader);
...
`;
     ...
     * ### ES6 Module Import
     *
     * `import "sap/esh/search/ui/gen/ui5/webcomponents/dist/DropIndicator.js";`
     *
     * @constructor
     * @extends UI5Element
     * @private
...
`;
     ...
     *
     * ### ES6 Module Import
     * `import "sap/esh/search/ui/gen/ui5/webcomponents/dist/ListItemGroup.js";`
