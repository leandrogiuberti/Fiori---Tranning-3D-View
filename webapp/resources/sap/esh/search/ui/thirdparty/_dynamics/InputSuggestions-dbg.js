sap.ui.define(['exports', 'sap/esh/search/ui/thirdparty/generateHighlightedMarkup', 'sap/esh/search/ui/thirdparty/Search2', 'sap/esh/search/ui/thirdparty/webcomponents-fiori', 'sap/esh/search/ui/thirdparty/ListItemGroup', 'sap/esh/search/ui/thirdparty/ListBoxItemGroupTemplate', 'sap/esh/search/ui/thirdparty/parameters-bundle.css', 'sap/esh/search/ui/thirdparty/decline', 'sap/esh/search/ui/thirdparty/ResponsivePopover', 'sap/esh/search/ui/thirdparty/toLowercaseEnumValue', 'sap/esh/search/ui/thirdparty/encodeXML', 'sap/esh/search/ui/thirdparty/i18n-defaults'], (function (exports, generateHighlightedMarkup, Search, webcomponentsBase, ListItemGroup, ListBoxItemGroupTemplate, parametersBundle_css, decline, ResponsivePopover, toLowercaseEnumValue, encodeXML, i18nDefaults) { 'use strict';
    ...
    function InputSuggestionsTemplate(hooks) {
        ...
        return (parametersBundle_css.jsxs(ResponsivePopover.ResponsivePopover, { class: this.classes.popover, hideArrow: true, preventFocusRestore: true, preventInitialFocus: true, placement: "Bottom", horizontalAlign: "Start", tabindex: -1, style: this.styles.suggestionsPopover, onOpen: this._afterOpenPicker, onClose: this._afterClosePicker, onScroll: this._scroll, open: this.open, opener: this, accessibleName: this._popupLabel, children: [this._isPhone &&
                    parametersBundle_css.jsxs(parametersBundle_css.Fragment, { children: [parametersBundle_css.jsxs("div", { slot: "header", class: "ui5-responsive-popover-header", children: [parametersBundle_css.jsxs("div", { class: "row", children: [parametersBundle_css.jsx("span", { children: this._headerTitleText }), parametersBundle_css.jsx(decline.Button, { class: "ui5-responsive-popover-close-btn", icon: decline.decline, design: "Transparent", onClick: this._closePicker })] }), parametersBundle_css.jsx("div", { class: "row", children: parametersBundle_css.jsx("div", { class: "input-root-phone native-input-wrapper", children: parametersBundle_css.jsx(Search.Input, { class: "ui5-input-inner-phone", type: this.inputType, value: this.value, showClearIcon: this.showClearIcon, placeholder: this.placeholder, onInput: this._handleInput, onChange: this._handleChange }) }) })] }), this.hasValueStateMessage &&
                                parametersBundle_css.jsxs("div", { class: this.classes.popoverValueState, style: this.styles.suggestionPopoverHeader, children: [parametersBundle_css.jsx(decline.Icon, { class: "ui5-input-value-state-message-icon", name: valueStateMessageInputIcon?.call(this) }), this.open && valueStateMessage?.call(this)] })] }), !this._isPhone && this.hasValueStateMessage &&
                    parametersBundle_css.jsxs("div", { slot: "header", class: {
                            "ui5-responsive-popover-header": true,
                            ...this.classes.popoverValueState,
                        }, style: this.styles.suggestionPopoverHeader, children: [parametersBundle_css.jsx(decline.Icon, { class: "ui5-input-value-state-message-icon", name: valueStateMessageInputIcon?.call(this) }), this.open && valueStateMessage?.call(this)] }), suggestionsList.call(this), this._isPhone &&
                    parametersBundle_css.jsx("div", { slot: "footer", class: "ui5-responsive-popover-footer", children: parametersBundle_css.jsx(decline.Button, { design: "Transparent", onClick: this._closePicker, children: this._suggestionsOkButtonText }) })] }));
    }
    function defaultSuggestionsList() {
        return (parametersBundle_css.jsx(Search.List, { accessibleRole: Search.ListAccessibleRole.ListBox, separators: this.suggestionSeparators, selectionMode: "Single", onMouseDown: this.onItemMouseDown, onItemClick: this._handleSuggestionItemPress, onSelectionChange: this._handleSelectionChange, children: parametersBundle_css.jsx("slot", {}) }));
    }
    ...
    class Suggestions {
        ...
        get itemSelectionAnnounce() {
            ...
            if (this.accInfo.isGroup) {
                return `${Suggestions.i18nBundle.getText(toLowercaseEnumValue.LIST_ITEM_GROUP_HEADER)} ${this.accInfo.itemText}`;
            }
            const itemPositionText = Suggestions.i18nBundle.getText(toLowercaseEnumValue.LIST_ITEM_POSITION, this.accInfo.currentPos || 0, this.accInfo.listSize || 0);
