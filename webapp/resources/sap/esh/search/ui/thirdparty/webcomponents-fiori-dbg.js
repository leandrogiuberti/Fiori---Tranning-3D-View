sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  const u$i=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$o=()=>typeof document>"u"?null:o$l('meta[name="ui5-shared-resources"]',document.head,u$i),m$i=(t,o)=>{const r=t.split(".");let e=l$o();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const n$v=m$i("AllOpenedPopupsRegistry",{openedRegistry:[]}),l$n=e=>{n$v.openedRegistry.push(e);},u$h=e=>{const t=n$v.openedRegistry.findIndex(o=>o.instance===e);t>-1&&n$v.openedRegistry.splice(t,1);},y$9=()=>n$v.openedRegistry[n$v.openedRegistry.length-1].instance,g$e=e=>{for(let t=n$v.openedRegistry.length-1;t>=0;t--){const o=n$v.openedRegistry[t];if(o.type!=="OpenUI5")return  false;if(o.instance===e)break}return  true},h$9=e=>{e.setAttribute("popover","manual"),e.showPopover();},f$e=e=>{e.hasAttribute("popover")&&(e.hidePopover(),e.removeAttribute("popover"));},a$n=(e=document)=>e.querySelector(":popover-open")?true:Array.from(e.querySelectorAll("*")).some(t=>{const o=t.shadowRoot;return o&&a$n(o)}),v$4=e=>{const t=e.prototype.open;e.prototype.open=function(...p){t.apply(this,p);const s=a$n();if(["OPENING","OPEN"].includes(this.getOpenState())&&s){const r=this.getContent();if(r){const i=r instanceof HTMLElement?r:r?.getDomRef();i&&h$9(i);}}l$n({type:"OpenUI5",instance:this});};},O$3=e=>{const t=e.prototype._closed;e.prototype._closed=function(...p){const s=this.getContent(),c=s instanceof HTMLElement?s:s?.getDomRef();t.apply(this,p),c&&f$e(c),u$h(this);};},m$h=e=>{const t=e.prototype.onFocusEvent;e.prototype.onFocusEvent=function(p){g$e(this)&&t.call(this,p);};},I$5=()=>{const e=new CSSStyleSheet;e.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e];},P$8=e=>{v$4(e),O$3(e),I$5(),m$h(e);};

  const e$k=new Map,s$w=(t,r)=>{e$k.set(t,r);},n$u=t=>e$k.get(t);

  var c$k={},e$j=c$k.hasOwnProperty,a$m=c$k.toString,o$k=e$j.toString,l$m=o$k.call(Object),i$n=function(r){var t,n;return !r||a$m.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$j.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$m):true)};

  var c$j=Object.create(null),u$g=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$j;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$n(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$n(n)?n:{},r[a]=u$g(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$i=function(n,t){return u$g(true,false,...arguments)};

  const _$4={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$h=_$4.themes.default,s$v=_$4.themes.all,a$l=_$4.languages.default,r$k=_$4.locales.default,l$l=_$4.locales.all;

  const o$j=typeof document>"u",n$t={search(){return o$j?"":window.location.search}},i$m=()=>o$j?"":window.location.hostname,c$i=()=>o$j?"":window.location.port,a$k=()=>o$j?"":window.location.protocol,s$u=()=>o$j?"":window.location.href,u$f=()=>n$t.search();

  const s$t=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},o$i=e=>{const t=s$t("sap-allowed-theme-origins")??s$t("sap-allowedThemeOrigins");return t?t.split(",").some(n=>n==="*"||e===n.trim()):false},a$j=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$d=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$u()).toString();else {const n=new URL(e),r=n.origin;r&&o$i(r)?t=n.toString():t=a$j(n.toString(),s$u());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};
  ...
  const e$g=new i$l,t$p="configurationReset",i$k=n=>{e$g.attachEvent(t$p,n);};

  let p$9=false,t$o={animationMode:u$e.Full,theme:e$h,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$6=()=>(o$h(),t$o.animationMode),T$3=()=>(o$h(),t$o.theme),S$4=()=>{if(o$h(),t$o.themeRoot!==void 0){if(!g$d(t$o.themeRoot)){console.warn(`The ${t$o.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$o.themeRoot}},L$3=()=>(o$h(),t$o.language),R$6=()=>(o$h(),t$o.fetchDefaultLanguage),F$1=()=>(o$h(),t$o.noConflict),U$2=()=>(o$h(),t$o.defaultFontLoading),b$b=()=>(o$h(),t$o.enableDefaultTooltips),D$4=()=>(o$h(),t$o.calendarType),M$3=()=>(o$h(),t$o.formatSettings),i$j=new Map;i$j.set("true",true),i$j.set("false",false);const w$7=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$o=e$i(t$o,e));}},z$1=()=>{const n=new URLSearchParams(u$f());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$c(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$c(r,e,"sap-ui");});},E$2=n=>{const e=n.split("@")[1];return g$d(e)},P$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$c=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$j.has(e)&&(e=i$j.get(a)),s==="theme"?(t$o.theme=P$7(s,e),e&&e.includes("@")&&(t$o.themeRoot=E$2(e))):t$o[s]=e;},j$1=()=>{const n=n$u("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$o=e$i(t$o,e);},o$h=()=>{typeof document>"u"||p$9||(l$k(),p$9=true);},l$k=n=>{w$7(),z$1(),j$1();};
  ...
  const e$f={version:"2.14.0-rc.7",major:2,minor:14,patch:0,suffix:"-rc.7",isNext:false,buildTime:1759224139};

  let s$s,t$n={include:[/^ui5-/],exclude:[]};const o$g=new Map,l$i=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$5()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$s=e;},c$h=()=>s$s,p$8=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$n=e,o$g.clear();},m$g=()=>t$n,i$i=e=>{if(!o$g.has(e)){const n=t$n.include.some(r=>e.match(r))&&!t$n.exclude.some(r=>e.match(r));o$g.set(e,n);}return o$g.get(e)},g$b=e=>{if(i$i(e))return c$h()},d$d=e=>{const n=`v${e$f.version.replaceAll(".","-")}`,r=/(--_?ui5)([^,:)\s]+)/g;return e.replaceAll(r,`$1-${n}$2`)};

  let i$h,s$r="";const u$d=new Map,r$j=m$i("Runtimes",[]),x$2=()=>{if(i$h===void 0){i$h=r$j.length;const e=e$f;r$j.push({...e,get scopingSuffix(){return c$h()},get registeredTags(){return T$2()},get scopingRules(){return m$g()},alias:s$r,description:`Runtime ${i$h} - ver ${e.version}${""}`});}},I$4=()=>i$h,b$a=(e,m)=>{const o=`${e},${m}`;if(u$d.has(o))return u$d.get(o);const t=r$j[e],n=r$j[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$d.set(o,l),l},$$3=()=>r$j;

  const g$a=m$i("Tags",new Map),d$c=new Set;let s$q=new Map,c$g;const m$f=-1,h$8=e=>{d$c.add(e),g$a.set(e,I$4());},w$6=e=>d$c.has(e),R$5=()=>d$c.size>0,T$2=()=>[...d$c.values()],$$2=e=>{let n=g$a.get(e);n===void 0&&(n=m$f),s$q.has(n)||s$q.set(n,new Set),s$q.get(n).add(e),c$g||(c$g=setTimeout(()=>{y$8(),s$q=new Map,c$g=void 0;},1e3));},y$8=()=>{const e=$$3(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(i=>`
${i.description}`).join("")}`),[...s$q.keys()].forEach(i=>{let o,r;i===m$f?(o=1,r={description:"Older unknown runtime"}):(o=b$a(n,i),r=e[i]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${s$q.get(i).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...s$q.get(i)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$p=new Set,d$b=new i$l,n$r=new l$j;let t$l,a$i,m$e,i$g;const l$h=async e=>{n$r.add(e),await P$6();},c$f=e=>{d$b.fireEvent("beforeComponentRender",e),s$p.add(e),e._render();},h$7=e=>{n$r.remove(e),s$p.delete(e);},P$6=async()=>{i$g||(i$g=new Promise(e=>{window.requestAnimationFrame(()=>{n$r.process(c$f),i$g=null,e(),m$e||(m$e=setTimeout(()=>{m$e=void 0,n$r.isEmpty()&&U$1();},200));});})),await i$g;},y$7=()=>t$l||(t$l=new Promise(e=>{a$i=e,window.requestAnimationFrame(()=>{n$r.isEmpty()&&(t$l=void 0,e());});}),t$l),I$3=()=>{const e=T$2().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$d=async()=>{await I$3(),await y$7();},U$1=()=>{n$r.isEmpty()&&a$i&&(a$i(),a$i=void 0,t$l=void 0);},C$5=async e=>{s$p.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$h(r);}),await f$d();};

  const g$9=typeof document>"u",i$f=(e,t)=>t?`${e}|${t}`:e,l$g=e=>e===void 0?true:b$a(I$4(),parseInt(e))===1,c$e=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$f(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$6=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$f(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$g(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$3=(e,t="")=>g$9?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$f(e,t)),f$c=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$f(e,t));},R$4=(e,t,r="",s)=>{S$3(t,r)?y$6(e,t,r,s):c$e(e,t,r,s);},m$d=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$k=new i$l,r$h="themeRegistered",n$q=e=>{t$k.attachEvent(r$h,e);},s$o=e=>t$k.fireEvent(r$h,e);

  const l$f=new Map,h$6=new Map,u$c=new Map,T$1=new Set,i$e=new Set,p$7=(e,r,t)=>{h$6.set(`${e}/${r}`,t),T$1.add(e),i$e.add(r),s$o(r);},m$c=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$f.get(g);if(s!==void 0)return s;if(!i$e.has(r)){const $=[...i$e.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$h}. Registered themes are: ${$}`),a$h(e,e$h)}const[n,d]=await Promise.all([a$h(e,r),t?a$h(e,t,true):void 0]),o=m$d(n,d);return o&&l$f.set(g,o),o},a$h=async(e,r,t=false)=>{const s=(t?u$c:h$6).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$1,P$5=e=>i$e.has(e);

  const r$g=new Set,s$n=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$f=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$g.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$g.add("decode"));return}try{return JSON.parse(a)}catch{r$g.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$g.add("parse"));}}},d$a=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$g.has("object")||(console.warn("Malformed theme metadata Object",e),r$g.add("object"));return}return {themeName:t,baseThemeName:a}},m$b=()=>{const e=s$n();if(!e||e==="none")return;const t=o$f(e);if(t)return d$a(t)};

  const t$j=new i$l,d$9="themeLoaded",o$e=e=>{t$j.attachEvent(d$9,e);},n$p=e=>{t$j.detachEvent(d$9,e);},r$f=e=>t$j.fireEvent(d$9,e);
  ...
  let t$i;i$k(()=>{t$i=void 0;});const n$o=()=>(t$i===void 0&&(t$i=S$4()),t$i),u$b=e=>`${n$o()}Base/baseLib/${e}/css_variables.css`,i$d=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$8(u$b(e),{"sap-ui-webcomponents-theme":e});};

  let _lib="ui5",_package="webcomponents-theming";const s$m="@"+_lib+"/"+_package,S$2=()=>w$5().has(s$m),P$4=async e=>{if(!S$2())return;const t=await m$c(s$m,e);t&&R$4(t,"data-ui5-theme-properties",s$m,e);},E$1=()=>{f$c("data-ui5-theme-properties",s$m);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$m)return;const i=await m$c(a,e,t);i&&R$4(i,`data-ui5-component-properties-${I$4()}`,a);});return Promise.all(o)},k$2=async e=>{const t=m$b();if(t)return t;const r=n$u("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$o())return await i$d(e),m$b()},w$4=async e=>{const t=await k$2(e);!t||e!==t.themeName?await P$4(e):E$1();const r=P$5(e)?e:t&&t.baseThemeName;await U(r||e$h,t&&t.themeName===e?e:void 0),r$f(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$d;i$k(()=>{o$d=void 0;});const a$g=()=>(o$d===void 0&&(o$d=U$2()),o$d);

  const a$f=()=>{const t=n$u("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$b();},f$b=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$g()||t||S$3("data-ui5-font-face")||c$e(n$n,"data-ui5-font-face");};

  var a$e = ":root{--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5_content_density:compact}";

  const e$e=()=>{S$3("data-ui5-system-css-vars")||c$e(a$e,"data-ui5-system-css-vars");};
  ...
  const s$l=()=>{S$3("data-ui5-scrollbar-styles")||c$e(t$h,"data-ui5-scrollbar-styles");};

  const t$g=typeof document>"u",e$d={get userAgent(){return t$g?"":navigator.userAgent},get touch(){return t$g?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$g?false:/(Chrome|CriOS)/.test(e$d.userAgent)},get firefox(){return t$g?false:/Firefox/.test(e$d.userAgent)},get safari(){return t$g?false:!e$d.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$d.userAgent)},get webkit(){return t$g?false:/webkit/.test(e$d.userAgent)},get windows(){return t$g?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$g?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$g?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$d.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$g?false:!e$d.windows&&/Android/.test(e$d.userAgent)},get androidPhone(){return t$g?false:e$d.android&&/(?=android)(?=.*mobile)/i.test(e$d.userAgent)},get ipad(){return t$g?false:/ipad/i.test(e$d.userAgent)||/Macintosh/i.test(e$d.userAgent)&&"ontouchend"in document},_isPhone(){return u$a(),e$d.touch&&!r$e}};let o$c,i$c,r$e;const s$k=()=>{if(t$g||!e$d.windows)return  false;if(o$c===void 0){const n=e$d.userAgent.match(/Windows NT (\d+).(\d)/);o$c=n?parseFloat(n[1]):0;}return o$c>=8},c$d=()=>{if(t$g||!e$d.webkit)return  false;if(i$c===void 0){const n=e$d.userAgent.match(/(webkit)[ /]([\w.]+)/);i$c=n?parseFloat(n[1]):0;}return i$c>=537.1},u$a=()=>{if(t$g)return  false;if(r$e===void 0){if(e$d.ipad){r$e=true;return}if(e$d.touch){if(s$k()){r$e=true;return}if(e$d.chrome&&e$d.android){r$e=!/Mobile Safari\/[.0-9]+/.test(e$d.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$d.android&&c$d()&&(n=1),r$e=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$e=e$d.userAgent.indexOf("Touch")!==-1||e$d.android&&!e$d.androidPhone;}},l$e=()=>e$d.touch,h$5=()=>e$d.safari,g$8=()=>e$d.chrome,b$9=()=>e$d.firefox,a$d=()=>(u$a(),(e$d.touch||s$k())&&r$e),d$6=()=>e$d._isPhone(),f$a=()=>t$g?false:!a$d()&&!d$6()||s$k(),m$a=()=>a$d()&&f$a(),w$3=()=>e$d.iOS,A$4=()=>e$d.macOS,P$3=()=>e$d.android||e$d.androidPhone;

  let t$f=false;const i$b=()=>{h$5()&&w$3()&&!t$f&&(document.body.addEventListener("touchstart",()=>{}),t$f=true);};

  let o$b=false,r$d;const p$6=new i$l,h$4=()=>o$b,P$2=t=>{if(!o$b){p$6.attachEvent("boot",t);return}t();},b$8=async()=>{if(r$d!==void 0)return r$d;const t=async n=>{if(x$2(),typeof document>"u"){n();return}n$q(F);const e=n$u("OpenUI5Support"),f=e?e.isOpenUI5Detected():false,s=n$u("F6Navigation");e&&await e.init(),s&&!f&&s.init(),await d$7(),await w$4(r$c()),e&&e.attachListeners(),a$f(),e$e(),s$l(),i$b(),n(),o$b=true,p$6.fireEvent("boot");};return r$d=new Promise(t),r$d},F=t=>{o$b&&t===r$c()&&w$4(r$c());};

  let t$e;i$k(()=>{t$e=void 0;});const r$c=()=>(t$e===void 0&&(t$e=T$3()),t$e),u$9=async e=>{t$e!==e&&(t$e=e,h$4()&&(await w$4(t$e),await C$5({themeAware:true})));},g$7=()=>e$h,n$m=()=>{const e=r$c();return l$d(e)?!e.startsWith("sap_horizon"):!m$b()?.baseThemeName?.startsWith("sap_horizon")},l$d=e=>s$v.includes(e);

  let a$c = class a{static isAtLeastVersion116(){if(!window.sap.ui.version)return  true;const e=window.sap.ui.version.split(".");return !e||e.length<2?false:parseInt(e[0])>1||parseInt(e[1])>=116}static isOpenUI5Detected(){return typeof window.sap?.ui?.require=="function"}static init(){return a.isOpenUI5Detected()?(a.initPromise||(a.initPromise=new Promise(t=>{window.sap.ui.require(["sap/ui/core/Core"],async e=>{const i=()=>{let n=["sap/ui/core/Popup","sap/ui/core/Patcher","sap/ui/core/LocaleData"];a.isAtLeastVersion116()&&(n=[...n,"sap/base/i18n/Formatting","sap/base/i18n/Localization","sap/ui/core/ControlBehavior","sap/ui/core/Theming","sap/ui/core/date/CalendarUtils"]),window.sap.ui.require(n,(o,r)=>{p$a(r),P$8(o),t();});};a.isAtLeastVersion116()?(await e.ready(),i()):e.attachInit(i);});})),a.initPromise):Promise.resolve()}static getConfigurationSettingsObject(){if(!a.isOpenUI5Detected())return {};if(a.isAtLeastVersion116()){const n=window.sap.ui.require("sap/ui/core/ControlBehavior"),o=window.sap.ui.require("sap/base/i18n/Localization"),r=window.sap.ui.require("sap/ui/core/Theming"),s=window.sap.ui.require("sap/base/i18n/Formatting"),c=window.sap.ui.require("sap/ui/core/date/CalendarUtils");return {animationMode:n.getAnimationMode(),language:o.getLanguage(),theme:r.getTheme(),themeRoot:r.getThemeRoot(),rtl:o.getRTL(),timezone:o.getTimezone(),calendarType:s.getCalendarType(),formatSettings:{firstDayOfWeek:c.getWeekConfigurationValues().firstDayOfWeek,legacyDateCalendarCustomizing:s.getCustomIslamicCalendarData?.()??s.getLegacyDateCalendarCustomizing?.()}}}const e=window.sap.ui.require("sap/ui/core/Core").getConfiguration(),i=window.sap.ui.require("sap/ui/core/LocaleData");return {animationMode:e.getAnimationMode(),language:e.getLanguage(),theme:e.getTheme(),themeRoot:e.getThemeRoot(),rtl:e.getRTL(),timezone:e.getTimezone(),calendarType:e.getCalendarType(),formatSettings:{firstDayOfWeek:i?i.getInstance(e.getLocale()).getFirstDayOfWeek():void 0,legacyDateCalendarCustomizing:e.getFormatSettings().getLegacyDateCalendarCustomizing()}}}static getLocaleDataObject(){if(!a.isOpenUI5Detected())return;const t=window.sap.ui.require("sap/ui/core/LocaleData");if(a.isAtLeastVersion116()){const n=window.sap.ui.require("sap/base/i18n/Localization");return t.getInstance(n.getLanguageTag())._get()}const i=window.sap.ui.require("sap/ui/core/Core").getConfiguration();return t.getInstance(i.getLocale())._get()}static _listenForThemeChange(){if(a.isAtLeastVersion116()){const t=window.sap.ui.require("sap/ui/core/Theming");t.attachApplied(()=>{u$9(t.getTheme());});}else {const t=window.sap.ui.require("sap/ui/core/Core"),e=t.getConfiguration();t.attachThemeChanged(()=>{u$9(e.getTheme());});}}static attachListeners(){a.isOpenUI5Detected()&&a._listenForThemeChange();}static cssVariablesLoaded(){if(!a.isOpenUI5Detected())return;const t=[...document.head.children].find(e=>e.id==="sap-ui-theme-sap.ui.core");return t?!!t.href.match(/\/css(-|_)variables\.css/)||!!t.href.match(/\/library\.css/):false}static addOpenedPopup(t){l$n(t);}static removeOpenedPopup(t){u$h(t);}static getTopmostPopup(){return y$9()}};s$w("OpenUI5Support",a$c);
   ...
   */
  var t$d;const i$a=window,s$j=i$a.trustedTypes,e$c=s$j?s$j.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$a="$lit$",n$l=`lit$${(Math.random()+"").slice(9)}$`,l$c="?"+n$l,h$3=`<${l$c}>`,r$b=document,u$8=()=>r$b.createComment(""),d$5=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$c=Array.isArray,v$3=t=>c$c(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$b="[ \t\n\f\r]",f$9=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$3=/-->/g,m$9=/>/g,p$5=RegExp(`>|${a$b}(?:([^\\s"'>=/]+)(${a$b}*=${a$b}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$6=/'/g,$$1=/"/g,y$5=/^(?:script|style|textarea|title)$/i,w$2=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$1=w$2(1),b$7=w$2(2),T=Symbol.for("lit-noChange"),A$3=Symbol.for("lit-nothing"),E=new WeakMap,C$4=r$b.createTreeWalker(r$b,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$c?e$c.createHTML(i):i}const V$1=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$9;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$9?"!--"===c[1]?u=_$3:void 0!==c[1]?u=m$9:void 0!==c[2]?(y$5.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$5):void 0!==c[3]&&(u=p$5):u===p$5?">"===c[0]?(u=null!=l?l:f$9,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$5:'"'===c[3]?$$1:g$6):u===$$1||u===g$6?u=p$5:u===_$3||u===m$9?u=f$9:(u=p$5,l=void 0);const w=u===p$5&&t[i+1].startsWith("/>")?" ":"";r+=u===f$9?s+h$3:v>=0?(e.push(d),s.slice(0,v)+o$a+s.slice(v)+n$l+w):s+n$l+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$2 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V$1(t,i);if(this.el=N.createElement(a,e),C$4.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$4.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$a)||i.startsWith(n$l)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$a).split(n$l),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H:"?"===i[1]?L$2:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$5.test(h.tagName)){const t=h.textContent.split(n$l),i=t.length-1;if(i>0){h.textContent=s$j?s$j.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$8()),C$4.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$8());}}}else if(8===h.nodeType)if(h.data===l$c)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$l,t+1));)v.push({type:7,index:r}),t+=n$l.length-1;}r++;}}static createElement(t,i){const s=r$b.createElement("template");return s.innerHTML=t,s}};function S$1(t,i,s=t,e){var o,n,l,h;if(i===T)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$5(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$1(t,r._$AS(t,i.values),r,e)),i}let M$2 = class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$b).importNode(s,true);C$4.currentNode=o;let n=C$4.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$3(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$4.nextNode(),l++);}return C$4.currentNode=r$b,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$3 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$3,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$1(this,t,i),d$5(t)?t===A$3||null==t||""===t?(this._$AH!==A$3&&this._$AR(),this._$AH=A$3):t!==this._$AH&&t!==T&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$3(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$3&&d$5(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$b.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N$2.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M$2(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N$2(t)),i}T(t){c$c(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$8()),this.k(u$8()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$3,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$3;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$1(this,t,i,0),n=!d$5(t)||t!==this._$AH&&t!==T,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$1(this,e[s+l],i,l),h===T&&(h=this._$AH[l]),n||(n=!d$5(h)||h!==this._$AH[l]),h===A$3?t=A$3:t!==A$3&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$3?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$3?void 0:t;}}const I$2=s$j?s$j.emptyScript:"";let L$2 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$3?this.element.setAttribute(this.name,I$2):this.element.removeAttribute(this.name);}};class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$1(this,t,i,0))&&void 0!==s?s:A$3)===T)return;const e=this._$AH,o=t===A$3&&e!==A$3||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$3&&(e===A$3||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$1(this,t);}}const B$1=i$a.litHtmlPolyfillSupport;null==B$1||B$1(N$2,R$3),(null!==(t$d=i$a.litHtmlVersions)&&void 0!==t$d?t$d:i$a.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$b=Symbol.for(""),l$b=t=>{if((null==t?void 0:t.r)===e$b)return null==t?void 0:t._$litStatic$},o$9=t=>({_$litStatic$:t,r:e$b}),s$i=new Map,a$a=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$b(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$i.get(t))&&(n.raw=n,s$i.set(t,r=n)),e=u;}return t(r,...e)},n$k=a$a(x$1),u$7=a$a(b$7);

  let t$c = class t{static{this.html=n$k;}static{this.svg=u$7;}static{this.unsafeStatic=o$9;}};s$w("LitStatic",t$c);
  ...
  let n$i;i$k(()=>{n$i=void 0;});const d$4=()=>(n$i===void 0&&(n$i=C$6()),n$i),m$8=o=>{Object.values(u$e).includes(o)&&(n$i=o);};

  var s$h=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$h||{});

  let n$h;i$k(()=>{n$h=void 0;});const i$9=()=>(n$h===void 0&&(n$h=D$4()),n$h&&n$h in s$h?n$h:s$h.Gregorian);

  let t$a;let a$8 = class a{static getLegacyDateCalendarCustomizing(){return t$a===void 0&&(t$a=M$3()),t$a.legacyDateCalendarCustomizing||[]}};s$w("LegacyDateFormats",a$8);

  let e$a;i$k(()=>{e$a=void 0;});const n$g=()=>(e$a===void 0&&(e$a=M$3()),e$a.firstDayOfWeek),i$8=n$u("LegacyDateFormats"),m$7=i$8?a$8.getLegacyDateCalendarCustomizing:()=>[];

  const t$9=new Map,e$9=(n,o)=>{t$9.set(n,o);},c$b=n=>t$9.get(n);

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$g=new Map;s$g.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$g.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$g.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$a=(n,e)=>{if(s$g.has(n)){s$g.set(n,{...e,...s$g.get(n)});return}s$g.set(n,e);},r$a=n=>{const e=n$m()?"legacy":"sap_horizon";return s$g.has(n)?s$g.get(n)[e]:n};
  ...
  var s$f = ":host{justify-content:center;align-items:center;display:flex;color:var(--sapList_TextColor);background-color:var(--sapList_Background);font-family:var(--sapFontFamily);height:var(--sapElement_LineHeight);border-bottom:var(--sapList_BorderWidth) solid var(--sapList_BorderColor);opacity:.8;position:absolute;padding:0 1rem;top:-1000px;left:-1000px}";

  const t$6=typeof document>"u",o$8=()=>{if(t$6)return a$l;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$l};

  const e$8=new i$l,n$e="languageChange",t$5=a=>{e$8.attachEvent(n$e,a);},r$9=a=>{e$8.detachEvent(n$e,a);},o$7=a=>e$8.fireEventAsync(n$e,a);

  let e$7,t$4;i$k(()=>{e$7=void 0,t$4=void 0;});let a$7=false;const s$e=()=>a$7,l$a=()=>(e$7===void 0&&(e$7=L$3()),e$7),L$1=async n=>{e$7!==n&&(a$7=true,e$7=n,await o$7(n),a$7=false,h$4()&&await C$5({languageAware:true}));},c$9=()=>a$l,m$6=n=>{t$4=n;},h$2=()=>(t$4===void 0&&(t$4=R$6()),t$4);
  ...
  const r$7=new Map,n$c=t=>(r$7.has(t)||r$7.set(t,new r$8(t)),r$7.get(t)),c$8=t=>{try{if(t&&typeof t=="string")return n$c(t)}catch{}return new r$8(r$k)},s$d=t=>{const e=l$a();return e?n$c(e):c$8(o$8())};

  const _$2=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$7=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$4=i=>{let e;if(!i)return r$k;if(typeof i=="string"&&(e=_$2.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$7.exec(o))||r&&(e=c$7.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$k};

  const r$6={zh_HK:"zh_TW",in:"id"},n$b=t=>{if(!t)return r$k;if(r$6[t])return r$6[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$k?r$k:""};

  const d$3=new Set,m$5=new Set,g$5=new Map,l$9=new Map,u$5=new Map,$=(n,t,e)=>{const r=`${n}/${t}`;u$5.set(r,e);},f$6=(n,t)=>{g$5.set(n,t);},A$2=n=>g$5.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$9.get(e)&&l$9.set(e,r(t)),l$9.get(e)},M$1=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L=(n,t)=>t!==a$l&&!h$1(n,t),w$1=async n=>{const t=s$d().getLanguage(),e=s$d().getRegion(),r=s$d().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L(n,s))for(s=p$4(s);L(n,s);)s=n$b(s);const I=h$2();if(s===a$l&&!I){f$6(n,null);return}if(!h$1(n,s)){M$1(n);return}try{const o=await B(n,s);f$6(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$5.keys()];return Promise.all(t.map(w$1))});
  ...
  const r$5=new Map;let s$c;let u$4 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$6=n=>{if(r$5.has(n))return r$5.get(n);const e=new u$4(n);return r$5.set(n,e),e},f$5=async n=>s$c?s$c(n):(await w$1(n),a$6(n)),y$4=n=>{s$c=n;};

  const e$6={key:"DRAG_DROP_MULTIPLE_TEXT",defaultText:"{0} items"};

  const l$8=2;let a$5=null;const g$3=e=>{a$5=e;},d$2=()=>{a$5=null;},p$3=()=>a$5,u$3=async e=>{const t=document.createElement("div"),n=await f$5("@ui5/webcomponents-base"),r=t.attachShadow({mode:"open"}),o=new CSSStyleSheet;return o.replaceSync(s$f),r.adoptedStyleSheets=[o],r.textContent=n.getText(e$6,e),t},m$4=async(e,t)=>{if(e<l$8){console.warn(`Cannot start multiple drag with count ${e}. Minimum is ${l$8}.`);return}if(!t.dataTransfer)return;const n=await u$3(e);document.body.appendChild(n),t.dataTransfer.setDragImage(n,0,0),requestAnimationFrame(()=>{n.remove();});},D$3={setDraggedElement:g$3,clearDraggedElement:d$2,getDraggedElement:p$3,startMultipleDrag:m$4};

  const c$6=["value-changed","click"];let e$5;i$k(()=>{e$5=void 0;});const s$b=t=>c$6.includes(t),l$7=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$5===void 0&&(e$5=F$1()),e$5),f$4=t=>{e$5=t;},a$4=t=>{const n=o$6();return s$b(t)?false:n===true?true:!l$7(t)};
  ...
  const y$3={BACKSPACE:8,TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,ARROW_LEFT:37,ARROW_UP:38,ARROW_RIGHT:39,ARROW_DOWN:40,DELETE:46,F4:115,F8:119},b$4=o=>(o.key?o.key==="Enter":o.keyCode===y$3.ENTER)&&!a$3(o),C$3=o=>e$4(o,true,false,false),A$1=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$3.SPACE)&&!a$3(o),D$2=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$3.ARROW_LEFT)&&!a$3(o),R$2=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$3.ARROW_RIGHT)&&!a$3(o),P=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$3.ARROW_UP)&&!a$3(o),_$1=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$3.ARROW_DOWN)&&!a$3(o),O$2=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$3.ARROW_UP)&&e$4(o,false,false,true),N$1=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$3.ARROW_DOWN)&&e$4(o,false,false,true),h=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$3.ARROW_LEFT)&&e$4(o,false,false,true),I$1=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$3.ARROW_RIGHT)&&e$4(o,false,false,true),M=o=>(o.key?o.key==="Home":o.keyCode===y$3.HOME)&&!a$3(o),n$a=o=>(o.key?o.key==="End":o.keyCode===y$3.END)&&!a$3(o),m$2=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$3.ESCAPE)&&!a$3(o),x=o=>(o.key?o.key==="Tab":o.keyCode===y$3.TAB)&&!a$3(o),V=o=>(o.key?o.key==="Tab":o.keyCode===y$3.TAB)&&e$4(o,false,false,true),Q=o=>(o.key?o.key==="Backspace":o.keyCode===y$3.BACKSPACE)&&!a$3(o),X=o=>(o.key?o.key==="Delete":o.keyCode===y$3.DELETE)&&!a$3(o),j=o=>(o.key?o.key==="PageUp":o.keyCode===y$3.PAGE_UP)&&!a$3(o),q=o=>(o.key?o.key==="PageDown":o.keyCode===y$3.PAGE_DOWN)&&!a$3(o),ko=o=>o.key?s$9(o)||Ao(o):o.keyCode===y$3.F4&&!a$3(o)||o.keyCode===y$3.ARROW_DOWN&&e$4(o,false,true,false),s$9=o=>o.key==="F4"&&!a$3(o),Co=o=>(o.key?o.key==="F8":o.keyCode===y$3.F8)&&e$4(o,true,true,false),Ao=o=>(o.key==="ArrowDown"||o.key==="Down"||o.key==="ArrowUp"||o.key==="Up")&&e$4(o,false,true,false),Ko=o=>o.key==="Shift"||o.keyCode===y$3.SHIFT,a$3=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey),e$4=(o,r,l,E)=>o.shiftKey===E&&o.altKey===l&&k(o)===r;
  ...
  var PackageModule = /*#__PURE__*/Object.freeze({
    ...
    getCustomElementsScopingSuffix: c$h,
    getDefaultIconCollection: c$b,
    getDefaultLanguage: c$9,
    getDefaultTheme: g$7,
    getEffectiveDir: r$1,
    getEffectiveIconCollection: i$7,
    getEffectiveScopingSuffixForTag: g$b,
    getFetchDefaultLanguage: h$2,
